...
![landing_page.png](https://developers.openai.com/cookbook/assets/images/landing_page.png)

1. A summary of changes in the referenced pull request(PR).

![First Interaction](https://developers.openai.com/cookbook/assets/images/first_interaction.png)

2. Quality and Security feedback and suggestions to incorporate in the next iteration of the PR.

![First Feedback](https://developers.openai.com/cookbook/assets/images/first_feedback.png)

3. An option to iterate on the feedback or accept it and have the GPT post it directly to the PR as a comment from you. 

![First Interaction](https://developers.openai.com/cookbook/assets/images/final_result.png)
