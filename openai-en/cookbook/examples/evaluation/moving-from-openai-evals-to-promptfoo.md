...
![Promptfoo results view after running the recreated evaluation](https://developers.openai.com/cookbook/assets/images/promptfoo-custom-example-view.png)
...
If you use Codex, see [Add evals to your AI application](https://developers.openai.com/codex/use-cases/ai-app-evals) to build and maintain Promptfoo eval suites with the Promptfoo Codex plugin.
