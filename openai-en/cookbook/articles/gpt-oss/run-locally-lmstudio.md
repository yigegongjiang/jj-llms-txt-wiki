...
Note about prompt formatting: LM Studio utilizes OpenAI's [Harmony](https://developers.openai.com/cookbook/articles/openai-harmony) library to construct the input to gpt-oss models, both when running via llama.cpp and MLX.
