...
Note that this guide is meant for consumer hardware, like running a model on a PC or Mac. For server applications with dedicated GPUs like NVIDIA’s H100s, [check out our vLLM guide](https://developers.openai.com/cookbook/articles/gpt-oss/run-vllm).
...
Ollama applies a **chat template** out of the box that mimics the [OpenAI harmony format](https://developers.openai.com/cookbook/articles/openai-harmony). Type your message and start the conversation.
