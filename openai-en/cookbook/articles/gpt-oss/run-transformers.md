...
Bonus: You can also fine-tune models via transformers, [check out our fine-tuning guide here](https://developers.openai.com/cookbook/articles/gpt-oss/fine-tune-transformers).
...
OpenAI gpt-oss models use the [harmony response format](https://developers.openai.com/cookbook/article/harmony) for structuring messages, including reasoning and tool calls.
