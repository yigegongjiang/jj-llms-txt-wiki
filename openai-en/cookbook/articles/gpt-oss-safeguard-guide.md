...
- [HuggingFace Transformers](https://developers.openai.com/cookbook/articles/gpt-oss/run-locally-lmstudio) (for consumer GPUs)
- [Google Colab](https://developers.openai.com/cookbook/articles/gpt-oss/run-colab)

And locally using:

- [LM Studio](https://developers.openai.com/cookbook/articles/gpt-oss/run-locally-lmstudio)
- [Ollama](https://developers.openai.com/cookbook/articles/gpt-oss/run-locally-ollama)
