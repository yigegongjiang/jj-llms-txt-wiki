...
![Model spending control: count the input, set aside the highest possible cost, run the model, and record the actual cost.](https://developers.openai.com/cookbook/assets/images/per_run_spending_controller/decision_flow.svg)
...
![Support ticket budget: the first answer spends $0.01 and the second answer is blocked because $0.0146 exceeds the remaining $0.01.](https://developers.openai.com/cookbook/assets/images/per_run_spending_controller/support_ticket.svg)
