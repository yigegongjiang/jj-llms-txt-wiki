...
* [Claude Code erweitern](/docs/de/features-overview): wann CLAUDE.md vs Skills vs Regeln vs Hooks vs MCP verwendet werden
* [Anweisungen und Erinnerungen speichern](/docs/de/memory): CLAUDE.md-Hierarchie und automatisches Gedächtnis
* [Subagents](/docs/de/sub-agents): Recherche an ein separates Kontextfenster delegieren
* [Best Practices](/docs/de/best-practices): Verwaltung des Kontexts als Ihre primäre Einschränkung
* [Prompt Caching](/docs/de/prompt-caching): welche Aktionen den zwischengespeicherten Präfix ungültig machen
* [Token-Nutzung reduzieren](/docs/de/costs#reduce-token-usage): Strategien zur Senkung der Kontextnutzung
