...
* [Estendi Claude Code](/docs/it/features-overview): quando usare CLAUDE.md rispetto a skill rispetto a regole rispetto a hook rispetto a MCP
* [Archivia istruzioni e memorie](/docs/it/memory): gerarchia CLAUDE.md e memoria automatica
* [Subagent](/docs/it/sub-agents): delega la ricerca a una finestra di contesto separata
* [Best practice](/docs/it/best-practices): gestione del contesto come vincolo principale
* [Prompt caching](/docs/it/prompt-caching): quali azioni invalidano il prefisso memorizzato nella cache
* [Riduci l'utilizzo dei token](/docs/it/costs#reduce-token-usage): strategie per mantenere basso l'utilizzo del contesto
