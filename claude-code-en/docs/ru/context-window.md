...
* [Расширьте Claude Code](/docs/ru/features-overview): когда использовать CLAUDE.md против skills против правил против hooks против MCP
* [Сохраняйте инструкции и воспоминания](/docs/ru/memory): иерархия CLAUDE.md и автоматическая память
* [Subagents](/docs/ru/sub-agents): делегируйте исследование отдельному контекстному окну
* [Лучшие практики](/docs/ru/best-practices): управление контекстом как вашим основным ограничением
* [Prompt caching](/docs/ru/prompt-caching): какие действия инвалидируют кэшированный префикс
* [Снизьте использование токенов](/docs/ru/costs#reduce-token-usage): стратегии для поддержания низкого использования контекста
