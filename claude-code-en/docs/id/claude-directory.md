...
# Jelajahi direktori .claude

> Tempat Claude Code membaca CLAUDE.md, settings.json, hooks, skills, commands, subagents, workflows, rules, dan auto memory. Jelajahi direktori .claude di proyek Anda dan ~/.claude di direktori home Anda.
...
<Note>
  ...
  * Beberapa variabel lingkungan memiliki prioritas di atas pengaturan yang setara, tetapi ini bervariasi: periksa [referensi variabel lingkungan](/docs/id/env-vars) untuk masing-masing
  ...
  Lihat [prioritas pengaturan](/docs/id/settings#settings-precedence) untuk urutan lengkapnya.
</Note>
...
| [`commands/*.md`](#ce-commands)                     | Proyek dan global | ✓      | Prompt file tunggal; mekanisme yang sama dengan skills                                                                 | [Skills](/docs/id/skills)                                            |
| [`output-styles/*.md`](#ce-output-styles)           | Proyek dan global | ✓      | Bagian prompt sistem khusus                                                                                            | [Output styles](/docs/id/output-styles)                              |
...
Jika pengaturan, hook, atau file tidak berlaku, lihat [Debug konfigurasi Anda](/docs/id/debug-your-config) untuk perintah inspeksi dan tabel pencarian berdasarkan gejala.
...
* [Kelola memory Claude](/docs/id/memory): tulis dan atur CLAUDE.md, rules, dan auto memory
* [Konfigurasi settings](/docs/id/settings): atur izin, hooks, variabel lingkungan, dan default model
* [Buat skills](/docs/id/skills): bangun prompt dan workflow yang dapat digunakan kembali
* [Konfigurasi subagents](/docs/id/sub-agents): tentukan agen khusus dengan konteks mereka sendiri
