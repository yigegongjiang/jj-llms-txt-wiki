...
* [Estenda Claude Code](/docs/pt/features-overview): quando usar CLAUDE.md vs skills vs regras vs hooks vs MCP
* [Armazene instruções e memórias](/docs/pt/memory): hierarquia CLAUDE.md e memória automática
* [Subagents](/docs/pt/sub-agents): delegue pesquisa a uma janela de contexto separada
* [Melhores práticas](/docs/pt/best-practices): gerenciando contexto como sua restrição principal
* [Prompt caching](/docs/pt/prompt-caching): quais ações invalidam o prefixo em cache
* [Reduza o uso de tokens](/docs/pt/costs#reduce-token-usage): estratégias para manter o uso de contexto baixo
