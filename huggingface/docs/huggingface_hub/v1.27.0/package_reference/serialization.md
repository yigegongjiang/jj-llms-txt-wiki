...
Here is how to export a folder containing different parts of a diffusion model using [export_folder_as_dduf()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.export_folder_as_dduf):
...
For more flexibility, you can use [export_entries_as_dduf()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.export_entries_as_dduf) and pass a list of files to include in the final DDUF file:
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_dduf.py#L160)
...
This is a lower-level helper than [export_folder_as_dduf()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.export_folder_as_dduf) that allows more flexibility when serializing data.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_dduf.py#L249)
...
AUses [export_entries_as_dduf()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.export_entries_as_dduf) under the hood.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_dduf.py#L91)
...
A dictionary of [DDUFEntry](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.DDUFEntry) indexed by filename.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_dduf.py#L36)
...
See [read_dduf_file()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.read_dduf_file) for how to read a DDUF file.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_dduf.py#L58)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_dduf.py#L75)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/errors.py#L509)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/errors.py#L513)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/errors.py#L517)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/errors.py#L521)

Exception thrown when the entry name is invalid.

## Saving tensors

The main helper of the `serialization` module takes a torch `nn.Module` as input and saves it to disk. It handles the logic to save shared tensors (see [safetensors explanation](https://huggingface.co/docs/safetensors/torch_shared_tensors)) as well as logic to split the state dictionary into shards, using [split_torch_state_dict_into_shards()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.split_torch_state_dict_into_shards) under the hood. At the moment, only `torch` framework is supported.

If you want to save a state dictionary (e.g. a mapping between layer names and related tensors) instead of a `nn.Module`, you can use [save_torch_state_dict()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.save_torch_state_dict) which provides the same features. This is useful for example if you want to apply custom logic to the state dict before saving it.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_torch.py#L41)
...
See also [save_torch_state_dict()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.save_torch_state_dict) to save a state dict with more flexibility.
...
[split_torch_state_dict_into_shards()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.split_torch_state_dict_into_shards) under the hood. If `safe_serialization` is `True`, the shards are saved as
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_torch.py#L135)
...
See also [save_torch_model()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.save_torch_model) to directly save a PyTorch model.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_torch.py#L292)
...
> [!TIP]
> To save a model state dictionary to the disk, see [save_torch_state_dict()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.save_torch_state_dict). This helper uses
...
```python
huggingface_hub.split_state_dict_into_shards_factory(state_dict: dict, get_storage_size: Callable, filename_pattern: str, get_storage_id: Callable = <function <lambda> at 0x7f8e79d5d1b0>, max_shard_size: int | str = '5GB')
```

[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_base.py#L50)
...
The loading helpers support both single-file and sharded checkpoints in either safetensors or pickle format. [load_torch_model()](/docs/huggingface_hub/v1.27.0/en/package_reference/serialization#huggingface_hub.load_torch_model) takes a `nn.Module` and a checkpoint path (either a single file or a directory) as input and load the weights into the model.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_torch.py#L365)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_torch.py#L571)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_torch.py#L757)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.27.0/src/huggingface_hub/serialization/_torch.py#L774)
