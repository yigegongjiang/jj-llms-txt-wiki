...
- If user is logged in, an [OAuthInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/oauth#huggingface_hub.OAuthInfo) object is returned with the user's info. If not, `None` is returned.
...
Returns the information from a logged-in user as a [OAuthInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/oauth#huggingface_hub.OAuthInfo) object.
...
See [attach_huggingface_oauth()](/docs/huggingface_hub/v1.25.1/en/package_reference/oauth#huggingface_hub.attach_huggingface_oauth) for an example on how to use this method.
...
- **user_info** ([OAuthUserInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/oauth#huggingface_hub.OAuthUserInfo)) --
