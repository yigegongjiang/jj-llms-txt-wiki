...
Using the root method is more straightforward but the [HfApi](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi) class gives you more flexibility.
In particular, you can pass a token that will be reused in all HTTP calls. This is different
from `hf auth login` or [login()](/docs/huggingface_hub/v1.25.1/en/package_reference/authentication#huggingface_hub.login) as the token is not persisted on the machine.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.- `HfHubHTTPError` -- 
...
- `HfHubHTTPError` -- 
  HTTP 404 if the user access request is already in the accepted list.`HfHubHTTPError`
...
cancelled or rejected at any time using [cancel_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.cancel_access_request) and [reject_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.reject_access_request).
...
- `HfHubHTTPError` -- 
  HTTP 409 if the item you try to add to the collection is already in the collection (and exists_ok=False)`HfHubHTTPError`
Add an item to a collection on the Hub.

Returns: [Collection](/docs/huggingface_hub/v1.25.1/en/package_reference/collections#huggingface_hub.Collection)
...
- **write** (`bool`, *optional*) --
  ...
  If `False` (default), only checks for read access.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
...
- [GatedRepoError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.GatedRepoError) -- 
  Raised if the repository exists but is gated and the user is not authorized to access it.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [GatedRepoError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.GatedRepoError)
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[BucketInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.BucketInfo)The bucket information.- `BucketNotFoundError` -- If the bucket cannot be found. This may be because it doesn't exist,
- ``or`` -- because it is set to `private` and you do not have access.</raises><raisederrors>`BucketNotFoundError` or ``or``
...
- `HfHubHTTPError` -- 
  HTTP 404 if the user access request cannot be found.
- `HfHubHTTPError` -- 
  HTTP 404 if the user access request is already in the pending list.`HfHubHTTPError`
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[DiscussionStatusChange](/docs/huggingface_hub/v1.25.1/en/package_reference/community#huggingface_hub.DiscussionStatusChange)the status change event
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[DiscussionComment](/docs/huggingface_hub/v1.25.1/en/package_reference/community#huggingface_hub.DiscussionComment)the newly created comment
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.- [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError) -- 
  If source/destination URIs are invalid or if copying from a bucket to a repo.``ValueError``
...
Repo-to-repo copies use [CommitOperationCopy](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitOperationCopy) under the hood and create a commit on the destination
...
- **exist_ok** (`bool`, *optional*, defaults to `False`) --
  If `True`, do not raise an error if branch already exists.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
...
- [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError) -- 
  ...
  set to `False`.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [BadRequestError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.BadRequestError) or [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError)

Create a new branch for a repo on the Hub, starting from the specified revision (defaults to `main`).
To find a revision suiting your needs, you can use [list_repo_refs()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_repo_refs) or [list_repo_commits()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_repo_commits).
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[BucketUrl](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.BucketUrl)URL to the newly created bucket containing
...
- **operations** (`Iterable` of `CommitOperation()`) --
  ...
  - [CommitOperationAdd](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitOperationAdd) to upload a file
  - [CommitOperationDelete](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitOperationDelete) to delete a file
  - [CommitOperationCopy](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitOperationCopy) to copy a file
...
- **run_as_future** (`bool`, *optional*) --
  ...
  object. Defaults to `False`.[CommitInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitInfo) or `Future`Instance of [CommitInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitInfo) containing information about the newly created commit (commit hash, commit
url, pr url, commit message,...). If `run_as_future=True` is passed, returns a Future object which will
contain the result when executed.- [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError) -- 
...
- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private
  but not authenticated or repo does not exist.``ValueError`` or [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError)
...
> create it first using [create_repo()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_repo).
...
Creating a Pull Request with changes can also be done at once with [HfApi.create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit).

Returns: [DiscussionWithDetails](/docs/huggingface_hub/v1.25.1/en/package_reference/community#huggingface_hub.DiscussionWithDetails)
...
"}, {"name": "domain", "val": ": str | None = None"}, {"name": "path", "val": ": str | None = None"}, {"name": "cache_http_responses", "val": ": bool | None = None"}, {"name": "tags", "val": ": list[str] | None = None"}, {"name": "namespace", "val": ": str | None = None"}, {"name": "token", "val": ": bool | str | None = None"}]}>
- **name** (`str`) --
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[InferenceEndpoint](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint)information about the updated Inference Endpoint.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
- **namespace** (`str`, *optional*) --
  The namespace where the Inference Endpoint will be created. Defaults to the current user's namespace.[InferenceEndpoint](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint)information about the new Inference Endpoint.
...
This is a wrapper around [HfApi.create_discussion()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_discussion).
...
- **space_hardware** (`SpaceHardware` or `str`, *optional*) --
  Choice of Hardware if repo_type is "space". See [SpaceHardware](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceHardware) for a complete list.
- **space_storage** (`SpaceStorage` or `str`, *optional*) --
   Choice of persistent storage tier. Example: `"small"`. See [SpaceStorage](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceStorage) for a complete list.
...
- **space_volumes** (`list[Volume]`, *optional*) --
  A list of [Volume](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.Volume) objects to mount in the Space at creation time. Each volume has a `type`
...
- **space_template** (`str`, *optional*) --
  ...
  [HfApi.list_space_templates()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_space_templates) to list available templates. Only applicable if repo_type is
  "space". If the template is recommended to be private and visibility is not explicitly set, the Space
  is created as private.[RepoUrl](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.RepoUrl)URL to the newly created repo. Value is a subclass of `str` containing
...
- **volumes** (`list[Volume]`, *optional*) --
  ...
  Each volume is a [Volume](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.Volume) with `type` (`"bucket"`, `"model"`, `"dataset"`, or `"space"`),
...
- **exist_ok** (`bool`, *optional*, defaults to `False`) --
  If `True`, do not raise an error if tag already exists.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private
  but not authenticated or repo does not exist.
...
- [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError) -- 
  If the branch already exists on the repo (error 409) and `exist_ok` is
  set to `False`.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) or [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError)
...
- **watched** (`list[WebhookWatchedItem]`) --
  List of [WebhookWatchedItem](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.WebhookWatchedItem) to be watched by the webhook. It can be users, orgs, models, datasets or spaces.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  To disable authentication, pass `False`.[WebhookInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.WebhookInfo)Info about the newly created webhook.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[hf_api.DatasetInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.DatasetInfo)The dataset repository information.
...
- **repo_type** (`str`, *optional*) --
  Set to `"dataset"` or `"space"` if creating a branch on a dataset or
  space, `None` or `"model"` if tagging a model. Default is `None`.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private
  but not authenticated or repo does not exist.
- [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError) -- 
  If trying to delete a protected branch. Ex: `main` cannot be deleted.
- [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError) -- 
  If trying to delete a branch that does not exist.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError)
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.- `BucketNotFoundError` -- If the bucket cannot be found and `missing_ok` is set to `False` (default).`BucketNotFoundError`
...
- **item_object_id** (`str`) --
  ...
  It must be retrieved from a [CollectionItem](/docs/huggingface_hub/v1.25.1/en/package_reference/collections#huggingface_hub.CollectionItem) object. Example: `collection.items[0].item_object_id`.
- **missing_ok** (`bool`, *optional*) --
...
Simple wrapper around [create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit) method.
...
to pause it with [pause_inference_endpoint()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.pause_inference_endpoint) or scale it to zero with [scale_to_zero_inference_endpoint()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.scale_to_zero_inference_endpoint).

For convenience, you can also delete an Inference Endpoint using [InferenceEndpoint.delete()](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint.delete).
...
- **missing_ok** (`bool`, *optional*, defaults to `False`) --
  If `True`, do not raise an error if repo does not exist.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If the repository to delete from cannot be found and `missing_ok` is set to False (default).[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError)
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime)Runtime information about a Space including Space stage and hardware.- `BadRequestError` -- 
  If space has no persistent storage.`BadRequestError`
Delete persistent storage for a Space.

> [!WARNING]
> `delete_space_storage` is deprecated and will be removed in version 2.0. Use [delete_space_volumes()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.delete_space_volumes) instead.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.- `BadRequestError` -- 
  If the Space has no volumes attached.`BadRequestError`
...
- **repo_type** (`str`, *optional*) --
  ...
  `"model"` if tagging a model. Default is `None`.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private
  but not authenticated or repo does not exist.
- [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) -- 
  If tag is not found.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError)
...
- **token** (`bool` or `str`, *optional*) --
  A valid user access token (string). Defaults to the locally saved token, which is the recommended
  method for authentication (see https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`None`
Delete a webhook.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime)Runtime information about your Space.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
...
- [BadRequestError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.BadRequestError) -- 
  ...
  a static Space, you can set it to private.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError) or [BadRequestError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.BadRequestError)
...
- **token** (`bool` or `str`, *optional*) --
  A valid user access token (string). Defaults to the locally saved token, which is the recommended
  method for authentication (see https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[WebhookInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.WebhookInfo)Info about the disabled webhook.
...
in the bucket or a [BucketFile](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.BucketFile) object, and `local file` is the destination path on the local filesystem.
When passing a [BucketFile](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.BucketFile) object (obtained from [list_bucket_tree()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_bucket_tree)), the method will skip the metadata
...
- **space_hardware** (`SpaceHardware` or `str`, *optional*) --
  ...
  [SpaceHardware](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceHardware) for a complete list.
- **space_storage** (`SpaceStorage` or `str`, *optional*) --
   Choice of persistent storage tier if repo_type is "space". Example:
  `"small"`. See [SpaceStorage](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceStorage) for a complete list.
- **space_sleep_time** (`int`, *optional*) --
...
- **space_variables** (`list[dict[str, str]]`, *optional*) --
  ...
  For more details, see https://huggingface.co/docs/hub/spaces-overview#managing-secrets-and-environment-variables.
- **space_volumes** (`list[Volume]`, *optional*) --
  A list of [Volume](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.Volume) objects to mount in the Space at duplication time. Each volume has a `type`
  (`"bucket"`, `"model"`, `"dataset"`, or `"space"`), a `source` (repo or bucket ID), a `mount_path`
  (path inside the container), and optional `revision`, `read_only`, and `path` fields.
  Only applicable if repo_type is "space".[RepoUrl](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.RepoUrl)URL to the newly created repo. Value is a subclass of `str` containing
attributes like `endpoint`, `repo_type` and `repo_id`.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If one of `from_id` or `to_id` cannot be found. This may be because it doesn't exist,
  or because it is set to `private` and you do not have access.
- `HfHubHTTPError` -- 
  If the HuggingFace API returned an error[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or `HfHubHTTPError`
...
- **hardware** (`SpaceHardware` or `str`, *optional*) --
  Choice of Hardware. Example: `"t4-medium"`. See [SpaceHardware](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceHardware) for a complete list.
...
- **variables** (`list[dict[str, str]]`, *optional*) --
  A list of public environment variables to set in your Space. Each item is in the form `{"key": ..., "value": ..., "description": ...}` where description is optional.
  For more details, see https://huggingface.co/docs/hub/spaces-overview#managing-secrets-and-environment-variables.[RepoUrl](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.RepoUrl)URL to the newly created repo. Value is a subclass of `str` containing
attributes like `endpoint`, `repo_type` and `repo_id`.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If one of `from_id` or `to_id` cannot be found. This may be because it doesn't exist,
  or because it is set to `private` and you do not have access.
- `HfHubHTTPError` -- 
...
> [!WARNING]
> `duplicate_space` is deprecated and will be removed in version 2.0. Use [duplicate_repo()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.duplicate_repo) instead.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[DiscussionComment](/docs/huggingface_hub/v1.25.1/en/package_reference/community#huggingface_hub.DiscussionComment)the edited comment
...
- **token** (`bool` or `str`, *optional*) --
  A valid user access token (string). Defaults to the locally saved token, which is the recommended
  method for authentication (see https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[WebhookInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.WebhookInfo)Info about the enabled webhook.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  authentication. See
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication.`Iterable[str]`A generator yielding log lines as they become available.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.True if the file exists, False otherwise.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[BucketFileMetadata](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.BucketFileMetadata)The file metadata containing size and xet information.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[BucketFile]`The information about the paths, as an iterable of [BucketFile](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.BucketFile) objects.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  To disable authentication, pass `False`.
- **timeout** (`float`, *optional*) --
  Whether to set a timeout for the request to the Hub.`list[DatasetLeaderboardEntry]`A list of [DatasetLeaderboardEntry](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.DatasetLeaderboardEntry) objects representing
...
view, use [model_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.model_info) with `expand=["evalResults"]`.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`str`The repository name in the user's namespace
...
- **timeout** (`float`, *optional*, defaults to 10) --
  How many seconds to wait for the server to send metadata before giving up.A [HfFileMetadata](/docs/huggingface_hub/v1.25.1/en/package_reference/file_download#huggingface_hub.HfFileMetadata) object containing metadata such as location, etag, size and commit_hash.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[InferenceEndpoint](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint)information about the requested Inference Endpoint.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  To disable authentication, pass `False`.`Organization`An `Organization` object with the organization's overview.- [`HTTPError`](https://requests.readthedocs.io/en/latest/api/#requests.HTTPError) -- 
  HTTP 404 If the organization does not exist on the Hub.``HTTPError``
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`list[Union[RepoFile, RepoFolder]]`The information about the paths, as a list of [RepoFile](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.RepoFile) and `RepoFolder` objects.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private but not authenticated or repo
  does not exist.
- [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) -- 
  If revision is not found (error 404) on the repo.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError)
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterator[Discussion]`An iterator of [Discussion](/docs/huggingface_hub/v1.25.1/en/package_reference/community#huggingface_hub.Discussion) objects.
...
- **timeout** (`float`, *optional*, defaults to 10) --
  ...
  connection can hang the call indefinitely).`SafetensorsRepoMetadata`information related to safetensors repo.- `NotASafetensorsRepoError` -- 
...
- `SafetensorsParsingError` -- 
  If a safetensors file header couldn't be parsed correctly.`NotASafetensorsRepoError` or `SafetensorsParsingError`
...
To parse metadata from a single safetensors file, use [parse_safetensors_file_metadata()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.parse_safetensors_file_metadata).
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime)Runtime information about a Space including Space stage and hardware.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`dict[str, SpaceSecret]`Dictionary of `SpaceSecret` objects keyed by secret name.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`User`A [User](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.User) object with the user's overview.- `HfHubHTTPError` -- 
...
- **token** (`bool` or `str`, *optional*) --
  A valid user access token (string). Defaults to the locally saved token, which is the recommended
  method for authentication (see https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[WebhookInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.WebhookInfo)Info about the webhook.
...
using [cancel_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.cancel_access_request) or [reject_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.reject_access_request).
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[DiscussionComment](/docs/huggingface_hub/v1.25.1/en/package_reference/community#huggingface_hub.DiscussionComment)the hidden comment
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[ModelInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.ModelInfo)The kernel repository information.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[AccessRequest]`An iterable of `AccessRequest` objects. Each time contains a `username`, `email`,
`status` and `timestamp` attribute. If the gated repo has a custom form, the `fields` attribute will
be populated with user's answers.- `HfHubHTTPError` -- 
  HTTP 400 if the repo is not gated.
- `HfHubHTTPError` -- 
  HTTP 403 if you only have read-only access to the repo. This can be the case if you don't have `write`
  or `admin` role in the organization the repo belongs to or if you passed a `read` token.`HfHubHTTPError`
...
requests. Accepted requests can be cancelled or rejected at any time using [cancel_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.cancel_access_request) and
[reject_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.reject_access_request). A cancelled request will go back to the pending list while a rejected request will
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[Union[BucketFile, BucketFolder]]`An iterable of [BucketFile](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.BucketFile) and `BucketFolder` objects
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[BucketInfo]`An iterable of [BucketInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.BucketInfo) objects.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[Collection]`an iterable of [Collection](/docs/huggingface_hub/v1.25.1/en/package_reference/collections#huggingface_hub.Collection) objects.
List collections on the Huggingface Hub, given some filters.

> [!WARNING]
> When listing collections, the item list per collection is truncated to 4 items maximum. To retrieve all items
> from a collection, you must use [get_collection()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_collection).
...
- **limit** (`int`, *optional*) --
  Limit of papers to fetch. Defaults to 50.`Iterable[PaperInfo]`an iterable of `huggingface_hub.hf_api.PaperInfo` objects.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`list[DatasetParquetEntry]`a list of `DatasetParquetEntry` objects
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[DatasetInfo]`an iterable of [huggingface_hub.hf_api.DatasetInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.DatasetInfo) objects.
...
- **token** (`bool` or `str`, *optional*) --
  A valid user access token (string). Defaults to the locally saved
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).List`str`A list of model IDs available in the catalog.
...
Use [create_inference_endpoint_from_catalog()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_inference_endpoint_from_catalog) to deploy a model from the catalog.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.list[InferenceEndpoint](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint)A list of all inference endpoints for the given namespace.
...
- **status** (`JobStage`, `str` or `list`, *optional*) --
  ...
  See [JobStage](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.JobStage) for possible values.
...
- **token** `(Union[bool, str, None]`, *optional*) --
  A valid user access token. If not provided, the locally saved token will be used, which is the
  recommended authentication method. Set to `False` to disable authentication.
  Refer to: https://huggingface.co/docs/huggingface_hub/quick-start#authentication.`Iterable[JobInfo]`an iterable of [JobInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.JobInfo) objects.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[LFSFileInfo]`An iterator of `LFSFileInfo` objects.
...
with [permanently_delete_lfs_files()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.permanently_delete_lfs_files). Note that this would be a permanent action that will affect all commits
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[UserLikes](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.UserLikes)object containing the user name and 3 lists of repo ids (1 for
models, 1 for datasets and 1 for Spaces).- [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError) -- 
  If `user` is not passed and no token found (either from argument or from machine).``ValueError``
...
See also [unlike()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.unlike).
...
- **model_name** (`str`, *optional*) --
  (deprecated). Use `search` instead.`Iterable[ModelInfo]`an iterable of [huggingface_hub.hf_api.ModelInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.ModelInfo) objects.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[User]`A list of [User](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.User) objects with the followers of the organization.- `HfHubHTTPError` -- 
  HTTP 404 If the organization does not exist on the Hub.`HfHubHTTPError`
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[User]`A list of [User](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.User) objects with the members of the organization.- `HfHubHTTPError` -- 
  HTTP 404 If the organization does not exist on the Hub.`HfHubHTTPError`
...
- **token** (Union[bool, str, None], *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[PaperInfo]`an iterable of `huggingface_hub.hf_api.PaperInfo` objects.
...
using [accept_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.accept_access_request) and [reject_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.reject_access_request).
...
repo. Rejected requests can be accepted or cancelled at any time using [accept_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.accept_access_request) and
[cancel_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.cancel_access_request). A cancelled request will go back to the pending list while an accepted request will
...
- **revision** (`str`, *optional*) --
  The git revision to commit from. Defaults to the head of the `"main"` branch.
- **formatted** (`bool`) --
  Whether to return the HTML-formatted title and description of the commits. Defaults to False.list[[GitCommitInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.GitCommitInfo)]list of objects containing information about the commits for a repo on the Hub.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private but not authenticated or repo
  does not exist.
- [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) -- 
  If revision is not found (error 404) on the repo.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError)
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`list[str]`the list of files in a given repository.
...
- **repo_type** (`str`, *optional*) --
  Set to `"dataset"` or `"space"` if uploading to a dataset or
  space, `None` or `"model"` if uploading to a model. Default is
  `None`.`Iterable[User]`an iterable of [huggingface_hub.hf_api.User](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.User) objects.

List all users who liked a given repo on the hugging Face Hub.

See also [list_liked_repos()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_liked_repos).
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[GitRefs](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.GitRefs)object containing all information about branches and tags for a
repo on the Hub.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[Union[RepoFile, RepoFolder]]`The information about the tree's files and folders, as an iterable of [RepoFile](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.RepoFile) and `RepoFolder` objects. The order of the files and folders is
not guaranteed.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private but not authenticated or repo
  does not exist.
- [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) -- 
  If revision is not found (error 404) on the repo.
- `~utils.RemoteEntryNotFoundError` -- 
  If the tree (folder) does not exist (error 404) on the repo.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) or `~utils.RemoteEntryNotFoundError`
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`list[SpaceTemplate]`The list of available Space templates.
...
to [HfApi.create_repo()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_repo) to seed a new Space from that template.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[SpaceInfo]`an iterable of [huggingface_hub.hf_api.SpaceInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.SpaceInfo) objects.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[User]`A list of [User](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.User) objects with the followers of the user.- `HfHubHTTPError` -- 
  HTTP 404 If the user does not exist on the Hub.`HfHubHTTPError`
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[User]`A list of [User](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.User) objects with the users followed by the user.- `HfHubHTTPError` -- 
  HTTP 404 If the user does not exist on the Hub.`HfHubHTTPError`
...
- **token** (`bool` or `str`, *optional*) --
  A valid user access token. Defaults to the locally saved token.`Iterable[RepoStorageInfo]`An iterable of `RepoStorageInfo` objects.
...
- **token** (`bool` or `str`, *optional*) --
  A valid user access token (string). Defaults to the locally saved token, which is the recommended
  method for authentication (see https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`list[WebhookInfo]`List of webhook info objects.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[huggingface_hub.hf_api.ModelInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.ModelInfo)The model repository information.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.- `BucketNotFoundError` -- 
  If the source bucket cannot be found. This may be because it doesn't exist,
  or because it is set to `private` and you do not have access.`BucketNotFoundError`
...
- **id** (`str`, **optional**) --
  ArXiv id of the paper.`PaperInfo`A `PaperInfo` object.- `HfHubHTTPError` -- 
  HTTP 404 If the paper does not exist on the Hub.`HfHubHTTPError`
...
- **timeout** (`float`, *optional*, defaults to 10) --
  ...
  timeout (not recommended, as a stalled connection can hang the call indefinitely).`SafetensorsFileMetadata`information related to a safetensors file.- `NotASafetensorsRepoError` -- 
  If the repo is not a safetensors repo i.e. doesn't have either a
  `model.safetensors` or a `model.safetensors.index.json` file.
- `SafetensorsParsingError` -- 
  If a safetensors file header couldn't be parsed correctly.`NotASafetensorsRepoError` or `SafetensorsParsingError`
...
To parse metadata from all safetensors files in a repo at once, use [get_safetensors_metadata()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_safetensors_metadata).
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[InferenceEndpoint](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint)information about the paused Inference Endpoint.
Pause an Inference Endpoint.

A paused Inference Endpoint will not be charged. It can be resumed at any time using [resume_inference_endpoint()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.resume_inference_endpoint).
This is different than scaling the Inference Endpoint to zero with [scale_to_zero_inference_endpoint()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.scale_to_zero_inference_endpoint), which
would be automatically restarted when a request is made to it.

For convenience, you can also pause an Inference Endpoint using [pause_inference_endpoint()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.pause_inference_endpoint).
...
hardware you've selected. To restart your Space, use [restart_space()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.restart_space) and go to your Space settings page.
...
- **lfs_files** (`Iterable[LFSFileInfo]`) --
  An iterable of `LFSFileInfo` items to permanently delete from the repo. Use [list_lfs_files()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_lfs_files) to list
...
- **additions** (`Iterable` of [CommitOperationAdd](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitOperationAdd)) --
...
- **free_memory** (`bool`, *optional*, defaults to `True`) --
  ...
  objects outside of a subsequent [create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit) call.
...
> Use [create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit) directly instead.
...
> objects except to pass them to [create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit). If you don't want to remove the attached content from the
...
- **id** (`str`) --
  ArXiv id of the paper.`str`The paper page content as markdown.- `HfHubHTTPError` -- 
  HTTP 404 If the paper does not exist on the Hub.`HfHubHTTPError`
...
- `HfHubHTTPError` -- 
  HTTP 404 if the user access request cannot be found.
- `HfHubHTTPError` -- 
  HTTP 404 if the user access request is already in the rejected list.`HfHubHTTPError`
...
requests can be accepted or cancelled at any time using [accept_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.accept_access_request) and [cancel_access_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.cancel_access_request).
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[DiscussionTitleChange](/docs/huggingface_hub/v1.25.1/en/package_reference/community#huggingface_hub.DiscussionTitleChange)the title change event
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.True if the repository exists, False otherwise.
...
- **expand** (`ExpandModelProperty_T` or `ExpandDatasetProperty_T` or `ExpandSpaceProperty_T`, *optional*) --
  List properties to return in the response. When used, only the properties in the list will be returned.
  This parameter cannot be used if `files_metadata` is passed.
  For an exhaustive list of available properties, check out [model_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.model_info), [dataset_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.dataset_info) or [space_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.space_info).
- **files_metadata** (`bool`, *optional*) --
  Whether or not to retrieve metadata for files in the repository
  (size, LFS metadata, etc). Defaults to `False`.
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Union[SpaceInfo, DatasetInfo, ModelInfo]`The repository information, as a
[huggingface_hub.hf_api.DatasetInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.DatasetInfo), [huggingface_hub.hf_api.ModelInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.ModelInfo)
or [huggingface_hub.hf_api.SpaceInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.SpaceInfo) object.
...
- **repo_id** (`str`) --
  ID of the repo to update. Example: `"bigcode/in-the-stack"`.
- **hardware** (`str` or [SpaceHardware](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceHardware)) --
...
- **sleep_time** (`int`, *optional*) --
  ...
  your Space to sleep (default behavior for upgraded hardware). For free hardware, you can't configure
  the sleep time (value is fixed to 48 hours of inactivity).
  See https://huggingface.co/docs/hub/spaces-gpus#sleep-time for more details.[SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime)Runtime information about a Space including Space stage and hardware.
Request new hardware for a Space.

> [!TIP]
> It is also possible to request hardware directly when creating the Space repo! See [create_repo()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_repo) for details.

- **repo_id** (`str`) --
  ID of the Space to update. Example: `"open-llm-leaderboard/open_llm_leaderboard"`.
- **storage** (`str` or [SpaceStorage](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceStorage)) --
...
> [!WARNING]
> `request_space_storage` is deprecated and will be removed in version 2.0. Use [set_space_volumes()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.set_space_volumes) instead.
...
- **factory_reboot** (`bool`, *optional*) --
  If `True`, the Space will be rebuilt from scratch without caching any requirements.[SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime)Runtime information about your Space.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If your Space is not found (error 404). Most probably wrong repo_id or your space is private but you
  are not authenticated.
- [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError) -- 
...
This is the only way to programmatically restart a Space if you've put it on Pause (see [pause_space()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.pause_space)). You
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[InferenceEndpoint](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint)information about the resumed Inference Endpoint.
Resume an Inference Endpoint.

For convenience, you can also resume an Inference Endpoint using [InferenceEndpoint.resume()](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint.resume).
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.True if the repository and the revision exists, False otherwise.
...
- ***args,** **kwargs --
  Arguments with which the method will be called.`Future`a [Future](https://docs.python.org/3/library/concurrent.futures.html#future-objects) instance to
...
Note: Most-used methods like [upload_file()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_file), [upload_folder()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_folder) and [create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit) have a `run_as_future: bool`
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[InferenceEndpoint](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint)information about the scaled-to-zero Inference Endpoint.
Scale Inference Endpoint to zero.

An Inference Endpoint scaled to zero will not be charged. It will be resume on the next request to it, with a
cold start delay. This is different than pausing the Inference Endpoint with [pause_inference_endpoint()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.pause_inference_endpoint), which
would require a manual resume with [resume_inference_endpoint()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.resume_inference_endpoint).

For convenience, you can also scale an Inference Endpoint to zero using [InferenceEndpoint.scale_to_zero()](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint.scale_to_zero).
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`Iterable[SpaceSearchResult]`an iterable of [SpaceSearchResult](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.SpaceSearchResult) objects.
...
> [!TIP]
> It is also possible to set a custom sleep time when requesting hardware with [request_space_hardware()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.request_space_hardware).

- **repo_id** (`str`) --
  ID of the Space to update. Example: `"username/my-space"`.
- **volumes** (`list[Volume]`) --
  List of [Volume](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.Volume) objects to mount. Each volume has a `type` (`"bucket"`, `"model"`, `"dataset"`, or
...
- **token** (`bool` or `str`, *optional*) --
  ...
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.- `BadRequestError` -- 
  If the Space is a static Space (volumes are not supported on static Spaces).`BadRequestError`
...
- **dry_run** (`bool`, *optional*, defaults to `False`) --
  ...
  [DryRunFileInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.DryRunFileInfo) objects containing information about what would be downloaded.`str` or list of [DryRunFileInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.DryRunFileInfo)- If `dry_run=False`: Folder path of the repo snapshot.
...
- [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError) -- 
  if some parameter value is invalid.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) or ``EnvironmentError`` or ``OSError`` or ``ValueError``
Download repo files.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[SpaceInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.SpaceInfo)The space repository information.
...
- **token** (`bool` or `str`, *optional*) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private but not authenticated or repo
  does not exist.
- [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) -- 
  If the branch to squash cannot be found.
- [BadRequestError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.BadRequestError) -- 
  If invalid reference for a branch. You cannot squash history on tags.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) or [BadRequestError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.BadRequestError)
...
- **token** (Union[bool, str, None], optional) --
  A valid user access token. If not provided, the locally saved token will be used.[*SyncPlan*]The computed (or loaded) sync plan.
...
- **read_only** (`bool`, *optional*, defaults to `True`) --
  ...
  bucket folder (e.g. to retrieve outputs with [sync_bucket()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.sync_bucket) afterwards).
- **namespace** (`str`, *optional*) --
...
- **token** (`Union[bool, str, None]`, *optional*) --
  A valid user access token. If not provided, the locally saved token will be used, which is the
  recommended authentication method. Set to `False` to disable authentication.
  Refer to: https://huggingface.co/docs/huggingface_hub/quick-start#authentication.[Volume](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.Volume)A bucket volume scoped to the synced subfolder, to pass in the `volumes` list
of [run_job()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.run_job), [run_uv_job()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.run_uv_job), [create_scheduled_job()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_scheduled_job) or [create_scheduled_uv_job()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_scheduled_uv_job).
Sync a local directory to a bucket and return a [Volume](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.Volume) ready to mount in a Job.
...
as [sync_bucket()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.sync_bucket): re-syncing the same directory only
...
the bucket folder back with [sync_bucket()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.sync_bucket). If the source directory is empty (e.g. an output
...
- **token** `(Union[bool, str, None]`, *optional*) --
  A valid user access token. If not provided, the locally saved token will be used, which is the
  recommended authentication method. Set to `False` to disable authentication.
  Refer to: https://huggingface.co/docs/huggingface_hub/quick-start#authentication.[JobInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.JobInfo)Info about the triggered run.- [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError) -- 
  HTTP 409 if another instance is already running and `concurrency` is disabled on the scheduled job.[HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError)
...
- **repo_type** (`str`, *optional*) --
  ...
  `"model"` if unliking a model. Default is `None`.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private
  but not authenticated or repo does not exist.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError)
...
For convenience, you can also update an Inference Endpoint using [InferenceEndpoint.update()](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_endpoints#huggingface_hub.InferenceEndpoint.update).
...
- **token** `(Union[bool, str, None]`, *optional*) --
  A valid user access token. If not provided, the locally saved token will be used, which is the
  recommended authentication method. Set to `False` to disable authentication.
  Refer to: https://huggingface.co/docs/huggingface_hub/quick-start#authentication.[JobInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.JobInfo)The updated Job info.
...
- **repo_type** (`str`, *optional*) --
  ...
  Defaults to `"model"`.- [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError) -- 
...
- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If the repository to download from cannot be found. This may be because it doesn't exist,
  or because it is set to `private` and you do not have access.``ValueError`` or [HfHubHTTPError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.HfHubHTTPError) or [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError)
...
- **token** `(Union[bool, str, None]`, *optional*) --
  A valid user access token. If not provided, the locally saved token will be used, which is the
  recommended authentication method. Set to `False` to disable authentication.
  Refer to: https://huggingface.co/docs/huggingface_hub/quick-start#authentication.`ScheduledJobInfo`The updated scheduled Job info.
...
- **watched** (`list[WebhookWatchedItem]`, optional) --
  ...
  Refer to [WebhookWatchedItem](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.WebhookWatchedItem) for more details. Watched items can also be provided as plain dictionaries.
- **domains** (`list[Literal["repo", "discussion"]]`, optional) --
...
- **token** (`bool` or `str`, *optional*) --
  A valid user access token (string). Defaults to the locally saved token, which is the recommended
  method for authentication (see https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.[WebhookInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.WebhookInfo)Info about the updated webhook.
...
`hf_xet` is not installed, falls back to a single commit created with [create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit).
...
> are set correctly. If repo does not exist, create it first using [create_repo()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_repo).
...
> [!WARNING]
> `upload_large_folder` is deprecated and will be removed in a future release. [upload_folder()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_folder) is now multi-commits
...
> [!WARNING]
> While being much more robust to upload large folders, `upload_large_folder` is more limited than [upload_folder()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_folder) feature-wise. In practice:
...
>     - you cannot create a PR directly. Please create a PR first (from the UI or using [create_pull_request()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_pull_request)) and then commit to it by passing `revision`.
...
- **token** (Union[bool, str, None], optional) --
  ...
  token, which is the recommended method for authentication (see
  https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
  To disable authentication, pass `False`.`FolderVerification`a structured result containing the verification details.- [RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) -- 
  If repository is not found (error 404): wrong repo_id/repo_type, private but not authenticated or repo
  does not exist.
- [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError) -- 
  If revision is not found (error 404) on the repo.[RepositoryNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RepositoryNotFoundError) or [RevisionNotFoundError](/docs/huggingface_hub/v1.25.1/en/package_reference/utilities#huggingface_hub.errors.RevisionNotFoundError)
...
- **job_id** (`str` or `list[str]`) --
  ID of the Job, or a list of Job IDs to wait for. If a list is passed, a list of [JobInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.JobInfo)
...
- **token** `(Union[bool, str, None]`, *optional*) --
  A valid user access token. If not provided, the locally saved token will be used, which is the
  recommended authentication method. Set to `False` to disable authentication.
  Refer to: https://huggingface.co/docs/huggingface_hub/quick-start#authentication.[JobInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.JobInfo) or `list[JobInfo]`the final Job info(s).- ``TimeoutError`` -- 
  If at least one Job has not reached one of the target stages after `timeout` seconds.``TimeoutError``

Wait until one or more compute Jobs on Hugging Face infrastructure reach a given stage.

Each Job status is polled (with [inspect_job()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.inspect_job)) every `poll_interval` seconds until its stage is one
of `stages` (terminal stages by default: `"COMPLETED"`, `"CANCELED"`, `"ERROR"` or `"DELETED"`). The
final [JobInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/jobs#huggingface_hub.JobInfo) is returned in all cases: a failed or canceled Job does **not** raise an exception —
...
- **token** (`bool` or `str`, *optional*) --
  ...
  recommended authentication method. Set to `False` to disable authentication.
  See https://huggingface.co/docs/huggingface_hub/quick-start#authentication.[SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime)The final runtime information once the Space reaches a terminal stage.- ``TimeoutError`` -- 
  If the Space has not reached a terminal stage after `timeout` seconds.``TimeoutError``
Wait until a Space reaches a terminal stage (not building/starting).

Polls [get_space_runtime()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_space_runtime) every `poll_interval` seconds until the Space's stage
is no longer intermediate (`BUILDING`, `RUNNING_BUILDING`, `APP_STARTING`,
`RUNNING_APP_STARTING`). Returns the final [SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime) in all cases — check
...
Contains information about a file in a bucket on the Hub. This object is returned by [list_bucket_tree()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_bucket_tree).

Similar to [RepoFile](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.RepoFile) but for files in buckets.
...
Returned by [get_bucket_file_metadata()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_bucket_file_metadata).
...
Contains information about a bucket on the Hub. This object is returned by [bucket_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.bucket_info) and [list_buckets()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_buckets).
...
`BucketUrl` is returned by [create_bucket()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_bucket). At initialization, the URL is parsed to populate properties:
- endpoint (`str`)
- namespace (`str`)
- bucket_id (`str`)
- url (`str`)
...
This object is returned by [get_dataset_leaderboard()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_dataset_leaderboard). To get evaluation results for a
specific model across benchmarks, see `ModelInfo.eval_results` (via [model_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.model_info) with
`expand=["evalResults"]`) and [EvalResultEntry](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.EvalResultEntry).
...
For the legacy `model-index` format in `README.md`, use [EvalResult](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.EvalResult) instead.
...
- **pr_num** (`int`, *optional*) --
  ...
  [get_discussion_details()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_discussion_details). Example: `1`.

- **repo_url** (`RepoUrl`) --
  Repo URL of the commit containing info like repo_id, repo_type, etc.
Data structure containing information about a newly created commit.

Returned by any method that creates a commit on the Hub: [create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit), [upload_file()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_file), [upload_folder()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_folder),
[delete_file()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.delete_file), [delete_folder()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.delete_folder). It inherits from `str` for backward compatibility but using methods specific
...
- **card_data** (`DatasetCardData`, *optional*) --
  Dataset Card Metadata  as a [huggingface_hub.repocard_data.DatasetCardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.DatasetCardData) object.
...
- **siblings** (`list[RepoSibling]`) --
  List of [huggingface_hub.hf_api.RepoSibling](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.hf_api.RepoSibling) objects that constitute the dataset.
- **tags** (`list[str]`) --
...
Contains information about a dataset on the Hub. This object is returned by [dataset_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.dataset_info) and [list_datasets()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_datasets).
...
> using [list_datasets()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_datasets) only a subset of the attributes are returned.
...
Returned by [hf_hub_download()](/docs/huggingface_hub/v1.25.1/en/package_reference/file_download#huggingface_hub.hf_hub_download) when `dry_run=True`.
...
Contains information about a git commit for a repo on the Hub. Check out [list_repo_commits()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_repo_commits) for more details.

### GitRefs[[huggingface_hub.GitRefs]]

- **branches** (`list[GitRefInfo]`) --
  A list of [GitRefInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.GitRefInfo) containing information about branches on the repo.
- **converts** (`list[GitRefInfo]`) --
  A list of [GitRefInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.GitRefInfo) containing information about "convert" refs on the repo.
  Converts are refs used (internally) to push preprocessed data in Dataset repos.
- **tags** (`list[GitRefInfo]`) --
  A list of [GitRefInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.GitRefInfo) containing information about tags on the repo.
- **pull_requests** (`list[GitRefInfo]`, *optional*) --
  A list of [GitRefInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.GitRefInfo) containing information about pull requests on the repo.
  Only returned if `include_prs=True` is set.

Contains information about all git references for a repo on the Hub.

Object is returned by [list_repo_refs()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_repo_refs).
...
Contains information about a kernel repo on the Hub. This object is returned by [kernel_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.kernel_info).
...
See [list_lfs_files()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_lfs_files) and [permanently_delete_lfs_files()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.permanently_delete_lfs_files) for more details.
...
- **card_data** (`ModelCardData`, *optional*) --
  Model Card Metadata  as a [huggingface_hub.repocard_data.ModelCardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.ModelCardData) object.
...
- **sha** (`str`, *optional*) --
  Repo SHA at this particular revision.
- **siblings** (`list[RepoSibling]`) --
  List of [huggingface_hub.hf_api.RepoSibling](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.hf_api.RepoSibling) objects that constitute the model.
...
Contains information about a model on the Hub. This object is returned by [model_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.model_info) and [list_models()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_models).

> [!TIP]
> Most attributes of this class are optional. This is because the data returned by the Hub depends on the query made.
> In general, the more specific the query, the more information is returned. On the contrary, when listing models
> using [list_models()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_models) only a subset of the attributes are returned.
...
- **size** (`int`, *optional*) --
  The file's size, in bytes. This attribute is defined when `files_metadata` argument of [repo_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.repo_info) is set
  to `True`. It's `None` otherwise.
- **blob_id** (`str`, *optional*) --
  The file's git OID. This attribute is defined when `files_metadata` argument of [repo_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.repo_info) is set to
  `True`. It's `None` otherwise.
- **lfs** (`BlobLfsInfo`, *optional*) --
  The file's LFS metadata. This attribute is defined when`files_metadata` argument of [repo_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.repo_info) is set to
...
> listing repositories on the Hub (with [list_models()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_models), [list_datasets()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_datasets) or [list_spaces()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_spaces)). If you need more
> information like file size, blob id or lfs details, you must request them specifically from one repo at a time
> (using [model_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.model_info), [dataset_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.dataset_info) or [space_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.space_info)) as it adds more constraints on the backend server to
> retrieve these.
...
- **last_commit** (`LastCommitInfo`, *optional*) --
  The file's last commit metadata. Only defined if [list_repo_tree()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_repo_tree) and [get_paths_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_paths_info)
  are called with `expand=True`.
- **security** (`BlobSecurityInfo`, *optional*) --
  The file's security scan metadata. Only defined if [list_repo_tree()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_repo_tree) and [get_paths_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_paths_info)
  are called with `expand=True`.
...
- **endpoint** (`str`, *optional*) --
  Endpoint of the Hub. Defaults to .- `HfUriError` -- 
  If the URL cannot be parsed (e.g. canonical single-segment repo, or unknown `repo_type`).`HfUriError`
...
This class is returned by [get_safetensors_metadata()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.get_safetensors_metadata).
...
This class is returned by [parse_safetensors_file_metadata()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.parse_safetensors_file_metadata).
...
- **card_data** (`SpaceCardData`, *optional*) --
  Space Card Metadata  as a [huggingface_hub.repocard_data.SpaceCardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.SpaceCardData) object.
- **created_at** (`datetime`, *optional*) --
  Date of creation of the repo on the Hub. Note that the lowest value is `2022-03-02T23:29:04.000Z`,
  corresponding to the date when we began to store creation dates.
...
- **runtime** (`SpaceRuntime`, *optional*) --
  Space runtime information as a [huggingface_hub.hf_api.SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime) object.
- **sdk** (`str`, *optional*) --
  SDK used by the Space.
- **sha** (`str`, *optional*) --
  Repo SHA at this particular revision.
- **siblings** (`list[RepoSibling]`) --
  List of [huggingface_hub.hf_api.RepoSibling](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.hf_api.RepoSibling) objects that constitute the Space.
...
Contains information about a Space on the Hub. This object is returned by [space_info()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.space_info) and [list_spaces()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_spaces).

> [!TIP]
> Most attributes of this class are optional. This is because the data returned by the Hub depends on the query made.
> In general, the more specific the query, the more information is returned. On the contrary, when listing spaces
> using [list_spaces()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.list_spaces) only a subset of the attributes are returned.
...
- **tags** (`list[str]` or `None`) --
  List of tags.
- **runtime** ([SpaceRuntime](/docs/huggingface_hub/v1.25.1/en/package_reference/space_runtime#huggingface_hub.SpaceRuntime) or `None`) --
...
Returned by [HfApi.search_spaces()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.search_spaces).
...
- **watched** (`list[WebhookWatchedItem]`) --
  List of items watched by the webhook, see [WebhookWatchedItem](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.WebhookWatchedItem).
...
- **path_or_fileobj** (`str`, `Path`, `bytes`, or `BinaryIO`) --
  ...
  - a "file object" (subclass of `io.BufferedIOBase`), typically obtained
    with `open(path, "rb")`. It must support `seek()` and `tell()` methods.- [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError) -- 
  If `path_or_fileobj` is not one of `str`, `Path`, `bytes` or `io.BufferedIOBase`.
- [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError) -- 
  If `path_or_fileobj` is a `str` or `Path` but not a path to an existing file.
- [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError) -- 
  If `path_or_fileobj` is a `io.BufferedIOBase` but it doesn't support both
  `seek()` and `tell()`.``ValueError``
...
automatically by [create_commit()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_commit). Note that cross-repository copies only work within the same
[storage region](https://huggingface.co/docs/hub/storage-regions); copying across regions is not supported.

Note: you can combine a [CommitOperationCopy](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitOperationCopy) and a [CommitOperationDelete](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitOperationDelete) to rename an LFS file on the Hub.
...
- **hf_api** (`HfApi`, *optional*) --
  The [HfApi](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi) client to use to commit to the Hub. Can be set with custom settings (user agent, token,...).
...
to change this behavior, you can inherit from [CommitScheduler](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.CommitScheduler) and override this method. This can be useful
