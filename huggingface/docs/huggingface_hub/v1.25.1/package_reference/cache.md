...
- **repo_type** (`str`, *optional*) --
  The type of the repository. Will default to `"model"`.`Optional[str]` or `_CACHED_NO_EXIST`Will return `None` if the file was not cached. Otherwise:
...
- **assets_dir** (`str`, `Path`, *optional*) --
  ...
  Can also be set with `HF_ASSETS_CACHE` environment variable.Path to the cache folder (`Path`).
...
Scan the entire HF cache-system and return a [~HFCacheInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.HFCacheInfo) structure.

Use `scan_cache_dir` in order to programmatically scan your cache-system. The cache
will be scanned repo by repo. If a repo is corrupted, a [~CorruptedCacheException](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.CorruptedCacheException)
will be thrown internally but captured and returned in the [~HFCacheInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.HFCacheInfo)
...
Returns: a [~HFCacheInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.HFCacheInfo) object.

## Data structures

All structures are built and returned by [scan_cache_dir()](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.scan_cache_dir) and are immutable.
...
- **repos** (`frozenset[CachedRepoInfo]`) --
  Set of [~CachedRepoInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.CachedRepoInfo) describing all valid cached repos found on the
  cache-system while scanning.
- **incomplete_files** (`frozenset[CachedIncompleteFileInfo]`) --
  Set of [~CachedIncompleteFileInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.CachedIncompleteFileInfo) describing orphaned `*.incomplete`
  files left behind by interrupted downloads.
- **warnings** (`list[CorruptedCacheException]`) --
  List of [~CorruptedCacheException](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.CorruptedCacheException) that occurred while scanning the cache.
  Those exceptions are captured so that the scan can continue. Corrupted repos
  are skipped from the scan.
Frozen data structure holding information about the entire cache-system.

This data structure is returned by [scan_cache_dir()](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.scan_cache_dir) and is immutable.
...
> [!WARNING]
> `delete_revisions` returns a [DeleteCacheStrategy](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.DeleteCacheStrategy) object that needs to
> be executed. The [DeleteCacheStrategy](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.DeleteCacheStrategy) is not meant to be modified but
> allows having a dry run before actually executing the deletion.

- **verbosity** (`int`, *optional*) --
  The verbosity level. Defaults to 0.`str`The table as a string.
Generate a table from the [HFCacheInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.HFCacheInfo) object.
...
- **revisions** (`frozenset[CachedRevisionInfo]`) --
  Set of [~CachedRevisionInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.CachedRevisionInfo) describing all revisions cached in the repo.
- **last_accessed** (`float`) --
...
- **files** -- (`frozenset[CachedFileInfo]`):
  Set of [~CachedFileInfo](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.CachedFileInfo) describing all files contained in the snapshot.
- **refs** (`frozenset[str]`) --
...
[scan_cache_dir()](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.scan_cache_dir).
...
[delete_revisions()](/docs/huggingface_hub/v1.25.1/en/package_reference/cache#huggingface_hub.HFCacheInfo.delete_revisions). See documentation for usage example.
