...
The `RepoCard` object is the parent class of [ModelCard](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.ModelCard), [DatasetCard](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.DatasetCard) and `SpaceCard`.
...
- **template_str** (`str`, *optional*) --
  ...
  nor the default template is appropriate. Ignored if `template_path` is also provided.[huggingface_hub.repocard.RepoCard](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.RepoCard)A RepoCard instance with the specified card data and content from the
template.
...
- **ignore_metadata_errors** (`str`) --
  ...
  the process. Use it at your own risk.[huggingface_hub.repocard.RepoCard](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.RepoCard)The RepoCard (or subclass) initialized from the repo's
...
- **parent_commit** (`str`, *optional*) --
  ...
  especially useful if the repo is updated / committed too concurrently.`str`URL of the commit which updated the card metadata.
...
internally by [huggingface_hub.repocard.RepoCard.push_to_hub()](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.RepoCard.push_to_hub).
...
The [CardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.CardData) object is the parent class of [ModelCardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.ModelCardData) and [DatasetCardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.DatasetCardData).

Structure containing metadata from a RepoCard.

[CardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.CardData) is the parent class of [ModelCardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.ModelCardData) and [DatasetCardData](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.DatasetCardData).
...
- **original_order** (`list[str]`, *optional*) --
  ...
  shuffling its keys.`str`CardData represented as a YAML block.
...
- **template_str** (`str`, *optional*) --
  A raw Jinja template string with optional variables. Used when neither `template_path`
  nor the default template is appropriate. Ignored if `template_path` is also provided.[huggingface_hub.ModelCard](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.ModelCard)A ModelCard instance with the specified card data and content from the
template.
...
- **template_str** (`str`, *optional*) --
  A raw Jinja template string with optional variables. Used when neither `template_path`
  nor the default template is appropriate. Ignored if `template_path` is also provided.[huggingface_hub.DatasetCard](/docs/huggingface_hub/v1.25.1/en/package_reference/cards#huggingface_hub.DatasetCard)A DatasetCard instance with the specified card data and content from the
template.
...
- **model_index** (`list[dict[str, Any]]`) --
  ...
  Hugging Face Hub.model_name (`str`)The name of the model as found in the model index. This is used as the
...
- **eval_results** (`list[EvalResult]`) --
  ...
  reported in the model-index.model_index (`list[dict[str, Any]]`)The eval_results converted to a model-index.
...
- **metrics_verification_token** (`bool`, *optional*) --
  A JSON Web Token that is used to verify whether the metrics originate from Hugging Face's [evaluation service](https://huggingface.co/spaces/autoevaluate/model-evaluator) or not.`dict`a metadata dict with the result from a model evaluated on a dataset.
