...
- **accept_kwargs** (`bool`, *optional*) --
  If True, allows arbitrary keyword arguments in `__init__`. Defaults to False.The enhanced dataclass with strict validation on field assignment.
...
- **data** (`dict`) --
  The dictionary to validate.- ``StrictDataclassFieldValidationError`` -- 
  If any field in the dictionary does not conform to the expected type.``StrictDataclassFieldValidationError``
...
"}, {"name": "default_factory", "val": ": typing.Any = "}, {"name": "init", "val": ": bool = True"}, {"name": "repr", "val": ": bool = True"}, {"name": "hash", "val": ": bool | None = None"}, {"name": "compare", "val": ": bool = True"}, {"name": "metadata", "val": ": dict | None = None"}, {"name": "**kwargs", "val": ": typing.Any"}]}>
- **validator** (`Callable` or `list[Callable]`) --
  A method that takes a value as input and raises ValueError/TypeError if the value is invalid.
  Can be a list of validators to apply multiple checks.
- ****kwargs** --
  Additional arguments to pass to `dataclasses.field()`.A field with the validator attached in metadata
