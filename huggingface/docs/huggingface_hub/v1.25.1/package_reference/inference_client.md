...
These services can be called with the [InferenceClient](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceClient) object. Please refer to [this guide](../guides/inference)
...
- **base_url** (`str`, `optional`) --
  Base URL to run inference. This is a duplicated argument from `model` to make [InferenceClient](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceClient)
  follow the same pattern as `openai.OpenAI` client. Cannot be used if `model` is set. Defaults to None.
- **api_key** (`str`, `optional`) --
  Token to use for authentication. This is a duplicated argument from `token` to make [InferenceClient](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceClient)
  follow the same pattern as `openai.OpenAI` client. Cannot be used if `token` is set. Defaults to None.

Initialize a new Inference Client.

[InferenceClient](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceClient) aims to provide a unified experience to perform inference. The client can be used
...
- **function_to_apply** (`"AudioClassificationOutputTransform"`, *optional*) --
  The function to apply to the model outputs in order to retrieve the scores.`list[AudioClassificationOutputElement]`List of [AudioClassificationOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.AudioClassificationOutputElement) items containing the predicted labels and their confidence.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **model** (`str`, *optional*) --
  ...
  or a URL to a deployed Inference Endpoint. If not provided, the default recommended model for
  audio_to_audio will be used.`list[AudioToAudioOutputElement]`A list of [AudioToAudioOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.AudioToAudioOutputElement) items containing audios label, content-type, and audio content in blob.- ``InferenceTimeoutError`` -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.``InferenceTimeoutError`` or `HfHubHTTPError`
...
- **extra_body** (`dict`, *optional*) --
  ...
  for supported parameters.[AutomaticSpeechRecognitionOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.AutomaticSpeechRecognitionOutput)An item containing the transcribed text and optionally the timestamp chunks.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **messages** (List of [ChatCompletionInputMessage](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ChatCompletionInputMessage)) --
...
- **model** (`str`, *optional*) --
  ...
  custom URL while setting `model` in the request payload, you must set `base_url` when initializing [InferenceClient](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceClient).
...
- **stream_options** ([ChatCompletionInputStreamOptions](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ChatCompletionInputStreamOptions), *optional*) --
...
- **tool_choice** ([ChatCompletionInputToolChoiceClass](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ChatCompletionInputToolChoiceClass) or `ChatCompletionInputToolChoiceEnum()`, *optional*) --
  The tool to use for the completion. Defaults to "auto".
- **tool_prompt** (`str`, *optional*) --
  A prompt to be appended before the tools.
- **tools** (List of [ChatCompletionInputTool](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ChatCompletionInputTool), *optional*) --
  A list of tools the model may call. Currently, only functions are supported as a tool. Use this to
  provide a list of functions the model may generate JSON inputs for.
- **extra_body** (`dict`, *optional*) --
  Additional provider-specific parameters to pass to the model. Refer to the provider's documentation
  for supported parameters.[ChatCompletionOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ChatCompletionOutput) or Iterable of [ChatCompletionStreamOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ChatCompletionStreamOutput)Generated text returned from the server:
- if `stream=False`, the generated text is returned as a [ChatCompletionOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ChatCompletionOutput) (default).
- if `stream=True`, the generated text is returned token by token as a sequence of [ChatCompletionStreamOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ChatCompletionStreamOutput).- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **word_boxes** (`list[Union[list[float], str`, *optional*) --
  ...
  step and use the provided bounding boxes instead.`list[DocumentQuestionAnsweringOutputElement]`a list of [DocumentQuestionAnsweringOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.DocumentQuestionAnsweringOutputElement) items containing the predicted label, associated probability, word ids, and page number.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **encoding_format** (*Literal["float", "base64"]*, *optional*) --
  ...
  Only available on OpenAI-compatible embedding endpoints.*np.ndarray*The embedding representing the input text(s) as a float32 numpy array.- [*InferenceTimeoutError*] -- 
  If the model is unavailable or the request times out.
- [*HfHubHTTPError*] -- 
  If the request fails with an HTTP error status code other than HTTP 503.[*InferenceTimeoutError*] or [*HfHubHTTPError*]
...
- **top_k** (`int`, *optional*) --
  When passed, overrides the number of predictions to return.`list[FillMaskOutputElement]`a list of [FillMaskOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.FillMaskOutputElement) items containing the predicted label, associated
probability, token reference, and completed text.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **model** (`str`, *optional*) --
  ...
  Inference Endpoint. This parameter overrides the model defined at the instance level. Defaults to None.`dict[str, Any]`Information about the endpoint.
...
- **model** (`str`, *optional*) --
  URL of the Inference Endpoint. This parameter overrides the model defined at the instance level. Defaults to None.`bool`True if everything is working fine.
...
- **top_k** (`int`, *optional*) --
  When specified, limits the output to the top K most probable classes.`list[ImageClassificationOutputElement]`a list of [ImageClassificationOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ImageClassificationOutputElement) items containing the predicted label and associated probability.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **threshold** (`float`, *optional*) --
  Probability threshold to filter out predicted masks.`list[ImageSegmentationOutputElement]`A list of [ImageSegmentationOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ImageSegmentationOutputElement) items containing the segmented masks and associated attributes.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **target_size** (`ImageToImageTargetSize`, *optional*) --
  ...
  specific models. It will be ignored when unsupported.`Image`The translated image.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **model** (`str`, *optional*) --
  The model to use for inference. Can be a model ID hosted on the Hugging Face Hub or a URL to a deployed
  Inference Endpoint. This parameter overrides the model defined at the instance level. Defaults to None.[ImageToTextOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ImageToTextOutput)The generated text.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **seed** (`int`, *optional*) --
  Seed for the random number generator.`bytes`The generated video.
...
- **threshold** (`float`, *optional*) --
  The probability necessary to make a prediction.`list[ObjectDetectionOutputElement]`A list of [ObjectDetectionOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ObjectDetectionOutputElement) items containing the bounding boxes and associated attributes.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.
- ``ValueError`` -- 
  If the request output is not a List.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError` or ``ValueError``
...
- **top_k** (`int`, *optional*) --
  ...
  topk answers if there are not enough options available within the context.Union[`QuestionAnsweringOutputElement`, list[QuestionAnsweringOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.QuestionAnsweringOutputElement)]When top_k is 1 or not provided, it returns a single `QuestionAnsweringOutputElement`.
When top_k is greater than 1, it returns a list of `QuestionAnsweringOutputElement`.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **model** (`str`, *optional*) --
  ...
  Defaults to None.`list[float]`The embedding representing the input text.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **truncation** (`"SummarizationTruncationStrategy"`, *optional*) --
  The truncation strategy to use.[SummarizationOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.SummarizationOutput)The generated summary text.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **truncation** (`bool`, *optional*) --
  Activates and controls truncation.[TableQuestionAnsweringOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.TableQuestionAnsweringOutputElement)a table question answering output containing the answer, coordinates, cells and the aggregator used.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **model** (`str`, *optional*) --
  ...
  Defaults to None.`List`a list of labels, one per row in the initial table.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **model** (`str`, *optional*) --
  ...
  Defaults to None.`List`a list of predicted numerical target values.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **function_to_apply** (`"TextClassificationOutputTransform"`, *optional*) --
  The function to apply to the model outputs in order to retrieve the scores.`list[TextClassificationOutputElement]`a list of [TextClassificationOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.TextClassificationOutputElement) items containing the predicted label and associated probability.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **grammar** ([TextGenerationInputGrammarType](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.TextGenerationInputGrammarType), *optional*) --
  Grammar constraints. Can be either a JSONSchema or a regex.
...
- **watermark** (`bool`, *optional*) --
  Watermarking with [A Watermark for Large Language Models](https://arxiv.org/abs/2301.10226)`Union[str, TextGenerationOutput, Iterable[str], Iterable[TextGenerationStreamOutput]]`Generated text returned from the server:
- if `stream=False` and `details=False`, the generated text is returned as a `str` (default)
- if `stream=True` and `details=False`, the generated text is returned token by token as a `Iterable[str]`
- if `stream=False` and `details=True`, the generated text is returned with more details as a [TextGenerationOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.TextGenerationOutput)
- if `details=True` and `stream=True`, the generated text is returned token by token as a iterable of [TextGenerationStreamOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.TextGenerationStreamOutput)- ``ValidationError`` -- 
  If input values are not valid. No HTTP call is made to the server.
- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.``ValidationError`` or [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`

Given a prompt, generate the following text.

> [!TIP]
> If you want to generate a response from chat messages, you should use the [InferenceClient.chat_completion()](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceClient.chat_completion) method.
...
- **extra_body** (`dict[str, Any]`, *optional*) --
  Additional provider-specific parameters to pass to the model. Refer to the provider's documentation
  for supported parameters.`Image`The generated image.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **extra_body** (`dict[str, Any]`, *optional*) --
  Additional provider-specific parameters to pass to the model. Refer to the provider's documentation
  for supported parameters.`bytes`The generated audio.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **extra_body** (`dict[str, Any]`, *optional*) --
  Additional provider-specific parameters to pass to the model. Refer to the provider's documentation
  for supported parameters.`bytes`The generated video.
...
- **stride** (`int`, *optional*) --
  The number of overlapping tokens between chunks when splitting the input text.`list[TokenClassificationOutputElement]`List of [TokenClassificationOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.TokenClassificationOutputElement) items containing the entity group, confidence score, word, start and end index.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **generate_parameters** (`dict[str, Any]`, *optional*) --
  Additional parametrization of the text generation algorithm.[TranslationOutput](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.TranslationOutput)The generated translated text.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.
- ``ValueError`` -- 
  If only one of the `src_lang` and `tgt_lang` arguments are provided.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError` or ``ValueError``
...
- **top_k** (`int`, *optional*) --
  The number of answers to return (will be chosen by order of likelihood). Note that we return less than
  topk answers if there are not enough options available within the context.`list[VisualQuestionAnsweringOutputElement]`a list of [VisualQuestionAnsweringOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.VisualQuestionAnsweringOutputElement) items containing the predicted label and associated probability.- ``InferenceTimeoutError`` -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.``InferenceTimeoutError`` or `HfHubHTTPError`
...
- **model** (`str`, *optional*) --
  The model to use for inference. Can be a model ID hosted on the Hugging Face Hub or a URL to a deployed
  Inference Endpoint. This parameter overrides the model defined at the instance level. If not provided, the default recommended zero-shot classification model will be used.`list[ZeroShotClassificationOutputElement]`List of [ZeroShotClassificationOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ZeroShotClassificationOutputElement) items containing the predicted labels and their confidence.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **hypothesis_template** (`str`, *optional*) --
  ...
  replacing the placeholder with the candidate labels.`list[ZeroShotImageClassificationOutputElement]`List of [ZeroShotImageClassificationOutputElement](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_types#huggingface_hub.ZeroShotImageClassificationOutputElement) items containing the predicted labels and their confidence.- [InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) -- 
  If the model is unavailable or the request times out.
- `HfHubHTTPError` -- 
  If the request fails with an HTTP error status code other than HTTP 503.[InferenceTimeoutError](/docs/huggingface_hub/v1.25.1/en/package_reference/inference_client#huggingface_hub.InferenceTimeoutError) or `HfHubHTTPError`
...
- **typical_p** (`float`, *optional`) --
  ...
  See [Typical Decoding for Natural Language Generation](https://arxiv.org/abs/2202.00666) for more information
- **watermark** (`bool`, *optional*) --
  Watermarking with [A Watermark for Large Language Models](https://arxiv.org/abs/2301.10226)`Union[str, TextGenerationOutput, AsyncIterable[str], AsyncIterable[TextGenerationStreamOutput]]`Generated text returned from the server:
- if `stream=False` and `details=False`, the generated text is returned as a `str` (default)
