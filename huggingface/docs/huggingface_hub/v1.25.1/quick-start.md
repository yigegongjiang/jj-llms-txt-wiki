...
or the whole repository. You can use the [hf_hub_download()](/docs/huggingface_hub/v1.25.1/en/package_reference/file_download#huggingface_hub.hf_hub_download) function to download files.
...
For more details and options, see the API reference for [hf_hub_download()](/docs/huggingface_hub/v1.25.1/en/package_reference/file_download#huggingface_hub.hf_hub_download).
...
The easiest way to authenticate is with the [login()](/docs/huggingface_hub/v1.25.1/en/package_reference/authentication#huggingface_hub.login) command:
...
Alternatively, you can programmatically log in using [login()](/docs/huggingface_hub/v1.25.1/en/package_reference/authentication#huggingface_hub.login) in a notebook or a script:
...
You can save multiple tokens on your machine by simply logging in with the [login()](/docs/huggingface_hub/v1.25.1/en/package_reference/authentication#huggingface_hub.login) command with each token. If you need to switch between these tokens locally, you can use the `auth switch` command:
...
Once you've registered and logged in, create a repository with the [create_repo()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.create_repo)
function:
...
Use the [upload_file()](/docs/huggingface_hub/v1.25.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_file) function to add a file to your newly created repository. You
need to specify:
