...
For web browsing, we can already use our native [WebSearchTool](/docs/smolagents/v1.26.0/en/reference/default_tools#smolagents.WebSearchTool) tool to provide a Google search equivalent.
