...
Let's see how it works. For example, let us check the default prompt templates for the [CodeAgent](/docs/smolagents/v1.26.0/en/reference/agents#smolagents.CodeAgent) (below version is shortened by skipping zero-shot examples).
...
This also works with the [ToolCallingAgent](/docs/smolagents/v1.26.0/en/reference/agents#smolagents.ToolCallingAgent).
