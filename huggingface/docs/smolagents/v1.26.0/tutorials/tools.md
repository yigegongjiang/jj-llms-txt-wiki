...
The custom tool subclasses [Tool](/docs/smolagents/v1.26.0/en/reference/tools#smolagents.Tool) to inherit useful methods. The child class also defines:
...
- As per the above point, **all imports should be defined directly within the tool's functions**, else you will get an error when trying to call [save()](/docs/smolagents/v1.26.0/en/reference/tools#smolagents.Tool.save) or [push_to_hub()](/docs/smolagents/v1.26.0/en/reference/tools#smolagents.Tool.push_to_hub) with your custom tool.
...
Then you can load the tool with [load_tool()](/docs/smolagents/v1.26.0/en/reference/tools#smolagents.load_tool) or create it with [from_hub()](/docs/smolagents/v1.26.0/en/reference/tools#smolagents.Tool.from_hub) and pass it to the `tools` parameter in your agent.
...
You can directly import a Gradio Space from the Hub as a tool using the [Tool.from_space()](/docs/smolagents/v1.26.0/en/reference/tools#smolagents.Tool.from_space) method!
...
You can leverage tool collections by using [ToolCollection](/docs/smolagents/v1.26.0/en/reference/tools#smolagents.ToolCollection). It supports loading either a collection from the Hub or an MCP server tools.
...
The MCP servers tools can be loaded with [ToolCollection.from_mcp()](/docs/smolagents/v1.26.0/en/reference/tools#smolagents.ToolCollection.from_mcp).
