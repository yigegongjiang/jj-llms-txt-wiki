...
with [SampleLevelMetric](/docs/lighteval/v0.13.0/en/package_reference/metrics#lighteval.metrics.utils.metric_utils.SampleLevelMetric):
...
with [SampleLevelMetricGrouping](/docs/lighteval/v0.13.0/en/package_reference/metrics#lighteval.metrics.utils.metric_utils.SampleLevelMetricGrouping):
