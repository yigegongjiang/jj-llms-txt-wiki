...
[EvaluationTracker](/docs/lighteval/v0.13.0/en/package_reference/logging#lighteval.logging.evaluation_tracker.EvaluationTracker), [PipelineParameters](/docs/lighteval/v0.13.0/en/package_reference/pipeline#lighteval.pipeline.PipelineParameters),
a [`model`](package_reference/models) or a [`model_config`](package_reference/model_config),
and a [Pipeline](/docs/lighteval/v0.13.0/en/package_reference/pipeline#lighteval.pipeline.Pipeline).
