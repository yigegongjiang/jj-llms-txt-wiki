...
You can define a task with or without subsets using [LightevalTaskConfig](/docs/lighteval/v0.13.0/en/package_reference/tasks#lighteval.tasks.lighteval_task.LightevalTaskConfig).
