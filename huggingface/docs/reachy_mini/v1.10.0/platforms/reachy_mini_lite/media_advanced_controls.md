...
Refer to the [Reachy Mini documentation](../reachy_mini/media_advanced_controls#microphones-and-speakers). The hardware is exactly the same for the Lite version.
...
WebRTC DataChannel — see the [Wireless page](../reachy_mini/media_advanced_controls#microphones-and-speakers)
