...
[Source](https://github.com/huggingface/trl/blob/v1.12.0/trl/experimental/gmpo/gmpo_trainer.py#L22)
...
The only change w.r.t. [GRPOTrainer](/docs/trl/v1.12.0/en/grpo_trainer#trl.GRPOTrainer) is `_compute_loss`. Everything else (generation, reward computation, weight
...
[Source](https://github.com/huggingface/trl/blob/v1.12.0/trl/experimental/gmpo/gmpo_config.py#L21)
...
`GMPOConfig` inherits every parameter from [GRPOConfig](/docs/trl/v1.12.0/en/grpo_trainer#trl.GRPOConfig); it only changes the meaning and default of the
