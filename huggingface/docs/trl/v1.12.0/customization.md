...
> [!NOTE]
> Although these examples use the [DPOTrainer](/docs/trl/v1.12.0/en/bema_for_reference_model#trl.DPOTrainer), these customization methods apply to most (if not all) trainers in TRL.

## Use different optimizers and schedulers

By default, the [DPOTrainer](/docs/trl/v1.12.0/en/bema_for_reference_model#trl.DPOTrainer) creates a `torch.optim.AdamW` optimizer. You can create and define a different optimizer and pass it to [DPOTrainer](/docs/trl/v1.12.0/en/bema_for_reference_model#trl.DPOTrainer) as follows:
