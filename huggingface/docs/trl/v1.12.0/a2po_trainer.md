...
[Source](https://github.com/huggingface/trl/blob/v1.12.0/trl/experimental/a2po/a2po_trainer.py#L48)

**Parameters:**

model (`PreTrainedModel` or `str`) : Model to be trained, or a model identifier (string) passed to [from_pretrained](https://huggingface.co/docs/transformers/v5.16.1/en/model_doc/auto#transformers.AutoModelForCausalLM.from_pretrained).
...
[Source](https://github.com/huggingface/trl/blob/v1.12.0/trl/experimental/a2po/a2po_trainer.py#L358)
...
[Source](https://github.com/huggingface/trl/blob/v1.12.0/trl/experimental/a2po/a2po_config.py#L21)

**Parameters that control the model and reference model:**

model_init_kwargs (`dict[str, Any]`, *optional*) : Keyword arguments for [from_pretrained](https://huggingface.co/docs/transformers/v5.16.1/en/model_doc/auto#transformers.AutoModelForCausalLM.from_pretrained), used when the `model` argument of the `A2POTrainer` is provided as a string.
