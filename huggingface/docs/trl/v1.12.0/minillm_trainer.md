...
[Source](https://github.com/huggingface/trl/blob/v1.12.0/trl/experimental/minillm/minillm_trainer.py#L48)
...
args ([experimental.minillm.MiniLLMConfig](/docs/trl/v1.12.0/en/minillm_trainer#trl.experimental.minillm.MiniLLMConfig), *optional*) : Configuration for this trainer. If `None`, a default configuration is used.
...
[Source](https://github.com/huggingface/trl/blob/v1.12.0/trl/experimental/minillm/minillm_config.py#L23)
...
arguments, please refer to the [TrainingArguments](https://huggingface.co/docs/transformers/v5.16.1/en/main_classes/trainer#transformers.TrainingArguments) and [GRPOConfig](/docs/trl/v1.12.0/en/grpo_trainer#trl.GRPOConfig) documentation.
