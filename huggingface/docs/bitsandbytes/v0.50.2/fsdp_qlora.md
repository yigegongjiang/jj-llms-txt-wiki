...
Configure the [LoraConfig](https://huggingface.co/docs/peft/v0.20.0/en/package_reference/lora#peft.LoraConfig) class for QLoRA training by setting `target_modules="all-linear"`.
