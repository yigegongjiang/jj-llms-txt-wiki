...
This directory contains usage examples of the Hugging Face Deep Learning Containers (DLCs) in Cloud Run.

## Inference Examples

| Example                                                                                | Title                                                        |
| -------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [finewiki-embeddings-with-embedding-gemma](https://github.com/huggingface/Google-Cloud-Containers/tree/main/examples/cloud-run/finewiki-embeddings-with-embedding-gemma) | 100,000 FineWiki embeddings with EmbeddingGemma on Cloud Run |
