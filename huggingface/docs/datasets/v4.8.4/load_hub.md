...
If you don't specify a `split`, 🤗 Datasets returns a [DatasetDict](/docs/datasets/v4.8.4/en/package_reference/main_classes#datasets.DatasetDict) object instead:
