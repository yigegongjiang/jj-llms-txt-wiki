...
Fusion is enabled through [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) with `fusion_config`:
...
1. [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) uses the explicit `fusion_config` argument or falls back to `config.fusion_config`.
...
4. Fused replacement classes are registered through [register_patch_mapping()](/docs/transformers/v5.15.1/en/monkey_patching#transformers.monkey_patching.register_patch_mapping).
...
6. By default, [save_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.save_pretrained) uses the reverse conversion path to restore the original checkpoint layout. Pass `save_original_format=False` to keep the converted runtime layout instead.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/fusion_mapping.py#L44)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/fusion_mapping.py#L54)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/fusion_mapping.py#L58)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/fusion_mapping.py#L62)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/fusion_mapping.py#L66)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/fusion_mapping.py#L94)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/fusion_mapping.py#L190)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/fusion_mapping.py#L255)
