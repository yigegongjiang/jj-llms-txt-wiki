...
You're ready to start training your model now! Load BERT with [AutoModelForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoModelForMultipleChoice):
