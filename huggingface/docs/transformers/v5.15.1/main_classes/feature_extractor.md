...
#### from_pretrained[[transformers.FeatureExtractionMixin.from_pretrained]]
...
#### pad[[transformers.SequenceFeatureExtractor.pad]]
...
#### center_crop[[transformers.ImageFeatureExtractionMixin.center_crop]]
