...
Call [cast_column](https://huggingface.co/docs/datasets/v5.0.1/en/package_reference/main_classes#datasets.Dataset.cast_column) on the `audio` column to upsample the sampling rate to 16kHz.
