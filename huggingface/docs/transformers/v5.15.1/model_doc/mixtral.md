...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mixtral/configuration_mixtral.py#L25)
...
```python
transformers.MixtralModel(config: MixtralConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mixtral/modeling_mixtral.py#L410)
...
#### forward[[transformers.MixtralModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mixtral/modeling_mixtral.py#L427)
...
elements depending on the configuration ([MixtralConfig](/docs/transformers/v5.15.1/en/model_doc/mixtral#transformers.MixtralConfig)) and inputs.

The [MixtralModel](/docs/transformers/v5.15.1/en/model_doc/mixtral#transformers.MixtralModel) forward method, overrides the `__call__` special method.
...
```python
transformers.MixtralForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mixtral/modeling_mixtral.py#L568)
...
#### forward[[transformers.MixtralForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mixtral/modeling_mixtral.py#L586)
...
The [MixtralForCausalLM](/docs/transformers/v5.15.1/en/model_doc/mixtral#transformers.MixtralForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.MixtralForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mixtral/modeling_mixtral.py#L671)

#### forward[[transformers.MixtralForSequenceClassification.forward]]
...
```python
transformers.MixtralForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mixtral/modeling_mixtral.py#L675)

#### forward[[transformers.MixtralForTokenClassification.forward]]
...
```python
transformers.MixtralForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mixtral/modeling_mixtral.py#L679)

#### forward[[transformers.MixtralForQuestionAnswering.forward]]
