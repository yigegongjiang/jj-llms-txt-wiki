...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rt_detr_v2/configuration_rt_detr_v2.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rt_detr_v2/modeling_rt_detr_v2.py#L1340)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rt_detr_v2/modeling_rt_detr_v2.py#L1459)
...
The [RTDetrV2Model](/docs/transformers/v5.15.1/en/model_doc/rt_detr_v2#transformers.RTDetrV2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rt_detr_v2/modeling_rt_detr_v2.py#L1762)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rt_detr_v2/modeling_rt_detr_v2.py#L1795)
...
The [RTDetrV2ForObjectDetection](/docs/transformers/v5.15.1/en/model_doc/rt_detr_v2#transformers.RTDetrV2ForObjectDetection) forward method, overrides the `__call__` special method.
