...
#### generate[[transformers.SeamlessM4Tv2Model.generate]]
...
#### generate[[transformers.SeamlessM4Tv2ForTextToSpeech.generate]]
...
#### generate[[transformers.SeamlessM4Tv2ForSpeechToSpeech.generate]]
...
#### forward[[transformers.SeamlessM4Tv2ForTextToText.forward]]
...
#### forward[[transformers.SeamlessM4Tv2ForSpeechToText.forward]]
...
position_embeddings_type (`str`, *optional*, defaults to `"relative_key"`) : Can be specified to `relative_key`. If left to `None`, no relative position embedding is applied. Only applied to the speech encoder. For more information on `"relative_key"`, please refer to [Self-Attention with Relative Position Representations (Shaw et al.)](https://huggingface.co/papers/1803.02155).
