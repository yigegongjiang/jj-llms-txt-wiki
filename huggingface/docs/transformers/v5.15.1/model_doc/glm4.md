...
#### transformers.Glm4Model[[transformers.Glm4Model]]

```python
transformers.Glm4Model(config: Glm4Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4/modeling_glm4.py#L362)

**Parameters:**

config ([Glm4Config](/docs/transformers/v5.15.1/en/model_doc/glm4#transformers.Glm4Config)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.Glm4Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4/modeling_glm4.py#L379)
...
elements depending on the configuration ([Glm4Config](/docs/transformers/v5.15.1/en/model_doc/glm4#transformers.Glm4Config)) and inputs.

The [Glm4Model](/docs/transformers/v5.15.1/en/model_doc/glm4#transformers.Glm4Model) forward method, overrides the `__call__` special method.
...
#### transformers.Glm4ForCausalLM[[transformers.Glm4ForCausalLM]]

```python
transformers.Glm4ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4/modeling_glm4.py#L436)

**Parameters:**

config ([Glm4ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/glm4#transformers.Glm4ForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.Glm4ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4/modeling_glm4.py#L451)
...
The [Glm4ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/glm4#transformers.Glm4ForCausalLM) forward method, overrides the `__call__` special method.
...
#### transformers.Glm4ForSequenceClassification[[transformers.Glm4ForSequenceClassification]]

```python
transformers.Glm4ForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4/modeling_glm4.py#L515)

#### forward[[transformers.Glm4ForSequenceClassification.forward]]
...
#### transformers.Glm4ForTokenClassification[[transformers.Glm4ForTokenClassification]]

```python
transformers.Glm4ForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4/modeling_glm4.py#L519)

#### forward[[transformers.Glm4ForTokenClassification.forward]]
