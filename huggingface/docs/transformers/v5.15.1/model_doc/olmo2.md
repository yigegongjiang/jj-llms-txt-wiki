...
This is the configuration class to store the configuration of a Olmo2Model. It is used to instantiate a Olmo2
...
```python
transformers.Olmo2Model(config: Olmo2Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo2/modeling_olmo2.py#L346)
...
#### forward[[transformers.Olmo2Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo2/modeling_olmo2.py#L363)
...
elements depending on the configuration ([Olmo2Config](/docs/transformers/v5.15.1/en/model_doc/olmo2#transformers.Olmo2Config)) and inputs.

The [Olmo2Model](/docs/transformers/v5.15.1/en/model_doc/olmo2#transformers.Olmo2Model) forward method, overrides the `__call__` special method.
...
```python
transformers.Olmo2ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo2/modeling_olmo2.py#L420)
...
#### forward[[transformers.Olmo2ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo2/modeling_olmo2.py#L435)
...
The [Olmo2ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/olmo2#transformers.Olmo2ForCausalLM) forward method, overrides the `__call__` special method.
...
## Olmo2ForSequenceClassification[[transformers.Olmo2ForSequenceClassification]]

#### transformers.Olmo2ForSequenceClassification[[transformers.Olmo2ForSequenceClassification]]

```python
transformers.Olmo2ForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo2/modeling_olmo2.py#L494)

#### forward[[transformers.Olmo2ForSequenceClassification.forward]]
