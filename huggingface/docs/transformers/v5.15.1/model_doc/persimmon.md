...
qk_layernorm (`bool`, *optional*, default to `True`) : Whether or not to normalize the Queries and Keys after projecting the hidden states
...
This is the configuration class to store the configuration of a PersimmonModel. It is used to instantiate a Persimmon
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [adept/persimmon-8b-base](https://huggingface.co/adept/persimmon-8b-base)
...
## PersimmonModel[[transformers.PersimmonModel]]

#### transformers.PersimmonModel[[transformers.PersimmonModel]]

```python
transformers.PersimmonModel(config: PersimmonConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/persimmon/modeling_persimmon.py#L376)

**Parameters:**

config ([PersimmonConfig](/docs/transformers/v5.15.1/en/model_doc/persimmon#transformers.PersimmonConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.PersimmonModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/persimmon/modeling_persimmon.py#L399)
...
elements depending on the configuration ([PersimmonConfig](/docs/transformers/v5.15.1/en/model_doc/persimmon#transformers.PersimmonConfig)) and inputs.

The [PersimmonModel](/docs/transformers/v5.15.1/en/model_doc/persimmon#transformers.PersimmonModel) forward method, overrides the `__call__` special method.
...
## PersimmonForCausalLM[[transformers.PersimmonForCausalLM]]

#### transformers.PersimmonForCausalLM[[transformers.PersimmonForCausalLM]]

```python
transformers.PersimmonForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/persimmon/modeling_persimmon.py#L456)

#### forward[[transformers.PersimmonForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/persimmon/modeling_persimmon.py#L469)
...
The [PersimmonForCausalLM](/docs/transformers/v5.15.1/en/model_doc/persimmon#transformers.PersimmonForCausalLM) forward method, overrides the `__call__` special method.
...
## PersimmonForSequenceClassification[[transformers.PersimmonForSequenceClassification]]

#### transformers.PersimmonForSequenceClassification[[transformers.PersimmonForSequenceClassification]]

```python
transformers.PersimmonForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/persimmon/modeling_persimmon.py#L532)

#### forward[[transformers.PersimmonForSequenceClassification.forward]]
...
## PersimmonForTokenClassification[[transformers.PersimmonForTokenClassification]]

#### transformers.PersimmonForTokenClassification[[transformers.PersimmonForTokenClassification]]

```python
transformers.PersimmonForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/persimmon/modeling_persimmon.py#L535)

#### forward[[transformers.PersimmonForTokenClassification.forward]]
