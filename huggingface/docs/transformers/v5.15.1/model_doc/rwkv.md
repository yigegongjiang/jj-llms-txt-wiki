...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rwkv/configuration_rwkv.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rwkv/modeling_rwkv.py#L487)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rwkv/modeling_rwkv.py#L508)
...
elements depending on the configuration ([RwkvConfig](/docs/transformers/v5.15.1/en/model_doc/rwkv#transformers.RwkvConfig)) and inputs.

The [RwkvModel](/docs/transformers/v5.15.1/en/model_doc/rwkv#transformers.RwkvModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rwkv/modeling_rwkv.py#L667)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/rwkv/modeling_rwkv.py#L684)
...
The [RwkvForCausalLM](/docs/transformers/v5.15.1/en/model_doc/rwkv#transformers.RwkvForCausalLM) forward method, overrides the `__call__` special method.
