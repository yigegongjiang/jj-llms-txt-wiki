...
```python
transformers.MptConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, d_model: int = 2048, n_heads: int = 16, n_layers: int = 24, expansion_ratio: int = 4, max_seq_len: int = 2048, vocab_size: int = 50368, resid_pdrop: float | int = 0.0, layer_norm_epsilon: float = 1e-05, emb_pdrop: float | int = 0.0, learned_pos_emb: bool = True, attn_config: dict | transformers.models.mpt.configuration_mpt.MptAttentionConfig | None = None, init_device: str = 'cpu', logit_scale: float | str | None = None, no_bias: bool = True, embedding_fraction: float = 1.0, norm_type: str = 'low_precision_layernorm', use_cache: bool = False, initializer_range: float = 0.02, tie_word_embeddings: bool = True, pad_token_id: int | None = None, bos_token_id: int | None = None, eos_token_id: int | list[int] | None = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/configuration_mpt.py#L71)

**Parameters:**

d_model (`int`, *optional*, defaults to `2048`) : Size of the encoder layers and the pooler layer.

n_heads (`int`, *optional*, defaults to `16`) : Number of attention heads for each attention layer in the Transformer decoder.

n_layers (`int`, *optional*, defaults to `24`) : Number of hidden layers in the Transformer decoder.
...
emb_pdrop (`Union[float, int]`, *optional*, defaults to `0.0`) : The dropout ratio for the embeddings.
...
defaults will yield a similar configuration to that of the [mosaicml/mpt-7b](https://huggingface.co/mosaicml/mpt-7b)
...
```python
transformers.MptModel(config: MptConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L224)
...
#### forward[[transformers.MptModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, attention_mask: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.LongTensor] = None, use_cache: bool | None = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L256)
...
elements depending on the configuration ([MptConfig](/docs/transformers/v5.15.1/en/model_doc/mpt#transformers.MptConfig)) and inputs.

The [MptModel](/docs/transformers/v5.15.1/en/model_doc/mpt#transformers.MptModel) forward method, overrides the `__call__` special method.
...
```python
transformers.MptForCausalLM(config: MptConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L368)
...
#### forward[[transformers.MptForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L382)
...
The [MptForCausalLM](/docs/transformers/v5.15.1/en/model_doc/mpt#transformers.MptForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.MptForSequenceClassification(config: MptConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L463)
...
[MptForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/mpt#transformers.MptForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
#### forward[[transformers.MptForSequenceClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, attention_mask: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, use_cache: bool | None = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L476)
...
The [MptForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/mpt#transformers.MptForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.MptForTokenClassification(config: MptConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L582)
...
#### forward[[transformers.MptForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, attention_mask: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, use_cache: bool | None = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **deprecated_arguments)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L600)
...
The [MptForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/mpt#transformers.MptForTokenClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.MptForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L671)
...
#### forward[[transformers.MptForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mpt/modeling_mpt.py#L680)
...
The [MptForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/mpt#transformers.MptForQuestionAnswering) forward method, overrides the `__call__` special method.
