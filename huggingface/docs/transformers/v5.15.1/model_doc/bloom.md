...
```python
transformers.BloomConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, vocab_size: int = 250880, hidden_size: int = 64, n_layer: int = 2, n_head: int = 8, layer_norm_epsilon: float = 1e-05, initializer_range: float = 0.02, use_cache: bool = True, bos_token_id: int | None = 1, eos_token_id: int | list[int] | None = 2, pad_token_id: int | None = None, apply_residual_connection_post_layernorm: bool = False, hidden_dropout: float | int = 0.0, attention_dropout: float | int = 0.0, pretraining_tp: int = 1, slow_but_exact: bool = False, tie_word_embeddings: bool = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/configuration_bloom.py#L24)
...
hidden_size (`int`, *optional*, defaults to `64`) : Dimension of the hidden representations.

n_layer (`int`, *optional*, defaults to `2`) : Number of hidden layers in the Transformer decoder.
...
defaults will yield a similar configuration to that of the [bigscience/bloom](https://huggingface.co/bigscience/bloom)
...
```python
transformers.BloomModel(config: BloomConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L416)
...
#### forward[[transformers.BloomModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L447)
...
elements depending on the configuration ([BloomConfig](/docs/transformers/v5.15.1/en/model_doc/bloom#transformers.BloomConfig)) and inputs.

The [BloomModel](/docs/transformers/v5.15.1/en/model_doc/bloom#transformers.BloomModel) forward method, overrides the `__call__` special method.
...
```python
transformers.BloomForCausalLM(config: BloomConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L560)
...
#### forward[[transformers.BloomForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L609)
...
The [BloomForCausalLM](/docs/transformers/v5.15.1/en/model_doc/bloom#transformers.BloomForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.BloomForSequenceClassification(config: BloomConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L695)
...
[BloomForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/bloom#transformers.BloomForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
#### forward[[transformers.BloomForSequenceClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, attention_mask: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, use_cache: bool | None = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L705)
...
The [BloomForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/bloom#transformers.BloomForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.BloomForTokenClassification(config: BloomConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L811)
...
#### forward[[transformers.BloomForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, attention_mask: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, use_cache: bool | None = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L829)
...
The [BloomForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/bloom#transformers.BloomForTokenClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.BloomForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L900)
...
#### forward[[transformers.BloomForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bloom/modeling_bloom.py#L909)
...
The [BloomForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/bloom#transformers.BloomForQuestionAnswering) forward method, overrides the `__call__` special method.
