...
d_model (`int`, *optional*, defaults to `8`) : Size of the encoder layers and the pooler layer.
...
dropout (`Union[float, int]`, *optional*, defaults to `0.2`) : The ratio for all dropout layers.
...
#### forward[[transformers.PatchTSMixerModel.forward]]
...
**Returns:** `PatchTSMixerModelOutput` or `tuple(torch.FloatTensor)`
...
#### forward[[transformers.PatchTSMixerForPrediction.forward]]
...
**Returns:** `PatchTSMixerForPredictionOutput` or `tuple(torch.FloatTensor)`
...
#### forward[[transformers.PatchTSMixerForTimeSeriesClassification.forward]]
...
**Returns:** `PatchTSMixerForTimeSeriesClassificationOutput` or `tuple(torch.FloatTensor)`
...
#### forward[[transformers.PatchTSMixerForPretraining.forward]]
...
**Returns:** `PatchTSMixerForPreTrainingOutput` or `tuple(torch.FloatTensor)`
...
#### forward[[transformers.PatchTSMixerForRegression.forward]]
...
**Returns:** `PatchTSMixerForRegressionOutput` or `tuple(torch.FloatTensor)`
