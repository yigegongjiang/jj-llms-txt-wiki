...
image_token_id (`int`, *optional*, defaults to `255036`) : The image token index used as a placeholder for input images.
...
```python
transformers.Cohere2VisionForConditionalGeneration(config: Cohere2VisionConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_vision/modeling_cohere2_vision.py#L245)
...
#### forward[[transformers.Cohere2VisionForConditionalGeneration.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_vision/modeling_cohere2_vision.py#L263)

**Parameters:**

input_ids (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) : Indices of input sequence tokens in the vocabulary. Padding will be ignored by default.  Indices can be obtained using [AutoTokenizer](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoTokenizer). See [PreTrainedTokenizer.encode()](/docs/transformers/v5.15.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and [PreTrainedTokenizer.__call__()](/docs/transformers/v5.15.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for details.  [What are input IDs?](../glossary#input-ids)

pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) : The tensors corresponding to the input images. Pixel values can be obtained using [Cohere2VisionImageProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionImageProcessor). See `Cohere2VisionImageProcessor.__call__()` for details ([Cohere2VisionProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionProcessor) uses [Cohere2VisionImageProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionImageProcessor) for processing images).
...
**Returns:** `Cohere2VisionCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`

A `Cohere2VisionCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Cohere2VisionConfig](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionConfig)) and inputs.

The [Cohere2VisionForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_vision/modeling_cohere2_vision.py#L257)

**Parameters:**

pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`) : The tensors corresponding to the input images. Pixel values can be obtained using [Cohere2VisionImageProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionImageProcessor). See `Cohere2VisionImageProcessor.__call__()` for details ([Cohere2VisionProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionProcessor) uses [Cohere2VisionImageProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionImageProcessor) for processing images).
...
```python
transformers.Cohere2VisionModel(config: Cohere2VisionConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_vision/modeling_cohere2_vision.py#L146)
...
#### forward[[transformers.Cohere2VisionModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, pixel_values: typing.Optional[torch.FloatTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_vision/modeling_cohere2_vision.py#L195)
...
**Returns:** `Cohere2VisionModelOutputWithPast` or `tuple(torch.FloatTensor)`

A `Cohere2VisionModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Cohere2VisionConfig](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionConfig)) and inputs.

The [Cohere2VisionModel](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_vision/modeling_cohere2_vision.py#L155)
...
#### transformers.Cohere2VisionImageProcessor[[transformers.Cohere2VisionImageProcessor]]

```python
transformers.Cohere2VisionImageProcessor(**kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_vision/image_processing_cohere2_vision.py#L110)
...
#### preprocess[[transformers.Cohere2VisionImageProcessor.preprocess]]
...
```python
transformers.Cohere2VisionProcessor(image_processor = None, tokenizer = None, chat_template = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_vision/processing_cohere2_vision.py#L32)

**Parameters:**

image_processor (`Cohere2VisionImageProcessor`) : The image processor is a required input.
...
[Cohere2VisionProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionProcessor) offers all the functionalities of [Cohere2VisionImageProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionImageProcessor) and `tokenizer_class`. See the
[~Cohere2VisionImageProcessor](/docs/transformers/v5.15.1/en/model_doc/cohere2_vision#transformers.Cohere2VisionImageProcessor) and `~tokenizer_class` for more information.

#### __call__[[transformers.Cohere2VisionProcessor.__call__]]
