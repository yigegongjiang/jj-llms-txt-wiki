...
#### preprocess[[transformers.DeiTImageProcessor.preprocess]]
...
#### transformers.DeiTImageProcessorPil[[transformers.DeiTImageProcessorPil]]
...
#### preprocess[[transformers.DeiTImageProcessorPil.preprocess]]
...
#### forward[[transformers.DeiTModel.forward]]
...
#### forward[[transformers.DeiTForMaskedImageModeling.forward]]
...
#### forward[[transformers.DeiTForImageClassification.forward]]
...
#### forward[[transformers.DeiTForImageClassificationWithTeacher.forward]]
...
**Returns:** `DeiTForImageClassificationWithTeacherOutput` or `tuple(torch.FloatTensor)`
