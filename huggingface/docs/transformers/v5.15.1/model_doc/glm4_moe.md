...
```python
transformers.Glm4MoeModel(config: Glm4MoeConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4_moe/modeling_glm4_moe.py#L484)
...
#### forward[[transformers.Glm4MoeModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4_moe/modeling_glm4_moe.py#L501)
...
elements depending on the configuration ([Glm4MoeConfig](/docs/transformers/v5.15.1/en/model_doc/glm4_moe#transformers.Glm4MoeConfig)) and inputs.

The [Glm4MoeModel](/docs/transformers/v5.15.1/en/model_doc/glm4_moe#transformers.Glm4MoeModel) forward method, overrides the `__call__` special method.
...
```python
transformers.Glm4MoeForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4_moe/modeling_glm4_moe.py#L558)
...
#### forward[[transformers.Glm4MoeForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm4_moe/modeling_glm4_moe.py#L573)
...
The [Glm4MoeForCausalLM](/docs/transformers/v5.15.1/en/model_doc/glm4_moe#transformers.Glm4MoeForCausalLM) forward method, overrides the `__call__` special method.
