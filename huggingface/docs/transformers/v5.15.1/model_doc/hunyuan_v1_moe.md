...
eod_token_id (`int`, *optional*, defaults to 3) : Token ID representing the end-of-document marker. Used to indicate the termination of a text sequence. For Example, in multi-document processing, this token helps the model distinguish between separate documents.

sep_token_id (`int`, *optional*, defaults to `4`) : Token id used for separator in the vocabulary.
...
num_experts (`int`, *optional*, defaults to `1`) : Number of routed experts in MoE layers. 

moe_topk (`int | list`, *optional*, defaults to 1) : Number of experts selected per token (Top-K routing). List form enables layer-wise customization.

head_dim (`int`, *optional*) : The attention head dimension. If None, it will default to hidden_size // num_attention_heads

This is the configuration class to store the configuration of a HunYuanMoEV1Model. It is used to instantiate a Hunyuan V1 Moe
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [tencent/Hunyuan-A13B-Instruct](https://huggingface.co/tencent/Hunyuan-A13B-Instruct)
...
```python
transformers.HunYuanMoEV1Model(config: HunYuanMoEV1Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L460)
...
#### forward[[transformers.HunYuanMoEV1Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L477)
...
elements depending on the configuration ([HunYuanMoEV1Config](/docs/transformers/v5.15.1/en/model_doc/hunyuan_v1_moe#transformers.HunYuanMoEV1Config)) and inputs.

The [HunYuanMoEV1Model](/docs/transformers/v5.15.1/en/model_doc/hunyuan_v1_moe#transformers.HunYuanMoEV1Model) forward method, overrides the `__call__` special method.
...
```python
transformers.HunYuanMoEV1ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L534)
...
#### forward[[transformers.HunYuanMoEV1ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L549)
...
The [HunYuanMoEV1ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/hunyuan_v1_moe#transformers.HunYuanMoEV1ForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.HunYuanMoEV1ForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L608)

#### forward[[transformers.HunYuanMoEV1ForSequenceClassification.forward]]
