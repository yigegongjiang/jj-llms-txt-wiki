...
defaults will yield a similar configuration to that of the [LiquidAI/LFM2-1.2B](https://huggingface.co/LiquidAI/LFM2-1.2B)
...
```python
transformers.Lfm2Model(config: Lfm2Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2/modeling_lfm2.py#L457)
...
#### forward[[transformers.Lfm2Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2/modeling_lfm2.py#L474)
...
elements depending on the configuration ([Lfm2Config](/docs/transformers/v5.15.1/en/model_doc/lfm2#transformers.Lfm2Config)) and inputs.

The [Lfm2Model](/docs/transformers/v5.15.1/en/model_doc/lfm2#transformers.Lfm2Model) forward method, overrides the `__call__` special method.
...
```python
transformers.Lfm2ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2/modeling_lfm2.py#L537)
...
#### forward[[transformers.Lfm2ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2/modeling_lfm2.py#L552)
...
The [Lfm2ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/lfm2#transformers.Lfm2ForCausalLM) forward method, overrides the `__call__` special method.
