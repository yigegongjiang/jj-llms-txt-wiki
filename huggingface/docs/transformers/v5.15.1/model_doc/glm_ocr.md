...
```python
transformers.GlmOcrConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, text_config: dict | transformers.configuration_utils.PreTrainedConfig | None = None, vision_config: dict | transformers.configuration_utils.PreTrainedConfig | None = None, image_token_id: int = 59280, video_token_id: int = 59281, image_start_token_id: int = 59256, image_end_token_id: int = 59257, video_start_token_id: int = 59258, video_end_token_id: int = 59259, tie_word_embeddings: bool = False)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/configuration_glm_ocr.py#L132)
...
image_token_id (`int`, *optional*, defaults to `59280`) : The image token index used as a placeholder for input images.

video_token_id (`int`, *optional*, defaults to `59281`) : The video token index used as a placeholder for input videos.
...
This is the configuration class to store the configuration of a GlmOcrModel. It is used to instantiate a Glm Ocr
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [zai-org/GLM-OCR](https://huggingface.co/zai-org/GLM-OCR)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/configuration_glm_ocr.py#L30)
...
```python
transformers.GlmOcrTextConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, vocab_size: int = 59392, hidden_size: int = 1024, intermediate_size: int = 4096, num_hidden_layers: int = 16, num_attention_heads: int = 16, num_key_value_heads: int = 8, hidden_act: str = 'silu', max_position_embeddings: int = 131072, initializer_range: float = 0.02, rms_norm_eps: float = 1e-05, use_cache: bool = True, attention_dropout: float | int = 0.0, rope_parameters: transformers.modeling_rope_utils.RopeParameters | dict | None = None, pad_token_id: int | None = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/configuration_glm_ocr.py#L72)

**Parameters:**

vocab_size (`int`, *optional*, defaults to `59392`) : Vocabulary size of the model. Defines the number of different tokens that can be represented by the `input_ids`.
...
```python
transformers.GlmOcrVisionModel(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L535)

#### forward[[transformers.GlmOcrVisionModel.forward]]

```python
forward(hidden_states: Tensor, grid_thw: Tensor, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L580)
...
The [GlmOcrVisionModel](/docs/transformers/v5.15.1/en/model_doc/glm_ocr#transformers.GlmOcrVisionModel) forward method, overrides the `__call__` special method.
...
```python
transformers.GlmOcrTextModel(config: GlmOcrTextConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L696)
...
The bare Glm Ocr Text Model outputting raw hidden-states without any specific head on top.
...
#### forward[[transformers.GlmOcrTextModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L720)
...
The [GlmOcrTextModel](/docs/transformers/v5.15.1/en/model_doc/glm_ocr#transformers.GlmOcrTextModel) forward method, overrides the `__call__` special method.
...
```python
transformers.GlmOcrModel(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L801)
...
#### forward[[transformers.GlmOcrModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1095)
...
**Returns:** `GlmOcrModelOutputWithPast` or `tuple(torch.FloatTensor)`

A `GlmOcrModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.

The [GlmOcrModel](/docs/transformers/v5.15.1/en/model_doc/glm_ocr#transformers.GlmOcrModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L987)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GlmOcrConfig](/docs/transformers/v5.15.1/en/model_doc/glm_ocr#transformers.GlmOcrConfig)) and inputs.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1004)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L868)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L961)

**Parameters:**

pixel_values_videos (`torch.FloatTensor` of shape `(batch_size, num_frames, num_channels, frame_size, frame_size)`) : The tensors corresponding to the input video. Pixel values for videos can be obtained using `video_processor_class`. See `video_processor_class.__call__` for details (`processor_class` uses `video_processor_class` for processing videos).
...
#### get_vision_position_ids[[transformers.GlmOcrModel.get_vision_position_ids]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L816)
...
```python
transformers.GlmOcrForConditionalGeneration(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1171)

#### forward[[transformers.GlmOcrForConditionalGeneration.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1209)
...
**Returns:** `GlmOcrCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`

A `GlmOcrCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GlmOcrConfig](/docs/transformers/v5.15.1/en/model_doc/glm_ocr#transformers.GlmOcrConfig)) and inputs.

The [GlmOcrForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/glm_ocr#transformers.GlmOcrForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1196)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1183)
