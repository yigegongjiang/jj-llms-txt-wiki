...
type_vocab_size (`int`, *optional*, defaults to 2) : The vocabulary size of the `token_type_ids` passed when calling [IBertModel](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertModel)
...
force_dequant (`str`, *optional*, defaults to `"none"`) : Force dequantize specific nonlinear layer. Dequantized layers are then executed with full precision. `"none"`, `"gelu"`, `"softmax"`, `"layernorm"` and `"nonlinear"` are supported. As default, it is set as `"none"`, which does not dequantize any layers. Please specify `"gelu"`, `"softmax"`, or `"layernorm"` to dequantize GELU, Softmax, or LayerNorm, respectively. `"nonlinear"` will dequantize all nonlinear layers, i.e., GELU, Softmax, and LayerNorm.

tie_word_embeddings (`bool`, *optional*, defaults to `True`) : Whether to tie weight embeddings according to model's `tied_weights_keys` mapping.

This is the configuration class to store the configuration of a IBertModel. It is used to instantiate a Ibert
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [kssteven/ibert-roberta-base](https://huggingface.co/kssteven/ibert-roberta-base)

Configuration objects inherit from [PreTrainedConfig](/docs/transformers/v5.15.1/en/main_classes/configuration#transformers.PreTrainedConfig) and can be used to control the model outputs. Read the
documentation from [PreTrainedConfig](/docs/transformers/v5.15.1/en/main_classes/configuration#transformers.PreTrainedConfig) for more information.

## IBertModel[[transformers.IBertModel]]

#### transformers.IBertModel[[transformers.IBertModel]]

```python
transformers.IBertModel(config, add_pooling_layer = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L621)

**Parameters:**

config ([IBertModel](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertModel)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.IBertModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L654)
...
elements depending on the configuration ([IBertConfig](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertConfig)) and inputs.

The [IBertModel](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertModel) forward method, overrides the `__call__` special method.
...
## IBertForMaskedLM[[transformers.IBertForMaskedLM]]

#### transformers.IBertForMaskedLM[[transformers.IBertForMaskedLM]]

```python
transformers.IBertForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L728)

**Parameters:**

config ([IBertForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForMaskedLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.IBertForMaskedLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L750)
...
The [IBertForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForMaskedLM) forward method, overrides the `__call__` special method.
...
## IBertForSequenceClassification[[transformers.IBertForSequenceClassification]]

#### transformers.IBertForSequenceClassification[[transformers.IBertForSequenceClassification]]

```python
transformers.IBertForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L830)

**Parameters:**

config ([IBertForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForSequenceClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.IBertForSequenceClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L841)
...
The [IBertForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
## IBertForMultipleChoice[[transformers.IBertForMultipleChoice]]

#### transformers.IBertForMultipleChoice[[transformers.IBertForMultipleChoice]]

```python
transformers.IBertForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L911)

**Parameters:**

config ([IBertForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForMultipleChoice)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.IBertForMultipleChoice.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L922)
...
The [IBertForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
## IBertForTokenClassification[[transformers.IBertForTokenClassification]]

#### transformers.IBertForTokenClassification[[transformers.IBertForTokenClassification]]

```python
transformers.IBertForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L1013)

**Parameters:**

config ([IBertForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForTokenClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.IBertForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L1025)
...
The [IBertForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForTokenClassification) forward method, overrides the `__call__` special method.
...
## IBertForQuestionAnswering[[transformers.IBertForQuestionAnswering]]

#### transformers.IBertForQuestionAnswering[[transformers.IBertForQuestionAnswering]]

```python
transformers.IBertForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L1098)

**Parameters:**

config ([IBertForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForQuestionAnswering)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.IBertForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ibert/modeling_ibert.py#L1109)
...
The [IBertForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/ibert#transformers.IBertForQuestionAnswering) forward method, overrides the `__call__` special method.
