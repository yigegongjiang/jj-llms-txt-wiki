...
## XLMRobertaXLConfig[[transformers.XLMRobertaXLConfig]]

#### transformers.XLMRobertaXLConfig[[transformers.XLMRobertaXLConfig]]

```python
transformers.XLMRobertaXLConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, vocab_size: int = 250880, hidden_size: int = 2560, num_hidden_layers: int = 36, num_attention_heads: int = 32, intermediate_size: int = 10240, hidden_act: str = 'gelu', hidden_dropout_prob: float | int = 0.1, attention_probs_dropout_prob: float | int = 0.1, max_position_embeddings: int = 514, type_vocab_size: int = 1, initializer_range: float = 0.02, layer_norm_eps: float = 1e-05, pad_token_id: int | None = 1, bos_token_id: int | None = 0, eos_token_id: int | list[int] | None = 2, use_cache: bool = True, classifier_dropout: float | int | None = None, is_decoder: bool = False, add_cross_attention: bool = False, tie_word_embeddings: bool = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/configuration_xlm_roberta_xl.py#L24)

**Parameters:**

vocab_size (`int`, *optional*, defaults to `250880`) : Vocabulary size of the model. Defines the number of different tokens that can be represented by the `input_ids`.
...
This is the configuration class to store the configuration of a Xlm Roberta XlModel. It is used to instantiate a Xlm Roberta Xl
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [FacebookAI/xlm-roberta-xl](https://huggingface.co/FacebookAI/xlm-roberta-xl)
...
## XLMRobertaXLModel[[transformers.XLMRobertaXLModel]]

#### transformers.XLMRobertaXLModel[[transformers.XLMRobertaXLModel]]

```python
transformers.XLMRobertaXLModel(config, add_pooling_layer = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L558)

**Parameters:**

config ([XLMRobertaXLModel](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.XLMRobertaXLModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L584)
...
elements depending on the configuration ([XLMRobertaXLConfig](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig)) and inputs.

The [XLMRobertaXLModel](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel) forward method, overrides the `__call__` special method.
...
## XLMRobertaXLForCausalLM[[transformers.XLMRobertaXLForCausalLM]]

#### transformers.XLMRobertaXLForCausalLM[[transformers.XLMRobertaXLForCausalLM]]

```python
transformers.XLMRobertaXLForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L734)

**Parameters:**

config ([XLMRobertaXLForCausalLM](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.XLMRobertaXLForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L758)
...
The [XLMRobertaXLForCausalLM](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForCausalLM) forward method, overrides the `__call__` special method.
...
## XLMRobertaXLForMaskedLM[[transformers.XLMRobertaXLForMaskedLM]]

#### transformers.XLMRobertaXLForMaskedLM[[transformers.XLMRobertaXLForMaskedLM]]

```python
transformers.XLMRobertaXLForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L832)

**Parameters:**

config ([XLMRobertaXLForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Xlm Roberta Xl Model with a `language modeling` head on top."
...
#### forward[[transformers.XLMRobertaXLForMaskedLM.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, encoder_hidden_states: typing.Optional[torch.Tensor] = None, encoder_attention_mask: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L859)
...
The [XLMRobertaXLForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM) forward method, overrides the `__call__` special method.
...
>>> tokenizer = AutoTokenizer.from_pretrained("FacebookAI/xlm-roberta-xl")
>>> model = XLMRobertaXLForMaskedLM.from_pretrained("FacebookAI/xlm-roberta-xl")
...
## XLMRobertaXLForSequenceClassification[[transformers.XLMRobertaXLForSequenceClassification]]

#### transformers.XLMRobertaXLForSequenceClassification[[transformers.XLMRobertaXLForSequenceClassification]]

```python
transformers.XLMRobertaXLForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L912)

**Parameters:**

config ([XLMRobertaXLForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForSequenceClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.XLMRobertaXLForSequenceClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L923)
...
The [XLMRobertaXLForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForSequenceClassification) forward method, overrides the `__call__` special method.
...
>>> tokenizer = AutoTokenizer.from_pretrained("FacebookAI/xlm-roberta-xl")
>>> model = XLMRobertaXLForSequenceClassification.from_pretrained("FacebookAI/xlm-roberta-xl")
...
>>> model = XLMRobertaXLForSequenceClassification.from_pretrained("FacebookAI/xlm-roberta-xl", num_labels=num_labels)
...
>>> tokenizer = AutoTokenizer.from_pretrained("FacebookAI/xlm-roberta-xl")
>>> model = XLMRobertaXLForSequenceClassification.from_pretrained("FacebookAI/xlm-roberta-xl", problem_type="multi_label_classification")
...
...     "FacebookAI/xlm-roberta-xl", num_labels=num_labels, problem_type="multi_label_classification"
... )
...
## XLMRobertaXLForMultipleChoice[[transformers.XLMRobertaXLForMultipleChoice]]

#### transformers.XLMRobertaXLForMultipleChoice[[transformers.XLMRobertaXLForMultipleChoice]]

```python
transformers.XLMRobertaXLForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L985)

**Parameters:**

config ([XLMRobertaXLForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMultipleChoice)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Xlm Roberta Xl Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
#### forward[[transformers.XLMRobertaXLForMultipleChoice.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L995)
...
The [XLMRobertaXLForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMultipleChoice) forward method, overrides the `__call__` special method.
...
>>> tokenizer = AutoTokenizer.from_pretrained("FacebookAI/xlm-roberta-xl")
>>> model = XLMRobertaXLForMultipleChoice.from_pretrained("FacebookAI/xlm-roberta-xl")
...
## XLMRobertaXLForTokenClassification[[transformers.XLMRobertaXLForTokenClassification]]

#### transformers.XLMRobertaXLForTokenClassification[[transformers.XLMRobertaXLForTokenClassification]]

```python
transformers.XLMRobertaXLForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1072)

**Parameters:**

config ([XLMRobertaXLForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForTokenClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Xlm Roberta Xl transformer with a token classification head on top (a linear layer on top of the hidden-states
...
#### forward[[transformers.XLMRobertaXLForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1086)
...
The [XLMRobertaXLForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForTokenClassification) forward method, overrides the `__call__` special method.
...
>>> tokenizer = AutoTokenizer.from_pretrained("FacebookAI/xlm-roberta-xl")
>>> model = XLMRobertaXLForTokenClassification.from_pretrained("FacebookAI/xlm-roberta-xl")
...
## XLMRobertaXLForQuestionAnswering[[transformers.XLMRobertaXLForQuestionAnswering]]

#### transformers.XLMRobertaXLForQuestionAnswering[[transformers.XLMRobertaXLForQuestionAnswering]]

```python
transformers.XLMRobertaXLForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1140)

**Parameters:**

config ([XLMRobertaXLForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForQuestionAnswering)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Xlm Roberta Xl transformer with a span classification head on top for extractive question-answering tasks like
...
#### forward[[transformers.XLMRobertaXLForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1150)
...
The [XLMRobertaXLForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForQuestionAnswering) forward method, overrides the `__call__` special method.
...
>>> tokenizer = AutoTokenizer.from_pretrained("FacebookAI/xlm-roberta-xl")
>>> model = XLMRobertaXLForQuestionAnswering.from_pretrained("FacebookAI/xlm-roberta-xl")
