...
This is the configuration class to store the configuration of a MinistralModel. It is used to instantiate a Ministral
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [mistralai/Ministral-8B-Instruct-2410](https://huggingface.co/mistralai/Ministral-8B-Instruct-2410)
...
## MinistralModel[[transformers.MinistralModel]]

#### transformers.MinistralModel[[transformers.MinistralModel]]

```python
transformers.MinistralModel(config: MinistralConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ministral/modeling_ministral.py#L337)

**Parameters:**

config ([MinistralConfig](/docs/transformers/v5.15.1/en/model_doc/ministral#transformers.MinistralConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.MinistralModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ministral/modeling_ministral.py#L354)
...
elements depending on the configuration ([MinistralConfig](/docs/transformers/v5.15.1/en/model_doc/ministral#transformers.MinistralConfig)) and inputs.

The [MinistralModel](/docs/transformers/v5.15.1/en/model_doc/ministral#transformers.MinistralModel) forward method, overrides the `__call__` special method.
...
## MinistralForCausalLM[[transformers.MinistralForCausalLM]]

#### transformers.MinistralForCausalLM[[transformers.MinistralForCausalLM]]

```python
transformers.MinistralForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ministral/modeling_ministral.py#L419)

**Parameters:**

config ([MinistralForCausalLM](/docs/transformers/v5.15.1/en/model_doc/ministral#transformers.MinistralForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.MinistralForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ministral/modeling_ministral.py#L434)
...
The [MinistralForCausalLM](/docs/transformers/v5.15.1/en/model_doc/ministral#transformers.MinistralForCausalLM) forward method, overrides the `__call__` special method.
...
## MinistralForSequenceClassification[[transformers.MinistralForSequenceClassification]]

#### transformers.MinistralForSequenceClassification[[transformers.MinistralForSequenceClassification]]

```python
transformers.MinistralForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ministral/modeling_ministral.py#L493)

#### forward[[transformers.MinistralForSequenceClassification.forward]]
...
## MinistralForTokenClassification[[transformers.MinistralForTokenClassification]]

#### transformers.MinistralForTokenClassification[[transformers.MinistralForTokenClassification]]

```python
transformers.MinistralForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ministral/modeling_ministral.py#L497)

#### forward[[transformers.MinistralForTokenClassification.forward]]
...
## MinistralForQuestionAnswering[[transformers.MinistralForQuestionAnswering]]

#### transformers.MinistralForQuestionAnswering[[transformers.MinistralForQuestionAnswering]]

```python
transformers.MinistralForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ministral/modeling_ministral.py#L501)

#### forward[[transformers.MinistralForQuestionAnswering.forward]]
