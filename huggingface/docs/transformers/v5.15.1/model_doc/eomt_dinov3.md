...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/eomt_dinov3/configuration_eomt_dinov3.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/eomt_dinov3/modeling_eomt_dinov3.py#L1057)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/eomt_dinov3/modeling_eomt_dinov3.py#L1164)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/eomt_dinov3/modeling_eomt_dinov3.py#L1228)
...
elements depending on the configuration ([EomtDinov3Config](/docs/transformers/v5.15.1/en/model_doc/eomt_dinov3#transformers.EomtDinov3Config)) and inputs.

The [EomtDinov3ForUniversalSegmentation](/docs/transformers/v5.15.1/en/model_doc/eomt_dinov3#transformers.EomtDinov3ForUniversalSegmentation) forward method, overrides the `__call__` special method.
