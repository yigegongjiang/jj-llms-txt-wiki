...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.15.1/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoModel) class.
...
This is the configuration class to store the configuration of a OlmoModel. It is used to instantiate a Olmo
...
```python
transformers.OlmoModel(config: OlmoConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo/modeling_olmo.py#L342)
...
#### forward[[transformers.OlmoModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo/modeling_olmo.py#L359)
...
elements depending on the configuration ([OlmoConfig](/docs/transformers/v5.15.1/en/model_doc/olmo#transformers.OlmoConfig)) and inputs.

The [OlmoModel](/docs/transformers/v5.15.1/en/model_doc/olmo#transformers.OlmoModel) forward method, overrides the `__call__` special method.
...
```python
transformers.OlmoForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo/modeling_olmo.py#L416)
...
#### forward[[transformers.OlmoForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo/modeling_olmo.py#L431)
...
The [OlmoForCausalLM](/docs/transformers/v5.15.1/en/model_doc/olmo#transformers.OlmoForCausalLM) forward method, overrides the `__call__` special method.
...
## OlmoForSequenceClassification[[transformers.OlmoForSequenceClassification]]

#### transformers.OlmoForSequenceClassification[[transformers.OlmoForSequenceClassification]]

```python
transformers.OlmoForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/olmo/modeling_olmo.py#L490)

#### forward[[transformers.OlmoForSequenceClassification.forward]]
