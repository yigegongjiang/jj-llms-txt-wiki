...
```python
transformers.DbrxConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, d_model: int | None = 2048, n_heads: int | None = 16, n_layers: int | None = 24, max_seq_len: int | None = 2048, vocab_size: int = 32000, resid_pdrop: float | None = 0.0, emb_pdrop: float | None = 0.0, attn_config: transformers.models.dbrx.configuration_dbrx.DbrxAttentionConfig | dict | None = None, ffn_config: transformers.models.dbrx.configuration_dbrx.DbrxFFNConfig | dict | None = None, use_cache: bool = True, initializer_range: float = 0.02, output_router_logits: bool | None = False, rope_parameters: transformers.modeling_rope_utils.RopeParameters | dict | None = None, pad_token_id: int | None = None, bos_token_id: int | None = None, eos_token_id: int | list[int] | None = None, tie_word_embeddings: bool = False)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/dbrx/configuration_dbrx.py#L104)
...
emb_pdrop (`float`, *optional*, defaults to `0.0`) : The dropout ratio for the embeddings.
...
This is the configuration class to store the configuration of a DbrxModel. It is used to instantiate a Dbrx
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [transformers-community/dbrx-instruct](https://huggingface.co/transformers-community/dbrx-instruct)
...
```python
transformers.DbrxModel(config: DbrxConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/dbrx/modeling_dbrx.py#L466)
...
#### forward[[transformers.DbrxModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/dbrx/modeling_dbrx.py#L495)
...
elements depending on the configuration ([DbrxConfig](/docs/transformers/v5.15.1/en/model_doc/dbrx#transformers.DbrxConfig)) and inputs.

The [DbrxModel](/docs/transformers/v5.15.1/en/model_doc/dbrx#transformers.DbrxModel) forward method, overrides the `__call__` special method.
...
```python
transformers.DbrxForCausalLM(config: DbrxConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/dbrx/modeling_dbrx.py#L636)

#### forward[[transformers.DbrxForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/dbrx/modeling_dbrx.py#L671)
...
The [DbrxForCausalLM](/docs/transformers/v5.15.1/en/model_doc/dbrx#transformers.DbrxForCausalLM) forward method, overrides the `__call__` special method.
