...
```python
transformers.NanoChatConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, vocab_size: int = 50304, hidden_size: int = 768, intermediate_size: int = 8192, num_hidden_layers: int = 12, num_attention_heads: int = 6, num_key_value_heads: int | None = None, max_position_embeddings: int = 2048, hidden_act: str = 'relu2', attention_dropout: float | int = 0.0, rms_norm_eps: float = 1e-06, initializer_range: float = 0.02, rope_parameters: transformers.modeling_rope_utils.RopeParameters | dict | None = None, use_cache: bool = True, final_logit_softcapping: float | None = 15.0, attention_bias: bool = False, bos_token_id: int | None = 0, eos_token_id: int | list[int] | None = 1, pad_token_id: int | None = 1, tie_word_embeddings: bool = False)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nanochat/configuration_nanochat.py#L25)
...
final_logit_softcapping (`float`, *optional*, defaults to `15.0`) : Soft-capping value applied to the final logits before computing the probability distribution. Logits are scaled by `tanh(logit / cap) * cap`.
...
```python
transformers.NanoChatModel(config: NanoChatConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nanochat/modeling_nanochat.py#L350)
...
#### forward[[transformers.NanoChatModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nanochat/modeling_nanochat.py#L368)
...
elements depending on the configuration ([NanoChatConfig](/docs/transformers/v5.15.1/en/model_doc/nanochat#transformers.NanoChatConfig)) and inputs.

The [NanoChatModel](/docs/transformers/v5.15.1/en/model_doc/nanochat#transformers.NanoChatModel) forward method, overrides the `__call__` special method.
...
```python
transformers.NanoChatForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nanochat/modeling_nanochat.py#L425)
...
#### forward[[transformers.NanoChatForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nanochat/modeling_nanochat.py#L441)
...
The [NanoChatForCausalLM](/docs/transformers/v5.15.1/en/model_doc/nanochat#transformers.NanoChatForCausalLM) forward method, overrides the `__call__` special method.
