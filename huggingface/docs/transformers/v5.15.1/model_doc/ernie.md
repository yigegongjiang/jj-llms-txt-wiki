...
#### transformers.models.ernie.modeling_ernie.ErnieForPreTrainingOutput[[transformers.models.ernie.modeling_ernie.ErnieForPreTrainingOutput]]

```python
transformers.models.ernie.modeling_ernie.ErnieForPreTrainingOutput(loss: typing.Optional[torch.FloatTensor] = None, prediction_logits: typing.Optional[torch.FloatTensor] = None, seq_relationship_logits: typing.Optional[torch.FloatTensor] = None, hidden_states: tuple[torch.FloatTensor] | None = None, attentions: tuple[torch.FloatTensor] | None = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L698)
...
Output type of [ErnieForPreTraining](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForPreTraining).

## ErnieModel[[transformers.ErnieModel]]

#### transformers.ErnieModel[[transformers.ErnieModel]]

```python
transformers.ErnieModel(config, add_pooling_layer = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L556)

**Parameters:**

config ([ErnieModel](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieModel)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L582)
...
elements depending on the configuration ([ErnieConfig](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieConfig)) and inputs.

The [ErnieModel](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieModel) forward method, overrides the `__call__` special method.
...
#### transformers.ErnieForPreTraining[[transformers.ErnieForPreTraining]]

```python
transformers.ErnieForPreTraining(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L735)

**Parameters:**

config ([ErnieForPreTraining](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForPreTraining)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieForPreTraining.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, task_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, next_sentence_label: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L757)
...
**Returns:** [ErnieForPreTrainingOutput](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.models.ernie.modeling_ernie.ErnieForPreTrainingOutput) or `tuple(torch.FloatTensor)`

A [ErnieForPreTrainingOutput](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.models.ernie.modeling_ernie.ErnieForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ErnieConfig](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieConfig)) and inputs.

The [ErnieForPreTraining](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForPreTraining) forward method, overrides the `__call__` special method.
...
#### transformers.ErnieForCausalLM[[transformers.ErnieForCausalLM]]

```python
transformers.ErnieForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L849)

**Parameters:**

config ([ErnieForCausalLM](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieForCausalLM.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, task_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, encoder_hidden_states: typing.Optional[torch.Tensor] = None, encoder_attention_mask: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, past_key_values: list[torch.Tensor] | None = None, use_cache: bool | None = None, logits_to_keep: typing.Union[int, torch.Tensor] = 0, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L874)
...
The [ErnieForCausalLM](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForCausalLM) forward method, overrides the `__call__` special method.
...
#### transformers.ErnieForMaskedLM[[transformers.ErnieForMaskedLM]]

```python
transformers.ErnieForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L941)

**Parameters:**

config ([ErnieForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForMaskedLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieForMaskedLM.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, task_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, encoder_hidden_states: typing.Optional[torch.Tensor] = None, encoder_attention_mask: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L969)
...
The [ErnieForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForMaskedLM) forward method, overrides the `__call__` special method.
...
#### transformers.ErnieForNextSentencePrediction[[transformers.ErnieForNextSentencePrediction]]

```python
transformers.ErnieForNextSentencePrediction(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1039)

**Parameters:**

config ([ErnieForNextSentencePrediction](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForNextSentencePrediction)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieForNextSentencePrediction.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, task_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1049)
...
The [ErnieForNextSentencePrediction](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
#### transformers.ErnieForSequenceClassification[[transformers.ErnieForSequenceClassification]]

```python
transformers.ErnieForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1128)

**Parameters:**

config ([ErnieForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForSequenceClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieForSequenceClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, task_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1144)
...
The [ErnieForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForSequenceClassification) forward method, overrides the `__call__` special method.
...
#### transformers.ErnieForMultipleChoice[[transformers.ErnieForMultipleChoice]]

```python
transformers.ErnieForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1216)

**Parameters:**

config ([ErnieForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForMultipleChoice)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieForMultipleChoice.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, task_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1230)
...
The [ErnieForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForMultipleChoice) forward method, overrides the `__call__` special method.
...
#### transformers.ErnieForTokenClassification[[transformers.ErnieForTokenClassification]]

```python
transformers.ErnieForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1321)

**Parameters:**

config ([ErnieForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForTokenClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, task_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1336)
...
The [ErnieForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForTokenClassification) forward method, overrides the `__call__` special method.
...
#### transformers.ErnieForQuestionAnswering[[transformers.ErnieForQuestionAnswering]]

```python
transformers.ErnieForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1388)

**Parameters:**

config ([ErnieForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForQuestionAnswering)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ErnieForQuestionAnswering.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, task_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, start_positions: typing.Optional[torch.Tensor] = None, end_positions: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie/modeling_ernie.py#L1399)
...
The [ErnieForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/ernie#transformers.ErnieForQuestionAnswering) forward method, overrides the `__call__` special method.
