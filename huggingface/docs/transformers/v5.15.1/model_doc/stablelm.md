...
- `StableLM 3B 4E1T`-based models uses the same tokenizer as [GPTNeoXTokenizerFast](/docs/transformers/v5.15.1/en/model_doc/gpt_neox#transformers.GPTNeoXTokenizer).
...
```python
transformers.StableLmConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, vocab_size: int = 50304, intermediate_size: int = 6912, hidden_size: int = 2560, num_hidden_layers: int = 32, num_attention_heads: int = 32, num_key_value_heads: int = 32, hidden_act: str = 'silu', max_position_embeddings: int = 4096, initializer_range: float = 0.02, layer_norm_eps: float = 1e-05, use_cache: bool = True, tie_word_embeddings: bool = False, rope_parameters: transformers.modeling_rope_utils.RopeParameters | dict | None = None, use_qkv_bias: bool = False, qk_layernorm: bool = False, use_parallel_residual: bool = False, hidden_dropout: float | int = 0.0, attention_dropout: float | int = 0.0, bos_token_id: int | None = 0, eos_token_id: int | list[int] | None = 0, pad_token_id: int | None = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/stablelm/configuration_stablelm.py#L25)
...
use_qkv_bias (`bool`, *optional*, defaults to `False`) : Whether to add a bias to the queries, keys and values.

qk_layernorm (`bool`, *optional*, defaults to `False`) : Whether to use query-key normalization in the attention.
...
```python
transformers.StableLmModel(config: StableLmConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/stablelm/modeling_stablelm.py#L403)
...
#### forward[[transformers.StableLmModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/stablelm/modeling_stablelm.py#L429)
...
elements depending on the configuration ([StableLmConfig](/docs/transformers/v5.15.1/en/model_doc/stablelm#transformers.StableLmConfig)) and inputs.

The [StableLmModel](/docs/transformers/v5.15.1/en/model_doc/stablelm#transformers.StableLmModel) forward method, overrides the `__call__` special method.
...
```python
transformers.StableLmForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/stablelm/modeling_stablelm.py#L487)

#### forward[[transformers.StableLmForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/stablelm/modeling_stablelm.py#L500)
...
The [StableLmForCausalLM](/docs/transformers/v5.15.1/en/model_doc/stablelm#transformers.StableLmForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.StableLmForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/stablelm/modeling_stablelm.py#L564)

#### forward[[transformers.StableLmForSequenceClassification.forward]]
...
```python
transformers.StableLmForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/stablelm/modeling_stablelm.py#L567)

#### forward[[transformers.StableLmForTokenClassification.forward]]
