...
## Cosmos3EdgeConfig[[transformers.Cosmos3EdgeConfig]]

#### transformers.Cosmos3EdgeConfig[[transformers.Cosmos3EdgeConfig]]
...
text_config (`Union[~models.cosmos3_edge.configuration_cosmos3_edge.Cosmos3EdgeTextConfig, dict]`, *optional*) : The config object or dictionary of the text backbone.

vision_config (`Union[~models.cosmos3_edge.configuration_cosmos3_edge.Cosmos3EdgeVisionConfig, dict]`, *optional*) : The config object or dictionary of the vision backbone.

projector_hidden_size (`int`, *optional*, defaults to 11520) : Intermediate hidden size of the vision-to-language projector MLP.

image_token_id (`int`, *optional*, defaults to `19`) : The image token index used as a placeholder for input images.

video_token_id (`int`, *optional*, defaults to `18`) : The video token index used as a placeholder for input videos.

vision_start_token_id (`int`, *optional*, defaults to `20`) : Token ID that marks the start of a visual segment in the multimodal input sequence.

vision_end_token_id (`int`, *optional*, defaults to `21`) : Token ID that marks the end of a visual segment in the multimodal input sequence.

tie_word_embeddings (`bool`, *optional*, defaults to `False`) : Whether to tie weight embeddings according to model's `tied_weights_keys` mapping.

This is the configuration class to store the configuration of a Cosmos3EdgeModel. It is used to instantiate a Cosmos3 Edge
...
## Cosmos3EdgeTextConfig[[transformers.Cosmos3EdgeTextConfig]]

#### transformers.Cosmos3EdgeTextConfig[[transformers.Cosmos3EdgeTextConfig]]
...
## Cosmos3EdgeVisionConfig[[transformers.Cosmos3EdgeVisionConfig]]

#### transformers.Cosmos3EdgeVisionConfig[[transformers.Cosmos3EdgeVisionConfig]]
...
num_patches (`int`, *optional*, defaults to 256) : Number of patches in the learned reference positional-embedding grid.
...
#### transformers.Cosmos3EdgeProcessor[[transformers.Cosmos3EdgeProcessor]]
...
image_processor (`Cosmos3EdgeImageProcessor`) : The image processor is a required input.

tokenizer (`tokenizer_class`) : The tokenizer is a required input.

video_processor (`Cosmos3EdgeVideoProcessor`) : The video processor is a required input.
...
## Cosmos3EdgeImageProcessor[[transformers.Cosmos3EdgeImageProcessor]]

#### transformers.Cosmos3EdgeImageProcessor[[transformers.Cosmos3EdgeImageProcessor]]
...
size (`Annotated[int | list[int] | tuple[int, ...] | dict[str, int] | None, None]`, *kwargs*, defaults to `{'shortest_edge' : 65536, 'longest_edge': 16777216}`): Describes the maximum input dimensions to the model.
...
#### preprocess[[transformers.Cosmos3EdgeImageProcessor.preprocess]]
...
## Cosmos3EdgeImageProcessorPil[[transformers.Cosmos3EdgeImageProcessorPil]]

#### transformers.Cosmos3EdgeImageProcessorPil[[transformers.Cosmos3EdgeImageProcessorPil]]
...
#### preprocess[[transformers.Cosmos3EdgeImageProcessorPil.preprocess]]
...
## Cosmos3EdgeVideoProcessor[[transformers.Cosmos3EdgeVideoProcessor]]

#### transformers.Cosmos3EdgeVideoProcessor[[transformers.Cosmos3EdgeVideoProcessor]]
...
- ****kwargs** (`Cosmos3EdgeVideoProcessorInitKwargs`, *optional*) : Additional image preprocessing options. Model-specific kwargs are listed above; see the TypedDict class for the complete list of supported arguments.

Constructs a Cosmos3EdgeVideoProcessor video processor.

#### preprocess[[transformers.Cosmos3EdgeVideoProcessor.preprocess]]
...
## Cosmos3EdgeModel[[transformers.Cosmos3EdgeModel]]

#### transformers.Cosmos3EdgeModel[[transformers.Cosmos3EdgeModel]]
...
#### forward[[transformers.Cosmos3EdgeModel.forward]]
...
#### get_image_features[[transformers.Cosmos3EdgeModel.get_image_features]]
...
#### get_video_features[[transformers.Cosmos3EdgeModel.get_video_features]]
...
## Cosmos3EdgeTextModel[[transformers.Cosmos3EdgeTextModel]]

#### transformers.Cosmos3EdgeTextModel[[transformers.Cosmos3EdgeTextModel]]
...
#### forward[[transformers.Cosmos3EdgeTextModel.forward]]
...
## Cosmos3EdgeVisionModel[[transformers.Cosmos3EdgeVisionModel]]

#### transformers.Cosmos3EdgeVisionModel[[transformers.Cosmos3EdgeVisionModel]]
...
#### forward[[transformers.Cosmos3EdgeVisionModel.forward]]
...
## Cosmos3EdgeForConditionalGeneration[[transformers.Cosmos3EdgeForConditionalGeneration]]

#### transformers.Cosmos3EdgeForConditionalGeneration[[transformers.Cosmos3EdgeForConditionalGeneration]]
...
#### get_image_features[[transformers.Cosmos3EdgeForConditionalGeneration.get_image_features]]
...
#### get_video_features[[transformers.Cosmos3EdgeForConditionalGeneration.get_video_features]]
