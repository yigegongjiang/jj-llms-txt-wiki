...
num_layers (`int`, *optional*, defaults to `28`) : Number of hidden layers in the Transformer decoder.
...
n_routed_experts (`int`, *optional*, defaults to `512`) : Number of routed experts.
...
routed_scaling_factor (`float`, *optional*, defaults to `6.0`) : Scaling factor or routed experts.
...
```python
transformers.LongcatFlashPreTrainedModel(config: PreTrainedConfig, *inputs, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/longcat_flash/modeling_longcat_flash.py#L545)
...
#### forward[[transformers.LongcatFlashPreTrainedModel.forward]]
...
```python
transformers.LongcatFlashModel(config: LongcatFlashConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/longcat_flash/modeling_longcat_flash.py#L578)

**Parameters:**

config ([LongcatFlashConfig](/docs/transformers/v5.15.1/en/model_doc/longcat_flash#transformers.LongcatFlashConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.LongcatFlashModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/longcat_flash/modeling_longcat_flash.py#L599)
...
elements depending on the configuration ([LongcatFlashConfig](/docs/transformers/v5.15.1/en/model_doc/longcat_flash#transformers.LongcatFlashConfig)) and inputs.

The [LongcatFlashModel](/docs/transformers/v5.15.1/en/model_doc/longcat_flash#transformers.LongcatFlashModel) forward method, overrides the `__call__` special method.
...
```python
transformers.LongcatFlashForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/longcat_flash/modeling_longcat_flash.py#L657)
...
#### forward[[transformers.LongcatFlashForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/longcat_flash/modeling_longcat_flash.py#L673)
...
The [LongcatFlashForCausalLM](/docs/transformers/v5.15.1/en/model_doc/longcat_flash#transformers.LongcatFlashForCausalLM) forward method, overrides the `__call__` special method.
