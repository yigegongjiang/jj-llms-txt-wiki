...
#### preprocess[[transformers.VideoLlama3ImageProcessor.preprocess]]
...
- ****kwargs** (`VideoLlama3VideoProcessorInitKwargs`, *optional*) : Additional image preprocessing options. Model-specific kwargs are listed above; see the TypedDict class for the complete list of supported arguments.

Constructs a VideoLlama3VideoProcessor video processor.

#### preprocess[[transformers.VideoLlama3VideoProcessor.preprocess]]
...
#### transformers.VideoLlama3ImageProcessorPil[[transformers.VideoLlama3ImageProcessorPil]]
...
#### preprocess[[transformers.VideoLlama3ImageProcessorPil.preprocess]]
...
image_processor (`VideoLlama3ImageProcessor`) : The image processor is a required input.
...
#### forward[[transformers.VideoLlama3Model.forward]]
...
**Returns:** `VideoLlama3ModelOutputWithPast` or `tuple(torch.FloatTensor)`
...
**Returns:** `VideoLlama3CausalLMOutputWithPast` or `tuple(torch.FloatTensor)`
