...
```python
transformers.LlavaImageProcessor(**kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/image_processing_llava.py#L38)
...
#### preprocess[[transformers.LlavaImageProcessor.preprocess]]
...
#### transformers.LlavaImageProcessorPil[[transformers.LlavaImageProcessorPil]]

```python
transformers.LlavaImageProcessorPil(**kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/image_processing_pil_llava.py#L31)
...
#### preprocess[[transformers.LlavaImageProcessorPil.preprocess]]
...
```python
transformers.LlavaProcessor(image_processor = None, tokenizer = None, patch_size = None, vision_feature_select_strategy = None, chat_template = None, image_token = '<image>', num_additional_image_tokens = 0, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/processing_llava.py#L37)

**Parameters:**

image_processor (`LlavaImageProcessor`) : The image processor is a required input.
...
[~LlavaImageProcessor](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.15.1/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.

#### __call__[[transformers.LlavaProcessor.__call__]]
...
```python
transformers.LlavaModel(config: LlavaConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/modeling_llava.py#L130)
...
#### forward[[transformers.LlavaModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, pixel_values: typing.Optional[torch.FloatTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, vision_feature_layer: int | list[int] | None = None, vision_feature_select_strategy: str | None = None, image_sizes: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/modeling_llava.py#L215)

**Parameters:**

input_ids (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) : Indices of input sequence tokens in the vocabulary. Padding will be ignored by default.  Indices can be obtained using [AutoTokenizer](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoTokenizer). See [PreTrainedTokenizer.encode()](/docs/transformers/v5.15.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and [PreTrainedTokenizer.__call__()](/docs/transformers/v5.15.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for details.  [What are input IDs?](../glossary#input-ids)

pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) : The tensors corresponding to the input images. Pixel values can be obtained using [LlavaImageProcessor](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaImageProcessor). See `LlavaImageProcessor.__call__()` for details ([LlavaProcessor](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaProcessor) uses [LlavaImageProcessor](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaImageProcessor) for processing images).
...
**Returns:** `LlavaModelOutputWithPast` or `tuple(torch.FloatTensor)`

A `LlavaModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LlavaConfig](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaConfig)) and inputs.

The [LlavaModel](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/modeling_llava.py#L139)

**Parameters:**

pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`) : The tensors corresponding to the input images. Pixel values can be obtained using [LlavaImageProcessor](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaImageProcessor). See `LlavaImageProcessor.__call__()` for details ([LlavaProcessor](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaProcessor) uses [LlavaImageProcessor](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaImageProcessor) for processing images).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/modeling_llava.py#L191)
...
```python
transformers.LlavaForConditionalGeneration(config: LlavaConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/modeling_llava.py#L272)
...
#### forward[[transformers.LlavaForConditionalGeneration.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/modeling_llava.py#L299)
...
**Returns:** `LlavaCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`

A `LlavaCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LlavaConfig](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaConfig)) and inputs.

The [LlavaForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/llava#transformers.LlavaForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/llava/modeling_llava.py#L284)
