...
#### transformers.DeepseekV32PreTrainedModel[[transformers.DeepseekV32PreTrainedModel]]

```python
transformers.DeepseekV32PreTrainedModel(config: PreTrainedConfig, *inputs, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L664)
...
#### forward[[transformers.DeepseekV32PreTrainedModel.forward]]
...
#### transformers.DeepseekV32Model[[transformers.DeepseekV32Model]]

```python
transformers.DeepseekV32Model(config: DeepseekV32Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L696)

**Parameters:**

config ([DeepseekV32Config](/docs/transformers/v5.15.1/en/model_doc/deepseek_v32#transformers.DeepseekV32Config)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.DeepseekV32Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L713)
...
elements depending on the configuration ([DeepseekV32Config](/docs/transformers/v5.15.1/en/model_doc/deepseek_v32#transformers.DeepseekV32Config)) and inputs.

The [DeepseekV32Model](/docs/transformers/v5.15.1/en/model_doc/deepseek_v32#transformers.DeepseekV32Model) forward method, overrides the `__call__` special method.
...
#### transformers.DeepseekV32ForCausalLM[[transformers.DeepseekV32ForCausalLM]]

```python
transformers.DeepseekV32ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L773)

**Parameters:**

config ([DeepseekV32ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/deepseek_v32#transformers.DeepseekV32ForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.DeepseekV32ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L788)
...
The [DeepseekV32ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/deepseek_v32#transformers.DeepseekV32ForCausalLM) forward method, overrides the `__call__` special method.
