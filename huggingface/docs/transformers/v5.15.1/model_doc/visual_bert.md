...
The example below demonstrates how to answer a question based on an image with the [AutoModel](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoModel) class.
...
- Use [BertTokenizer](/docs/transformers/v5.15.1/en/model_doc/layoutlm#transformers.BertTokenizer) to encode the text and implement a custom detector/image processor to get the visual embeddings.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/configuration_visual_bert.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L492)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L520)
...
elements depending on the configuration ([VisualBertConfig](/docs/transformers/v5.15.1/en/model_doc/visual_bert#transformers.VisualBertConfig)) and inputs.

The [VisualBertModel](/docs/transformers/v5.15.1/en/model_doc/visual_bert#transformers.VisualBertModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L681)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L703)
...
The [VisualBertForPreTraining](/docs/transformers/v5.15.1/en/model_doc/visual_bert#transformers.VisualBertForPreTraining) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1022)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1034)
...
The [VisualBertForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/visual_bert#transformers.VisualBertForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L836)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L847)
...
The [VisualBertForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/visual_bert#transformers.VisualBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1159)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1171)
...
The [VisualBertForVisualReasoning](/docs/transformers/v5.15.1/en/model_doc/visual_bert#transformers.VisualBertForVisualReasoning) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1327)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1344)
...
The [VisualBertForRegionToPhraseAlignment](/docs/transformers/v5.15.1/en/model_doc/visual_bert#transformers.VisualBertForRegionToPhraseAlignment) forward method, overrides the `__call__` special method.
