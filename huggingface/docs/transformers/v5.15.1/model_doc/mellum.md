...
rope_parameters (`Union[dict, ~modeling_rope_utils.RopeParameters]`, *optional*) : Dictionary containing the configuration parameters for the RoPE embeddings. The dictionary should contain a value for `rope_theta` and optionally parameters used for scaling in case you want to use RoPE with longer `max_position_embeddings`.
...
moe_intermediate_size (`int`, *optional*, defaults to `896`) : Intermediate size of the routed expert MLPs.
...
mlp_layer_types (`list[str]`, *optional*) : Per-layer MLP type — `"dense"` or `"sparse"`. Length must equal `num_hidden_layers`. Defaults to all sparse.

This is the configuration class to store the configuration of a MellumModel. It is used to instantiate a Mellum
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [JetBrains/Mellum2-12B-A2.5B-Base](https://huggingface.co/JetBrains/Mellum2-12B-A2.5B-Base)
...
## MellumModel[[transformers.MellumModel]]

#### transformers.MellumModel[[transformers.MellumModel]]

```python
transformers.MellumModel(config: MellumConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mellum/modeling_mellum.py#L457)

**Parameters:**

config ([MellumConfig](/docs/transformers/v5.15.1/en/model_doc/mellum#transformers.MellumConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The bare Mellum Model outputting raw hidden-states without any specific head on top.
...
#### forward[[transformers.MellumModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mellum/modeling_mellum.py#L474)
...
elements depending on the configuration ([MellumConfig](/docs/transformers/v5.15.1/en/model_doc/mellum#transformers.MellumConfig)) and inputs.

The [MellumModel](/docs/transformers/v5.15.1/en/model_doc/mellum#transformers.MellumModel) forward method, overrides the `__call__` special method.
...
## MellumForCausalLM[[transformers.MellumForCausalLM]]

#### transformers.MellumForCausalLM[[transformers.MellumForCausalLM]]

```python
transformers.MellumForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mellum/modeling_mellum.py#L623)

**Parameters:**

config ([MellumForCausalLM](/docs/transformers/v5.15.1/en/model_doc/mellum#transformers.MellumForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Mellum Model for causal language modeling.
...
#### forward[[transformers.MellumForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mellum/modeling_mellum.py#L641)
...
The [MellumForCausalLM](/docs/transformers/v5.15.1/en/model_doc/mellum#transformers.MellumForCausalLM) forward method, overrides the `__call__` special method.
