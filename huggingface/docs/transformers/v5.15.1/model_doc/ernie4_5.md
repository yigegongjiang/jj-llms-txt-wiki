...
Other models from the family can be found at [Ernie 4.5 Moe](./ernie4_5_moe) and [Ernie 4.5 VL MoE](./ernie4_5_vl_moe).
...
## Ernie4_5Config[[transformers.Ernie4_5Config]]

#### transformers.Ernie4_5Config[[transformers.Ernie4_5Config]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5/configuration_ernie4_5.py#L25)
...
This is the configuration class to store the configuration of a Ernie4_5Model. It is used to instantiate a Ernie4 5
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [baidu/ERNIE-4.5-0.3B-PT](https://huggingface.co/baidu/ERNIE-4.5-0.3B-PT)
...
## Ernie4_5Model[[transformers.Ernie4_5Model]]

#### transformers.Ernie4_5Model[[transformers.Ernie4_5Model]]

```python
transformers.Ernie4_5Model(config: Ernie4_5Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5/modeling_ernie4_5.py#L337)

**Parameters:**

config ([Ernie4_5Config](/docs/transformers/v5.15.1/en/model_doc/ernie4_5#transformers.Ernie4_5Config)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The bare Ernie4 5 Model outputting raw hidden-states without any specific head on top.
...
#### forward[[transformers.Ernie4_5Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5/modeling_ernie4_5.py#L354)
...
elements depending on the configuration ([Ernie4_5Config](/docs/transformers/v5.15.1/en/model_doc/ernie4_5#transformers.Ernie4_5Config)) and inputs.

The [Ernie4_5Model](/docs/transformers/v5.15.1/en/model_doc/ernie4_5#transformers.Ernie4_5Model) forward method, overrides the `__call__` special method.
...
## Ernie4_5ForCausalLM[[transformers.Ernie4_5ForCausalLM]]

#### transformers.Ernie4_5ForCausalLM[[transformers.Ernie4_5ForCausalLM]]

```python
transformers.Ernie4_5ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5/modeling_ernie4_5.py#L411)

**Parameters:**

config ([Ernie4_5ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/ernie4_5#transformers.Ernie4_5ForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Ernie4 5 Model for causal language modeling.
...
#### forward[[transformers.Ernie4_5ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5/modeling_ernie4_5.py#L426)
...
The [Ernie4_5ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/ernie4_5#transformers.Ernie4_5ForCausalLM) forward method, overrides the `__call__` special method.
