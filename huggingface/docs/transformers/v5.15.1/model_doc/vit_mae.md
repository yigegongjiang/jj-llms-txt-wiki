...
#### forward[[transformers.ViTMAEModel.forward]]
...
**Returns:** `ViTMAEModelOutput` or `tuple(torch.FloatTensor)`
...
#### forward[[transformers.ViTMAEForPreTraining.forward]]
...
**Returns:** `ViTMAEForPreTrainingOutput` or `tuple(torch.FloatTensor)`
