...
#### add_mask_inputs[[transformers.Sam3TrackerVideoInferenceSession.add_mask_inputs]]
...
#### forward[[transformers.Sam3TrackerVideoModel.forward]]
...
**Returns:** `Sam3TrackerVideoSegmentationOutput` or `tuple(torch.FloatTensor)`
...
#### get_image_features[[transformers.Sam3TrackerVideoModel.get_image_features]]
...
**Returns:** `Sam3TrackerVideoVisionEncoderOutput` or `tuple(torch.FloatTensor)`
