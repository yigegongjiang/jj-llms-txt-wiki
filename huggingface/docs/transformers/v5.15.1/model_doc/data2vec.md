...
- For Data2VecAudio, preprocessing is identical to [Wav2Vec2Model](/docs/transformers/v5.15.1/en/model_doc/wav2vec2#transformers.Wav2Vec2Model), including feature extraction
- For Data2VecText, preprocessing is identical to [RobertaModel](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaModel), including tokenization.
- For Data2VecVision, preprocessing is identical to [BeitModel](/docs/transformers/v5.15.1/en/model_doc/beit#transformers.BeitModel), including feature extraction.
...
final_dropout (`float`, *optional*, defaults to 0.1) : The dropout probability for the final projection layer of [Data2VecAudioForCTC](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioForCTC).
...
conv_kernel (`Union[list[int], tuple[int, ...]]`, *optional*, defaults to `(10, 3, 3, 3, 3, 2, 2)`) : The size of the convolutional kernel.
...
conv_pos_kernel_size (`int`, *optional*, defaults to `19`) : Kernel size of positional conv module.
...
ctc_loss_reduction (`str`, *optional*, defaults to `"sum"`) : Specifies the reduction to apply to the output of `torch.nn.CTCLoss`. Only relevant when training an instance of [Data2VecAudioForCTC](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioForCTC).

ctc_zero_infinity (`bool`, *optional*, defaults to `False`) : Whether to zero infinite losses and the associated gradients of `torch.nn.CTCLoss`. Infinite losses mainly occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance of [Data2VecAudioForCTC](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioForCTC).

use_weighted_layer_sum (`bool`, *optional*, defaults to `False`) : Whether to use a weighted average of layer outputs with learned weights. Only relevant when using an instance of [Data2VecAudioForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioForSequenceClassification).
...
add_adapter (`bool`, *optional*, defaults to `False`) : Whether a convolutional network should be stacked on top of the Data2VecAudio Encoder. Can be very useful for warm-starting Data2VecAudio for SpeechEncoderDecoder models.
...
#### transformers.Data2VecVisionConfig[[transformers.Data2VecVisionConfig]]

```python
transformers.Data2VecVisionConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, hidden_size: int = 768, num_hidden_layers: int = 12, num_attention_heads: int = 12, intermediate_size: int = 3072, hidden_act: str = 'gelu', hidden_dropout_prob: float | int = 0.0, attention_probs_dropout_prob: float | int = 0.0, initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, image_size: int | list[int] | tuple[int, int] = 224, patch_size: int | list[int] | tuple[int, int] = 16, num_channels: int = 3, use_mask_token: bool = False, use_absolute_position_embeddings: bool = False, use_relative_position_bias: bool = False, use_shared_relative_position_bias: bool = False, layer_scale_init_value: float = 0.1, drop_path_rate: float | int = 0.1, use_mean_pooling: bool = True, out_indices: list[int] | tuple[int, ...] = (3, 5, 7, 11), pool_scales: list[int] | tuple[int, ...] = (1, 2, 3, 6), use_auxiliary_head: bool = True, auxiliary_loss_weight: float = 0.4, auxiliary_channels: int = 256, auxiliary_num_convs: int = 1, auxiliary_concat_input: bool = False, semantic_loss_ignore_index: int = 255)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/configuration_data2vec_vision.py#L24)
...
use_relative_position_bias (`bool`, *optional*, defaults to `False`) : Whether to use relative position bias in the self-attention layers.
...
out_indices (`Union[list[int], tuple[int, ...]]`, *optional*, defaults to `(3, 5, 7, 11)`) : Indices of the intermediate hidden states (feature maps) to return from the backbone. Each index corresponds to one stage of the model.
...
```python
transformers.Data2VecAudioModel(config: Data2VecAudioConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L662)
...
#### forward[[transformers.Data2VecAudioModel.forward]]
...
elements depending on the configuration ([Data2VecAudioConfig](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioConfig)) and inputs.

The [Data2VecAudioModel](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioModel) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecAudioForAudioFrameClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1020)
...
#### forward[[transformers.Data2VecAudioForAudioFrameClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1052)

**Parameters:**

input_values (`torch.FloatTensor` of shape `(batch_size, sequence_length)`) : Float values of input raw speech waveform. Values can be obtained by loading a `.flac` or `.wav` audio file into an array of type `list[float]`, a `numpy.ndarray` or a `torch.Tensor`, *e.g.* via the torchcodec library (`pip install torchcodec`) or the soundfile library (`pip install soundfile`). To prepare the array into `input_values`, the [AutoProcessor](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoProcessor) should be used for padding and conversion into a tensor of type `torch.FloatTensor`. See `Data2VecAudioProcessor.__call__` for details.
...
The [Data2VecAudioForAudioFrameClassification](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioForAudioFrameClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecAudioForCTC(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L801)
...
#### forward[[transformers.Data2VecAudioForCTC.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L836)
...
The [Data2VecAudioForCTC](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioForCTC) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecAudioForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L915)
...
#### forward[[transformers.Data2VecAudioForSequenceClassification.forward]]

```python
forward(input_values: typing.Optional[torch.Tensor], attention_mask: typing.Optional[torch.Tensor] = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, labels: typing.Optional[torch.Tensor] = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L948)
...
The [Data2VecAudioForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecAudioForXVector(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1174)
...
#### forward[[transformers.Data2VecAudioForXVector.forward]]

```python
forward(input_values: typing.Optional[torch.Tensor], attention_mask: typing.Optional[torch.Tensor] = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, labels: typing.Optional[torch.Tensor] = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_audio.py#L1224)
...
The [Data2VecAudioForXVector](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecAudioForXVector) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecTextModel(config, add_pooling_layer = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L536)
...
The bare Data2Vec Text Text Model outputting raw hidden-states without any specific head on top.
...
#### forward[[transformers.Data2VecTextModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L562)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Data2VecTextConfig](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecTextConfig)) and inputs.

The [Data2VecTextModel](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecTextModel) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecTextForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L712)
...
#### forward[[transformers.Data2VecTextForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L736)
...
The [Data2VecTextForCausalLM](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecTextForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecTextForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L812)
...
#### forward[[transformers.Data2VecTextForMaskedLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L839)
...
The [Data2VecTextForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecTextForMaskedLM) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecTextForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L894)
...
#### forward[[transformers.Data2VecTextForSequenceClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L906)
...
The [Data2VecTextForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecTextForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecTextForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L970)
...
#### forward[[transformers.Data2VecTextForMultipleChoice.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L981)
...
The [Data2VecTextForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecTextForMultipleChoice) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecTextForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L1066)
...
#### forward[[transformers.Data2VecTextForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L1081)
...
The [Data2VecTextForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecTextForTokenClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecTextForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L1128)
...
#### forward[[transformers.Data2VecTextForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_text.py#L1139)
...
The [Data2VecTextForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecTextForQuestionAnswering) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecVisionModel(config: Data2VecVisionConfig, add_pooling_layer: bool = False)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_vision.py#L684)
...
#### forward[[transformers.Data2VecVisionModel.forward]]

```python
forward(pixel_values: Tensor, bool_masked_pos: typing.Optional[torch.BoolTensor] = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, interpolate_pos_encoding: bool = False, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_vision.py#L707)
...
**Returns:** `Data2VecVisionModelOutputWithPooling` or `tuple(torch.FloatTensor)`

A `Data2VecVisionModelOutputWithPooling` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Data2VecVisionConfig](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecVisionConfig)) and inputs.

The [Data2VecVisionModel](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecVisionModel) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecVisionForImageClassification(config: Data2VecVisionConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_vision.py#L775)
...
#### forward[[transformers.Data2VecVisionForImageClassification.forward]]

```python
forward(pixel_values: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, interpolate_pos_encoding: bool = False, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_vision.py#L788)
...
The [Data2VecVisionForImageClassification](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecVisionForImageClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.Data2VecVisionForSemanticSegmentation(config: Data2VecVisionConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_vision.py#L1064)
...
#### forward[[transformers.Data2VecVisionForSemanticSegmentation.forward]]

```python
forward(pixel_values: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_attentions: bool | None = None, output_hidden_states: bool | None = None, interpolate_pos_encoding: bool = False, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/data2vec/modeling_data2vec_vision.py#L1116)
...
The [Data2VecVisionForSemanticSegmentation](/docs/transformers/v5.15.1/en/model_doc/data2vec#transformers.Data2VecVisionForSemanticSegmentation) forward method, overrides the `__call__` special method.
