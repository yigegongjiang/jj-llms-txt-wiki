...
```python
transformers.BambaModel(config: BambaConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bamba/modeling_bamba.py#L922)
...
#### forward[[transformers.BambaModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bamba/modeling_bamba.py#L942)
...
elements depending on the configuration ([BambaConfig](/docs/transformers/v5.15.1/en/model_doc/bamba#transformers.BambaConfig)) and inputs.

The [BambaModel](/docs/transformers/v5.15.1/en/model_doc/bamba#transformers.BambaModel) forward method, overrides the `__call__` special method.
...
```python
transformers.BambaForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bamba/modeling_bamba.py#L1004)
...
#### forward[[transformers.BambaForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/bamba/modeling_bamba.py#L1020)
...
The [BambaForCausalLM](/docs/transformers/v5.15.1/en/model_doc/bamba#transformers.BambaForCausalLM) forward method, overrides the `__call__` special method.
