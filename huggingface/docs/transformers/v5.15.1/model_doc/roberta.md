...
```python
transformers.RobertaTokenizerFast(vocab_file = None, merges_file = None, tokenizer_file = None, errors = 'replace', bos_token = '<s>', eos_token = '</s>', sep_token = '</s>', cls_token = '<s>', unk_token = '<unk>', pad_token = '<pad>', mask_token = '<mask>', add_prefix_space = False, trim_offsets = True, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/tokenization_roberta_old.py#L31)
...
#### create_token_type_ids_from_sequences[[transformers.RobertaTokenizerFast.create_token_type_ids_from_sequences]]

```python
create_token_type_ids_from_sequences(token_ids_0: list, token_ids_1: list[int] | None = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/tokenization_roberta_old.py#L238)
...
```python
transformers.RobertaModel(config, add_pooling_layer = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L551)
...
#### forward[[transformers.RobertaModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L577)
...
elements depending on the configuration ([RobertaConfig](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaConfig)) and inputs.

The [RobertaModel](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaModel) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L683)
...
#### forward[[transformers.RobertaForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L707)
...
The [RobertaForCausalLM](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L792)
...
#### forward[[transformers.RobertaForMaskedLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L819)
...
The [RobertaForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaForMaskedLM) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L905)
...
#### forward[[transformers.RobertaForSequenceClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L917)
...
The [RobertaForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L990)
...
#### forward[[transformers.RobertaForMultipleChoice.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L1001)
...
The [RobertaForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaForMultipleChoice) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L1087)
...
#### forward[[transformers.RobertaForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L1102)
...
The [RobertaForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaForTokenClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L1180)
...
#### forward[[transformers.RobertaForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta/modeling_roberta.py#L1191)
...
The [RobertaForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/roberta#transformers.RobertaForQuestionAnswering) forward method, overrides the `__call__` special method.
