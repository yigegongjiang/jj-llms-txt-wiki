...
## Cohere2MoeConfig[[transformers.Cohere2MoeConfig]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_moe/configuration_cohere2_moe.py#L24)
...
num_experts_per_tok (`int`, *optional*, defaults to 2) : Number of selected experts per token.
...
expert_selection_fn (`str`, *optional*, defaults to `"softmax"`) : Expert selection function of router.
...
prefix_dense_sliding_window_pattern (`int`, *optional*, defaults to 1) : Sliding window pattern for the prefix dense layers.

norm_topk_prob (`bool`, *optional*, defaults to `True`) : Whether to normalize the top-k expert probabilities when sigmoid is used.

prefix_dense_intermediate_size (`int`, *optional*) : Intermediate dimension of the dense prefix layers.

rms_norm_eps (`float`, *optional*) : The epsilon used by the RMS normalization layers.

sliding_window_pattern (`int`, *optional*, defaults to 4) : Sliding window pattern for the layers.

This is the configuration class to store the configuration of a Cohere2MoeModel. It is used to instantiate a Cohere2 Moe
...
>>> model = Cohere2MoeModel(configuration)
>>> # Accessing the model configuration
>>> configuration = model.config
```

## Cohere2MoeModel[[transformers.Cohere2MoeModel]]

#### transformers.Cohere2MoeModel[[transformers.Cohere2MoeModel]]

```python
transformers.Cohere2MoeModel(config: Cohere2MoeConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_moe/modeling_cohere2_moe.py#L489)
...
#### forward[[transformers.Cohere2MoeModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_moe/modeling_cohere2_moe.py#L509)
...
elements depending on the configuration ([Cohere2MoeConfig](/docs/transformers/v5.15.1/en/model_doc/cohere2_moe#transformers.Cohere2MoeConfig)) and inputs.

The [Cohere2MoeModel](/docs/transformers/v5.15.1/en/model_doc/cohere2_moe#transformers.Cohere2MoeModel) forward method, overrides the `__call__` special method.
...
## Cohere2MoeForCausalLM[[transformers.Cohere2MoeForCausalLM]]

#### transformers.Cohere2MoeForCausalLM[[transformers.Cohere2MoeForCausalLM]]

```python
transformers.Cohere2MoeForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_moe/modeling_cohere2_moe.py#L571)
...
#### forward[[transformers.Cohere2MoeForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/cohere2_moe/modeling_cohere2_moe.py#L588)
...
The [Cohere2MoeForCausalLM](/docs/transformers/v5.15.1/en/model_doc/cohere2_moe#transformers.Cohere2MoeForCausalLM) forward method, overrides the `__call__` special method.
