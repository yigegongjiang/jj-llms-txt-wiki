...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_next/configuration_qwen3_next.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_next/modeling_qwen3_next.py#L901)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_next/modeling_qwen3_next.py#L914)
...
elements depending on the configuration ([Qwen3NextConfig](/docs/transformers/v5.15.1/en/model_doc/qwen3_next#transformers.Qwen3NextConfig)) and inputs.

The [Qwen3NextModel](/docs/transformers/v5.15.1/en/model_doc/qwen3_next#transformers.Qwen3NextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_next/modeling_qwen3_next.py#L1061)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_next/modeling_qwen3_next.py#L1079)
...
The [Qwen3NextForCausalLM](/docs/transformers/v5.15.1/en/model_doc/qwen3_next#transformers.Qwen3NextForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_next/modeling_qwen3_next.py#L1164)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_next/modeling_qwen3_next.py#L1172)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_next/modeling_qwen3_next.py#L1168)
