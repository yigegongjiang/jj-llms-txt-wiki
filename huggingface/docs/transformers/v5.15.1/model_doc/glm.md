...
pad_token_id (`int`, *optional*, defaults to `151329`) : Token id used for padding in the vocabulary.
...
defaults will yield a similar configuration to that of the [THUDM/glm-4-9b-chat](https://huggingface.co/THUDM/glm-4-9b-chat)
...
```python
transformers.GlmModel(config: GlmConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm/modeling_glm.py#L358)
...
#### forward[[transformers.GlmModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm/modeling_glm.py#L375)
...
elements depending on the configuration ([GlmConfig](/docs/transformers/v5.15.1/en/model_doc/glm#transformers.GlmConfig)) and inputs.

The [GlmModel](/docs/transformers/v5.15.1/en/model_doc/glm#transformers.GlmModel) forward method, overrides the `__call__` special method.
...
```python
transformers.GlmForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm/modeling_glm.py#L432)
...
#### forward[[transformers.GlmForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm/modeling_glm.py#L447)
...
The [GlmForCausalLM](/docs/transformers/v5.15.1/en/model_doc/glm#transformers.GlmForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.GlmForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm/modeling_glm.py#L506)

#### forward[[transformers.GlmForSequenceClassification.forward]]
...
```python
transformers.GlmForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/glm/modeling_glm.py#L510)

#### forward[[transformers.GlmForTokenClassification.forward]]
