...
moe_intermediate_size (`int`, *optional*, defaults to `1792`) : Intermediate size of the routed expert MLPs.
...
num_experts (`int`, *optional*, defaults to `32`) : Number of routed experts in MoE layers. 
...
defaults will yield a similar configuration to that of the [LiquidAI/LFM2-8B-A1B](https://huggingface.co/LiquidAI/LFM2-8B-A1B)
...
```python
transformers.Lfm2MoeForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L638)
...
#### forward[[transformers.Lfm2MoeForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L653)
...
elements depending on the configuration ([Lfm2MoeConfig](/docs/transformers/v5.15.1/en/model_doc/lfm2_moe#transformers.Lfm2MoeConfig)) and inputs.

The [Lfm2MoeForCausalLM](/docs/transformers/v5.15.1/en/model_doc/lfm2_moe#transformers.Lfm2MoeForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.Lfm2MoeModel(config: Lfm2MoeConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L558)
...
#### forward[[transformers.Lfm2MoeModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L575)
...
The [Lfm2MoeModel](/docs/transformers/v5.15.1/en/model_doc/lfm2_moe#transformers.Lfm2MoeModel) forward method, overrides the `__call__` special method.
...
```python
transformers.Lfm2MoePreTrainedModel(config: PreTrainedConfig, *inputs, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L527)
...
#### forward[[transformers.Lfm2MoePreTrainedModel.forward]]
