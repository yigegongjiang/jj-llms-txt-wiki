...
#### forward[[transformers.Idefics3Model.forward]]
...
**Returns:** `Idefics3BaseModelOutputWithPast` or `tuple(torch.FloatTensor)`
...
#### forward[[transformers.Idefics3ForConditionalGeneration.forward]]
...
**Returns:** `Idefics3CausalLMOutputWithPast` or `tuple(torch.FloatTensor)`
...
#### preprocess[[transformers.Idefics3ImageProcessor.preprocess]]
...
#### transformers.Idefics3ImageProcessorPil[[transformers.Idefics3ImageProcessorPil]]
...
#### preprocess[[transformers.Idefics3ImageProcessorPil.preprocess]]
...
#### transformers.Idefics3Processor[[transformers.Idefics3Processor]]
...
image_processor (`Idefics3ImageProcessor`) : The image processor is a required input.
