...
This is the configuration class to store the configuration of a SolarOpenModel. It is used to instantiate a Solar Open
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [upstage/Solar-Open-100B](https://huggingface.co/upstage/Solar-Open-100B)
...
```python
transformers.SolarOpenModel(config: SolarOpenConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/solar_open/modeling_solar_open.py#L455)
...
#### forward[[transformers.SolarOpenModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/solar_open/modeling_solar_open.py#L472)
...
elements depending on the configuration ([SolarOpenConfig](/docs/transformers/v5.15.1/en/model_doc/solar_open#transformers.SolarOpenConfig)) and inputs.

The [SolarOpenModel](/docs/transformers/v5.15.1/en/model_doc/solar_open#transformers.SolarOpenModel) forward method, overrides the `__call__` special method.
...
```python
transformers.SolarOpenForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/solar_open/modeling_solar_open.py#L529)
...
#### forward[[transformers.SolarOpenForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/solar_open/modeling_solar_open.py#L544)
...
The [SolarOpenForCausalLM](/docs/transformers/v5.15.1/en/model_doc/solar_open#transformers.SolarOpenForCausalLM) forward method, overrides the `__call__` special method.
