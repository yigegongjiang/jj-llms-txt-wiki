...
#### transformers.FNetConfig[[transformers.FNetConfig]]

```python
transformers.FNetConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, vocab_size: int = 32000, hidden_size: int = 768, num_hidden_layers: int = 12, intermediate_size: int = 3072, hidden_act: str = 'gelu_new', hidden_dropout_prob: float | int = 0.1, max_position_embeddings: int = 512, type_vocab_size: int = 4, initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, use_tpu_fourier_optimizations: bool = False, tpu_short_seq_length: int = 512, pad_token_id: int | None = 3, bos_token_id: int | None = 1, eos_token_id: int | list[int] | None = 2, tie_word_embeddings: bool = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/configuration_fnet.py#L24)
...
type_vocab_size (`int`, *optional*, defaults to `4`) : The vocabulary size of the `token_type_ids`.
...
This tokenizer inherits from [AlbertTokenizer](/docs/transformers/v5.15.1/en/model_doc/albert#transformers.AlbertTokenizer) which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.

#### get_special_tokens_mask[[transformers.FNetTokenizer.get_special_tokens_mask]]
...
#### save_vocabulary[[transformers.FNetTokenizer.save_vocabulary]]
...
#### transformers.FNetModel[[transformers.FNetModel]]

```python
transformers.FNetModel(config, add_pooling_layer = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L401)

**Parameters:**

config ([FNetModel](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetModel)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.FNetModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L431)
...
elements depending on the configuration ([FNetConfig](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetConfig)) and inputs.

The [FNetModel](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetModel) forward method, overrides the `__call__` special method.
...
#### transformers.FNetForPreTraining[[transformers.FNetForPreTraining]]

```python
transformers.FNetForPreTraining(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L509)

**Parameters:**

config ([FNetForPreTraining](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForPreTraining)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.FNetForPreTraining.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L531)
...
**Returns:** `FNetForPreTrainingOutput` or `tuple(torch.FloatTensor)`

A `FNetForPreTrainingOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FNetConfig](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetConfig)) and inputs.

The [FNetForPreTraining](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForPreTraining) forward method, overrides the `__call__` special method.
...
#### transformers.FNetForMaskedLM[[transformers.FNetForMaskedLM]]

```python
transformers.FNetForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L603)

**Parameters:**

config ([FNetForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForMaskedLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.FNetForMaskedLM.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L625)
...
The [FNetForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForMaskedLM) forward method, overrides the `__call__` special method.
...
#### transformers.FNetForNextSentencePrediction[[transformers.FNetForNextSentencePrediction]]

```python
transformers.FNetForNextSentencePrediction(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L674)

**Parameters:**

config ([FNetForNextSentencePrediction](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForNextSentencePrediction)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.FNetForNextSentencePrediction.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L684)
...
The [FNetForNextSentencePrediction](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
#### transformers.FNetForSequenceClassification[[transformers.FNetForSequenceClassification]]

```python
transformers.FNetForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L757)

**Parameters:**

config ([FNetForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForSequenceClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.FNetForSequenceClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L769)
...
The [FNetForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForSequenceClassification) forward method, overrides the `__call__` special method.
...
#### transformers.FNetForMultipleChoice[[transformers.FNetForMultipleChoice]]

```python
transformers.FNetForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L832)

**Parameters:**

config ([FNetForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForMultipleChoice)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.FNetForMultipleChoice.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L843)
...
The [FNetForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForMultipleChoice) forward method, overrides the `__call__` special method.
...
#### transformers.FNetForTokenClassification[[transformers.FNetForTokenClassification]]

```python
transformers.FNetForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L925)

**Parameters:**

config ([FNetForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForTokenClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.FNetForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L938)
...
The [FNetForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForTokenClassification) forward method, overrides the `__call__` special method.
...
#### transformers.FNetForQuestionAnswering[[transformers.FNetForQuestionAnswering]]

```python
transformers.FNetForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L984)

**Parameters:**

config ([FNetForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForQuestionAnswering)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.FNetForQuestionAnswering.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, start_positions: typing.Optional[torch.Tensor] = None, end_positions: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fnet/modeling_fnet.py#L996)
...
The [FNetForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/fnet#transformers.FNetForQuestionAnswering) forward method, overrides the `__call__` special method.
