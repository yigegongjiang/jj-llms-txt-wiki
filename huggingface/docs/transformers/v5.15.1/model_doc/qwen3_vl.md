...
This is the configuration class to store the configuration of a Qwen3VLModel. It is used to instantiate a Qwen3 Vl
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [Qwen/Qwen3-VL-4B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct)
...
```python
transformers.Qwen3VLProcessor(image_processor = None, tokenizer = None, video_processor = None, chat_template = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/processing_qwen3_vl.py#L42)
...
#### __call__[[transformers.Qwen3VLProcessor.__call__]]
...
```python
transformers.Qwen3VLVideoProcessor(**kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L95)

**Parameters:**

- ****kwargs** (`Qwen3VLVideoProcessorInitKwargs`, *optional*) : Additional image preprocessing options. Model-specific kwargs are listed above; see the TypedDict class for the complete list of supported arguments.

Constructs a Qwen3VLVideoProcessor video processor.

#### patchify[[transformers.Qwen3VLVideoProcessor.patchify]]

```python
patchify(videos: torch.Tensor, patch_size: int, merge_size: int, temporal_patch_size: int)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L199)

Patchifies each video into flat layout of shape (`seq_len`, `patch_dim`) so we can concat dynamically shaped pixels.

#### resize[[transformers.Qwen3VLVideoProcessor.resize]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L170)

Resize dynamically based on input video aspect ratio.

#### sample_frames[[transformers.Qwen3VLVideoProcessor.sample_frames]]

```python
sample_frames(metadata: VideoMetadata, num_frames: int | None = None, fps: int | float | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L121)
...
```python
transformers.Qwen3VLVisionModel(config, *inputs, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L606)

#### forward[[transformers.Qwen3VLVisionModel.forward]]

```python
forward(hidden_states: Tensor, grid_thw: Tensor, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L679)
...
```python
transformers.Qwen3VLTextModel(config: Qwen3VLTextConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L746)
...
#### forward[[transformers.Qwen3VLTextModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L766)
...
elements depending on the configuration ([Qwen3VLConfig](/docs/transformers/v5.15.1/en/model_doc/qwen3_vl#transformers.Qwen3VLConfig)) and inputs.

The [Qwen3VLTextModel](/docs/transformers/v5.15.1/en/model_doc/qwen3_vl#transformers.Qwen3VLTextModel) forward method, overrides the `__call__` special method.
...
```python
transformers.Qwen3VLModel(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L866)
...
#### forward[[transformers.Qwen3VLModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1147)
...
**Returns:** `Qwen3VLModelOutputWithPast` or `tuple(torch.FloatTensor)`

A `Qwen3VLModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.

The [Qwen3VLModel](/docs/transformers/v5.15.1/en/model_doc/qwen3_vl#transformers.Qwen3VLModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1025)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1037)
...
```python
transformers.Qwen3VLForConditionalGeneration(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1260)

#### forward[[transformers.Qwen3VLForConditionalGeneration.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1298)
...
**Returns:** `Qwen3VLCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`

A `Qwen3VLCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Qwen3VLConfig](/docs/transformers/v5.15.1/en/model_doc/qwen3_vl#transformers.Qwen3VLConfig)) and inputs.

The [Qwen3VLForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/qwen3_vl#transformers.Qwen3VLForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1272)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1285)
