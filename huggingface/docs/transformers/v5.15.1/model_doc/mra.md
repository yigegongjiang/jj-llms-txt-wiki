...
This is the configuration class to store the configuration of a MraModel. It is used to instantiate a Mra
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [uw-madison/mra-base-512-4](https://huggingface.co/uw-madison/mra-base-512-4)
...
```python
transformers.MraModel(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L802)
...
#### forward[[transformers.MraModel.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L819)
...
elements depending on the configuration ([MraConfig](/docs/transformers/v5.15.1/en/model_doc/mra#transformers.MraConfig)) and inputs.

The [MraModel](/docs/transformers/v5.15.1/en/model_doc/mra#transformers.MraModel) forward method, overrides the `__call__` special method.
...
```python
transformers.MraForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L895)
...
#### forward[[transformers.MraForMaskedLM.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L917)
...
The [MraForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/mra#transformers.MraForMaskedLM) forward method, overrides the `__call__` special method.
...
```python
transformers.MraForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L996)
...
#### forward[[transformers.MraForSequenceClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L1006)
...
The [MraForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/mra#transformers.MraForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.MraForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L1075)
...
#### forward[[transformers.MraForMultipleChoice.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L1086)
...
The [MraForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/mra#transformers.MraForMultipleChoice) forward method, overrides the `__call__` special method.
...
```python
transformers.MraForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L1178)
...
#### forward[[transformers.MraForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L1190)
...
The [MraForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/mra#transformers.MraForTokenClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.MraForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L1251)
...
#### forward[[transformers.MraForQuestionAnswering.forward]]

```python
forward(input_ids: typing.Optional[torch.Tensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, token_type_ids: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.Tensor] = None, inputs_embeds: typing.Optional[torch.Tensor] = None, start_positions: typing.Optional[torch.Tensor] = None, end_positions: typing.Optional[torch.Tensor] = None, output_hidden_states: bool | None = None, return_dict: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mra/modeling_mra.py#L1264)
...
The [MraForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/mra#transformers.MraForQuestionAnswering) forward method, overrides the `__call__` special method.
