...
max_position_embeddings (`int`, *optional*, defaults to `196608`) : The maximum sequence length that this model might ever be used with.
...
This is the configuration class to store the configuration of a MiniMaxM2Model. It is used to instantiate a Minimax M2
...
```python
transformers.MiniMaxM2Model(config: MiniMaxM2Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax_m2/modeling_minimax_m2.py#L422)
...
#### forward[[transformers.MiniMaxM2Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax_m2/modeling_minimax_m2.py#L439)
...
elements depending on the configuration ([MiniMaxM2Config](/docs/transformers/v5.15.1/en/model_doc/minimax_m2#transformers.MiniMaxM2Config)) and inputs.

The [MiniMaxM2Model](/docs/transformers/v5.15.1/en/model_doc/minimax_m2#transformers.MiniMaxM2Model) forward method, overrides the `__call__` special method.
...
```python
transformers.MiniMaxM2ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax_m2/modeling_minimax_m2.py#L580)
...
#### forward[[transformers.MiniMaxM2ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax_m2/modeling_minimax_m2.py#L598)
...
The [MiniMaxM2ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/minimax_m2#transformers.MiniMaxM2ForCausalLM) forward method, overrides the `__call__` special method.
