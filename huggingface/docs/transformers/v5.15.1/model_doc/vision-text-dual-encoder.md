...
logit_scale_init_value (`Union[int, float]`, *optional*, defaults to `2.6592`) : The initial value of the *logit_scale* parameter.
...
#### from_vision_text_configs[[transformers.VisionTextDualEncoderConfig.from_vision_text_configs]]
...
#### forward[[transformers.VisionTextDualEncoderModel.forward]]
