...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5_moe/configuration_ernie4_5_moe.py#L25)
...
```python
transformers.Ernie4_5_MoeModel(config: Ernie4_5_MoeConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5_moe/modeling_ernie4_5_moe.py#L487)
...
#### forward[[transformers.Ernie4_5_MoeModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5_moe/modeling_ernie4_5_moe.py#L504)
...
elements depending on the configuration ([Ernie4_5_MoeConfig](/docs/transformers/v5.15.1/en/model_doc/ernie4_5_moe#transformers.Ernie4_5_MoeConfig)) and inputs.

The [Ernie4_5_MoeModel](/docs/transformers/v5.15.1/en/model_doc/ernie4_5_moe#transformers.Ernie4_5_MoeModel) forward method, overrides the `__call__` special method.
...
```python
transformers.Ernie4_5_MoeForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5_moe/modeling_ernie4_5_moe.py#L646)
...
#### forward[[transformers.Ernie4_5_MoeForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/ernie4_5_moe/modeling_ernie4_5_moe.py#L665)
...
The [Ernie4_5_MoeForCausalLM](/docs/transformers/v5.15.1/en/model_doc/ernie4_5_moe#transformers.Ernie4_5_MoeForCausalLM) forward method, overrides the `__call__` special method.
