...
vocab_size (`int`, *optional*, defaults to `201088`) : Vocabulary size of the model. Defines the number of different tokens that can be represented by the `input_ids`.

hidden_size (`int`, *optional*, defaults to `2880`) : Dimension of the hidden representations.

intermediate_size (`int`, *optional*, defaults to `2880`) : Dimension of the MLP representations.
...
```python
transformers.GptOssModel(config: GptOssConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L422)
...
#### forward[[transformers.GptOssModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L439)
...
elements depending on the configuration ([GptOssConfig](/docs/transformers/v5.15.1/en/model_doc/gpt_oss#transformers.GptOssConfig)) and inputs.

The [GptOssModel](/docs/transformers/v5.15.1/en/model_doc/gpt_oss#transformers.GptOssModel) forward method, overrides the `__call__` special method.
...
```python
transformers.GptOssForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L582)
...
#### forward[[transformers.GptOssForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L600)
...
The [GptOssForCausalLM](/docs/transformers/v5.15.1/en/model_doc/gpt_oss#transformers.GptOssForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.GptOssForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L685)

#### forward[[transformers.GptOssForSequenceClassification.forward]]
...
```python
transformers.GptOssForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L689)

#### forward[[transformers.GptOssForTokenClassification.forward]]
