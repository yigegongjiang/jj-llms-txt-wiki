...
- Set the `eos_token_id` as the `decoder_start_token_id` for mBART-50. The target language id is used as the first generated token by passing `forced_bos_token_id` to [generate()](/docs/transformers/v5.15.1/en/main_classes/text_generation#transformers.GenerationMixin.generate).
...
defaults will yield a similar configuration to that of the [facebook/mbart-large-cc25](https://huggingface.co/facebook/mbart-large-cc25)
...
```python
transformers.MBartTokenizer(vocab: str | dict | list | None = None, bos_token = '<s>', eos_token = '</s>', sep_token = '</s>', cls_token = '<s>', unk_token = '<unk>', pad_token = '<pad>', mask_token = '<mask>', src_lang = None, tgt_lang = None, additional_special_tokens = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/tokenization_mbart.py#L33)
...
#### set_src_lang_special_tokens[[transformers.MBartTokenizer.set_src_lang_special_tokens]]

```python
set_src_lang_special_tokens(src_lang)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/tokenization_mbart.py#L177)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/tokenization_mbart.py#L192)
...
```python
transformers.MBart50Tokenizer(vocab: str | dict | list | None = None, _spm_precompiled_charsmap: str | None = None, src_lang = None, tgt_lang = None, eos_token = '</s>', sep_token = '</s>', cls_token = '<s>', unk_token = '<unk>', pad_token = '<pad>', mask_token = '<mask>', **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart50/tokenization_mbart50.py#L33)
...
#### set_src_lang_special_tokens[[transformers.MBart50Tokenizer.set_src_lang_special_tokens]]

```python
set_src_lang_special_tokens(src_lang: str)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart50/tokenization_mbart50.py#L266)
...
```python
set_tgt_lang_special_tokens(tgt_lang: str)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart50/tokenization_mbart50.py#L281)
...
```python
transformers.MBartModel(config: MBartConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L763)
...
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.15.1/en/model_doc/mbart#transformers.MBartConfig)) and inputs.

The [MBartModel](/docs/transformers/v5.15.1/en/model_doc/mbart#transformers.MBartModel) forward method, overrides the `__call__` special method.
...
```python
transformers.MBartForConditionalGeneration(config: MBartConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L883)
...
#### forward[[transformers.MBartForConditionalGeneration.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, decoder_input_ids: typing.Optional[torch.LongTensor] = None, decoder_attention_mask: typing.Optional[torch.LongTensor] = None, encoder_outputs: tuple[tuple[torch.FloatTensor]] | None = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, decoder_inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, use_cache: bool | None = None, return_dict: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L913)
...
The [MBartForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/mbart#transformers.MBartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
```python
transformers.MBartForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L1177)
...
#### forward[[transformers.MBartForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L1190)
...
The [MBartForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/mbart#transformers.MBartForQuestionAnswering) forward method, overrides the `__call__` special method.
...
```python
transformers.MBartForSequenceClassification(config: MBartConfig, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L1048)
...
#### forward[[transformers.MBartForSequenceClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L1062)
...
The [MBartForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/mbart#transformers.MBartForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.MBartForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L1300)

#### forward[[transformers.MBartForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mbart/modeling_mbart.py#L1322)
...
The [MBartForCausalLM](/docs/transformers/v5.15.1/en/model_doc/mbart#transformers.MBartForCausalLM) forward method, overrides the `__call__` special method.
