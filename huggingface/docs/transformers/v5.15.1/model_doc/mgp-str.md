...
image_size (`Union[list[int], tuple[int, ...]]`, *optional*, defaults to `(32, 128)`) : The size (resolution) of each image.
...
tokenizer (`MgpstrTokenizer`) : The tokenizer is a required input.
...
#### forward[[transformers.MgpstrModel.forward]]
...
#### forward[[transformers.MgpstrForSceneTextRecognition.forward]]
