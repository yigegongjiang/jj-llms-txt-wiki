...
```python
transformers.DeepseekVLProcessor(image_processor, tokenizer, chat_template = None, num_image_tokens = 576)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/processing_deepseek_vl.py#L38)
...
[~DeepseekVLImageProcessor](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.15.1/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.

#### __call__[[transformers.DeepseekVLProcessor.__call__]]
...
```python
transformers.DeepseekVLImageProcessor(**kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/image_processing_deepseek_vl.py#L44)
...
#### transformers.DeepseekVLImageProcessorPil[[transformers.DeepseekVLImageProcessorPil]]

```python
transformers.DeepseekVLImageProcessorPil(**kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/image_processing_pil_deepseek_vl.py#L50)
...
#### preprocess[[transformers.DeepseekVLImageProcessorPil.preprocess]]

```python
preprocess(images: typing.Union[ForwardRef('PIL.Image.Image'), numpy.ndarray, ForwardRef('torch.Tensor'), list['PIL.Image.Image'], list[numpy.ndarray], list['torch.Tensor']], **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/image_processing_pil_deepseek_vl.py#L71)
...
```python
transformers.DeepseekVLModel(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L129)
...
#### forward[[transformers.DeepseekVLModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L177)

**Parameters:**

input_ids (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) : Indices of input sequence tokens in the vocabulary. Padding will be ignored by default.  Indices can be obtained using [AutoTokenizer](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoTokenizer). See [PreTrainedTokenizer.encode()](/docs/transformers/v5.15.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and [PreTrainedTokenizer.__call__()](/docs/transformers/v5.15.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for details.  [What are input IDs?](../glossary#input-ids)

pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) : The tensors corresponding to the input images. Pixel values can be obtained using [DeepseekVLImageProcessor](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor). See `DeepseekVLImageProcessor.__call__()` for details ([DeepseekVLProcessor](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLProcessor) uses [DeepseekVLImageProcessor](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor) for processing images).
...
**Returns:** `DeepseekVLBaseModelOutputWithPast` or `tuple(torch.FloatTensor)`

A `DeepseekVLBaseModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DeepseekVLConfig](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLConfig)) and inputs.

The [DeepseekVLModel](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L143)

**Parameters:**

pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`) : The tensors corresponding to the input images. Pixel values can be obtained using [DeepseekVLImageProcessor](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor). See `DeepseekVLImageProcessor.__call__()` for details ([DeepseekVLProcessor](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLProcessor) uses [DeepseekVLImageProcessor](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor) for processing images).
...
```python
transformers.DeepseekVLForConditionalGeneration(config: DeepseekVLConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L226)

#### forward[[transformers.DeepseekVLForConditionalGeneration.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L240)
...
**Returns:** `DeepseekVLCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`

A `DeepseekVLCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DeepseekVLConfig](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLConfig)) and inputs.

The [DeepseekVLForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/deepseek_vl#transformers.DeepseekVLForConditionalGeneration) forward method, overrides the `__call__` special method.
