...
This model combines Llama model and Differential Transformer's Attention.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/diffllama/configuration_diffllama.py#L28)
...
This is the configuration class to store the configuration of a DiffLlamaModel. It is used to instantiate a Diffllama
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [kajuma/DiffLlama-0.3B-handcut](https://huggingface.co/kajuma/DiffLlama-0.3B-handcut)
...
```python
transformers.DiffLlamaModel(config: DiffLlamaConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/diffllama/modeling_diffllama.py#L418)
...
#### forward[[transformers.DiffLlamaModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/diffllama/modeling_diffllama.py#L435)
...
elements depending on the configuration ([DiffLlamaConfig](/docs/transformers/v5.15.1/en/model_doc/diffllama#transformers.DiffLlamaConfig)) and inputs.

The [DiffLlamaModel](/docs/transformers/v5.15.1/en/model_doc/diffllama#transformers.DiffLlamaModel) forward method, overrides the `__call__` special method.
...
```python
transformers.DiffLlamaForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/diffllama/modeling_diffllama.py#L492)
...
#### forward[[transformers.DiffLlamaForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/diffllama/modeling_diffllama.py#L507)
...
The [DiffLlamaForCausalLM](/docs/transformers/v5.15.1/en/model_doc/diffllama#transformers.DiffLlamaForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.DiffLlamaForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/diffllama/modeling_diffllama.py#L566)

#### forward[[transformers.DiffLlamaForSequenceClassification.forward]]
...
```python
transformers.DiffLlamaForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/diffllama/modeling_diffllama.py#L570)

#### forward[[transformers.DiffLlamaForQuestionAnswering.forward]]
...
```python
transformers.DiffLlamaForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/diffllama/modeling_diffllama.py#L574)

#### forward[[transformers.DiffLlamaForTokenClassification.forward]]
