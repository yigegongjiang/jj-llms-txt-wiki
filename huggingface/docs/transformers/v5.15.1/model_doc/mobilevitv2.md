...
- One can use [MobileViTImageProcessor](/docs/transformers/v5.15.1/en/model_doc/mobilevit#transformers.MobileViTImageProcessor) to prepare images for the model. Note that if you do your own preprocessing, the pretrained checkpoints expect images to be in BGR pixel order (not RGB).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mobilevitv2/configuration_mobilevitv2.py#L24)
...
expand_ratio (`float`, *optional*, defaults to `2.0`) : Expand ratio to set the output dimensions for the expansion
...
attn_dropout (`Union[float, int]`, *optional*, defaults to `0.0`) : The dropout ratio for the attention probabilities.
...
```python
transformers.MobileViTV2Model(config: MobileViTV2Config, expand_output: bool = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mobilevitv2/modeling_mobilevitv2.py#L590)
...
#### forward[[transformers.MobileViTV2Model.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mobilevitv2/modeling_mobilevitv2.py#L619)
...
elements depending on the configuration ([MobileViTV2Config](/docs/transformers/v5.15.1/en/model_doc/mobilevitv2#transformers.MobileViTV2Config)) and inputs.

The [MobileViTV2Model](/docs/transformers/v5.15.1/en/model_doc/mobilevitv2#transformers.MobileViTV2Model) forward method, overrides the `__call__` special method.
...
```python
transformers.MobileViTV2ForImageClassification(config: MobileViTV2Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mobilevitv2/modeling_mobilevitv2.py#L669)
...
#### forward[[transformers.MobileViTV2ForImageClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mobilevitv2/modeling_mobilevitv2.py#L687)
...
The [MobileViTV2ForImageClassification](/docs/transformers/v5.15.1/en/model_doc/mobilevitv2#transformers.MobileViTV2ForImageClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.MobileViTV2ForSemanticSegmentation(config: MobileViTV2Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mobilevitv2/modeling_mobilevitv2.py#L844)
...
#### forward[[transformers.MobileViTV2ForSemanticSegmentation.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/mobilevitv2/modeling_mobilevitv2.py#L855)
...
The [MobileViTV2ForSemanticSegmentation](/docs/transformers/v5.15.1/en/model_doc/mobilevitv2#transformers.MobileViTV2ForSemanticSegmentation) forward method, overrides the `__call__` special method.
