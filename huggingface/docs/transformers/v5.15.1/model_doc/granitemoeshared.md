...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granitemoeshared/configuration_granitemoeshared.py#L30)
...
This is the configuration class to store the configuration of a GraniteMoeSharedModel. It is used to instantiate a Granitemoeshared
...
```python
transformers.GraniteMoeSharedModel(config: GraniteMoeSharedConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granitemoeshared/modeling_granitemoeshared.py#L472)
...
#### forward[[transformers.GraniteMoeSharedModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granitemoeshared/modeling_granitemoeshared.py#L490)
...
elements depending on the configuration ([GraniteMoeSharedConfig](/docs/transformers/v5.15.1/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedConfig)) and inputs.

The [GraniteMoeSharedModel](/docs/transformers/v5.15.1/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedModel) forward method, overrides the `__call__` special method.
...
```python
transformers.GraniteMoeSharedForCausalLM(config: GraniteMoeSharedConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granitemoeshared/modeling_granitemoeshared.py#L632)
...
#### forward[[transformers.GraniteMoeSharedForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granitemoeshared/modeling_granitemoeshared.py#L651)
...
The [GraniteMoeSharedForCausalLM](/docs/transformers/v5.15.1/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedForCausalLM) forward method, overrides the `__call__` special method.
