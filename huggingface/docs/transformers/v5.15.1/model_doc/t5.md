...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.15.1/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoModel), and how to translate with T5 from the command line.
...
- T5 models need a slightly higher learning rate than the default used in [Trainer](/docs/transformers/v5.15.1/en/main_classes/trainer#transformers.Trainer). Typically, values of `1e-4` and `3e-4` work well for most tasks.
...
```python
transformers.T5Tokenizer(vocab: str | list[tuple[str, float]] | None = None, eos_token = '</s>', unk_token = '<unk>', pad_token = '<pad>', _spm_precompiled_charsmap = None, extra_ids = 100, additional_special_tokens = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/tokenization_t5.py#L30)
...
#### get_special_tokens_mask[[transformers.T5Tokenizer.get_special_tokens_mask]]
...
#### get_sentinel_token_ids[[transformers.T5Tokenizer.get_sentinel_token_ids]]

```python
get_sentinel_token_ids()
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/tokenization_t5.py#L154)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/tokenization_t5.py#L148)
...
```python
transformers.T5Model(config: T5Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L754)
...
#### forward[[transformers.T5Model.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L788)
...
elements depending on the configuration ([T5Config](/docs/transformers/v5.15.1/en/model_doc/t5#transformers.T5Config)) and inputs.

The [T5Model](/docs/transformers/v5.15.1/en/model_doc/t5#transformers.T5Model) forward method, overrides the `__call__` special method.
...
```python
transformers.T5ForConditionalGeneration(config: T5Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L898)
...
#### forward[[transformers.T5ForConditionalGeneration.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L937)
...
The [T5ForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/t5#transformers.T5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
```python
transformers.T5EncoderModel(config: T5Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L1073)
...
#### forward[[transformers.T5EncoderModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L1096)
...
The [T5EncoderModel](/docs/transformers/v5.15.1/en/model_doc/t5#transformers.T5EncoderModel) forward method, overrides the `__call__` special method.
...
```python
transformers.T5ForSequenceClassification(config: T5Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L1144)
...
#### forward[[transformers.T5ForSequenceClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L1155)
...
The [T5ForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/t5#transformers.T5ForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.T5ForTokenClassification(config: T5Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L1286)
...
#### forward[[transformers.T5ForTokenClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L1298)
...
The [T5ForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/t5#transformers.T5ForTokenClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.T5ForQuestionAnswering(config: T5Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L1347)
...
#### forward[[transformers.T5ForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/t5/modeling_t5.py#L1384)
...
The [T5ForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/t5#transformers.T5ForQuestionAnswering) forward method, overrides the `__call__` special method.
