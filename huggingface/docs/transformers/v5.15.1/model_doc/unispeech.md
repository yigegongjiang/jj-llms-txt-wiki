...
replace_prob (`float`, *optional*, defaults to 0.5) : Probability that transformer feature is replaced by quantized feature for pretraining.
...
#### transformers.models.unispeech.modeling_unispeech.UniSpeechForPreTrainingOutput[[transformers.models.unispeech.modeling_unispeech.UniSpeechForPreTrainingOutput]]
...
#### transformers.UniSpeechModel[[transformers.UniSpeechModel]]
...
#### forward[[transformers.UniSpeechModel.forward]]
...
#### transformers.UniSpeechForCTC[[transformers.UniSpeechForCTC]]
...
#### forward[[transformers.UniSpeechForCTC.forward]]
...
#### forward[[transformers.UniSpeechForSequenceClassification.forward]]
...
#### forward[[transformers.UniSpeechForPreTraining.forward]]
