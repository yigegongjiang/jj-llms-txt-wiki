...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fast_vlm/configuration_fast_vlm.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fast_vlm/modeling_fast_vlm.py#L101)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fast_vlm/modeling_fast_vlm.py#L166)
...
elements depending on the configuration ([FastVlmConfig](/docs/transformers/v5.15.1/en/model_doc/fast_vlm#transformers.FastVlmConfig)) and inputs.

The [FastVlmModel](/docs/transformers/v5.15.1/en/model_doc/fast_vlm#transformers.FastVlmModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fast_vlm/modeling_fast_vlm.py#L110)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fast_vlm/modeling_fast_vlm.py#L142)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fast_vlm/modeling_fast_vlm.py#L258)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fast_vlm/modeling_fast_vlm.py#L285)
...
The [FastVlmForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/fast_vlm#transformers.FastVlmForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/fast_vlm/modeling_fast_vlm.py#L270)
