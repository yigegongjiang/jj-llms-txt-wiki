...
```python
transformers.ConvNextV2Model(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/convnextv2/modeling_convnextv2.py#L273)
...
#### forward[[transformers.ConvNextV2Model.forward]]

```python
forward(pixel_values: typing.Optional[torch.FloatTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/convnextv2/modeling_convnextv2.py#L287)
...
elements depending on the configuration ([ConvNextV2Config](/docs/transformers/v5.15.1/en/model_doc/convnextv2#transformers.ConvNextV2Config)) and inputs.

The [ConvNextV2Model](/docs/transformers/v5.15.1/en/model_doc/convnextv2#transformers.ConvNextV2Model) forward method, overrides the `__call__` special method.
...
```python
transformers.ConvNextV2ForImageClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/convnextv2/modeling_convnextv2.py#L316)
...
#### forward[[transformers.ConvNextV2ForImageClassification.forward]]

```python
forward(pixel_values: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/convnextv2/modeling_convnextv2.py#L334)
...
The [ConvNextV2ForImageClassification](/docs/transformers/v5.15.1/en/model_doc/convnextv2#transformers.ConvNextV2ForImageClassification) forward method, overrides the `__call__` special method.
