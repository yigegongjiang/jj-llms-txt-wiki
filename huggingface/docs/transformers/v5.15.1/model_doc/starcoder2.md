...
initializer_range (`float`, *optional*, defaults to `0.018042`) : The standard deviation of the truncated_normal_initializer for initializing all weight matrices.

norm_epsilon (`float`, *optional*, defaults to `1e-05`) : The epsilon used by the layer normalization layers.
...
residual_dropout (`Union[float, int]`, *optional*, defaults to `0.0`) : The dropout probability for all fully connected layers in the embeddings, encoder, and pooler.
...
```python
transformers.Starcoder2Model(config: Starcoder2Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/starcoder2/modeling_starcoder2.py#L323)
...
#### forward[[transformers.Starcoder2Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/starcoder2/modeling_starcoder2.py#L341)
...
```python
transformers.Starcoder2ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/starcoder2/modeling_starcoder2.py#L402)
...
#### forward[[transformers.Starcoder2ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/starcoder2/modeling_starcoder2.py#L417)
...
elements depending on the configuration ([Starcoder2Config](/docs/transformers/v5.15.1/en/model_doc/starcoder2#transformers.Starcoder2Config)) and inputs.

The [Starcoder2ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/starcoder2#transformers.Starcoder2ForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.Starcoder2ForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/starcoder2/modeling_starcoder2.py#L476)

#### forward[[transformers.Starcoder2ForSequenceClassification.forward]]
...
```python
transformers.Starcoder2ForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/starcoder2/modeling_starcoder2.py#L480)

#### forward[[transformers.Starcoder2ForTokenClassification.forward]]
