...
The examples below demonstrate how to predict the `<mask>` token with [Pipeline](/docs/transformers/v5.15.1/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoModel), and from the command line.
...
This is the configuration class to store the configuration of a CamembertModel. It is used to instantiate a Camembert
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [almanach/camembert-base](https://huggingface.co/almanach/camembert-base)
...
## CamembertTokenizer[[transformers.CamembertTokenizer]]

#### transformers.CamembertTokenizer[[transformers.CamembertTokenizer]]

```python
transformers.CamembertTokenizer(bos_token = '<s>', eos_token = '</s>', sep_token = '</s>', cls_token = '<s>', unk_token = '<unk>', pad_token = '<pad>', _spm_precompiled_charsmap = None, mask_token = '<mask>', additional_special_tokens = None, add_prefix_space = True, vocab_file = None, vocab: str | dict | list | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/tokenization_camembert.py#L32)
...
#### get_special_tokens_mask[[transformers.CamembertTokenizer.get_special_tokens_mask]]
...
#### save_vocabulary[[transformers.CamembertTokenizer.save_vocabulary]]
...
## CamembertTokenizerFast[[transformers.CamembertTokenizer]]
...
## CamembertModel[[transformers.CamembertModel]]

#### transformers.CamembertModel[[transformers.CamembertModel]]

```python
transformers.CamembertModel(config, add_pooling_layer = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L573)

**Parameters:**

config ([CamembertModel](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertModel)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.CamembertModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L599)
...
elements depending on the configuration ([CamembertConfig](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertConfig)) and inputs.

The [CamembertModel](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertModel) forward method, overrides the `__call__` special method.
...
## CamembertForCausalLM[[transformers.CamembertForCausalLM]]

#### transformers.CamembertForCausalLM[[transformers.CamembertForCausalLM]]

```python
transformers.CamembertForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L1150)

**Parameters:**

config ([CamembertForCausalLM](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.CamembertForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L1174)
...
The [CamembertForCausalLM](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForCausalLM) forward method, overrides the `__call__` special method.
...
## CamembertForMaskedLM[[transformers.CamembertForMaskedLM]]

#### transformers.CamembertForMaskedLM[[transformers.CamembertForMaskedLM]]

```python
transformers.CamembertForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L701)

**Parameters:**

config ([CamembertForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForMaskedLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Camembert Model with a `language modeling` head on top."
...
#### forward[[transformers.CamembertForMaskedLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L728)
...
The [CamembertForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForMaskedLM) forward method, overrides the `__call__` special method.
...
## CamembertForSequenceClassification[[transformers.CamembertForSequenceClassification]]

#### transformers.CamembertForSequenceClassification[[transformers.CamembertForSequenceClassification]]

```python
transformers.CamembertForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L814)

**Parameters:**

config ([CamembertForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForSequenceClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.CamembertForSequenceClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L826)
...
The [CamembertForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForSequenceClassification) forward method, overrides the `__call__` special method.
...
## CamembertForMultipleChoice[[transformers.CamembertForMultipleChoice]]

#### transformers.CamembertForMultipleChoice[[transformers.CamembertForMultipleChoice]]

```python
transformers.CamembertForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L899)

**Parameters:**

config ([CamembertForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForMultipleChoice)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Camembert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
#### forward[[transformers.CamembertForMultipleChoice.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L910)
...
The [CamembertForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForMultipleChoice) forward method, overrides the `__call__` special method.
...
## CamembertForTokenClassification[[transformers.CamembertForTokenClassification]]

#### transformers.CamembertForTokenClassification[[transformers.CamembertForTokenClassification]]

```python
transformers.CamembertForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L996)

**Parameters:**

config ([CamembertForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForTokenClassification)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Camembert transformer with a token classification head on top (a linear layer on top of the hidden-states
...
#### forward[[transformers.CamembertForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L1011)
...
The [CamembertForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForTokenClassification) forward method, overrides the `__call__` special method.
...
## CamembertForQuestionAnswering[[transformers.CamembertForQuestionAnswering]]

#### transformers.CamembertForQuestionAnswering[[transformers.CamembertForQuestionAnswering]]

```python
transformers.CamembertForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L1067)

**Parameters:**

config ([CamembertForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForQuestionAnswering)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Camembert transformer with a span classification head on top for extractive question-answering tasks like
...
#### forward[[transformers.CamembertForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/camembert/modeling_camembert.py#L1078)
...
The [CamembertForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/camembert#transformers.CamembertForQuestionAnswering) forward method, overrides the `__call__` special method.
