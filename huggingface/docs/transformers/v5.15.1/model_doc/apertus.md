...
hidden_act (`str`, *optional*, defaults to `xielu`) : The non-linear activation function (function or string) in the decoder. For example, `"gelu"`, `"relu"`, `"silu"`, etc.
...
#### transformers.ApertusModel[[transformers.ApertusModel]]

```python
transformers.ApertusModel(config: ApertusConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/apertus/modeling_apertus.py#L341)

**Parameters:**

config ([ApertusConfig](/docs/transformers/v5.15.1/en/model_doc/apertus#transformers.ApertusConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ApertusModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/apertus/modeling_apertus.py#L358)
...
elements depending on the configuration ([ApertusConfig](/docs/transformers/v5.15.1/en/model_doc/apertus#transformers.ApertusConfig)) and inputs.

The [ApertusModel](/docs/transformers/v5.15.1/en/model_doc/apertus#transformers.ApertusModel) forward method, overrides the `__call__` special method.
...
#### transformers.ApertusForCausalLM[[transformers.ApertusForCausalLM]]

```python
transformers.ApertusForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/apertus/modeling_apertus.py#L415)

**Parameters:**

config ([ApertusForCausalLM](/docs/transformers/v5.15.1/en/model_doc/apertus#transformers.ApertusForCausalLM)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward[[transformers.ApertusForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/apertus/modeling_apertus.py#L430)
...
The [ApertusForCausalLM](/docs/transformers/v5.15.1/en/model_doc/apertus#transformers.ApertusForCausalLM) forward method, overrides the `__call__` special method.
...
#### transformers.ApertusForTokenClassification[[transformers.ApertusForTokenClassification]]

```python
transformers.ApertusForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/apertus/modeling_apertus.py#L494)

#### forward[[transformers.ApertusForTokenClassification.forward]]
