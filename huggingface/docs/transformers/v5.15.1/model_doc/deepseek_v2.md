...
This is the configuration class to store the configuration of a DeepseekV2Model. It is used to instantiate a Deepseek V2
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [deepseek-ai/DeepSeek-V2-Lite](https://huggingface.co/deepseek-ai/DeepSeek-V2-Lite)
...
```python
transformers.DeepseekV2Model(config: DeepseekV2Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L492)
...
#### forward[[transformers.DeepseekV2Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L509)
...
elements depending on the configuration ([DeepseekV2Config](/docs/transformers/v5.15.1/en/model_doc/deepseek_v2#transformers.DeepseekV2Config)) and inputs.

The [DeepseekV2Model](/docs/transformers/v5.15.1/en/model_doc/deepseek_v2#transformers.DeepseekV2Model) forward method, overrides the `__call__` special method.
...
```python
transformers.DeepseekV2ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L566)
...
#### forward[[transformers.DeepseekV2ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L581)
...
The [DeepseekV2ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/deepseek_v2#transformers.DeepseekV2ForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.DeepseekV2ForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L640)

#### forward[[transformers.DeepseekV2ForSequenceClassification.forward]]
