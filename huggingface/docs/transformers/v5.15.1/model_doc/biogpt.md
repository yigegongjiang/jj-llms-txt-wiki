...
The example below demonstrates how to generate biomedical text with [Pipeline](/docs/transformers/v5.15.1/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.15.1/en/model_doc/auto#transformers.AutoModel), and also from the command line.
...
- BioGPT can reuse previously computed key-value attention pairs. Access this feature with the [past_key_values](/docs/transformers/v5.15.1/en/model_doc/biogpt#transformers.BioGptModel.forward.past_key_values) parameter in `BioGPTModel.forward`.
...
```python
transformers.BioGptConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, vocab_size: int = 42384, hidden_size: int = 1024, num_hidden_layers: int = 24, num_attention_heads: int = 16, intermediate_size: int = 4096, hidden_act: str = 'gelu', hidden_dropout_prob: float | int = 0.1, attention_probs_dropout_prob: float | int = 0.1, max_position_embeddings: int = 1024, initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, scale_embedding: bool = True, use_cache: bool = True, layerdrop: float | int = 0.0, activation_dropout: float | int = 0.0, pad_token_id: int | None = 1, bos_token_id: int | None = 0, eos_token_id: int | list[int] | None = 2, tie_word_embeddings: bool = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/configuration_biogpt.py#L24)
...
```python
transformers.BioGptTokenizer(vocab_file, merges_file, unk_token = '<unk>', bos_token = '<s>', eos_token = '</s>', sep_token = '</s>', pad_token = '<pad>', **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/tokenization_biogpt.py#L44)
...
#### save_vocabulary[[transformers.BioGptTokenizer.save_vocabulary]]

```python
save_vocabulary(save_directory: str, filename_prefix: str | None = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/tokenization_biogpt.py#L282)
...
```python
transformers.BioGptModel(config: BioGptConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/modeling_biogpt.py#L321)
...
#### forward[[transformers.BioGptModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, use_cache: bool | None = None, position_ids: typing.Optional[torch.LongTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/modeling_biogpt.py#L343)
...
elements depending on the configuration ([BioGptConfig](/docs/transformers/v5.15.1/en/model_doc/biogpt#transformers.BioGptConfig)) and inputs.

The [BioGptModel](/docs/transformers/v5.15.1/en/model_doc/biogpt#transformers.BioGptModel) forward method, overrides the `__call__` special method.
...
```python
transformers.BioGptForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/modeling_biogpt.py#L420)
...
#### forward[[transformers.BioGptForCausalLM.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, labels: typing.Optional[torch.LongTensor] = None, use_cache: bool | None = None, position_ids: typing.Optional[torch.LongTensor] = None, logits_to_keep: typing.Union[int, torch.Tensor] = 0, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/modeling_biogpt.py#L438)
...
The [BioGptForCausalLM](/docs/transformers/v5.15.1/en/model_doc/biogpt#transformers.BioGptForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.BioGptForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/modeling_biogpt.py#L487)
...
#### forward[[transformers.BioGptForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, use_cache: bool | None = None, position_ids: typing.Optional[torch.LongTensor] = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/modeling_biogpt.py#L502)
...
The [BioGptForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/biogpt#transformers.BioGptForTokenClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.BioGptForSequenceClassification(config: BioGptConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/modeling_biogpt.py#L571)
...
[BioGptForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/biogpt#transformers.BioGptForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.
...
#### forward[[transformers.BioGptForSequenceClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, use_cache: bool | None = None, position_ids: typing.Optional[torch.LongTensor] = None, logits_to_keep: typing.Union[int, torch.Tensor] = 0, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/biogpt/modeling_biogpt.py#L581)
...
The [BioGptForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/biogpt#transformers.BioGptForSequenceClassification) forward method, overrides the `__call__` special method.
