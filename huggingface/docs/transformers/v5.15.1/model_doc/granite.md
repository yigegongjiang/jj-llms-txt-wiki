...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granite/configuration_granite.py#L30)
...
This is the configuration class to store the configuration of a GraniteModel. It is used to instantiate a Granite
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [ibm-granite/granite-3.0-8b-base](https://huggingface.co/ibm-granite/granite-3.0-8b-base)
...
```python
transformers.GraniteModel(config: GraniteConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granite/modeling_granite.py#L360)
...
#### forward[[transformers.GraniteModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granite/modeling_granite.py#L378)
...
elements depending on the configuration ([GraniteConfig](/docs/transformers/v5.15.1/en/model_doc/granite#transformers.GraniteConfig)) and inputs.

The [GraniteModel](/docs/transformers/v5.15.1/en/model_doc/granite#transformers.GraniteModel) forward method, overrides the `__call__` special method.
...
```python
transformers.GraniteForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granite/modeling_granite.py#L438)
...
#### forward[[transformers.GraniteForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/granite/modeling_granite.py#L453)
...
The [GraniteForCausalLM](/docs/transformers/v5.15.1/en/model_doc/granite#transformers.GraniteForCausalLM) forward method, overrides the `__call__` special method.
