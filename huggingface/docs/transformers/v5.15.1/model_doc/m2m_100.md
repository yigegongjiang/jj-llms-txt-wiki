...
The [M2M100Tokenizer](/docs/transformers/v5.15.1/en/model_doc/m2m_100#transformers.M2M100Tokenizer) depends on `sentencepiece` so be sure to install it before running the
...
```python
transformers.M2M100Tokenizer(vocab_file, spm_file, src_lang = None, tgt_lang = None, bos_token = '<s>', eos_token = '</s>', sep_token = '</s>', pad_token = '<pad>', unk_token = '<unk>', language_codes = 'm2m100', sp_model_kwargs: dict[str, typing.Any] | None = None, num_madeup_words = 8, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L49)
...
#### build_inputs_with_special_tokens[[transformers.M2M100Tokenizer.build_inputs_with_special_tokens]]

```python
build_inputs_with_special_tokens(token_ids_0: list, token_ids_1: list[int] | None = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L255)
...
#### get_special_tokens_mask[[transformers.M2M100Tokenizer.get_special_tokens_mask]]

```python
get_special_tokens_mask(token_ids_0: list, token_ids_1: list[int] | None = None, already_has_special_tokens: bool = False)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L225)
...
#### create_token_type_ids_from_sequences[[transformers.M2M100Tokenizer.create_token_type_ids_from_sequences]]
...
#### save_vocabulary[[transformers.M2M100Tokenizer.save_vocabulary]]

```python
save_vocabulary(save_directory: str, filename_prefix: str | None = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L296)

## M2M100Model[[transformers.M2M100Model]]

#### transformers.M2M100Model[[transformers.M2M100Model]]

```python
transformers.M2M100Model(config: M2M100Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L716)
...
#### forward[[transformers.M2M100Model.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L743)
...
elements depending on the configuration ([M2M100Config](/docs/transformers/v5.15.1/en/model_doc/m2m_100#transformers.M2M100Config)) and inputs.

The [M2M100Model](/docs/transformers/v5.15.1/en/model_doc/m2m_100#transformers.M2M100Model) forward method, overrides the `__call__` special method.
...
#### transformers.M2M100ForConditionalGeneration[[transformers.M2M100ForConditionalGeneration]]

```python
transformers.M2M100ForConditionalGeneration(config: M2M100Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L818)
...
#### forward[[transformers.M2M100ForConditionalGeneration.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, decoder_input_ids: typing.Optional[torch.LongTensor] = None, decoder_attention_mask: typing.Optional[torch.LongTensor] = None, encoder_outputs: tuple[tuple[torch.FloatTensor]] | None = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, decoder_inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L830)
...
The [M2M100ForConditionalGeneration](/docs/transformers/v5.15.1/en/model_doc/m2m_100#transformers.M2M100ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
To load a model using Flash Attention 2, we can pass the argument `attn_implementation="flash_attention_2"` to [from_pretrained()](/docs/transformers/v5.15.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained). You can use either `torch.float16` or `torch.bfloat16` precision.
