...
eod_token_id (`int`, *optional*, defaults to 3) : Token ID representing the end-of-document marker. Used to indicate the termination of a text sequence.
...
```python
transformers.HunYuanDenseV1Model(config: HunYuanDenseV1Config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L383)
...
#### forward[[transformers.HunYuanDenseV1Model.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L400)
...
elements depending on the configuration ([HunYuanDenseV1Config](/docs/transformers/v5.15.1/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Config)) and inputs.

The [HunYuanDenseV1Model](/docs/transformers/v5.15.1/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Model) forward method, overrides the `__call__` special method.
...
```python
transformers.HunYuanDenseV1ForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L457)
...
#### forward[[transformers.HunYuanDenseV1ForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L472)
...
The [HunYuanDenseV1ForCausalLM](/docs/transformers/v5.15.1/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1ForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.HunYuanDenseV1ForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L531)

#### forward[[transformers.HunYuanDenseV1ForSequenceClassification.forward]]
