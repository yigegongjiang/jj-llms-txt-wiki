...
```python
transformers.NemotronConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, vocab_size: int = 256000, hidden_size: int = 6144, intermediate_size: int = 24576, num_hidden_layers: int = 32, num_attention_heads: int = 48, head_dim: int | None = None, num_key_value_heads: int | None = None, hidden_act: str = 'relu2', max_position_embeddings: int = 4096, initializer_range: float = 0.0134, norm_eps: float = 1e-05, use_cache: bool = True, pad_token_id: int | None = None, bos_token_id: int | None = 2, eos_token_id: int | list[int] | None = 3, tie_word_embeddings: bool = False, rope_parameters: transformers.modeling_rope_utils.RopeParameters | dict | None = None, attention_bias: bool = False, attention_dropout: float | int = 0.0, mlp_bias: bool = False)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nemotron/configuration_nemotron.py#L26)
...
```python
transformers.NemotronModel(config: NemotronConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nemotron/modeling_nemotron.py#L374)
...
#### forward[[transformers.NemotronModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nemotron/modeling_nemotron.py#L398)
...
elements depending on the configuration ([NemotronConfig](/docs/transformers/v5.15.1/en/model_doc/nemotron#transformers.NemotronConfig)) and inputs.

The [NemotronModel](/docs/transformers/v5.15.1/en/model_doc/nemotron#transformers.NemotronModel) forward method, overrides the `__call__` special method.
...
```python
transformers.NemotronForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nemotron/modeling_nemotron.py#L456)

#### forward[[transformers.NemotronForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nemotron/modeling_nemotron.py#L468)
...
The [NemotronForCausalLM](/docs/transformers/v5.15.1/en/model_doc/nemotron#transformers.NemotronForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.NemotronForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nemotron/modeling_nemotron.py#L531)

#### forward[[transformers.NemotronForSequenceClassification.forward]]
...
```python
transformers.NemotronForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nemotron/modeling_nemotron.py#L534)

#### forward[[transformers.NemotronForQuestionAnswering.forward]]
...
```python
transformers.NemotronForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/nemotron/modeling_nemotron.py#L538)

#### forward[[transformers.NemotronForTokenClassification.forward]]
