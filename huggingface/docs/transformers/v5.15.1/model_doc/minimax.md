...
This is the configuration class to store the configuration of a MiniMaxModel. It is used to instantiate a Minimax
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [MiniMaxAI/MiniMax-Text-01-hf](https://huggingface.co/MiniMaxAI/MiniMax-Text-01-hf)
...
```python
transformers.MiniMaxModel(config: MiniMaxConfig)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax/modeling_minimax.py#L617)
...
#### forward[[transformers.MiniMaxModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, past_key_values: transformers.models.minimax.modeling_minimax.MiniMaxCache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax/modeling_minimax.py#L634)
...
```python
transformers.MiniMaxForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax/modeling_minimax.py#L785)
...
#### forward[[transformers.MiniMaxForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax/modeling_minimax.py#L803)
...
elements depending on the configuration ([MiniMaxConfig](/docs/transformers/v5.15.1/en/model_doc/minimax#transformers.MiniMaxConfig)) and inputs.

The [MiniMaxForCausalLM](/docs/transformers/v5.15.1/en/model_doc/minimax#transformers.MiniMaxForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.MiniMaxForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax/modeling_minimax.py#L888)

#### forward[[transformers.MiniMaxForSequenceClassification.forward]]
...
```python
transformers.MiniMaxForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax/modeling_minimax.py#L892)

#### forward[[transformers.MiniMaxForTokenClassification.forward]]
...
```python
transformers.MiniMaxForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/minimax/modeling_minimax.py#L896)

#### forward[[transformers.MiniMaxForQuestionAnswering.forward]]
