...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/configuration_roberta_prelayernorm.py#L26)
...
This is the configuration class to store the configuration of a Roberta PrelayernormModel. It is used to instantiate a Roberta Prelayernorm
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [andreasmadsen/efficient_mlm_m0.40](https://huggingface.co/andreasmadsen/efficient_mlm_m0.40)
...
```python
transformers.RobertaPreLayerNormModel(config, add_pooling_layer = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L565)
...
#### forward[[transformers.RobertaPreLayerNormModel.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L590)
...
elements depending on the configuration ([RobertaPreLayerNormConfig](/docs/transformers/v5.15.1/en/model_doc/roberta-prelayernorm#transformers.RobertaPreLayerNormConfig)) and inputs.

The [RobertaPreLayerNormModel](/docs/transformers/v5.15.1/en/model_doc/roberta-prelayernorm#transformers.RobertaPreLayerNormModel) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaPreLayerNormForCausalLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L710)
...
#### forward[[transformers.RobertaPreLayerNormForCausalLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L736)
...
The [RobertaPreLayerNormForCausalLM](/docs/transformers/v5.15.1/en/model_doc/roberta-prelayernorm#transformers.RobertaPreLayerNormForCausalLM) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaPreLayerNormForMaskedLM(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L825)
...
#### forward[[transformers.RobertaPreLayerNormForMaskedLM.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L853)
...
The [RobertaPreLayerNormForMaskedLM](/docs/transformers/v5.15.1/en/model_doc/roberta-prelayernorm#transformers.RobertaPreLayerNormForMaskedLM) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaPreLayerNormForSequenceClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L941)
...
#### forward[[transformers.RobertaPreLayerNormForSequenceClassification.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L953)
...
The [RobertaPreLayerNormForSequenceClassification](/docs/transformers/v5.15.1/en/model_doc/roberta-prelayernorm#transformers.RobertaPreLayerNormForSequenceClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaPreLayerNormForMultipleChoice(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L1028)
...
#### forward[[transformers.RobertaPreLayerNormForMultipleChoice.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L1039)
...
The [RobertaPreLayerNormForMultipleChoice](/docs/transformers/v5.15.1/en/model_doc/roberta-prelayernorm#transformers.RobertaPreLayerNormForMultipleChoice) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaPreLayerNormForTokenClassification(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L1125)
...
#### forward[[transformers.RobertaPreLayerNormForTokenClassification.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.FloatTensor] = None, token_type_ids: typing.Optional[torch.LongTensor] = None, position_ids: typing.Optional[torch.LongTensor] = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, labels: typing.Optional[torch.LongTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L1140)
...
The [RobertaPreLayerNormForTokenClassification](/docs/transformers/v5.15.1/en/model_doc/roberta-prelayernorm#transformers.RobertaPreLayerNormForTokenClassification) forward method, overrides the `__call__` special method.
...
```python
transformers.RobertaPreLayerNormForQuestionAnswering(config)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L1220)
...
#### forward[[transformers.RobertaPreLayerNormForQuestionAnswering.forward]]
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.1/src/transformers/models/roberta_prelayernorm/modeling_roberta_prelayernorm.py#L1231)
...
The [RobertaPreLayerNormForQuestionAnswering](/docs/transformers/v5.15.1/en/model_doc/roberta-prelayernorm#transformers.RobertaPreLayerNormForQuestionAnswering) forward method, overrides the `__call__` special method.
