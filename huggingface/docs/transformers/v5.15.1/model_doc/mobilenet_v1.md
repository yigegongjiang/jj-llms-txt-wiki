...
classifier_dropout_prob (`Union[float, int]`, *optional*, defaults to `0.999`) : The dropout ratio for classifier.
...
#### forward[[transformers.MobileNetV1Model.forward]]
...
#### forward[[transformers.MobileNetV1ForImageClassification.forward]]
