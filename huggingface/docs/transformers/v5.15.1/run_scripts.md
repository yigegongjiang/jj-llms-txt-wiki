...
The example script downloads and preprocesses a dataset, and then fine-tunes it with [Trainer](/docs/transformers/v5.15.1/en/main_classes/trainer#transformers.Trainer) with a supported model architecture.
