...
'"}, {"name": "unk_token", "val": " = ''"}, {"name": "pad_token", "val": " = ''"}, {"name": "_spm_precompiled_charsmap", "val": " = None"}, {"name": "extra_ids", "val": " = 100"}, {"name": "additional_special_tokens", "val": " = None"}, {"name": "vocab", "val": " = None"}, {"name": "vocab_file", "val": " = None"}, {"name": "**kwargs", "val": ""}]}>
...
[LasrProcessor](/docs/transformers/v5.14.0/en/model_doc/lasr#transformers.LasrProcessor) offers all the functionalities of `feature_extractor_class` and `tokenizer_class`. See the
...
- **ctc_loss_reduction** (`str`, *optional*, defaults to `"mean"`) --
  ...
  instance of [LasrForCTC](/docs/transformers/v5.14.0/en/model_doc/lasr#transformers.LasrForCTC).
- **ctc_zero_infinity** (`bool`, *optional*, defaults to `True`) --
  Whether to zero infinite losses and the associated gradients of `torch.nn.CTCLoss`. Infinite losses mainly
  occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
  of [LasrForCTC](/docs/transformers/v5.14.0/en/model_doc/lasr#transformers.LasrForCTC).
...
- **config** ([LasrEncoderConfig](/docs/transformers/v5.14.0/en/model_doc/lasr#transformers.LasrEncoderConfig)) --
...
)>"}, {"name": "attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "output_attention_mask", "val": ": bool | None = None"}, {"name": "**kwargs", "val": ": Unpack"}]}>
...
- **output_attention_mask** (`bool`, *optional*) --
  Whether to return the output attention mask.`LasrEncoderModelOutput` or `tuple(torch.FloatTensor)`A `LasrEncoderModelOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.
The [LasrEncoder](/docs/transformers/v5.14.0/en/model_doc/lasr#transformers.LasrEncoder) forward method, overrides the `__call__` special method.
...
- **config** ([LasrCTCConfig](/docs/transformers/v5.14.0/en/model_doc/lasr#transformers.LasrCTCConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.
The [LasrForCTC](/docs/transformers/v5.14.0/en/model_doc/lasr#transformers.LasrForCTC) forward method, overrides the `__call__` special method.
