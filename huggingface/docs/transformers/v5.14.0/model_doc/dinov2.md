...
- **config** ([Dinov2Config](/docs/transformers/v5.14.0/en/model_doc/dinov2#transformers.Dinov2Config)) --
...
elements depending on the configuration ([Dinov2Config](/docs/transformers/v5.14.0/en/model_doc/dinov2#transformers.Dinov2Config)) and inputs.
The [Dinov2Model](/docs/transformers/v5.14.0/en/model_doc/dinov2#transformers.Dinov2Model) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Dinov2Config](/docs/transformers/v5.14.0/en/model_doc/dinov2#transformers.Dinov2Config)) and inputs.
The [Dinov2ForImageClassification](/docs/transformers/v5.14.0/en/model_doc/dinov2#transformers.Dinov2ForImageClassification) forward method, overrides the `__call__` special method.
