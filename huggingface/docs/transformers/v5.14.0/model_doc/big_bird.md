...
- **sep_token_id** (`int`, *optional*, defaults to `66`) --
...
'"}, {"name": "bos_token", "val": " = ''"}, {"name": "eos_token", "val": " = ''"}, {"name": "pad_token", "val": " = ''"}, {"name": "sep_token", "val": " = '[SEP]'"}, {"name": "mask_token", "val": " = '[MASK]'"}, {"name": "cls_token", "val": " = '[CLS]'"}, {"name": "add_prefix_space", "val": " = True"}, {"name": "**kwargs", "val": ""}]}>
...
tokenizer inherits from [PreTrainedTokenizerFast](/docs/transformers/v5.14.0/en/main_classes/tokenizer#transformers.TokenizersBackend) which contains most of the main methods. Users should refer to
...
Output type of [BigBirdForPreTraining](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForPreTraining).

## BigBirdModel[[transformers.BigBirdModel]]

- **config** ([BigBirdModel](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdModel)) --
...
elements depending on the configuration ([BigBirdConfig](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdConfig)) and inputs.
The [BigBirdModel](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdModel) forward method, overrides the `__call__` special method.
...
- **next_sentence_label** (`torch.LongTensor` of shape `(batch_size,)`, *optional*) --
  ...
  - 1 indicates sequence B is a random sequence.[BigBirdForPreTrainingOutput](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.models.big_bird.modeling_big_bird.BigBirdForPreTrainingOutput) or `tuple(torch.FloatTensor)`A [BigBirdForPreTrainingOutput](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.models.big_bird.modeling_big_bird.BigBirdForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BigBirdConfig](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdConfig)) and inputs.
The [BigBirdForPreTraining](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForPreTraining) forward method, overrides the `__call__` special method.
...
- **config** ([BigBirdForCausalLM](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BigBirdConfig](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdConfig)) and inputs.
The [BigBirdForCausalLM](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([BigBirdForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BigBirdConfig](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdConfig)) and inputs.
The [BigBirdForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([BigBirdForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BigBirdConfig](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdConfig)) and inputs.
The [BigBirdForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([BigBirdForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BigBirdConfig](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdConfig)) and inputs.
The [BigBirdForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([BigBirdForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BigBirdConfig](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdConfig)) and inputs.
The [BigBirdForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([BigBirdForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
- **add_pooling_layer** (`bool`, *optional*, defaults to `True`) --
...
- **end_positions** (`torch.LongTensor` of shape `(batch_size,)`, *optional*) --
  ...
  Positions are clamped to the length of the sequence (`sequence_length`). Position outside of the sequence
  are not taken into account for computing the loss.`BigBirdForQuestionAnsweringModelOutput` or `tuple(torch.FloatTensor)`A `BigBirdForQuestionAnsweringModelOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BigBirdConfig](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdConfig)) and inputs.
The [BigBirdForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/big_bird#transformers.BigBirdForQuestionAnswering) forward method, overrides the `__call__` special method.
