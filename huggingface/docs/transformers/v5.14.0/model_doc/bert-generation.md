...
The example below demonstrates how to use BertGeneration with [EncoderDecoderModel](/docs/transformers/v5.14.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) for sequence-to-sequence tasks.
...
'"}, {"name": "eos_token", "val": " = ''"}, {"name": "unk_token", "val": " = ''"}, {"name": "pad_token", "val": " = ''"}, {"name": "sep_token", "val": " = '<::::>'"}, {"name": "sp_model_kwargs", "val": ": dict[str, typing.Any] | None = None"}, {"name": "**kwargs", "val": ""}]}>
- **vocab_file** (`str`) --
...
- **config** ([BertGenerationEncoder](/docs/transformers/v5.14.0/en/model_doc/bert-generation#transformers.BertGenerationEncoder)) --
...
elements depending on the configuration ([BertGenerationConfig](/docs/transformers/v5.14.0/en/model_doc/bert-generation#transformers.BertGenerationConfig)) and inputs.
The [BertGenerationEncoder](/docs/transformers/v5.14.0/en/model_doc/bert-generation#transformers.BertGenerationEncoder) forward method, overrides the `__call__` special method.
...
- **config** ([BertGenerationDecoder](/docs/transformers/v5.14.0/en/model_doc/bert-generation#transformers.BertGenerationDecoder)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertGenerationConfig](/docs/transformers/v5.14.0/en/model_doc/bert-generation#transformers.BertGenerationConfig)) and inputs.
The [BertGenerationDecoder](/docs/transformers/v5.14.0/en/model_doc/bert-generation#transformers.BertGenerationDecoder) forward method, overrides the `__call__` special method.
