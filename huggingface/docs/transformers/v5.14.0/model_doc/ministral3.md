...
- **config** ([Ministral3Config](/docs/transformers/v5.14.0/en/model_doc/ministral3#transformers.Ministral3Config)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
elements depending on the configuration ([Ministral3Config](/docs/transformers/v5.14.0/en/model_doc/ministral3#transformers.Ministral3Config)) and inputs.
The [Ministral3Model](/docs/transformers/v5.14.0/en/model_doc/ministral3#transformers.Ministral3Model) forward method, overrides the `__call__` special method.
...
- **config** ([Ministral3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/ministral3#transformers.Ministral3ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Ministral3Config](/docs/transformers/v5.14.0/en/model_doc/ministral3#transformers.Ministral3Config)) and inputs.
The [Ministral3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/ministral3#transformers.Ministral3ForCausalLM) forward method, overrides the `__call__` special method.
