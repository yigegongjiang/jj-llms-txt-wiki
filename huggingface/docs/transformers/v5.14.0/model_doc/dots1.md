...
- **config** ([Dots1Config](/docs/transformers/v5.14.0/en/model_doc/dots1#transformers.Dots1Config)) --
...
elements depending on the configuration ([Dots1Config](/docs/transformers/v5.14.0/en/model_doc/dots1#transformers.Dots1Config)) and inputs.
The [Dots1Model](/docs/transformers/v5.14.0/en/model_doc/dots1#transformers.Dots1Model) forward method, overrides the `__call__` special method.
...
- **config** ([Dots1ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/dots1#transformers.Dots1ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Dots1Config](/docs/transformers/v5.14.0/en/model_doc/dots1#transformers.Dots1Config)) and inputs.
The [Dots1ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/dots1#transformers.Dots1ForCausalLM) forward method, overrides the `__call__` special method.
