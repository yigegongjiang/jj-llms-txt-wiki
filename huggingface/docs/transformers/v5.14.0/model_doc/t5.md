...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoModel), and how to translate with T5 from the command line.
...
- T5 models need a slightly higher learning rate than the default used in [Trainer](/docs/transformers/v5.14.0/en/main_classes/trainer#transformers.Trainer). Typically, values of `1e-4` and `3e-4` work well for most tasks.
...
- **config** ([T5Config](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5Config)) --
...
elements depending on the configuration ([T5Config](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5Config)) and inputs.
The [T5Model](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5Model) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([T5Config](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5Config)) and inputs.
The [T5ForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([T5Config](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5Config)) and inputs.
The [T5EncoderModel](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5EncoderModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([T5Config](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5Config)) and inputs.
The [T5ForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5ForSequenceClassification) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([T5Config](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5Config)) and inputs.
The [T5ForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5ForTokenClassification) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([T5Config](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5Config)) and inputs.
The [T5ForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/t5#transformers.T5ForQuestionAnswering) forward method, overrides the `__call__` special method.
