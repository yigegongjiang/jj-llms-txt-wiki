...
- **config** ([BloomConfig](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomConfig)) --
...
elements depending on the configuration ([BloomConfig](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomConfig)) and inputs.
The [BloomModel](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BloomConfig](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomConfig)) and inputs.
The [BloomForCausalLM](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomForCausalLM) forward method, overrides the `__call__` special method.
...
[BloomForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BloomConfig](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomConfig)) and inputs.
The [BloomForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomForSequenceClassification) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BloomConfig](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomConfig)) and inputs.
The [BloomForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([BloomForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BloomConfig](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomConfig)) and inputs.
The [BloomForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/bloom#transformers.BloomForQuestionAnswering) forward method, overrides the `__call__` special method.
