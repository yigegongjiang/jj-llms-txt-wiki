...
- **config** ([LightOnOcrConfig](/docs/transformers/v5.14.0/en/model_doc/lighton_ocr#transformers.LightOnOcrConfig)) --
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [PixtralImageProcessor](/docs/transformers/v5.14.0/en/model_doc/pixtral#transformers.PixtralImageProcessor). See `PixtralImageProcessor.__call__()` for details ([LightOnOcrProcessor](/docs/transformers/v5.14.0/en/model_doc/lighton_ocr#transformers.LightOnOcrProcessor) uses
...
- **image_sizes** (`torch.Tensor` of shape `(batch_size, 2)`, *optional*) --
  The sizes of the images in the batch, being (height, width) for each image.`LightOnOcrModelOutputWithPast` or `tuple(torch.FloatTensor)`A `LightOnOcrModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LightOnOcrConfig](/docs/transformers/v5.14.0/en/model_doc/lighton_ocr#transformers.LightOnOcrConfig)) and inputs.
The [LightOnOcrModel](/docs/transformers/v5.14.0/en/model_doc/lighton_ocr#transformers.LightOnOcrModel) forward method, overrides the `__call__` special method.
...
- **image_sizes** (`torch.Tensor` of shape `(batch_size, 2)`, *optional*) --
  The sizes of the images in the batch, being (height, width) for each image.`LightOnOcrCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `LightOnOcrCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LightOnOcrConfig](/docs/transformers/v5.14.0/en/model_doc/lighton_ocr#transformers.LightOnOcrConfig)) and inputs.
The [LightOnOcrForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/lighton_ocr#transformers.LightOnOcrForConditionalGeneration) forward method, overrides the `__call__` special method.
