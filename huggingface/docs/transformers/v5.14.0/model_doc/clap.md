...
The example below demonstrates how to extract text embeddings with the [AutoModel](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoModel) class.
...
- **logit_scale_init_value** (`float`, *optional*, defaults to `14.285714285714285`) --
...
- **num_attention_heads** (`Union[list[int], tuple[int, ...]]`, *optional*, defaults to `(4, 8, 16, 32)`) --
  Number of attention heads for each attention layer in the Transformer decoder.
...
[~ClapFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapFeatureExtractor) and [~RobertaTokenizer](/docs/transformers/v5.14.0/en/model_doc/roberta#transformers.RobertaTokenizer) for more information.
...
- **config** ([ClapConfig](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapConfig)) --
...
- **input_features** (`torch.FloatTensor` of shape `(batch_size, sequence_length, feature_dim)`, *optional*) --
  ...
  [ClapFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapFeatureExtractor). See `ClapFeatureExtractor.__call__()` for details ([ClapProcessor](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapProcessor) uses
  [ClapFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapFeatureExtractor) for processing audios).
...
- **return_loss** (`bool`, *optional*) --
  Whether or not to return the contrastive loss.`ClapOutput` or `tuple(torch.FloatTensor)`A `ClapOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ClapConfig](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapConfig)) and inputs.
The [ClapModel](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapModel) forward method, overrides the `__call__` special method.
...
- **logits_per_text** (`torch.FloatTensor` of shape `(text_batch_size, audio_batch_size)`) -- The scaled dot product scores between `text_embeds` and `audio_embeds`. This represents the text-audio
  similarity scores.
- **text_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The text embeddings obtained by applying the projection layer to the pooled output of [ClapTextModel](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapTextModel).
- **audio_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The audio embeddings obtained by applying the projection layer to the pooled output of [ClapAudioModel](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapAudioModel).
- **text_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [ClapTextModel](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapTextModel).
- **audio_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [ClapAudioModel](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapAudioModel).
...
)>"}, {"name": "is_longer", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "**kwargs", "val": ": Unpack"}]}>
...
- **config** ([ClapTextModel](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapTextModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ClapConfig](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapConfig)) and inputs.
The [ClapTextModel](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapTextModel) forward method, overrides the `__call__` special method.
...
- **config** ([ClapTextConfig](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapTextConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **position_ids** (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  [What are position IDs?](../glossary#position-ids)`ClapTextModelOutput` or `tuple(torch.FloatTensor)`A `ClapTextModelOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ClapConfig](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapConfig)) and inputs.
The [ClapTextModelWithProjection](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapTextModelWithProjection) forward method, overrides the `__call__` special method.
...
- **is_longer** (`torch.FloatTensor`, of shape `(batch_size, 1)`, *optional*) --
  Whether the audio clip is longer than `max_length`. If `True`, a feature fusion will be enabled to enhance
  the features.[BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or `tuple(torch.FloatTensor)`A [BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ClapConfig](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapConfig)) and inputs.
The [ClapAudioModel](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapAudioModel) forward method, overrides the `__call__` special method.
...
- **config** ([ClapAudioConfig](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapAudioConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **is_longer** (`torch.FloatTensor`, of shape `(batch_size, 1)`, *optional*) --
  Whether the audio clip is longer than `max_length`. If `True`, a feature fusion will be enabled to enhance
  the features.`ClapAudioModelOutput` or `tuple(torch.FloatTensor)`A `ClapAudioModelOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ClapConfig](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapConfig)) and inputs.
The [ClapAudioModelWithProjection](/docs/transformers/v5.14.0/en/model_doc/clap#transformers.ClapAudioModelWithProjection) forward method, overrides the `__call__` special method.
