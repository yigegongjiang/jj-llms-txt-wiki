...
- **config** ([FlexOlmoForCausalLM](/docs/transformers/v5.14.0/en/model_doc/flex_olmo#transformers.FlexOlmoForCausalLM)) --
...
elements depending on the configuration ([FlexOlmoConfig](/docs/transformers/v5.14.0/en/model_doc/flex_olmo#transformers.FlexOlmoConfig)) and inputs.
The [FlexOlmoForCausalLM](/docs/transformers/v5.14.0/en/model_doc/flex_olmo#transformers.FlexOlmoForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([FlexOlmoConfig](/docs/transformers/v5.14.0/en/model_doc/flex_olmo#transformers.FlexOlmoConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FlexOlmoConfig](/docs/transformers/v5.14.0/en/model_doc/flex_olmo#transformers.FlexOlmoConfig)) and inputs.
The [FlexOlmoModel](/docs/transformers/v5.14.0/en/model_doc/flex_olmo#transformers.FlexOlmoModel) forward method, overrides the `__call__` special method.
