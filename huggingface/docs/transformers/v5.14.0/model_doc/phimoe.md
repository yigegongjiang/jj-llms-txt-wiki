...
- **config** ([PhimoeConfig](/docs/transformers/v5.14.0/en/model_doc/phimoe#transformers.PhimoeConfig)) --
...
elements depending on the configuration ([PhimoeConfig](/docs/transformers/v5.14.0/en/model_doc/phimoe#transformers.PhimoeConfig)) and inputs.
The [PhimoeModel](/docs/transformers/v5.14.0/en/model_doc/phimoe#transformers.PhimoeModel) forward method, overrides the `__call__` special method.
...
- **config** ([PhimoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/phimoe#transformers.PhimoeForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([PhimoeConfig](/docs/transformers/v5.14.0/en/model_doc/phimoe#transformers.PhimoeConfig)) and inputs.
The [PhimoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/phimoe#transformers.PhimoeForCausalLM) forward method, overrides the `__call__` special method.
