...
'"}, {"name": "default_transcription_prompt", "val": " = 'Transcribe the input speech.'"}, {"name": "max_audio_len", "val": " = 600"}]}>
...
[~WhisperFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/whisper#transformers.WhisperFeatureExtractor) and [~Qwen2Tokenizer](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2Tokenizer) for more information.
...
- **config** ([AudioFlamingo3EncoderConfig](/docs/transformers/v5.14.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3EncoderConfig)) --
...
)>"}, {"name": "input_features_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "**kwargs", "val": ""}]}>
...
- **config** ([AudioFlamingo3Model](/docs/transformers/v5.14.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3Model)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **use_cache** (`bool`, *optional*) --
  ...
  `past_key_values`).`AudioFlamingo3ModelOutputWithPast` or `tuple(torch.FloatTensor)`A `AudioFlamingo3ModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([AudioFlamingo3Config](/docs/transformers/v5.14.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3Config)) and inputs.
The [AudioFlamingo3Model](/docs/transformers/v5.14.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3Model) forward method, overrides the `__call__` special method.
...
- **config** ([AudioFlamingo3ForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3ForConditionalGeneration)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  This is useful when using packed tensor format (single dimension for batch and sequence length).`AudioFlamingo3CausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `AudioFlamingo3CausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([AudioFlamingo3Config](/docs/transformers/v5.14.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3Config)) and inputs.
The [AudioFlamingo3ForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3ForConditionalGeneration) forward method, overrides the `__call__` special method.
