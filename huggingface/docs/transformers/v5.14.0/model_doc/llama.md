...
'"}, {"name": "bos_token", "val": " = ''"}, {"name": "eos_token", "val": " = ''"}, {"name": "use_default_system_prompt", "val": " = False"}, {"name": "legacy", "val": " = False"}, {"name": "add_prefix_space", "val": " = None"}, {"name": "**kwargs", "val": ""}]}>
...
- **config** ([LlamaConfig](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaConfig)) --
...
elements depending on the configuration ([LlamaConfig](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaConfig)) and inputs.
The [LlamaModel](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaModel) forward method, overrides the `__call__` special method.
...
- **config** ([LlamaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LlamaConfig](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaConfig)) and inputs.
The [LlamaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaForCausalLM) forward method, overrides the `__call__` special method.
