...
- **config** ([UMT5Model](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Model)) --
...
elements depending on the configuration ([UMT5Config](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Config)) and inputs.
The [UMT5Model](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Model) forward method, overrides the `__call__` special method.
...
- **config** ([UMT5ForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5ForConditionalGeneration)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([UMT5Config](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Config)) and inputs.
The [UMT5ForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **config** ([UMT5EncoderModel](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5EncoderModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([UMT5Config](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Config)) and inputs.
The [UMT5EncoderModel](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5EncoderModel) forward method, overrides the `__call__` special method.
...
- **config** ([UMT5Config](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Config)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([UMT5Config](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Config)) and inputs.
The [UMT5ForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5ForSequenceClassification) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([UMT5Config](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Config)) and inputs.
The [UMT5ForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5ForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([UMT5ForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5ForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([UMT5Config](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5Config)) and inputs.
The [UMT5ForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/umt5#transformers.UMT5ForQuestionAnswering) forward method, overrides the `__call__` special method.
