...
- `StableLM 3B 4E1T`-based models uses the same tokenizer as [GPTNeoXTokenizerFast](/docs/transformers/v5.14.0/en/model_doc/gpt_neox#transformers.GPTNeoXTokenizer).
...
This is the configuration class to store the configuration of a StableLmModel. It is used to instantiate a Stablelm
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [stabilityai/stablelm-3b-4e1t](https://huggingface.co/stabilityai/stablelm-3b-4e1t)
...
- **config** ([StableLmConfig](/docs/transformers/v5.14.0/en/model_doc/stablelm#transformers.StableLmConfig)) --
...
elements depending on the configuration ([StableLmConfig](/docs/transformers/v5.14.0/en/model_doc/stablelm#transformers.StableLmConfig)) and inputs.
The [StableLmModel](/docs/transformers/v5.14.0/en/model_doc/stablelm#transformers.StableLmModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([StableLmConfig](/docs/transformers/v5.14.0/en/model_doc/stablelm#transformers.StableLmConfig)) and inputs.
The [StableLmForCausalLM](/docs/transformers/v5.14.0/en/model_doc/stablelm#transformers.StableLmForCausalLM) forward method, overrides the `__call__` special method.
