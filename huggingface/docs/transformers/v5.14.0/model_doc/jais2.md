...
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `150024`) --
...
- **config** ([Jais2Config](/docs/transformers/v5.14.0/en/model_doc/jais2#transformers.Jais2Config)) --
...
elements depending on the configuration ([Jais2Config](/docs/transformers/v5.14.0/en/model_doc/jais2#transformers.Jais2Config)) and inputs.
The [Jais2Model](/docs/transformers/v5.14.0/en/model_doc/jais2#transformers.Jais2Model) forward method, overrides the `__call__` special method.
...
- **config** ([Jais2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/jais2#transformers.Jais2ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Jais2Config](/docs/transformers/v5.14.0/en/model_doc/jais2#transformers.Jais2Config)) and inputs.
The [Jais2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/jais2#transformers.Jais2ForCausalLM) forward method, overrides the `__call__` special method.
