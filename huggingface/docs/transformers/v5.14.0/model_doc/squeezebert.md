...
- **config** ([SqueezeBertModel](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertModel)) --
...
elements depending on the configuration ([SqueezeBertConfig](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertConfig)) and inputs.
The [SqueezeBertModel](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertModel) forward method, overrides the `__call__` special method.
...
- **config** ([SqueezeBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SqueezeBertConfig](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertConfig)) and inputs.
The [SqueezeBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([SqueezeBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SqueezeBertConfig](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertConfig)) and inputs.
The [SqueezeBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([SqueezeBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SqueezeBertConfig](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertConfig)) and inputs.
The [SqueezeBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([SqueezeBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SqueezeBertConfig](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertConfig)) and inputs.
The [SqueezeBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([SqueezeBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SqueezeBertConfig](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertConfig)) and inputs.
The [SqueezeBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/squeezebert#transformers.SqueezeBertForQuestionAnswering) forward method, overrides the `__call__` special method.
