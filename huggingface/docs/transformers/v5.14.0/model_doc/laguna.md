...
- **config** ([LagunaConfig](/docs/transformers/v5.14.0/en/model_doc/laguna#transformers.LagunaConfig)) --
...
elements depending on the configuration ([LagunaConfig](/docs/transformers/v5.14.0/en/model_doc/laguna#transformers.LagunaConfig)) and inputs.
The [LagunaModel](/docs/transformers/v5.14.0/en/model_doc/laguna#transformers.LagunaModel) forward method, overrides the `__call__` special method.
...
- **config** ([LagunaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/laguna#transformers.LagunaForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LagunaConfig](/docs/transformers/v5.14.0/en/model_doc/laguna#transformers.LagunaConfig)) and inputs.
The [LagunaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/laguna#transformers.LagunaForCausalLM) forward method, overrides the `__call__` special method.
