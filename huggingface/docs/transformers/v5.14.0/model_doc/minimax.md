...
- **config** ([MiniMaxConfig](/docs/transformers/v5.14.0/en/model_doc/minimax#transformers.MiniMaxConfig)) --
...
- **config** ([MiniMaxForCausalLM](/docs/transformers/v5.14.0/en/model_doc/minimax#transformers.MiniMaxForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
elements depending on the configuration ([MiniMaxConfig](/docs/transformers/v5.14.0/en/model_doc/minimax#transformers.MiniMaxConfig)) and inputs.
The [MiniMaxForCausalLM](/docs/transformers/v5.14.0/en/model_doc/minimax#transformers.MiniMaxForCausalLM) forward method, overrides the `__call__` special method.
