...
The Inkling model was proposed in []() by .
...
- **config** ([InklingTextConfig](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingTextConfig)) --
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  This is useful when using packed tensor format (single dimension for batch and sequence length).`InklingCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `InklingCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([InklingConfig](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingConfig)) and inputs.
The [InklingForCausalLM](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([InklingConfig](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **audio_input_ids** (`torch.LongTensor` of shape `(num_audios, max_num_frames, n_mel_bins)`, *optional*) --
  Batch of (padded) discretized dMel bin tokens produced by [InklingProcessor](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingProcessor).
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([InklingConfig](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingConfig)) and inputs.
The [InklingForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **use_cache** (`bool`, *optional*) --
  If set to `True`, `past_key_values` key value states are returned and can be used to speed up decoding (see
  `past_key_values`).`InklingModelOutputWithPast` or `tuple(torch.FloatTensor)`A `InklingModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([InklingConfig](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingConfig)) and inputs.
The [InklingModel](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingModel) forward method, overrides the `__call__` special method.
...
The bare Inkling Text Model outputting raw hidden-states without any specific head on to.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([InklingConfig](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingConfig)) and inputs.
The [InklingTextModel](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingTextModel) forward method, overrides the `__call__` special method.
...
dMel bins is performed downstream by [InklingProcessor](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingProcessor).

This feature extractor inherits from [SequenceFeatureExtractor](/docs/transformers/v5.14.0/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor)
...
'"}, {"name": "audio_token", "val": " = '<|unused_200053|>'"}, {"name": "image_bos_token", "val": " = '<|content_image|>'"}, {"name": "audio_bos_token", "val": " = '<|content_audio_input|>'"}, {"name": "num_dmel_bins", "val": " = 16"}, {"name": "dmel_min_value", "val": " = -7.0"}, {"name": "dmel_max_value", "val": " = 2.0"}, {"name": "**kwargs", "val": ""}]}>
...
[InklingProcessor](/docs/transformers/v5.14.0/en/model_doc/inkling#transformers.InklingProcessor) offers all the functionalities of `feature_extractor_class`, `image_processor_class`, and `tokenizer_class`. See the
