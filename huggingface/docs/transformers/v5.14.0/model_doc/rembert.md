...
- **bos_token_id** (`int`, *optional*, defaults to `312`) --
  Token id used for beginning-of-stream in the vocabulary.
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `313`) --
...
'"}, {"name": "sep_token", "val": ": str = '[SEP]'"}, {"name": "pad_token", "val": ": str = ''"}, {"name": "cls_token", "val": ": str = '[CLS]'"}, {"name": "mask_token", "val": ": str = '[MASK]'"}, {"name": "_spm_precompiled_charsmap", "val": ": str | None = None"}, {"name": "add_prefix_space", "val": ": bool = True"}, {"name": "remove_space", "val": ": bool = True"}, {"name": "**kwargs", "val": ""}]}>
...
tokenizer inherits from [AlbertTokenizer](/docs/transformers/v5.14.0/en/model_doc/albert#transformers.AlbertTokenizer) which contains most of the main methods. Users should refer to
...
- **config** ([RemBertModel](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertModel)) --
...
- **return_dict** (`bool`, *optional*) --
  Whether or not to return a [ModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput) instead of a plain tuple.[BaseModelOutputWithPoolingAndCrossAttentions](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions) or `tuple(torch.FloatTensor)`A [BaseModelOutputWithPoolingAndCrossAttentions](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([RemBertConfig](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertConfig)) and inputs.
The [RemBertModel](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertModel) forward method, overrides the `__call__` special method.
...
- **config** ([RemBertForCausalLM](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([RemBertConfig](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertConfig)) and inputs.
The [RemBertForCausalLM](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([RemBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([RemBertConfig](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertConfig)) and inputs.
The [RemBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([RemBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([RemBertConfig](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertConfig)) and inputs.
The [RemBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([RemBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([RemBertConfig](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertConfig)) and inputs.
The [RemBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([RemBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([RemBertConfig](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertConfig)) and inputs.
The [RemBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([RemBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([RemBertConfig](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertConfig)) and inputs.
The [RemBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/rembert#transformers.RemBertForQuestionAnswering) forward method, overrides the `__call__` special method.
