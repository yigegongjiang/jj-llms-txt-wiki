...
- **residual_dropout** (`Union[float, int]`, *optional*, defaults to `0.1`) --
...
This is the configuration class to store the configuration of a SeedOssModel. It is used to instantiate a Seed Oss
...
- **config** ([SeedOssConfig](/docs/transformers/v5.14.0/en/model_doc/seed_oss#transformers.SeedOssConfig)) --
...
elements depending on the configuration ([SeedOssConfig](/docs/transformers/v5.14.0/en/model_doc/seed_oss#transformers.SeedOssConfig)) and inputs.
The [SeedOssModel](/docs/transformers/v5.14.0/en/model_doc/seed_oss#transformers.SeedOssModel) forward method, overrides the `__call__` special method.
...
- **config** ([SeedOssForCausalLM](/docs/transformers/v5.14.0/en/model_doc/seed_oss#transformers.SeedOssForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SeedOssConfig](/docs/transformers/v5.14.0/en/model_doc/seed_oss#transformers.SeedOssConfig)) and inputs.
The [SeedOssForCausalLM](/docs/transformers/v5.14.0/en/model_doc/seed_oss#transformers.SeedOssForCausalLM) forward method, overrides the `__call__` special method.
