...
This is the configuration class to store the configuration of a BertModel. It is used to instantiate a Bert
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [google-bert/bert-base-uncased](https://huggingface.co/google-bert/bert-base-uncased)
...
## BertTokenizerLegacy[[transformers.BertTokenizerLegacy]]
...
## BertTokenizerFast[[transformers.BertTokenizer]]
...
- **config** ([BertModel](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertModel)) --
...
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertModel](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertModel) forward method, overrides the `__call__` special method.
...
- **config** ([BertForPreTraining](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForPreTraining)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **next_sentence_label** (`torch.LongTensor` of shape `(batch_size,)`, *optional*) --
  ...
  - 1 indicates sequence B is a random sequence.[BertForPreTrainingOutput](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.models.bert.modeling_bert.BertForPreTrainingOutput) or `tuple(torch.FloatTensor)`A [BertForPreTrainingOutput](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.models.bert.modeling_bert.BertForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertForPreTraining](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForPreTraining) forward method, overrides the `__call__` special method.
...
- **config** ([BertLMHeadModel](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertLMHeadModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertLMHeadModel](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertLMHeadModel) forward method, overrides the `__call__` special method.
...
- **config** ([BertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([BertForNextSentencePrediction](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForNextSentencePrediction)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertForNextSentencePrediction](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
- **config** ([BertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([BertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([BertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([BertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BertConfig](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertConfig)) and inputs.
The [BertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForQuestionAnswering) forward method, overrides the `__call__` special method.
...
Output type of [BertForPreTraining](/docs/transformers/v5.14.0/en/model_doc/bert#transformers.BertForPreTraining).
