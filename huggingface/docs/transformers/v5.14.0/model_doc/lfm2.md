...
- **config** ([Lfm2Config](/docs/transformers/v5.14.0/en/model_doc/lfm2#transformers.Lfm2Config)) --
...
elements depending on the configuration ([Lfm2Config](/docs/transformers/v5.14.0/en/model_doc/lfm2#transformers.Lfm2Config)) and inputs.
The [Lfm2Model](/docs/transformers/v5.14.0/en/model_doc/lfm2#transformers.Lfm2Model) forward method, overrides the `__call__` special method.
...
- **config** ([Lfm2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/lfm2#transformers.Lfm2ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Lfm2Config](/docs/transformers/v5.14.0/en/model_doc/lfm2#transformers.Lfm2Config)) and inputs.
The [Lfm2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/lfm2#transformers.Lfm2ForCausalLM) forward method, overrides the `__call__` special method.
