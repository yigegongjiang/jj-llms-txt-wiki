...
- **config** ([Glm4MoeLiteConfig](/docs/transformers/v5.14.0/en/model_doc/glm4_moe_lite#transformers.Glm4MoeLiteConfig)) --
...
elements depending on the configuration ([Glm4MoeLiteConfig](/docs/transformers/v5.14.0/en/model_doc/glm4_moe_lite#transformers.Glm4MoeLiteConfig)) and inputs.
The [Glm4MoeLiteModel](/docs/transformers/v5.14.0/en/model_doc/glm4_moe_lite#transformers.Glm4MoeLiteModel) forward method, overrides the `__call__` special method.
...
- **config** ([Glm4MoeLiteForCausalLM](/docs/transformers/v5.14.0/en/model_doc/glm4_moe_lite#transformers.Glm4MoeLiteForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Glm4MoeLiteConfig](/docs/transformers/v5.14.0/en/model_doc/glm4_moe_lite#transformers.Glm4MoeLiteConfig)) and inputs.
The [Glm4MoeLiteForCausalLM](/docs/transformers/v5.14.0/en/model_doc/glm4_moe_lite#transformers.Glm4MoeLiteForCausalLM) forward method, overrides the `__call__` special method.
