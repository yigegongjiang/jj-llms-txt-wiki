...
This is the configuration class to store the configuration of a NemotronModel. It is used to instantiate a Nemotron
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [thhaus/nemotron3-8b](https://huggingface.co/thhaus/nemotron3-8b)
...
- **config** ([NemotronConfig](/docs/transformers/v5.14.0/en/model_doc/nemotron#transformers.NemotronConfig)) --
...
elements depending on the configuration ([NemotronConfig](/docs/transformers/v5.14.0/en/model_doc/nemotron#transformers.NemotronConfig)) and inputs.
The [NemotronModel](/docs/transformers/v5.14.0/en/model_doc/nemotron#transformers.NemotronModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([NemotronConfig](/docs/transformers/v5.14.0/en/model_doc/nemotron#transformers.NemotronConfig)) and inputs.
The [NemotronForCausalLM](/docs/transformers/v5.14.0/en/model_doc/nemotron#transformers.NemotronForCausalLM) forward method, overrides the `__call__` special method.
