...
- SEWForCTC is fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded using
  [Wav2Vec2CTCTokenizer](/docs/transformers/v5.14.0/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer).
...
- **final_dropout** (`float`, *optional*, defaults to 0.1) --
  The dropout probability for the final projection layer of [SEWForCTC](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWForCTC).
...
- **ctc_zero_infinity** (`bool`, *optional*, defaults to `False`) --
  ...
  of [SEWForCTC](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWForCTC).
...
- **config** ([SEWConfig](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWConfig)) --
...
elements depending on the configuration ([SEWConfig](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWConfig)) and inputs.
The [SEWModel](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWModel) forward method, overrides the `__call__` special method.
...
- **config** ([SEWForCTC](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWForCTC)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
- **target_lang** (`str`, *optional*) --
  Language id of adapter weights. Adapter weights are stored in the format adapter..safetensors or
  adapter..bin. Only relevant when using an instance of [SEWForCTC](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWForCTC) with adapters. Uses 'eng' by
  default.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SEWConfig](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWConfig)) and inputs.
The [SEWForCTC](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWForCTC) forward method, overrides the `__call__` special method.
...
- **config** ([SEWForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SEWConfig](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWConfig)) and inputs.
The [SEWForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/sew#transformers.SEWForSequenceClassification) forward method, overrides the `__call__` special method.
