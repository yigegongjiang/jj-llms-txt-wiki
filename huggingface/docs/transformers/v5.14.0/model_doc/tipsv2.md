...
Use [AutoBackbone](/docs/transformers/v5.14.0/en/main_classes/backbones#transformers.AutoBackbone) to load the vision backbone directly and get spatial feature maps, without the text model. 
...
- [Tipsv2Model](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Model) returns normalized `image_embeds` and `text_embeds`. `logits_per_image` and `logits_per_text` are convenience outputs computed as cosine similarity divided by the temperature.
- Use [get_image_features()](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Model.get_image_features) and [get_text_features()](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Model.get_text_features) to retrieve image and text embeddings individually.
- Use [Tipsv2VisionBackbone](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2VisionBackbone) if you need access to feature maps from all layers.
- Use [Tipsv2VisionModel](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2VisionModel) if you need access to the two vision class tokens.

## Tipsv2Config[[transformers.Tipsv2Config]]

- **text_config** (`dict`, *optional*) --
  Dictionary of configuration options used to initialize [Tipsv2TextConfig](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2TextConfig).
- **vision_config** (`dict`, *optional*) --
  Dictionary of configuration options used to initialize [Tipsv2VisionConfig](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2VisionConfig).
- **temperature_init_value** (`float`, *optional*, defaults to `0.005065968260169029`) --
  Initial value for the learnable temperature parameter used to scale cosine-similarity logits in [Tipsv2Model](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Model).
...
- **num_attention_heads** (`int`, *optional*, defaults to `12`) --
  Number of attention heads for each attention layer in the Transformer decoder.
- **mlp_ratio** (`Union[int, float]`, *optional*, defaults to `4`) --
...
'"}, {"name": "pad_token", "val": ": str | None = ''"}, {"name": "bos_token", "val": ": str | None = None"}, {"name": "eos_token", "val": ": str | None = None"}, {"name": "model_max_length", "val": ": int = 64"}, {"name": "do_lower_case", "val": ": bool = True"}, {"name": "token_type_ids_pattern", "val": ": str = 'all_zeros'"}, {"name": "_spm_precompiled_charsmap", "val": " = None"}, {"name": "**kwargs", "val": ""}]}>
...
[~Tipsv2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2ImageProcessor) and [~Tipsv2Tokenizer](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Tokenizer) for more information.
...
- **config** ([Tipsv2Config](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Config)) --
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [Tipsv2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2ImageProcessor). See `Tipsv2ImageProcessor.__call__()` for details ([Tipsv2Processor](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Processor) uses
  [Tipsv2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2ImageProcessor) for processing images).
...
- **return_loss** (`bool`, *optional*) --
  Whether or not to return the contrastive loss when both image and text inputs are provided.`Tipsv2Output` or `tuple(torch.FloatTensor)`A `Tipsv2Output` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Tipsv2Config](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Config)) and inputs.
The [Tipsv2Model](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Model) forward method, overrides the `__call__` special method.
...
- **logits_per_text** (`torch.FloatTensor` of shape `(text_batch_size, image_batch_size)`) -- The scaled dot product scores between `text_embeds` and `image_embeds`. This represents the text-image
  similarity scores.
- **text_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The text embeddings obtained by applying the projection layer to the pooled output of [Tipsv2TextModel](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2TextModel).
- **image_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The image embeddings obtained by applying the projection layer to the pooled output of [Tipsv2VisionModel](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2VisionModel).
- **text_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [Tipsv2TextModel](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2TextModel).
- **vision_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [Tipsv2VisionModel](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2VisionModel).
...
- **config** ([Tipsv2TextConfig](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2TextConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Tipsv2Config](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Config)) and inputs.
The [Tipsv2TextModel](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2TextModel) forward method, overrides the `__call__` special method.
...
- **config** ([Tipsv2VisionConfig](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2VisionConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Tipsv2Config](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Config)) and inputs.
The [Tipsv2VisionModel](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2VisionModel) forward method, overrides the `__call__` special method.
...
- **pixel_values** (`doc_builder.mock_imports.torch.Tensor` of shape `(batch_size, num_channels, image_size, image_size)`) --
  The tensors corresponding to the input images. Pixel values can be obtained using
  [Tipsv2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2ImageProcessor). See `Tipsv2ImageProcessor.__call__()` for details ([Tipsv2Processor](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Processor) uses
  [Tipsv2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2ImageProcessor) for processing images).`BackboneOutput` or `tuple(torch.FloatTensor)`A `BackboneOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Tipsv2Config](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2Config)) and inputs.
The [Tipsv2VisionBackbone](/docs/transformers/v5.14.0/en/model_doc/tipsv2#transformers.Tipsv2VisionBackbone) forward method, overrides the `__call__` special method.
