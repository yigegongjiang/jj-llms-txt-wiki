...
- **config** ([JambaConfig](/docs/transformers/v5.14.0/en/model_doc/jamba#transformers.JambaConfig)) --
...
elements depending on the configuration ([JambaConfig](/docs/transformers/v5.14.0/en/model_doc/jamba#transformers.JambaConfig)) and inputs.
The [JambaModel](/docs/transformers/v5.14.0/en/model_doc/jamba#transformers.JambaModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([JambaConfig](/docs/transformers/v5.14.0/en/model_doc/jamba#transformers.JambaConfig)) and inputs.
The [JambaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/jamba#transformers.JambaForCausalLM) forward method, overrides the `__call__` special method.
