...
- **config** ([PPLCNetV4Config](/docs/transformers/v5.14.0/en/model_doc/pp_lcnet_v4#transformers.PPLCNetV4Config)) --
...
elements depending on the configuration ([PPLCNetV4Config](/docs/transformers/v5.14.0/en/model_doc/pp_lcnet_v4#transformers.PPLCNetV4Config)) and inputs.
The [PPLCNetV4Backbone](/docs/transformers/v5.14.0/en/model_doc/pp_lcnet_v4#transformers.PPLCNetV4Backbone) forward method, overrides the `__call__` special method.
