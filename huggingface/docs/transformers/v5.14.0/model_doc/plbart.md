...
In cases where the language code is needed, the regular [__call__()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) will encode source text format
...
'"}, {"name": "eos_token", "val": " = ''"}, {"name": "sep_token", "val": " = ''"}, {"name": "cls_token", "val": " = ''"}, {"name": "unk_token", "val": " = ''"}, {"name": "pad_token", "val": " = ''"}, {"name": "mask_token", "val": " = ''"}, {"name": "language_codes", "val": " = 'base'"}, {"name": "src_lang", "val": " = None"}, {"name": "tgt_lang", "val": " = None"}, {"name": "sp_model_kwargs", "val": ": dict[str, typing.Any] | None = None"}, {"name": "additional_special_tokens", "val": " = None"}, {"name": "clean_up_tokenization_spaces", "val": " = True"}, {"name": "**kwargs", "val": ""}]}>
- **vocab_file** (`str`) --
...
Adapted from [RobertaTokenizer](/docs/transformers/v5.14.0/en/model_doc/roberta#transformers.RobertaTokenizer) and [XLNetTokenizer](/docs/transformers/v5.14.0/en/model_doc/xlnet#transformers.XLNetTokenizer). Based on
...
- **config** ([PLBartConfig](/docs/transformers/v5.14.0/en/model_doc/plbart#transformers.PLBartConfig)) --
...
- **decoder_input_ids** (`torch.LongTensor` of shape `(batch_size, target_sequence_length)`, *optional*) --
  ...
  Indices can be obtained using [AutoTokenizer](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoTokenizer) or `PLBartMultiTokenizer` depending on the checkpoint.
  See [PreTrainedTokenizer.encode()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and [PreTrainedTokenizer.__call__()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) for details.
...
elements depending on the configuration ([PLBartConfig](/docs/transformers/v5.14.0/en/model_doc/plbart#transformers.PLBartConfig)) and inputs.
The [PLBartModel](/docs/transformers/v5.14.0/en/model_doc/plbart#transformers.PLBartModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([PLBartConfig](/docs/transformers/v5.14.0/en/model_doc/plbart#transformers.PLBartConfig)) and inputs.
The [PLBartForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/plbart#transformers.PLBartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **config** ([PLBartForCausalLM](/docs/transformers/v5.14.0/en/model_doc/plbart#transformers.PLBartForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([PLBartConfig](/docs/transformers/v5.14.0/en/model_doc/plbart#transformers.PLBartConfig)) and inputs.
The [PLBartForCausalLM](/docs/transformers/v5.14.0/en/model_doc/plbart#transformers.PLBartForCausalLM) forward method, overrides the `__call__` special method.
