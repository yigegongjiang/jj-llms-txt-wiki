...
- **qa_dropout** (`float`, *optional*, defaults to 0.1) --
  The dropout probabilities used in the question answering model [DistilBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertForQuestionAnswering).
- **seq_classif_dropout** (`float`, *optional*, defaults to 0.2) --
  The dropout probabilities used in the sequence classification and the multiple choice model
  [DistilBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification).
...
- **position_ids** (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  [What are position IDs?](../glossary#position-ids)[BaseModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput) or `tuple(torch.FloatTensor)`A [BaseModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DistilBertConfig](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertConfig)) and inputs.
The [DistilBertModel](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertModel) forward method, overrides the `__call__` special method.
...
- **position_ids** (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  [What are position IDs?](../glossary#position-ids)[MaskedLMOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput) or `tuple(torch.FloatTensor)`A [MaskedLMOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DistilBertConfig](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertConfig)) and inputs.
The [DistilBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertForMaskedLM) forward method, overrides the `__call__` special method.
...
- **position_ids** (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  [What are position IDs?](../glossary#position-ids)[SequenceClassifierOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput) or `tuple(torch.FloatTensor)`A [SequenceClassifierOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DistilBertConfig](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertConfig)) and inputs.
The [DistilBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **position_ids** (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  [What are position IDs?](../glossary#position-ids)[MultipleChoiceModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput) or `tuple(torch.FloatTensor)`A [MultipleChoiceModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DistilBertConfig](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertConfig)) and inputs.
The [DistilBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **position_ids** (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  [What are position IDs?](../glossary#position-ids)[TokenClassifierOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput) or `tuple(torch.FloatTensor)`A [TokenClassifierOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DistilBertConfig](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertConfig)) and inputs.
The [DistilBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertForTokenClassification) forward method, overrides the `__call__` special method.
...
- **position_ids** (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  [What are position IDs?](../glossary#position-ids)[QuestionAnsweringModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput) or `tuple(torch.FloatTensor)`A [QuestionAnsweringModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DistilBertConfig](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertConfig)) and inputs.
The [DistilBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/distilbert#transformers.DistilBertForQuestionAnswering) forward method, overrides the `__call__` special method.
