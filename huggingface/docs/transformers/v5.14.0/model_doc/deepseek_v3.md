...
- **config** ([DeepseekV3Config](/docs/transformers/v5.14.0/en/model_doc/deepseek_v3#transformers.DeepseekV3Config)) --
...
elements depending on the configuration ([DeepseekV3Config](/docs/transformers/v5.14.0/en/model_doc/deepseek_v3#transformers.DeepseekV3Config)) and inputs.
The [DeepseekV3Model](/docs/transformers/v5.14.0/en/model_doc/deepseek_v3#transformers.DeepseekV3Model) forward method, overrides the `__call__` special method.
...
- **config** ([DeepseekV3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/deepseek_v3#transformers.DeepseekV3ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DeepseekV3Config](/docs/transformers/v5.14.0/en/model_doc/deepseek_v3#transformers.DeepseekV3Config)) and inputs.
The [DeepseekV3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/deepseek_v3#transformers.DeepseekV3ForCausalLM) forward method, overrides the `__call__` special method.
