...
- **config** ([MoonshineConfig](/docs/transformers/v5.14.0/en/model_doc/moonshine#transformers.MoonshineConfig)) --
...
elements depending on the configuration ([MoonshineConfig](/docs/transformers/v5.14.0/en/model_doc/moonshine#transformers.MoonshineConfig)) and inputs.
The [MoonshineModel](/docs/transformers/v5.14.0/en/model_doc/moonshine#transformers.MoonshineModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MoonshineConfig](/docs/transformers/v5.14.0/en/model_doc/moonshine#transformers.MoonshineConfig)) and inputs.
The [MoonshineForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/moonshine#transformers.MoonshineForConditionalGeneration) forward method, overrides the `__call__` special method.
