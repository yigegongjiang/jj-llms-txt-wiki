...
- **config** ([OlmoConfig](/docs/transformers/v5.14.0/en/model_doc/olmo#transformers.OlmoConfig)) --
...
elements depending on the configuration ([OlmoConfig](/docs/transformers/v5.14.0/en/model_doc/olmo#transformers.OlmoConfig)) and inputs.
The [OlmoModel](/docs/transformers/v5.14.0/en/model_doc/olmo#transformers.OlmoModel) forward method, overrides the `__call__` special method.
...
- **config** ([OlmoForCausalLM](/docs/transformers/v5.14.0/en/model_doc/olmo#transformers.OlmoForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([OlmoConfig](/docs/transformers/v5.14.0/en/model_doc/olmo#transformers.OlmoConfig)) and inputs.
The [OlmoForCausalLM](/docs/transformers/v5.14.0/en/model_doc/olmo#transformers.OlmoForCausalLM) forward method, overrides the `__call__` special method.
