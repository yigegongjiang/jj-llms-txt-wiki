...
- **config** ([GlmConfig](/docs/transformers/v5.14.0/en/model_doc/glm#transformers.GlmConfig)) --
...
elements depending on the configuration ([GlmConfig](/docs/transformers/v5.14.0/en/model_doc/glm#transformers.GlmConfig)) and inputs.
The [GlmModel](/docs/transformers/v5.14.0/en/model_doc/glm#transformers.GlmModel) forward method, overrides the `__call__` special method.
...
- **config** ([GlmForCausalLM](/docs/transformers/v5.14.0/en/model_doc/glm#transformers.GlmForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GlmConfig](/docs/transformers/v5.14.0/en/model_doc/glm#transformers.GlmConfig)) and inputs.
The [GlmForCausalLM](/docs/transformers/v5.14.0/en/model_doc/glm#transformers.GlmForCausalLM) forward method, overrides the `__call__` special method.
