...
- **config** ([BitNetConfig](/docs/transformers/v5.14.0/en/model_doc/bitnet#transformers.BitNetConfig)) --
...
elements depending on the configuration ([BitNetConfig](/docs/transformers/v5.14.0/en/model_doc/bitnet#transformers.BitNetConfig)) and inputs.
The [BitNetModel](/docs/transformers/v5.14.0/en/model_doc/bitnet#transformers.BitNetModel) forward method, overrides the `__call__` special method.
...
- **config** ([BitNetForCausalLM](/docs/transformers/v5.14.0/en/model_doc/bitnet#transformers.BitNetForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BitNetConfig](/docs/transformers/v5.14.0/en/model_doc/bitnet#transformers.BitNetConfig)) and inputs.
The [BitNetForCausalLM](/docs/transformers/v5.14.0/en/model_doc/bitnet#transformers.BitNetForCausalLM) forward method, overrides the `__call__` special method.
