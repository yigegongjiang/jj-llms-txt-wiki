...
- **vocab_size** (`int`, *optional*, defaults to `262272`) --
...
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `106`) --
...
- **config** ([ZayaConfig](/docs/transformers/v5.14.0/en/model_doc/zaya#transformers.ZayaConfig)) --
...
elements depending on the configuration ([ZayaConfig](/docs/transformers/v5.14.0/en/model_doc/zaya#transformers.ZayaConfig)) and inputs.
The [ZayaModel](/docs/transformers/v5.14.0/en/model_doc/zaya#transformers.ZayaModel) forward method, overrides the `__call__` special method.
...
- **config** ([ZayaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/zaya#transformers.ZayaForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ZayaConfig](/docs/transformers/v5.14.0/en/model_doc/zaya#transformers.ZayaConfig)) and inputs.
The [ZayaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/zaya#transformers.ZayaForCausalLM) forward method, overrides the `__call__` special method.
