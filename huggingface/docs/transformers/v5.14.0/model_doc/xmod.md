...
- **config** ([XmodModel](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodModel)) --
...
elements depending on the configuration ([XmodConfig](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodConfig)) and inputs.
The [XmodModel](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodModel) forward method, overrides the `__call__` special method.
...
- **config** ([XmodForCausalLM](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XmodConfig](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodConfig)) and inputs.
The [XmodForCausalLM](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([XmodForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XmodConfig](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodConfig)) and inputs.
The [XmodForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([XmodForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XmodConfig](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodConfig)) and inputs.
The [XmodForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([XmodForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XmodConfig](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodConfig)) and inputs.
The [XmodForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([XmodForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XmodConfig](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodConfig)) and inputs.
The [XmodForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([XmodForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XmodConfig](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodConfig)) and inputs.
The [XmodForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/xmod#transformers.XmodForQuestionAnswering) forward method, overrides the `__call__` special method.
