...
The [Speech2TextFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor) class is responsible for extracting the log-mel filter-bank
features. The [Speech2TextProcessor](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextProcessor) wraps [Speech2TextFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor) and
[Speech2TextTokenizer](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer) into a single instance to both extract the input features and decode the
predicted token ids.
...
'"}, {"name": "eos_token", "val": " = ''"}, {"name": "pad_token", "val": " = ''"}, {"name": "unk_token", "val": " = ''"}, {"name": "do_upper_case", "val": " = False"}, {"name": "do_lower_case", "val": " = False"}, {"name": "tgt_lang", "val": " = None"}, {"name": "lang_codes", "val": " = None"}, {"name": "additional_special_tokens", "val": " = None"}, {"name": "sp_model_kwargs", "val": ": dict[str, typing.Any] | None = None"}, {"name": "**kwargs", "val": ""}]}>
- **vocab_file** (`str`) --
...
This feature extractor inherits from [Speech2TextFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor) which contains most of the main methods. Users
...
[~Speech2TextFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor) and [~Speech2TextTokenizer](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer) for more information.
...
- **config** ([Speech2TextConfig](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextConfig)) --
...
- **input_features** (`torch.LongTensor` of shape `(batch_size, sequence_length, feature_dim)`, *optional*) --
  ...
  [Speech2TextFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor) for processing audios).
...
- **decoder_input_ids** (`torch.LongTensor` of shape `(batch_size, target_sequence_length)`, *optional*) --
  ...
  Indices can be obtained using `SpeechToTextTokenizer`. See [PreTrainedTokenizer.encode()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and
...
elements depending on the configuration ([Speech2TextConfig](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextConfig)) and inputs.
The [Speech2TextModel](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Speech2TextConfig](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextConfig)) and inputs.
The [Speech2TextForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/speech_to_text#transformers.Speech2TextForConditionalGeneration) forward method, overrides the `__call__` special method.
