...
- The tokenizer used for this model is identical to the [LlamaTokenizer](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaTokenizer), with the exception of additional tokens.
...
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `32000`) --
...
- **config** ([Phi3Config](/docs/transformers/v5.14.0/en/model_doc/phi3#transformers.Phi3Config)) --
...
elements depending on the configuration ([Phi3Config](/docs/transformers/v5.14.0/en/model_doc/phi3#transformers.Phi3Config)) and inputs.
The [Phi3Model](/docs/transformers/v5.14.0/en/model_doc/phi3#transformers.Phi3Model) forward method, overrides the `__call__` special method.
...
- **config** ([Phi3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/phi3#transformers.Phi3ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Phi3Config](/docs/transformers/v5.14.0/en/model_doc/phi3#transformers.Phi3Config)) and inputs.
The [Phi3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/phi3#transformers.Phi3ForCausalLM) forward method, overrides the `__call__` special method.
