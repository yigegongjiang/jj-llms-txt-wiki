...
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `100257`) --
...
- **config** ([OlmoHybridForCausalLM](/docs/transformers/v5.14.0/en/model_doc/olmo_hybrid#transformers.OlmoHybridForCausalLM)) --
...
elements depending on the configuration ([OlmoHybridConfig](/docs/transformers/v5.14.0/en/model_doc/olmo_hybrid#transformers.OlmoHybridConfig)) and inputs.
The [OlmoHybridForCausalLM](/docs/transformers/v5.14.0/en/model_doc/olmo_hybrid#transformers.OlmoHybridForCausalLM) forward method, overrides the `__call__` special method.
