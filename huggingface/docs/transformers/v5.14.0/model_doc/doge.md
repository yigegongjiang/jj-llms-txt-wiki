...
- **config** ([DogeConfig](/docs/transformers/v5.14.0/en/model_doc/doge#transformers.DogeConfig)) --
...
elements depending on the configuration ([DogeConfig](/docs/transformers/v5.14.0/en/model_doc/doge#transformers.DogeConfig)) and inputs.
The [DogeModel](/docs/transformers/v5.14.0/en/model_doc/doge#transformers.DogeModel) forward method, overrides the `__call__` special method.
...
- **config** ([DogeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/doge#transformers.DogeForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **output_router_logits** (`bool`, *optional*) --
  ...
  should not be returned during inference.`MoeCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `MoeCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DogeConfig](/docs/transformers/v5.14.0/en/model_doc/doge#transformers.DogeConfig)) and inputs.
The [DogeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/doge#transformers.DogeForCausalLM) forward method, overrides the `__call__` special method.
