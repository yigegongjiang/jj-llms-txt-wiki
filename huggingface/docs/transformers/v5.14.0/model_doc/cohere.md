...
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `255001`) --
...
'"}, {"name": "bos_token", "val": ": str = ''"}, {"name": "eos_token", "val": ": str = '<|END_OF_TURN_TOKEN|>'"}, {"name": "pad_token", "val": ": str = ''"}, {"name": "cls_token", "val": ": str = ''"}, {"name": "sep_token", "val": ": str = ''"}, {"name": "mask_token", "val": ": str = ''"}, {"name": "use_default_system_prompt", "val": ": bool = False"}, {"name": "add_prefix_space", "val": ": bool = False"}, {"name": "**kwargs", "val": ""}]}>
...
- ****tokenizer_kwargs** -- Additional kwargs to pass to the tokenizer.`str`A rendered prompt string.
or if tokenize=True:
...
- **config** ([CohereConfig](/docs/transformers/v5.14.0/en/model_doc/cohere#transformers.CohereConfig)) --
...
elements depending on the configuration ([CohereConfig](/docs/transformers/v5.14.0/en/model_doc/cohere#transformers.CohereConfig)) and inputs.
The [CohereModel](/docs/transformers/v5.14.0/en/model_doc/cohere#transformers.CohereModel) forward method, overrides the `__call__` special method.
...
- **config** ([CohereForCausalLM](/docs/transformers/v5.14.0/en/model_doc/cohere#transformers.CohereForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([CohereConfig](/docs/transformers/v5.14.0/en/model_doc/cohere#transformers.CohereConfig)) and inputs.
The [CohereForCausalLM](/docs/transformers/v5.14.0/en/model_doc/cohere#transformers.CohereForCausalLM) forward method, overrides the `__call__` special method.
