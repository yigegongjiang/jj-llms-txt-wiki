...
- **config** ([Ernie4_5Config](/docs/transformers/v5.14.0/en/model_doc/ernie4_5#transformers.Ernie4_5Config)) --
...
elements depending on the configuration ([Ernie4_5Config](/docs/transformers/v5.14.0/en/model_doc/ernie4_5#transformers.Ernie4_5Config)) and inputs.
The [Ernie4_5Model](/docs/transformers/v5.14.0/en/model_doc/ernie4_5#transformers.Ernie4_5Model) forward method, overrides the `__call__` special method.
...
- **config** ([Ernie4_5ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/ernie4_5#transformers.Ernie4_5ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Ernie4_5Config](/docs/transformers/v5.14.0/en/model_doc/ernie4_5#transformers.Ernie4_5Config)) and inputs.
The [Ernie4_5ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/ernie4_5#transformers.Ernie4_5ForCausalLM) forward method, overrides the `__call__` special method.
