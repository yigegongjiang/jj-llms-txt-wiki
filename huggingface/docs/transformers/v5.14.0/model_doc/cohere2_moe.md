...
- **config** ([Cohere2MoeConfig](/docs/transformers/v5.14.0/en/model_doc/cohere2_moe#transformers.Cohere2MoeConfig)) --
...
elements depending on the configuration ([Cohere2MoeConfig](/docs/transformers/v5.14.0/en/model_doc/cohere2_moe#transformers.Cohere2MoeConfig)) and inputs.
The [Cohere2MoeModel](/docs/transformers/v5.14.0/en/model_doc/cohere2_moe#transformers.Cohere2MoeModel) forward method, overrides the `__call__` special method.
...
- **config** ([Cohere2MoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/cohere2_moe#transformers.Cohere2MoeForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Cohere2MoeConfig](/docs/transformers/v5.14.0/en/model_doc/cohere2_moe#transformers.Cohere2MoeConfig)) and inputs.
The [Cohere2MoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/cohere2_moe#transformers.Cohere2MoeForCausalLM) forward method, overrides the `__call__` special method.
