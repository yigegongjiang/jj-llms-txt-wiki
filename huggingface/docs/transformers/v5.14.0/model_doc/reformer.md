...
For training, the [ReformerModelWithLMHead](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerModelWithLMHead) should be used as follows:
...
- **hidden_act** (`str`, *optional*, defaults to `relu`) --
  ...
  `"relu"`, `"silu"`, etc.
- **hidden_dropout_prob** (`Union[float, int]`, *optional*, defaults to `0.05`) --
...
'"}, {"name": "unk_token", "val": ": str = ''"}, {"name": "_spm_precompiled_charsmap", "val": ": str | None = None"}, {"name": "additional_special_tokens", "val": ": list | None = None"}, {"name": "**kwargs", "val": ""}]}>
- **vocab_file** (`str`) --
...
- **config** ([ReformerModel](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerModel)) --
...
- **num_hashes** (`int`, *optional*) --
  ...
  For more information, see `num_hashes` in [ReformerConfig](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerConfig).
...
- **return_dict** (`bool`, *optional*) --
  Whether or not to return a [ModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput) instead of a plain tuple.`ReformerModelOutput` or `tuple(torch.FloatTensor)`A `ReformerModelOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ReformerConfig](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerConfig)) and inputs.
The [ReformerModel](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerModel) forward method, overrides the `__call__` special method.
...
- **config** ([ReformerModelWithLMHead](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerModelWithLMHead)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
)>]] | None = None"}, {"name": "use_cache", "val": ": bool | None = None"}, {"name": "output_hidden_states", "val": ": bool | None = None"}, {"name": "output_attentions", "val": ": bool | None = None"}, {"name": "return_dict", "val": ": bool | None = None"}, {"name": "labels", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "logits_to_keep", "val": ": typing.Union[int, torch.Tensor] = 0"}, {"name": "**kwargs", "val": ""}]}>
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. During training the input_ids sequence_length has to be
  a multiple of the relevant model's chunk lengths (lsh's, local's or both). During evaluation, the indices
  are automatically padded to be a multiple of the chunk length.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ReformerConfig](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerConfig)) and inputs.
The [ReformerModelWithLMHead](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerModelWithLMHead) forward method, overrides the `__call__` special method.
...
- **config** ([ReformerForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ReformerConfig](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerConfig)) and inputs.
The [ReformerForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([ReformerForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ReformerConfig](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerConfig)) and inputs.
The [ReformerForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([ReformerForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ReformerConfig](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerConfig)) and inputs.
The [ReformerForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/reformer#transformers.ReformerForQuestionAnswering) forward method, overrides the `__call__` special method.
