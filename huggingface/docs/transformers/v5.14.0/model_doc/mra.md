...
- **config** ([MraModel](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraModel)) --
...
elements depending on the configuration ([MraConfig](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraConfig)) and inputs.
The [MraModel](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraModel) forward method, overrides the `__call__` special method.
...
- **config** ([MraForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MraConfig](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraConfig)) and inputs.
The [MraForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([MraForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MraConfig](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraConfig)) and inputs.
The [MraForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([MraForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MraConfig](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraConfig)) and inputs.
The [MraForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([MraForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MraConfig](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraConfig)) and inputs.
The [MraForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([MraForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MraConfig](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraConfig)) and inputs.
The [MraForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/mra#transformers.MraForQuestionAnswering) forward method, overrides the `__call__` special method.
