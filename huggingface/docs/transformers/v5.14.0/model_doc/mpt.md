...
- **emb_pdrop** (`Union[float, int]`, *optional*, defaults to `0.0`) --
...
- **config** ([MptConfig](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptConfig)) --
...
elements depending on the configuration ([MptConfig](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptConfig)) and inputs.
The [MptModel](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MptConfig](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptConfig)) and inputs.
The [MptForCausalLM](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptForCausalLM) forward method, overrides the `__call__` special method.
...
[MptForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MptConfig](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptConfig)) and inputs.
The [MptForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptForSequenceClassification) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MptConfig](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptConfig)) and inputs.
The [MptForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([MptForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MptConfig](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptConfig)) and inputs.
The [MptForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/mpt#transformers.MptForQuestionAnswering) forward method, overrides the `__call__` special method.
