...
- **config** ([VoxtralEncoderConfig](/docs/transformers/v5.14.0/en/model_doc/voxtral#transformers.VoxtralEncoderConfig)) --
...
- **input_features** (`torch.LongTensor` of shape `(batch_size, feature_size, sequence_length)`) --
  ...
  `input_features`, the [AutoFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoFeatureExtractor) should be used for extracting the mel features, padding
  and conversion into a tensor of type `torch.FloatTensor`. See [__call__()](/docs/transformers/v5.14.0/en/model_doc/whisper#transformers.WhisperFeatureExtractor.__call__)
...
- **config** ([VoxtralModel](/docs/transformers/v5.14.0/en/model_doc/voxtral#transformers.VoxtralModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **use_cache** (`bool`, *optional*) --
  ...
  `past_key_values`).`VoxtralModelOutputWithPast` or `tuple(torch.FloatTensor)`A `VoxtralModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([VoxtralConfig](/docs/transformers/v5.14.0/en/model_doc/voxtral#transformers.VoxtralConfig)) and inputs.
The [VoxtralModel](/docs/transformers/v5.14.0/en/model_doc/voxtral#transformers.VoxtralModel) forward method, overrides the `__call__` special method.
...
- **config** ([VoxtralForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/voxtral#transformers.VoxtralForConditionalGeneration)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([VoxtralConfig](/docs/transformers/v5.14.0/en/model_doc/voxtral#transformers.VoxtralConfig)) and inputs.
The [VoxtralForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/voxtral#transformers.VoxtralForConditionalGeneration) forward method, overrides the `__call__` special method.
