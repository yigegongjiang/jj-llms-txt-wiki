...
- **config** ([VitDetConfig](/docs/transformers/v5.14.0/en/model_doc/vitdet#transformers.VitDetConfig)) --
...
elements depending on the configuration ([VitDetConfig](/docs/transformers/v5.14.0/en/model_doc/vitdet#transformers.VitDetConfig)) and inputs.
The [VitDetModel](/docs/transformers/v5.14.0/en/model_doc/vitdet#transformers.VitDetModel) forward method, overrides the `__call__` special method.
