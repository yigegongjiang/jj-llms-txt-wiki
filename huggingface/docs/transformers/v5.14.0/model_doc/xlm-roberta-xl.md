...
- **config** ([XLMRobertaXLModel](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel)) --
...
elements depending on the configuration ([XLMRobertaXLConfig](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig)) and inputs.
The [XLMRobertaXLModel](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel) forward method, overrides the `__call__` special method.
...
- **config** ([XLMRobertaXLForCausalLM](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XLMRobertaXLConfig](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig)) and inputs.
The [XLMRobertaXLForCausalLM](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([XLMRobertaXLForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XLMRobertaXLConfig](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig)) and inputs.
The [XLMRobertaXLForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([XLMRobertaXLForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XLMRobertaXLConfig](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig)) and inputs.
The [XLMRobertaXLForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([XLMRobertaXLForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XLMRobertaXLConfig](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig)) and inputs.
The [XLMRobertaXLForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([XLMRobertaXLForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XLMRobertaXLConfig](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig)) and inputs.
The [XLMRobertaXLForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([XLMRobertaXLForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XLMRobertaXLConfig](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig)) and inputs.
The [XLMRobertaXLForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForQuestionAnswering) forward method, overrides the `__call__` special method.
