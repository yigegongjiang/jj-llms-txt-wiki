...
Note that [BlenderbotSmallModel](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallModel) and
[BlenderbotSmallForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallForConditionalGeneration) are only used in combination with the checkpoint
[facebook/blenderbot-90M](https://huggingface.co/facebook/blenderbot-90M). Larger Blenderbot checkpoints should
instead be used with [BlenderbotModel](/docs/transformers/v5.14.0/en/model_doc/blenderbot#transformers.BlenderbotModel) and
[BlenderbotForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/blenderbot#transformers.BlenderbotForConditionalGeneration)
...
- **config** ([BlenderbotSmallConfig](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig)) --
...
elements depending on the configuration ([BlenderbotSmallConfig](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig)) and inputs.
The [BlenderbotSmallModel](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BlenderbotSmallConfig](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig)) and inputs.
The [BlenderbotSmallForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallForConditionalGeneration) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BlenderbotSmallConfig](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig)) and inputs.
The [BlenderbotSmallForCausalLM](/docs/transformers/v5.14.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallForCausalLM) forward method, overrides the `__call__` special method.
