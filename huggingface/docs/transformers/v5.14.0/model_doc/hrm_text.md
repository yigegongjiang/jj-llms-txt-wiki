...
> not follow the `flash_attention_*` naming convention — is rejected by [HrmTextModel](/docs/transformers/v5.14.0/en/model_doc/hrm_text#transformers.HrmTextModel)
...
See [HrmTextModel.forward()](/docs/transformers/v5.14.0/en/model_doc/hrm_text#transformers.HrmTextModel.forward) for the accepted shape.

## HrmTextConfig[[transformers.HrmTextConfig]]

- **vocab_size** (`int`, *optional*, defaults to `151808`) --
...
- **config** ([HrmTextConfig](/docs/transformers/v5.14.0/en/model_doc/hrm_text#transformers.HrmTextConfig)) --
...
elements depending on the configuration ([HrmTextConfig](/docs/transformers/v5.14.0/en/model_doc/hrm_text#transformers.HrmTextConfig)) and inputs.
The [HrmTextModel](/docs/transformers/v5.14.0/en/model_doc/hrm_text#transformers.HrmTextModel) forward method, overrides the `__call__` special method.
...
- **config** ([HrmTextForCausalLM](/docs/transformers/v5.14.0/en/model_doc/hrm_text#transformers.HrmTextForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HrmTextConfig](/docs/transformers/v5.14.0/en/model_doc/hrm_text#transformers.HrmTextConfig)) and inputs.
The [HrmTextForCausalLM](/docs/transformers/v5.14.0/en/model_doc/hrm_text#transformers.HrmTextForCausalLM) forward method, overrides the `__call__` special method.
