...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline), [`AutoModel`, and from the command line.
...
- **config** ([GraniteConfig](/docs/transformers/v5.14.0/en/model_doc/granite#transformers.GraniteConfig)) --
...
elements depending on the configuration ([GraniteConfig](/docs/transformers/v5.14.0/en/model_doc/granite#transformers.GraniteConfig)) and inputs.
The [GraniteModel](/docs/transformers/v5.14.0/en/model_doc/granite#transformers.GraniteModel) forward method, overrides the `__call__` special method.
...
- **config** ([GraniteForCausalLM](/docs/transformers/v5.14.0/en/model_doc/granite#transformers.GraniteForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GraniteConfig](/docs/transformers/v5.14.0/en/model_doc/granite#transformers.GraniteConfig)) and inputs.
The [GraniteForCausalLM](/docs/transformers/v5.14.0/en/model_doc/granite#transformers.GraniteForCausalLM) forward method, overrides the `__call__` special method.
