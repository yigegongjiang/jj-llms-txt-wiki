...
[SeamlessM4TModel](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel) can perform all the above tasks, but each task also has its own dedicated sub-model.
...
[SeamlessM4TModel](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel) can *seamlessly* generate text or speech with few or no changes. Let's target Russian voice translation:
...
Similarly, you can generate translated text from audio files or from text with the same model. You only have to pass `generate_speech=False` to [SeamlessM4TModel.generate()](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel.generate).
...
[SeamlessM4TModel](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel) is transformers top level model to generate speech and text, but you can also use dedicated models that perform the task without additional components, thus reducing the memory footprint.
...
Feel free to try out [SeamlessM4TForSpeechToText](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForSpeechToText) and [SeamlessM4TForTextToSpeech](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForTextToSpeech) as well.
...
Use `return_intermediate_token_ids=True` with [SeamlessM4TModel](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel) to return both speech and text !
...
- **config** ([SeamlessM4TModel](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel)) --
...
- **kwargs** (*optional*) --
  ...
  other.`Union[SeamlessM4TGenerationOutput, tuple[Tensor], ModelOutput]`- If `generate_speech` and `return_intermediate_token_ids`, returns `SeamlessM4TGenerationOutput`.
...
- **config** ([SeamlessM4TConfig](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **kwargs** (*optional*) --
  ...
  This means you can, for example, specify a generation strategy for one generation but not for the
  other.`Union[SeamlessM4TGenerationOutput, tuple[Tensor]]`- If `return_intermediate_token_ids`, returns `SeamlessM4TGenerationOutput`.
...
- **config** ([SeamlessM4TForSpeechToSpeech](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForSpeechToSpeech)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
elements depending on the configuration ([SeamlessM4TConfig](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TConfig)) and inputs.
The [SeamlessM4TForTextToText](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForTextToText) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SeamlessM4TConfig](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TConfig)) and inputs.
The [SeamlessM4TForSpeechToText](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForSpeechToText) forward method, overrides the `__call__` special method.
...
- **t2u_vocab_size** (`int`, *optional*, defaults to 10082) --
  ...
  represented by the `inputs_ids` passed when calling the Text-To-Units sub-model of [~SeamlessM4TModel](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel),
  [~SeamlessM4TForSpeechToSpeech](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForSpeechToSpeech) or [~SeamlessM4TForTextToSpeech](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForTextToSpeech).
...
- **unit_hifi_gan_vocab_size** (`int`, *optional*, defaults to 10000) --
  ...
  represented by the `inputs_ids` passed when calling the vocoder of [~SeamlessM4TModel](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel),
  [~SeamlessM4TForSpeechToSpeech](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForSpeechToSpeech) or [~SeamlessM4TForTextToSpeech](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForTextToSpeech).
...
'"}, {"name": "eos_token", "val": " = ''"}, {"name": "sep_token", "val": " = ''"}, {"name": "cls_token", "val": " = ''"}, {"name": "unk_token", "val": " = ''"}, {"name": "pad_token", "val": " = ''"}, {"name": "src_lang", "val": " = 'eng'"}, {"name": "tgt_lang", "val": " = 'fra'"}, {"name": "additional_special_tokens", "val": " = None"}, {"name": "keep_accents", "val": " = None"}, {"name": "vocab_file", "val": " = None"}, {"name": "**kwargs", "val": ""}]}>
...
- **tgt_lang** (`str`, *optional*) --
  ...
  during initialization or when calling this tokenizer) will be used.
- **kwargs** (*optional*) --
  Remaining dictionary of keyword arguments that will be passed to [TokenizersBackend.__call__()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__).
...
[~SeamlessM4TFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TFeatureExtractor) and [~SeamlessM4TTokenizer](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TTokenizer) for more information.
...
- **config** ([SeamlessM4TCodeHifiGan](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TCodeHifiGan)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
)>"}, {"name": "lang_id", "val": ": )>"}, {"name": "**kwargs", "val": ""}]}>
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.

  Indices can be obtained using [SeamlessM4TTextToUnitForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TTextToUnitForConditionalGeneration). [What are input
...
- **spectrogram** (`torch.FloatTensor`) --
  ...
  is the sum of `config.unit_embed_dim`, `config.lang_embed_dim` and `config.spkr_embed_dim`.`torch.FloatTensor`Tensor containing the speech waveform. If the input spectrogram is batched, will be of
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SeamlessM4TConfig](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TConfig)) and inputs.
The [SeamlessM4TTextToUnitForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TTextToUnitForConditionalGeneration) forward method, overrides the `__call__` special method.
