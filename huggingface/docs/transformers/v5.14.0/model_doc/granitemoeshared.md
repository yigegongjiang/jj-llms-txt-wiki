...
- **config** ([GraniteMoeSharedConfig](/docs/transformers/v5.14.0/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedConfig)) --
...
elements depending on the configuration ([GraniteMoeSharedConfig](/docs/transformers/v5.14.0/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedConfig)) and inputs.
The [GraniteMoeSharedModel](/docs/transformers/v5.14.0/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedModel) forward method, overrides the `__call__` special method.
...
The [GraniteMoeSharedForCausalLM](/docs/transformers/v5.14.0/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedForCausalLM) forward method, overrides the `__call__` special method.
