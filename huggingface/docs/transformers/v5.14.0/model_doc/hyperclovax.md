...
- **logits_scaling** (`float`, *optional*, defaults to `1.0`) --
  ...
  [GraniteConfig](/docs/transformers/v5.14.0/en/model_doc/granite#transformers.GraniteConfig), this is a multiplier, not a divisor.
...
- **config** ([HyperCLOVAXConfig](/docs/transformers/v5.14.0/en/model_doc/hyperclovax#transformers.HyperCLOVAXConfig)) --
...
elements depending on the configuration ([HyperCLOVAXConfig](/docs/transformers/v5.14.0/en/model_doc/hyperclovax#transformers.HyperCLOVAXConfig)) and inputs.
The [HyperCLOVAXModel](/docs/transformers/v5.14.0/en/model_doc/hyperclovax#transformers.HyperCLOVAXModel) forward method, overrides the `__call__` special method.
...
- **config** ([HyperCLOVAXForCausalLM](/docs/transformers/v5.14.0/en/model_doc/hyperclovax#transformers.HyperCLOVAXForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HyperCLOVAXConfig](/docs/transformers/v5.14.0/en/model_doc/hyperclovax#transformers.HyperCLOVAXConfig)) and inputs.
The [HyperCLOVAXForCausalLM](/docs/transformers/v5.14.0/en/model_doc/hyperclovax#transformers.HyperCLOVAXForCausalLM) forward method, overrides the `__call__` special method.
