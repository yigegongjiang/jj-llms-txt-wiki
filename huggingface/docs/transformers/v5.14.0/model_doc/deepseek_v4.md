...
- **rope_theta** (`Union[float, int]`, *optional*, defaults to `10000.0`) --
...
- **compress_rope_theta** (`Union[float, int]`, *optional*, defaults to `160000.0`) --
...
- **config** ([DeepseekV4Config](/docs/transformers/v5.14.0/en/model_doc/deepseek_v4#transformers.DeepseekV4Config)) --
...
elements depending on the configuration ([DeepseekV4Config](/docs/transformers/v5.14.0/en/model_doc/deepseek_v4#transformers.DeepseekV4Config)) and inputs.
The [DeepseekV4Model](/docs/transformers/v5.14.0/en/model_doc/deepseek_v4#transformers.DeepseekV4Model) forward method, overrides the `__call__` special method.
...
- **config** ([DeepseekV4ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/deepseek_v4#transformers.DeepseekV4ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DeepseekV4Config](/docs/transformers/v5.14.0/en/model_doc/deepseek_v4#transformers.DeepseekV4Config)) and inputs.
The [DeepseekV4ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/deepseek_v4#transformers.DeepseekV4ForCausalLM) forward method, overrides the `__call__` special method.
