...
- **type_vocab_size** (`int`, *optional*, defaults to 2) --
  The vocabulary size of the `token_type_ids` passed when calling [IBertModel](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertModel)
...
- **config** ([IBertModel](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertModel)) --
...
elements depending on the configuration ([IBertConfig](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertConfig)) and inputs.
The [IBertModel](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertModel) forward method, overrides the `__call__` special method.
...
- **config** ([IBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([IBertConfig](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertConfig)) and inputs.
The [IBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([IBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([IBertConfig](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertConfig)) and inputs.
The [IBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([IBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([IBertConfig](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertConfig)) and inputs.
The [IBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([IBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([IBertConfig](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertConfig)) and inputs.
The [IBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([IBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([IBertConfig](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertConfig)) and inputs.
The [IBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/ibert#transformers.IBertForQuestionAnswering) forward method, overrides the `__call__` special method.
