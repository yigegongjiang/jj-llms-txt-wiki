...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoModel) class.
...
This is the configuration class to store the configuration of a OlmoeModel. It is used to instantiate a Olmoe
...
- **config** ([OlmoeConfig](/docs/transformers/v5.14.0/en/model_doc/olmoe#transformers.OlmoeConfig)) --
...
elements depending on the configuration ([OlmoeConfig](/docs/transformers/v5.14.0/en/model_doc/olmoe#transformers.OlmoeConfig)) and inputs.
The [OlmoeModel](/docs/transformers/v5.14.0/en/model_doc/olmoe#transformers.OlmoeModel) forward method, overrides the `__call__` special method.
...
- **config** ([OlmoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/olmoe#transformers.OlmoeForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([OlmoeConfig](/docs/transformers/v5.14.0/en/model_doc/olmoe#transformers.OlmoeConfig)) and inputs.
The [OlmoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/olmoe#transformers.OlmoeForCausalLM) forward method, overrides the `__call__` special method.
