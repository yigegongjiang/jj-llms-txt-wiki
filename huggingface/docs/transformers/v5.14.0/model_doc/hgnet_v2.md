...
elements depending on the configuration ([HGNetV2Config](/docs/transformers/v5.14.0/en/model_doc/hgnet_v2#transformers.HGNetV2Config)) and inputs.
The [HGNetV2Backbone](/docs/transformers/v5.14.0/en/model_doc/hgnet_v2#transformers.HGNetV2Backbone) forward method, overrides the `__call__` special method.
...
- **config** ([HGNetV2Config](/docs/transformers/v5.14.0/en/model_doc/hgnet_v2#transformers.HGNetV2Config)) --
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HGNetV2Config](/docs/transformers/v5.14.0/en/model_doc/hgnet_v2#transformers.HGNetV2Config)) and inputs.
The [HGNetV2ForImageClassification](/docs/transformers/v5.14.0/en/model_doc/hgnet_v2#transformers.HGNetV2ForImageClassification) forward method, overrides the `__call__` special method.
