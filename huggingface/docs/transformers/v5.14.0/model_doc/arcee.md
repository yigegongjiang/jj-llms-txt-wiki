...
The example below demonstrates how to generate text with Arcee using [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoModel).
...
- **config** ([ArceeConfig](/docs/transformers/v5.14.0/en/model_doc/arcee#transformers.ArceeConfig)) --
...
elements depending on the configuration ([ArceeConfig](/docs/transformers/v5.14.0/en/model_doc/arcee#transformers.ArceeConfig)) and inputs.
The [ArceeModel](/docs/transformers/v5.14.0/en/model_doc/arcee#transformers.ArceeModel) forward method, overrides the `__call__` special method.
...
- **config** ([ArceeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/arcee#transformers.ArceeForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ArceeConfig](/docs/transformers/v5.14.0/en/model_doc/arcee#transformers.ArceeConfig)) and inputs.
The [ArceeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/arcee#transformers.ArceeForCausalLM) forward method, overrides the `__call__` special method.
