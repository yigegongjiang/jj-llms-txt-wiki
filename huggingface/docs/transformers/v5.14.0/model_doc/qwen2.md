...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoModel), and from the command line using the instruction-tuned models.
...
This is the configuration class to store the configuration of a Qwen2Model. It is used to instantiate a Qwen2
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [Qwen/Qwen2-7B](https://huggingface.co/Qwen/Qwen2-7B)
...
## Qwen2TokenizerFast[[transformers.Qwen2Tokenizer]]

'"}, {"name": "bos_token", "val": " = None"}, {"name": "eos_token", "val": ": str = '<|endoftext|>'"}, {"name": "pad_token", "val": ": str = '<|endoftext|>'"}, {"name": "add_prefix_space", "val": " = None"}, {"name": "**kwargs", "val": ""}]}>

## Qwen2RMSNorm[[transformers.Qwen2RMSNorm]]

)>"}]}>

## Qwen2Model[[transformers.Qwen2Model]]

- **config** ([Qwen2Config](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2Config)) --
...
elements depending on the configuration ([Qwen2Config](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2Config)) and inputs.
The [Qwen2Model](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2Model) forward method, overrides the `__call__` special method.
...
- **config** ([Qwen2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Qwen2Config](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2Config)) and inputs.
The [Qwen2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2ForCausalLM) forward method, overrides the `__call__` special method.
...
## Qwen2ForSequenceClassification[[transformers.Qwen2ForSequenceClassification]]
...
## Qwen2ForTokenClassification[[transformers.Qwen2ForTokenClassification]]
...
## Qwen2ForQuestionAnswering[[transformers.Qwen2ForQuestionAnswering]]
