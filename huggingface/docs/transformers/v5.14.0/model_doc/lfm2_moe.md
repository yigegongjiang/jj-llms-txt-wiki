...
- **config** ([Lfm2MoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeForCausalLM)) --
...
elements depending on the configuration ([Lfm2MoeConfig](/docs/transformers/v5.14.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeConfig)) and inputs.
The [Lfm2MoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([Lfm2MoeConfig](/docs/transformers/v5.14.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Lfm2MoeConfig](/docs/transformers/v5.14.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeConfig)) and inputs.
The [Lfm2MoeModel](/docs/transformers/v5.14.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeModel) forward method, overrides the `__call__` special method.
