...
- **config** ([JetMoeConfig](/docs/transformers/v5.14.0/en/model_doc/jetmoe#transformers.JetMoeConfig)) --
...
elements depending on the configuration ([JetMoeConfig](/docs/transformers/v5.14.0/en/model_doc/jetmoe#transformers.JetMoeConfig)) and inputs.
The [JetMoeModel](/docs/transformers/v5.14.0/en/model_doc/jetmoe#transformers.JetMoeModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([JetMoeConfig](/docs/transformers/v5.14.0/en/model_doc/jetmoe#transformers.JetMoeConfig)) and inputs.
The [JetMoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/jetmoe#transformers.JetMoeForCausalLM) forward method, overrides the `__call__` special method.
