...
This is the configuration class to store the configuration of a DeepseekVLModel. It is used to instantiate a Deepseek Vl
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [deepseek-community/deepseek-vl-1.3b-chat](https://huggingface.co/deepseek-community/deepseek-vl-1.3b-chat)
...
[DeepseekVLProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLProcessor) offers all the functionalities of [DeepseekVLImageProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor) and [TokenizersBackend](/docs/transformers/v5.14.0/en/main_classes/tokenizer#transformers.TokenizersBackend). See the
[~DeepseekVLImageProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.14.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
Constructs a DeepseekVLImageProcessor image processor.
...
## DeepseekVLImageProcessorPil[[transformers.DeepseekVLImageProcessorPil]]
...
- **config** ([DeepseekVLModel](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLModel)) --
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [DeepseekVLImageProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor). See `DeepseekVLImageProcessor.__call__()` for details ([DeepseekVLProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLProcessor) uses
  [DeepseekVLImageProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor) for processing images).
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  This is useful when using packed tensor format (single dimension for batch and sequence length).`DeepseekVLBaseModelOutputWithPast` or `tuple(torch.FloatTensor)`A `DeepseekVLBaseModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DeepseekVLConfig](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLConfig)) and inputs.
The [DeepseekVLModel](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLModel) forward method, overrides the `__call__` special method.
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`) --
  The tensors corresponding to the input images. Pixel values can be obtained using
  [DeepseekVLImageProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor). See `DeepseekVLImageProcessor.__call__()` for details ([DeepseekVLProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLProcessor) uses
  [DeepseekVLImageProcessor](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor) for processing images).[BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or `tuple(torch.FloatTensor)`A [BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DeepseekVLConfig](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLConfig)) and inputs.
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  token can save memory, which becomes pretty significant for long sequences or large vocabulary size.
  If a `torch.Tensor`, must be 1D corresponding to the indices to keep in the sequence length dimension.
  This is useful when using packed tensor format (single dimension for batch and sequence length).`DeepseekVLCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `DeepseekVLCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DeepseekVLConfig](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLConfig)) and inputs.
The [DeepseekVLForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/deepseek_vl#transformers.DeepseekVLForConditionalGeneration) forward method, overrides the `__call__` special method.
