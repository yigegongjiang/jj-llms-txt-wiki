...
- **config** ([Gemma4UnifiedAssistantConfig](/docs/transformers/v5.14.0/en/model_doc/gemma4_unified_assistant#transformers.Gemma4UnifiedAssistantConfig)) --
...
The [Gemma4UnifiedAssistantForCausalLM](/docs/transformers/v5.14.0/en/model_doc/gemma4_unified_assistant#transformers.Gemma4UnifiedAssistantForCausalLM) forward method, overrides the `__call__` special method.
