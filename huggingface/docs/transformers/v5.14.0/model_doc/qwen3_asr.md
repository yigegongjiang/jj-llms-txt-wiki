...
- **pad_token_id** (*int*, *optional*, defaults to *151645*) --
  Token id used for padding in the vocabulary.
- **eos_token_id** (*Union[list[int], tuple[int, ...], int]*, *optional*, defaults to *(151643, 151645)*) --
...
- **max_position_embeddings** (*int*, *optional*, defaults to *13*) --
...
[~Qwen3ASRFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRFeatureExtractor) and [~Qwen2Tokenizer](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2Tokenizer) for more information.
...
- ****kwargs** --
  ...
  [*~Qwen3ASRProcessor.apply_chat_template*].[*BatchFeature*]Processor outputs ready to be passed to
...
- ****kwargs** --
  Additional keyword arguments forwarded to
  [*~Qwen3ASRProcessor.apply_chat_template*].*tuple[BatchFeature, list[list[str]]]*- `inputs`: A [*BatchFeature*] with `input_ids`, `attention_mask`,
...
- **timestamp_segment_time** (*float*, *optional*) --
  Milliseconds per timestamp class. If not provided, uses *self.timestamp_segment_time*.*list[list[dict]]*One list per sample.  Each inner list contains dicts
...
- **config** ([Qwen3ASREncoderConfig](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASREncoderConfig)) --
...
- **input_features** (`torch.Tensor` of shape `(batch_size, sequence_length, feature_dim)`) --
  ...
  [Qwen3ASRFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRFeatureExtractor). See [Qwen3ASRFeatureExtractor.__call__()](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRFeatureExtractor.__call__) for details ([Qwen3ASRProcessor](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRProcessor) uses
  [Qwen3ASRFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRFeatureExtractor) for processing audios).
- **input_features_mask** (`torch.LongTensor` of shape `(batch_size, padded_feature_length)`) --
  1 for valid mel frames and 0 for padding.[BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or `tuple(torch.FloatTensor)`A [BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Qwen3ASRConfig](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRConfig)) and inputs.
The [Qwen3ASREncoder](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASREncoder) forward method, overrides the `__call__` special method.
...
- **config** ([Qwen3ASRModel](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **use_cache** (`bool`, *optional*) --
  ...
  `past_key_values`).`Qwen3ASRModelOutputWithPast` or `tuple(torch.FloatTensor)`A `Qwen3ASRModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Qwen3ASRConfig](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRConfig)) and inputs.
The [Qwen3ASRModel](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRModel) forward method, overrides the `__call__` special method.
...
- **config** ([Qwen3ASRForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRForConditionalGeneration)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  This is useful when using packed tensor format (single dimension for batch and sequence length).`Qwen3ASRCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `Qwen3ASRCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Qwen3ASRConfig](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRConfig)) and inputs.
The [Qwen3ASRForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/qwen3_asr#transformers.Qwen3ASRForConditionalGeneration) forward method, overrides the `__call__` special method.
