...
This is the configuration class to store the configuration of a Gemma2Model. It is used to instantiate a Gemma2
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [google/gemma2-7b](https://huggingface.co/google/gemma2-7b)
...
- **config** ([Gemma2Config](/docs/transformers/v5.14.0/en/model_doc/gemma2#transformers.Gemma2Config)) --
...
elements depending on the configuration ([Gemma2Config](/docs/transformers/v5.14.0/en/model_doc/gemma2#transformers.Gemma2Config)) and inputs.
The [Gemma2Model](/docs/transformers/v5.14.0/en/model_doc/gemma2#transformers.Gemma2Model) forward method, overrides the `__call__` special method.
...
- **config** ([Gemma2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/gemma2#transformers.Gemma2ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Gemma2Config](/docs/transformers/v5.14.0/en/model_doc/gemma2#transformers.Gemma2Config)) and inputs.
The [Gemma2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/gemma2#transformers.Gemma2ForCausalLM) forward method, overrides the `__call__` special method.
