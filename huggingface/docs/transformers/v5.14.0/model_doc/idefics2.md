...
- **config** ([Idefics2Config](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2Config)) --
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [Idefics2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2ImageProcessor). See `Idefics2ImageProcessor.__call__()` for details ([Idefics2Processor](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2Processor) uses
  [Idefics2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2ImageProcessor) for processing images).
...
- **use_cache** (`bool`, *optional*) --
  ...
  `past_key_values`).`Idefics2BaseModelOutputWithPast` or `tuple(torch.FloatTensor)`A `Idefics2BaseModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Idefics2Config](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2Config)) and inputs.
...
- **config** ([Idefics2ForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2ForConditionalGeneration)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  This is useful when using packed tensor format (single dimension for batch and sequence length).`Idefics2CausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `Idefics2CausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Idefics2Config](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2Config)) and inputs.
The [Idefics2ForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **do_image_splitting** (`bool`, *kwargs*, *optional*, defaults to `self.do_image_splitting`) --
...
[~Idefics2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/idefics2#transformers.Idefics2ImageProcessor) and [~LlamaTokenizer](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaTokenizer) for more information.
