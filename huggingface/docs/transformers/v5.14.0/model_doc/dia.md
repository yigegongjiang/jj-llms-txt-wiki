...
- **encoder_config** (`Union[~models.dia.configuration_dia.DiaEncoderConfig, dict]`, *optional*) --
  The config object or dictionary of the encoder backbone.
- **decoder_config** (`Union[~models.dia.configuration_dia.DiaDecoderConfig, dict]`, *optional*) --
...
- **pad_token_id** (`int`, *optional*, defaults to `1025`) --
  Token id used for padding in the vocabulary.
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `1024`) --
  Token id used for end-of-stream in the vocabulary.
...
'"}, {"name": "unk_token", "val": ": str | None = ''"}, {"name": "max_length", "val": ": int | None = 1024"}, {"name": "offset", "val": ": int = 0"}, {"name": "**kwargs", "val": ""}]}>
...
- **return_tensors** (`str` or [TensorType](/docs/transformers/v5.14.0/en/internal/file_utils#transformers.TensorType), *optional*, default to 'pt') --
  If set, will return tensors instead of list of python integers. Acceptable values are:
...
- **audio_tokenizer** (`DacModel`) --
  An instance of [DacModel](/docs/transformers/v5.14.0/en/model_doc/dac#transformers.DacModel) used to encode/decode audio into/from codebooks. It is a required input.
...
[~DiaFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/dia#transformers.DiaFeatureExtractor) and [~DiaTokenizer](/docs/transformers/v5.14.0/en/model_doc/dia#transformers.DiaTokenizer) for more information.
...
- **bos_token_id** (`int`, *kwargs*, *optional*, defaults to `1026`) --
...
- **eos_token_id** (`int`, *kwargs*, *optional*, defaults to `1024`) --
...
- **pad_token_id** (`int`, *kwargs*, *optional*, defaults to `1025`) --
...
- **delay_pattern** (`list[int]`, *kwargs*, *optional*, defaults to `[0, 8, 9, 10, 11, 12, 13, 14, 15]`) --
...
- **generation** (`bool`, *kwargs*, *optional*, defaults to `True`) --
...
`audio_tokenizer`. See [decode()](/docs/transformers/v5.14.0/en/model_doc/dac#transformers.DacModel.decode) for more information.

Decodes a single sequence of audio codebooks into the respective audio waveform via the
`audio_tokenizer`. See [decode()](/docs/transformers/v5.14.0/en/model_doc/dac#transformers.DacModel.decode) and [batch_decode()](/docs/transformers/v5.14.0/en/model_doc/dia#transformers.DiaProcessor.batch_decode) for more information.

## DiaModel[[transformers.DiaModel]]

- **config** ([DiaConfig](/docs/transformers/v5.14.0/en/model_doc/dia#transformers.DiaConfig)) --
...
- **or** (batch_size, target_sequence_length, num_codebooks)`, *optional*) --
  ...
  `(batch_size, 1, num_codebooks)`. Indices can be obtained using the [DiaProcessor](/docs/transformers/v5.14.0/en/model_doc/dia#transformers.DiaProcessor). See
  [DiaProcessor.__call__()](/docs/transformers/v5.14.0/en/model_doc/dia#transformers.DiaProcessor.__call__) for more details.
...
- **encoder_outputs** (`Union[~modeling_outputs.BaseModelOutput, tuple]`, *optional*) --
...
The [DiaModel](/docs/transformers/v5.14.0/en/model_doc/dia#transformers.DiaModel) forward method, overrides the `__call__` special method.
...
- **labels** (`torch.LongTensor` of shape `(batch_size * num_codebooks,)`, *optional*) --
  ...
  are ignored (masked).[Seq2SeqLMOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput) or `tuple(torch.FloatTensor)`A [Seq2SeqLMOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.
The [DiaForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/dia#transformers.DiaForConditionalGeneration) forward method, overrides the `__call__` special method.
