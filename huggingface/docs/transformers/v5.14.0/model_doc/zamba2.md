...
- **time_step_limit** (`Union[list[float], tuple[float, ...]]`, *optional*) --
...
- **config** ([Zamba2Config](/docs/transformers/v5.14.0/en/model_doc/zamba2#transformers.Zamba2Config)) --
...
elements depending on the configuration ([Zamba2Config](/docs/transformers/v5.14.0/en/model_doc/zamba2#transformers.Zamba2Config)) and inputs.
The [Zamba2Model](/docs/transformers/v5.14.0/en/model_doc/zamba2#transformers.Zamba2Model) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Zamba2Config](/docs/transformers/v5.14.0/en/model_doc/zamba2#transformers.Zamba2Config)) and inputs.
The [Zamba2ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/zamba2#transformers.Zamba2ForCausalLM) forward method, overrides the `__call__` special method.
...
[Zamba2ForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/zamba2#transformers.Zamba2ForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Zamba2Config](/docs/transformers/v5.14.0/en/model_doc/zamba2#transformers.Zamba2Config)) and inputs.
The [Zamba2ForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/zamba2#transformers.Zamba2ForSequenceClassification) forward method, overrides the `__call__` special method.
