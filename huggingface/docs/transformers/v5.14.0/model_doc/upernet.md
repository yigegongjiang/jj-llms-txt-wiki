...
- **config** ([UperNetForSemanticSegmentation](/docs/transformers/v5.14.0/en/model_doc/upernet#transformers.UperNetForSemanticSegmentation)) --
...
elements depending on the configuration ([UperNetConfig](/docs/transformers/v5.14.0/en/model_doc/upernet#transformers.UperNetConfig)) and inputs.
The [UperNetForSemanticSegmentation](/docs/transformers/v5.14.0/en/model_doc/upernet#transformers.UperNetForSemanticSegmentation) forward method, overrides the `__call__` special method.
