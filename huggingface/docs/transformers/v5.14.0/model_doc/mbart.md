...
- Set the `eos_token_id` as the `decoder_start_token_id` for mBART-50. The target language id is used as the first generated token by passing `forced_bos_token_id` to [generate()](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationMixin.generate).
...
'"}, {"name": "eos_token", "val": " = ''"}, {"name": "sep_token", "val": " = ''"}, {"name": "cls_token", "val": " = ''"}, {"name": "unk_token", "val": " = ''"}, {"name": "pad_token", "val": " = ''"}, {"name": "mask_token", "val": " = ''"}, {"name": "src_lang", "val": " = None"}, {"name": "tgt_lang", "val": " = None"}, {"name": "additional_special_tokens", "val": " = None"}, {"name": "**kwargs", "val": ""}]}>
...
'"}, {"name": "sep_token", "val": " = ''"}, {"name": "cls_token", "val": " = ''"}, {"name": "unk_token", "val": " = ''"}, {"name": "pad_token", "val": " = ''"}, {"name": "mask_token", "val": " = ''"}, {"name": "**kwargs", "val": ""}]}>
...
- **config** ([MBartConfig](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartConfig)) --
...
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.
The [MBartModel](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.
The [MBartForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **config** ([MBartForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.
The [MBartForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartForQuestionAnswering) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.
The [MBartForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartForSequenceClassification) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.
The [MBartForCausalLM](/docs/transformers/v5.14.0/en/model_doc/mbart#transformers.MBartForCausalLM) forward method, overrides the `__call__` special method.
