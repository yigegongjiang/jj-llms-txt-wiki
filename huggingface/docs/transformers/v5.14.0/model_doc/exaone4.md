...
- **config** ([Exaone4Config](/docs/transformers/v5.14.0/en/model_doc/exaone4#transformers.Exaone4Config)) --
...
- **config** ([Exaone4ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/exaone4#transformers.Exaone4ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
elements depending on the configuration ([Exaone4Config](/docs/transformers/v5.14.0/en/model_doc/exaone4#transformers.Exaone4Config)) and inputs.
The [Exaone4ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/exaone4#transformers.Exaone4ForCausalLM) forward method, overrides the `__call__` special method.
