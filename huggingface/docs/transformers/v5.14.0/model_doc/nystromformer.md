...
- **max_position_embeddings** (`int`, *optional*, defaults to `510`) --
...
- **config** ([NystromformerModel](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerModel)) --
...
elements depending on the configuration ([NystromformerConfig](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerConfig)) and inputs.
The [NystromformerModel](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerModel) forward method, overrides the `__call__` special method.
...
- **config** ([NystromformerForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([NystromformerConfig](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerConfig)) and inputs.
The [NystromformerForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([NystromformerForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([NystromformerConfig](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerConfig)) and inputs.
The [NystromformerForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([NystromformerForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([NystromformerConfig](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerConfig)) and inputs.
The [NystromformerForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([NystromformerForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([NystromformerConfig](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerConfig)) and inputs.
The [NystromformerForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([NystromformerForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([NystromformerConfig](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerConfig)) and inputs.
The [NystromformerForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/nystromformer#transformers.NystromformerForQuestionAnswering) forward method, overrides the `__call__` special method.
