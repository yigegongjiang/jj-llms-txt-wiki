...
- **config** ([SolarOpenConfig](/docs/transformers/v5.14.0/en/model_doc/solar_open#transformers.SolarOpenConfig)) --
...
elements depending on the configuration ([SolarOpenConfig](/docs/transformers/v5.14.0/en/model_doc/solar_open#transformers.SolarOpenConfig)) and inputs.
The [SolarOpenModel](/docs/transformers/v5.14.0/en/model_doc/solar_open#transformers.SolarOpenModel) forward method, overrides the `__call__` special method.
...
- **config** ([SolarOpenForCausalLM](/docs/transformers/v5.14.0/en/model_doc/solar_open#transformers.SolarOpenForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SolarOpenConfig](/docs/transformers/v5.14.0/en/model_doc/solar_open#transformers.SolarOpenConfig)) and inputs.
The [SolarOpenForCausalLM](/docs/transformers/v5.14.0/en/model_doc/solar_open#transformers.SolarOpenForCausalLM) forward method, overrides the `__call__` special method.
