...
- **qformer_config** (`dict`, *optional*) --
  Dictionary of configuration options used to initialize [InstructBlipQFormerConfig](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipQFormerConfig).
...
[~BlipImageProcessor](/docs/transformers/v5.14.0/en/model_doc/blip#transformers.BlipImageProcessor), [~GPT2Tokenizer](/docs/transformers/v5.14.0/en/model_doc/gpt2#transformers.GPT2Tokenizer), and `~{qformer_tokenizer_class}` for more information.
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [BlipImageProcessor](/docs/transformers/v5.14.0/en/model_doc/blip#transformers.BlipImageProcessor). See `BlipImageProcessor.__call__()` for details ([InstructBlipProcessor](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipProcessor) uses
...
elements depending on the configuration ([InstructBlipConfig](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipConfig)) and inputs.
The [InstructBlipVisionModel](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipVisionModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([InstructBlipConfig](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipConfig)) and inputs.
The [InstructBlipQFormerModel](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipQFormerModel) forward method, overrides the `__call__` special method.
...
- **config** ([InstructBlipConfig](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipConfig)) --
...
- **qformer_input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  Indices can be obtained using [InstructBlipProcessor](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipProcessor). See [InstructBlipProcessor.__call__()](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipProcessor.__call__) for
  details.
...
- **interpolate_pos_encoding** (`bool`, *optional*, defaults to `False`) --
  Whether to interpolate the pre-trained position encodings.`InstructBlipForConditionalGenerationModelOutput` or `tuple(torch.FloatTensor)`A `InstructBlipForConditionalGenerationModelOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([InstructBlipConfig](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipConfig)) and inputs.
The [InstructBlipModel](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([InstructBlipConfig](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipConfig)) and inputs.
The [InstructBlipForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/instructblip#transformers.InstructBlipForConditionalGeneration) forward method, overrides the `__call__` special method.
