...
- **classifier_activation** (`bool`, *optional*, defaults to `True`) --
...
Output type of [MobileBertForPreTraining](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForPreTraining).

## MobileBertModel[[transformers.MobileBertModel]]

- **config** ([MobileBertModel](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertModel)) --
...
elements depending on the configuration ([MobileBertConfig](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertConfig)) and inputs.
The [MobileBertModel](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertModel) forward method, overrides the `__call__` special method.
...
- **config** ([MobileBertForPreTraining](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForPreTraining)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **next_sentence_label** (`torch.LongTensor` of shape `(batch_size,)`, *optional*) --
  ...
  - 1 indicates sequence B is a random sequence.[MobileBertForPreTrainingOutput](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput) or `tuple(torch.FloatTensor)`A [MobileBertForPreTrainingOutput](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MobileBertConfig](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertConfig)) and inputs.
The [MobileBertForPreTraining](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForPreTraining) forward method, overrides the `__call__` special method.
...
- **config** ([MobileBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MobileBertConfig](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertConfig)) and inputs.
The [MobileBertForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([MobileBertForNextSentencePrediction](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForNextSentencePrediction)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MobileBertConfig](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertConfig)) and inputs.
The [MobileBertForNextSentencePrediction](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
- **config** ([MobileBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MobileBertConfig](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertConfig)) and inputs.
The [MobileBertForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([MobileBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForMultipleChoice)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MobileBertConfig](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertConfig)) and inputs.
The [MobileBertForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
- **config** ([MobileBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MobileBertConfig](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertConfig)) and inputs.
The [MobileBertForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([MobileBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MobileBertConfig](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertConfig)) and inputs.
The [MobileBertForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/mobilebert#transformers.MobileBertForQuestionAnswering) forward method, overrides the `__call__` special method.
