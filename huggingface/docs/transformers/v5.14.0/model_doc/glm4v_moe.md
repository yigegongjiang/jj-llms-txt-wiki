...
- **config** ([Glm4vMoeVisionModel](/docs/transformers/v5.14.0/en/model_doc/glm4v_moe#transformers.Glm4vMoeVisionModel)) --
...
The [Glm4vMoeVisionModel](/docs/transformers/v5.14.0/en/model_doc/glm4v_moe#transformers.Glm4vMoeVisionModel) forward method, overrides the `__call__` special method.
...
- **config** ([Glm4vMoeTextConfig](/docs/transformers/v5.14.0/en/model_doc/glm4v_moe#transformers.Glm4vMoeTextConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
The [Glm4vMoeTextModel](/docs/transformers/v5.14.0/en/model_doc/glm4v_moe#transformers.Glm4vMoeTextModel) forward method, overrides the `__call__` special method.
...
- **config** ([Glm4vMoeModel](/docs/transformers/v5.14.0/en/model_doc/glm4v_moe#transformers.Glm4vMoeModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **mm_token_type_ids** (`torch.IntTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  Multimodal token type ids can be obtained using [AutoProcessor](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoProcessor). See [ProcessorMixin.__call__()](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.ProcessorMixin.__call__) for details.`Glm4vMoeModelOutputWithPast` or `tuple(torch.FloatTensor)`A `Glm4vMoeModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.
The [Glm4vMoeModel](/docs/transformers/v5.14.0/en/model_doc/glm4v_moe#transformers.Glm4vMoeModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Glm4vMoeConfig](/docs/transformers/v5.14.0/en/model_doc/glm4v_moe#transformers.Glm4vMoeConfig)) and inputs.
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  This is useful when using packed tensor format (single dimension for batch and sequence length).`Glm4vMoeCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `Glm4vMoeCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.
The [Glm4vMoeForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/glm4v_moe#transformers.Glm4vMoeForConditionalGeneration) forward method, overrides the `__call__` special method.
