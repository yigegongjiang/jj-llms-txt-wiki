...
Then simply load the quantized model by adding [BitsAndBytesConfig](/docs/transformers/v5.14.0/en/main_classes/quantization#transformers.BitsAndBytesConfig) as shown below:
...
'"}, {"name": "image_token", "val": " = ''"}, {"name": "num_additional_image_tokens", "val": " = 0"}, {"name": "**kwargs", "val": ""}]}>
...
[LlavaNextVideoProcessor](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoProcessor) offers all the functionalities of [LlavaNextVideoVideoProcessor](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoVideoProcessor), [LlavaNextImageProcessor](/docs/transformers/v5.14.0/en/model_doc/llava_next#transformers.LlavaNextImageProcessor), and `tokenizer_class`. See the
[~LlavaNextVideoVideoProcessor](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoVideoProcessor), [~LlavaNextImageProcessor](/docs/transformers/v5.14.0/en/model_doc/llava_next#transformers.LlavaNextImageProcessor), and `~tokenizer_class` for more information.
...
- **config** ([LlavaNextVideoConfig](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoConfig)) --
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [LlavaNextImageProcessor](/docs/transformers/v5.14.0/en/model_doc/llava_next#transformers.LlavaNextImageProcessor). See `LlavaNextImageProcessor.__call__()` for details ([LlavaNextVideoProcessor](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoProcessor) uses
...
- **pixel_values_videos** (`torch.FloatTensor` of shape `(batch_size, num_frames, num_channels, frame_size, frame_size)`, *optional*) --
  ...
  [LlavaNextVideoVideoProcessor](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoVideoProcessor) for processing videos).
...
- **use_cache** (`bool`, *optional*) --
  ...
  `past_key_values`).`LlavaNextVideoModelOutputWithPast` or `tuple(torch.FloatTensor)`A `LlavaNextVideoModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LlavaNextVideoConfig](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoConfig)) and inputs.
The [LlavaNextVideoModel](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoModel) forward method, overrides the `__call__` special method.
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  This is useful when using packed tensor format (single dimension for batch and sequence length).`LlavaNextVideoCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `LlavaNextVideoCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LlavaNextVideoConfig](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoConfig)) and inputs.
The [LlavaNextVideoForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoForConditionalGeneration) forward method, overrides the `__call__` special method.
