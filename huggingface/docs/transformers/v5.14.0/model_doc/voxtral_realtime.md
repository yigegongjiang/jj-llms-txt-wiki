...
.Placeholder"} anchor={"transformers.models.voxtral_realtime.processing_voxtral_realtime._LazyModule.__getattr__..Placeholder"} parameters={[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]}>
...
- **config** ([VoxtralRealtimeEncoder](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeEncoder)) --
...
- **input_features** (`torch.FloatTensor` of shape `(batch_size, sequence_length, feature_dim)`, *optional*) --
  ...
  [VoxtralRealtimeFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeFeatureExtractor). See `VoxtralRealtimeFeatureExtractor.__call__()` for details ([VoxtralRealtimeProcessor](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.models.voxtral_realtime.processing_voxtral_realtime._LazyModule.__getattr__..Placeholder) uses
  [VoxtralRealtimeFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeFeatureExtractor) for processing audios).
...
elements depending on the configuration ([VoxtralRealtimeConfig](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeConfig)) and inputs.
The [VoxtralRealtimeEncoder](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeEncoder) forward method, overrides the `__call__` special method.
...
- **config** ([VoxtralRealtimeModel](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **num_delay_tokens** (`int` or `torch.Tensor`, *optional*) --
  Number of delay tokens used when preparing inputs.`VoxtralRealtimeModelOutputWithPast` or `tuple(torch.FloatTensor)`A `VoxtralRealtimeModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([VoxtralRealtimeConfig](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeConfig)) and inputs.
The [VoxtralRealtimeModel](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeModel) forward method, overrides the `__call__` special method.
...
- **num_delay_tokens** (`int` or `torch.Tensor`, *optional*) --
  Number of delay tokens used when preparing inputs, see [~VoxtralRealtimeProcessor](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.models.voxtral_realtime.processing_voxtral_realtime._LazyModule.__getattr__..Placeholder) for more details.`VoxtralRealtimeCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `VoxtralRealtimeCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([VoxtralRealtimeConfig](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeConfig)) and inputs.
The [VoxtralRealtimeForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeForConditionalGeneration) forward method, overrides the `__call__` special method.
