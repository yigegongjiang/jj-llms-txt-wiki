...
- **config** ([HeliumConfig](/docs/transformers/v5.14.0/en/model_doc/helium#transformers.HeliumConfig)) --
...
elements depending on the configuration ([HeliumConfig](/docs/transformers/v5.14.0/en/model_doc/helium#transformers.HeliumConfig)) and inputs.
The [HeliumModel](/docs/transformers/v5.14.0/en/model_doc/helium#transformers.HeliumModel) forward method, overrides the `__call__` special method.
...
- **config** ([HeliumForCausalLM](/docs/transformers/v5.14.0/en/model_doc/helium#transformers.HeliumForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HeliumConfig](/docs/transformers/v5.14.0/en/model_doc/helium#transformers.HeliumConfig)) and inputs.
The [HeliumForCausalLM](/docs/transformers/v5.14.0/en/model_doc/helium#transformers.HeliumForCausalLM) forward method, overrides the `__call__` special method.
