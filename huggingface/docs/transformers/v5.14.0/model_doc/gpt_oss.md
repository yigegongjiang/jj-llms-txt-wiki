...
This is the configuration class to store the configuration of a GptOssModel. It is used to instantiate a Gpt Oss
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [openai/gpt-oss-20b](https://huggingface.co/openai/gpt-oss-20b)
...
- **config** ([GptOssConfig](/docs/transformers/v5.14.0/en/model_doc/gpt_oss#transformers.GptOssConfig)) --
...
elements depending on the configuration ([GptOssConfig](/docs/transformers/v5.14.0/en/model_doc/gpt_oss#transformers.GptOssConfig)) and inputs.
The [GptOssModel](/docs/transformers/v5.14.0/en/model_doc/gpt_oss#transformers.GptOssModel) forward method, overrides the `__call__` special method.
...
- **config** ([GptOssForCausalLM](/docs/transformers/v5.14.0/en/model_doc/gpt_oss#transformers.GptOssForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GptOssConfig](/docs/transformers/v5.14.0/en/model_doc/gpt_oss#transformers.GptOssConfig)) and inputs.
The [GptOssForCausalLM](/docs/transformers/v5.14.0/en/model_doc/gpt_oss#transformers.GptOssForCausalLM) forward method, overrides the `__call__` special method.
