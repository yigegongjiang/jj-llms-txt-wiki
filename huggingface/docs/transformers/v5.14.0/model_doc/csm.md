...
[CsmProcessor](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmProcessor) offers all the functionalities of [EncodecFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/encodec#transformers.EncodecFeatureExtractor) and `tokenizer_class`. See the
[~EncodecFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/encodec#transformers.EncodecFeatureExtractor) and `~tokenizer_class` for more information.
...
- **encoded_length_kwargs** (`dict[str, *kwargs*, Any]`, *optional*) --
...
- **config** ([CsmForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmForConditionalGeneration)) --
...
- **input_values** (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  into a tensor of type `torch.FloatTensor`. See [CsmProcessor.__call__()](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmProcessor.__call__) for details.
...
- **labels** (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  Such labels can be prepared using `output_labels=True` when calling [CsmProcessor](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmProcessor).
...
- **logits_to_keep** (`int` or `torch.Tensor`, *optional*) --
  ...
  2. `1`, which is equivalent to keeping only the last logit, used in the generation regime`CsmOutputWithPast` or `tuple(torch.FloatTensor)`A `CsmOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([CsmConfig](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmConfig)) and inputs.
The [CsmForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **kwargs** (`dict[str, Any]`, *optional*) --
  ...
  forwarded to the `forward` function of the model. Depth decoder specific kwargs should be prefixed with *depth_decoder_*.`CsmGenerateOutput` or `torch.LongTensor` or `list[torch.FloatTensor]`A `CsmGenerateOutput`
...
This method overrides [generate()](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationMixin.generate) to match the specifics of the Csm model.
...
- **config** ([CsmDepthDecoderForCausalLM](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmDepthDecoderForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([CsmConfig](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmConfig)) and inputs.
The [CsmDepthDecoderForCausalLM](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmDepthDecoderForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([CsmDepthDecoderModel](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmDepthDecoderModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([CsmConfig](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmConfig)) and inputs.
The [CsmDepthDecoderModel](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmDepthDecoderModel) forward method, overrides the `__call__` special method.
...
- **config** ([CsmBackboneModel](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmBackboneModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([CsmConfig](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmConfig)) and inputs.
The [CsmBackboneModel](/docs/transformers/v5.14.0/en/model_doc/csm#transformers.CsmBackboneModel) forward method, overrides the `__call__` special method.
