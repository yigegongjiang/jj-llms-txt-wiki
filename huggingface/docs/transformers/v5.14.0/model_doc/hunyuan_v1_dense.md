...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModelForCausalLM](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoModelForCausalLM) class.
...
This is the configuration class to store the configuration of a HunYuanDenseV1Model. It is used to instantiate a Hunyuan V1 Dense
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the [tencent/Hunyuan-7B-Instruct](https://huggingface.co/tencent/Hunyuan-7B-Instruct)
...
## HunYuanDenseV1Model[[transformers.HunYuanDenseV1Model]]

- **config** ([HunYuanDenseV1Config](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Config)) --
...
elements depending on the configuration ([HunYuanDenseV1Config](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Config)) and inputs.
The [HunYuanDenseV1Model](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Model) forward method, overrides the `__call__` special method.
...
- **config** ([HunYuanDenseV1ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HunYuanDenseV1Config](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Config)) and inputs.
The [HunYuanDenseV1ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1ForCausalLM) forward method, overrides the `__call__` special method.
