...
- Use the [apply_chat_template()](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.ProcessorMixin.apply_chat_template) method to correctly format inputs.
...
'"}, {"name": "downsample_factor", "val": ": int = 1"}, {"name": "start_of_img_token", "val": " = '<|START_OF_IMG|>'"}, {"name": "end_of_img_token", "val": " = '<|END_OF_IMG|>'"}, {"name": "img_patch_token", "val": " = '<|IMG_PATCH|>'"}, {"name": "img_line_break_token", "val": " = '<|IMG_LINE_BREAK|>'"}, {"name": "tile_token", "val": " = 'TILE'"}, {"name": "tile_global_token", "val": " = 'TILE_GLOBAL'"}, {"name": "chat_template", "val": " = None"}, {"name": "**kwargs", "val": ""}]}>
...
[~GotOcr2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/got_ocr2#transformers.GotOcr2ImageProcessor) and [~CohereTokenizer](/docs/transformers/v5.14.0/en/model_doc/cohere#transformers.CohereTokenizer) for more information.
...
- **config** ([AyaVisionConfig](/docs/transformers/v5.14.0/en/model_doc/aya_vision#transformers.AyaVisionConfig)) --
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [GotOcr2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/got_ocr2#transformers.GotOcr2ImageProcessor). See `GotOcr2ImageProcessor.__call__()` for details ([AyaVisionProcessor](/docs/transformers/v5.14.0/en/model_doc/aya_vision#transformers.AyaVisionProcessor) uses
...
- **use_cache** (`bool`, *optional*) --
  ...
  `past_key_values`).`AyaVisionModelOutputWithPast` or `tuple(torch.FloatTensor)`A `AyaVisionModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([AyaVisionConfig](/docs/transformers/v5.14.0/en/model_doc/aya_vision#transformers.AyaVisionConfig)) and inputs.
The [AyaVisionModel](/docs/transformers/v5.14.0/en/model_doc/aya_vision#transformers.AyaVisionModel) forward method, overrides the `__call__` special method.
...
- **image_sizes** (`torch.Tensor` of shape `(batch_size, 2)`, *optional*) --
  The sizes of the images in the batch, being (height, width) for each image.`AyaVisionCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `AyaVisionCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([AyaVisionConfig](/docs/transformers/v5.14.0/en/model_doc/aya_vision#transformers.AyaVisionConfig)) and inputs.
The [AyaVisionForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/aya_vision#transformers.AyaVisionForConditionalGeneration) forward method, overrides the `__call__` special method.
