...
Here we explain how you can fine-tune [TapasForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForQuestionAnswering) on your own dataset.

**STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment**

Basically, there are 3 different ways in which one can fine-tune [TapasForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForQuestionAnswering), corresponding to the different datasets on which Tapas was fine-tuned:
...
Note that [TapasTokenizer](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasTokenizer) expects the data of the table to be **text-only**. You can use `.astype(str)` on a dataframe to turn it into text-only data.
...
You can then fine-tune [TapasForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForQuestionAnswering) as follows (shown here for the weak supervision for aggregation case):
...
Output type of [TapasForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForQuestionAnswering).
...
- **type_vocab_sizes** (`list[int]`, *optional*, defaults to `[3, 256, 256, 2, 256, 256, 10]`) --
  The vocabulary sizes of the `token_type_ids` passed when calling [TapasModel](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasModel).
...
this superclass for more information regarding those methods. [TapasTokenizer](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasTokenizer) creates several token type ids to
...
[TapasTokenizer](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasTokenizer) runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.
...
- **data** (`dict`) --
  Dictionary mapping features to actual values. Should be created using [TapasTokenizer](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasTokenizer).
...
- **cell_classification_threshold** (`float`, *optional*, defaults to 0.5) --
  ...
  this threshold will be selected.`tuple` comprising various elements depending on the inputs- predicted_answer_coordinates (`list[list[[tuple]]` of length `batch_size`): Predicted answer coordinates
...
Converts logits of [TapasForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForQuestionAnswering) to actual predicted answer coordinates and optional
aggregation indices.
...
- **config** ([TapasModel](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasModel)) --
...
- **token_type_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length, 7)`, *optional*) --
  Token indices that encode tabular structure. Indices can be obtained using [AutoTokenizer](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoTokenizer). See this
  class for more info.

  [What are token type IDs?](../glossary#token-type-ids)
- **position_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  Indices of positions of each input sequence tokens in the position embeddings. If
  `reset_position_index_per_cell` of [TapasConfig](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasConfig) is set to `True`, relative position embeddings will be
...
elements depending on the configuration ([TapasConfig](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasConfig)) and inputs.
The [TapasModel](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasModel) forward method, overrides the `__call__` special method.
...
- **config** ([TapasForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([TapasConfig](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasConfig)) and inputs.
The [TapasForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([TapasForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([TapasConfig](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasConfig)) and inputs.
The [TapasForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([TapasConfig](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **labels** (`torch.LongTensor` of shape `(batch_size, seq_length)`, *optional*) --
  ...
  answer appearing in the table. Can be obtained using [AutoTokenizer](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoTokenizer).
...
- **numeric_values** (`torch.FloatTensor` of shape `(batch_size, seq_length)`, *optional*) --
  ...
  [AutoTokenizer](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoTokenizer). Only required in case of weak supervision for aggregation (WTQ) to calculate the
  regression loss.
- **numeric_values_scale** (`torch.FloatTensor` of shape `(batch_size, seq_length)`, *optional*) --
  Scale of the numeric values of every token. Can be obtained using [AutoTokenizer](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoTokenizer). Only required in case
...
- **output_hidden_states** (`bool`, *optional*) --
  ...
  more detail.
- **return_dict** (`bool`, *optional*) --
  Whether or not to return a [ModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput) instead of a plain tuple.[TableQuestionAnsweringOutput](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput) or `tuple(torch.FloatTensor)`A [TableQuestionAnsweringOutput](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([TapasConfig](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasConfig)) and inputs.
The [TapasForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/tapas#transformers.TapasForQuestionAnswering) forward method, overrides the `__call__` special method.
