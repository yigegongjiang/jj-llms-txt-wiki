...
The examples below demonstrates how to generate with [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoModel). We additionally add an example
...
[Llama4Processor](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4Processor) offers all the functionalities of [Llama4ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4ImageProcessor) and `tokenizer_class`. See the
[~Llama4ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4ImageProcessor) and `~tokenizer_class` for more information.
...
- **max_patches** (`int`, *kwargs*, *optional*, defaults to 16) --
  The maximum number of patches to be extracted from the image.
  Can be overridden by the `max_patches` parameter in the `preprocess` method.
- **resize_to_max_canvas** (`bool`, *kwargs*, *optional*, defaults to False) --
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [Llama4ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4ImageProcessor). See `Llama4ImageProcessor.__call__()` for details ([Llama4Processor](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4Processor) uses
  [Llama4ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4ImageProcessor) for processing images).
...
- **logits_to_keep** (`Union[int, torch.Tensor]`, *optional*, defaults to `0`) --
  ...
  This is useful when using packed tensor format (single dimension for batch and sequence length).`Llama4CausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `Llama4CausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Llama4Config](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4Config)) and inputs.
The [Llama4ForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Llama4Config](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4Config)) and inputs.
The [Llama4ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4ForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([Llama4TextConfig](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4TextConfig)) --
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Llama4Config](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4Config)) and inputs.
The [Llama4TextModel](/docs/transformers/v5.14.0/en/model_doc/llama4#transformers.Llama4TextModel) forward method, overrides the `__call__` special method.
