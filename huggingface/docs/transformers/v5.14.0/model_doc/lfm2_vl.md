...
- **downsample_factor** (`int`, *kwargs*, *optional*, defaults to `2`) --
...
- **min_tiles** (`int`, *kwargs*, *optional*, defaults to `2`) --
...
- **use_thumbnail** (`bool`, *kwargs*, *optional*, defaults to `True`) --
  ...
  one tile.
- **min_image_tokens** (`int`, *kwargs*, *optional*, defaults to `64`) --
...
- **max_image_tokens** (`int`, *kwargs*, *optional*, defaults to `256`) --
...
- **encoder_patch_size** (`int`, *kwargs*, *optional*, defaults to `16`) --
...
- **tile_size** (`int`, *kwargs*, *optional*, defaults to `512`) --
...
- **max_pixels_tolerance** (`float`, *kwargs*, *optional*, defaults to `2.0`) --
...
[Lfm2VlProcessor](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlProcessor) offers all the functionalities of [Lfm2VlImageProcessor](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlImageProcessor) and `tokenizer_class`. See the
[~Lfm2VlImageProcessor](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlImageProcessor) and `~tokenizer_class` for more information.
...
- **config** ([Lfm2VlConfig](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlConfig)) --
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) --
  ...
  [Lfm2VlImageProcessor](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlImageProcessor). See `Lfm2VlImageProcessor.__call__()` for details ([Lfm2VlProcessor](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlProcessor) uses
  [Lfm2VlImageProcessor](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlImageProcessor) for processing images).
...
- **use_cache** (`bool`, *optional*) --
  ...
  `past_key_values`).`Lfm2VlModelOutputWithPast` or `tuple(torch.FloatTensor)`A `Lfm2VlModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Lfm2VlConfig](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlConfig)) and inputs.
The [Lfm2VlModel](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlModel) forward method, overrides the `__call__` special method.
...
)>"}, {"name": "pixel_attention_mask", "val": ": )>"}, {"name": "**kwargs", "val": ": Unpack"}]}>
...
- **pixel_attention_mask** (`torch.Tensor` of shape `(batch_size, height, width)`) --
  The pixel attention mask of the input images.[BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or `tuple(torch.FloatTensor)`A [BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Lfm2VlConfig](/docs/transformers/v5.14.0/en/model_doc/lfm2_vl#transformers.Lfm2VlConfig)) and inputs.
