...
## MiniCPM3Config[[transformers.MiniCPM3Config]]

- **vocab_size** (`int`, *optional*, defaults to `73448`) --
...
- **num_key_value_heads** (`int`, *optional*, defaults to `40`) --
...
defaults will yield a similar configuration to that of the [openbmb/MiniCPM3-4B](https://huggingface.co/openbmb/MiniCPM3-4B)
...
## MiniCPM3Model[[transformers.MiniCPM3Model]]

- **config** ([MiniCPM3Config](/docs/transformers/v5.14.0/en/model_doc/minicpm3#transformers.MiniCPM3Config)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The bare Minicpm3 Model outputting raw hidden-states without any specific head on top.
...
elements depending on the configuration ([MiniCPM3Config](/docs/transformers/v5.14.0/en/model_doc/minicpm3#transformers.MiniCPM3Config)) and inputs.
The [MiniCPM3Model](/docs/transformers/v5.14.0/en/model_doc/minicpm3#transformers.MiniCPM3Model) forward method, overrides the `__call__` special method.
...
## MiniCPM3ForCausalLM[[transformers.MiniCPM3ForCausalLM]]

- **config** ([MiniCPM3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/minicpm3#transformers.MiniCPM3ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Minicpm3 Model for causal language modeling.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MiniCPM3Config](/docs/transformers/v5.14.0/en/model_doc/minicpm3#transformers.MiniCPM3Config)) and inputs.
The [MiniCPM3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/minicpm3#transformers.MiniCPM3ForCausalLM) forward method, overrides the `__call__` special method.
...
## MiniCPM3ForSequenceClassification[[transformers.MiniCPM3ForSequenceClassification]]
