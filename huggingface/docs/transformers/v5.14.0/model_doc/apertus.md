...
## ApertusConfig[[transformers.ApertusConfig]]
...
- **num_key_value_heads** (`int`, *optional*) --
  ...
  `num_attention_heads`.
- **hidden_act** (`str`, *optional*, defaults to `xielu`) --
...
defaults will yield a similar configuration to that of the [swiss-ai/Apertus-8B-Instruct-2509](https://huggingface.co/swiss-ai/Apertus-8B-Instruct-2509)
...
## ApertusModel[[transformers.ApertusModel]]

- **config** ([ApertusConfig](/docs/transformers/v5.14.0/en/model_doc/apertus#transformers.ApertusConfig)) --
...
elements depending on the configuration ([ApertusConfig](/docs/transformers/v5.14.0/en/model_doc/apertus#transformers.ApertusConfig)) and inputs.
The [ApertusModel](/docs/transformers/v5.14.0/en/model_doc/apertus#transformers.ApertusModel) forward method, overrides the `__call__` special method.
...
## ApertusForCausalLM[[transformers.ApertusForCausalLM]]

- **config** ([ApertusForCausalLM](/docs/transformers/v5.14.0/en/model_doc/apertus#transformers.ApertusForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ApertusConfig](/docs/transformers/v5.14.0/en/model_doc/apertus#transformers.ApertusConfig)) and inputs.
The [ApertusForCausalLM](/docs/transformers/v5.14.0/en/model_doc/apertus#transformers.ApertusForCausalLM) forward method, overrides the `__call__` special method.
...
## ApertusForTokenClassification[[transformers.ApertusForTokenClassification]]
