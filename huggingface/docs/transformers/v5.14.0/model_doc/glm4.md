...
## Glm4Config[[transformers.Glm4Config]]
...
This is the configuration class to store the configuration of a Glm4Model. It is used to instantiate a Glm4
...
## Glm4Model[[transformers.Glm4Model]]

- **config** ([Glm4Config](/docs/transformers/v5.14.0/en/model_doc/glm4#transformers.Glm4Config)) --
...
elements depending on the configuration ([Glm4Config](/docs/transformers/v5.14.0/en/model_doc/glm4#transformers.Glm4Config)) and inputs.
The [Glm4Model](/docs/transformers/v5.14.0/en/model_doc/glm4#transformers.Glm4Model) forward method, overrides the `__call__` special method.
...
## Glm4ForCausalLM[[transformers.Glm4ForCausalLM]]

- **config** ([Glm4ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/glm4#transformers.Glm4ForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Glm4 Model for causal language modeling.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Glm4Config](/docs/transformers/v5.14.0/en/model_doc/glm4#transformers.Glm4Config)) and inputs.
The [Glm4ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/glm4#transformers.Glm4ForCausalLM) forward method, overrides the `__call__` special method.
...
## Glm4ForSequenceClassification[[transformers.Glm4ForSequenceClassification]]
...
## Glm4ForTokenClassification[[transformers.Glm4ForTokenClassification]]
