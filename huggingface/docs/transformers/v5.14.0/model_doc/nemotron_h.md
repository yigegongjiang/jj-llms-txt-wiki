...
- **routed_scaling_factor** (`Union[float, int]`, *optional*, defaults to `1.0`) --
...
elements depending on the configuration ([NemotronHConfig](/docs/transformers/v5.14.0/en/model_doc/nemotron_h#transformers.NemotronHConfig)) and inputs.
The [NemotronHForCausalLM](/docs/transformers/v5.14.0/en/model_doc/nemotron_h#transformers.NemotronHForCausalLM) forward method, overrides the `__call__` special method.
