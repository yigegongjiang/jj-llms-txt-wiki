...
[~HunYuanVLImageProcessor](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLImageProcessor) and [~Qwen2Tokenizer](/docs/transformers/v5.14.0/en/model_doc/qwen2#transformers.Qwen2Tokenizer) for more information.
...
- **min_pixels** (`int`, *kwargs*, *optional*, defaults to `512 * 512`) --
  The min pixels of the image to resize the image.
- **max_pixels** (`int`, *kwargs*, *optional*, defaults to `2048 * 2048`) --
  The max pixels of the image to resize the image.
- **patch_size** (`int`, *kwargs*, *optional*, defaults to 16) --
...
[HunYuanVLTextConfig](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLTextConfig) (text backbone) and a [HunYuanVLVisionConfig](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLVisionConfig) (vision tower) plus a few token ids that
...
- **eod_token_id** (`int`, *optional*, defaults to 3) --
  Token id representing the end-of-document marker. Inherited from [HunYuanDenseV1Config](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Config) and re-documented
...
- **rope_parameters** (`dict`, *optional*) --
  RoPE configuration inherited from [HunYuanDenseV1Config](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Config). When `mrope_section` is present, it partitions
...
Inherits the standard fields from [HunYuanDenseV1Config](/docs/transformers/v5.14.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Config) and declares the canonical field names
...
)>"}, {"name": "grid_thw", "val": ": LongTensor"}, {"name": "**kwargs", "val": ": Unpack"}]}>
...
- **grid_thw** (`torch.LongTensor` of shape `(num_images, 3)`) --
  The temporal, height and width dimensions for each image. Each row contains `[t, h, w]` patch counts.[BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or `tuple(torch.FloatTensor)`A [BaseModelOutputWithPooling](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HunYuanVLConfig](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLConfig)) and inputs.
The [HunYuanVLVisionTransformer](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLVisionTransformer) forward method, overrides the `__call__` special method.
...
- **config** ([HunYuanVLTextConfig](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLTextConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The bare Hunyuan Vl Text Model outputting raw hidden-states without any specific head on to.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HunYuanVLConfig](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLConfig)) and inputs.
The [HunYuanVLTextModel](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLTextModel) forward method, overrides the `__call__` special method.
...
- **config** ([HunYuanVLConfig](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **mm_token_type_ids** (`torch.IntTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  Multimodal token type ids can be obtained using [AutoProcessor](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoProcessor). See [ProcessorMixin.__call__()](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.ProcessorMixin.__call__) for details.`HunYuanVLModelOutputWithPast` or `tuple(torch.FloatTensor)`A `HunYuanVLModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HunYuanVLConfig](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLConfig)) and inputs.
The [HunYuanVLModel](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLModel) forward method, overrides the `__call__` special method.
...
- **mm_token_type_ids** (`torch.IntTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  Indices of input sequence tokens matching each modality. For example text (0), image (1), video (2).
  Multimodal token type ids can be obtained using [AutoProcessor](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoProcessor). See [ProcessorMixin.__call__()](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.ProcessorMixin.__call__) for details.[CausalLMOutputWithPast](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast) or `tuple(torch.FloatTensor)`A [CausalLMOutputWithPast](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([HunYuanVLConfig](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLConfig)) and inputs.
The [HunYuanVLForConditionalGeneration](/docs/transformers/v5.14.0/en/model_doc/hunyuan_vl#transformers.HunYuanVLForConditionalGeneration) forward method, overrides the `__call__` special method.
