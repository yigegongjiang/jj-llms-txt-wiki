...
The example below demonstrates how to classify text with [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.14.0/en/model_doc/auto#transformers.AutoModel), and from the command line.
...
- **config** ([DebertaModel](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaModel)) --
...
elements depending on the configuration ([DebertaConfig](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaConfig)) and inputs.
The [DebertaModel](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaModel) forward method, overrides the `__call__` special method.
...
- **config** ([DebertaForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaForMaskedLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DebertaConfig](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaConfig)) and inputs.
The [DebertaForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaForMaskedLM) forward method, overrides the `__call__` special method.
...
- **config** ([DebertaForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DebertaConfig](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaConfig)) and inputs.
The [DebertaForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([DebertaForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaForTokenClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DebertaConfig](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaConfig)) and inputs.
The [DebertaForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaForTokenClassification) forward method, overrides the `__call__` special method.
...
- **config** ([DebertaForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaForQuestionAnswering)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DebertaConfig](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaConfig)) and inputs.
The [DebertaForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/deberta#transformers.DebertaForQuestionAnswering) forward method, overrides the `__call__` special method.
