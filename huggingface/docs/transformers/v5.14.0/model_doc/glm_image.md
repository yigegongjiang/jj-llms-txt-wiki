...
- **image_size** (`Union[int, list[int], tuple[int, int]]`, *optional*, defaults to `2048`) --
...
- **vision_vocab_size** (`int`, *optional*, defaults to 16512) --
  ...
  represented by the `inputs_ids` passed when calling [GlmImageVisionModel](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageVisionModel)
- **attention_bias** (`bool`, *optional*, defaults to `True`) --
  Whether to use a bias in the query, key, value and output projection layers during self-attention.
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `16385`) --
...
- **image_processor** ([GlmImageProcessor](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageProcessor), *optional*) --
  The image processor is a required input.
- **tokenizer** ([PreTrainedTokenizerFast](/docs/transformers/v5.14.0/en/main_classes/tokenizer#transformers.TokenizersBackend), *optional*) --
...
[__call__()](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageProcessor.__call__) and [decode()](/docs/transformers/v5.14.0/en/model_doc/donut#transformers.DonutProcessor.decode) for more information.
...
and `kwargs` arguments to PreTrainedTokenizerFast's [__call__()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) if `text` is not `None` to encode
the text.
...
- **grid_thw** (`torch.Tensor` of shape `(num_images, 3)`) --
  The temporal, height and width of feature shape of each image.`torch.Tensor` of shape `(total_patches, hidden_size)`Hidden states.
The [GlmImageVisionModel](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageVisionModel) forward method, overrides the `__call__` special method.
...
- **config** ([GlmImageTextConfig](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageTextConfig)) --
...
The [GlmImageTextModel](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageTextModel) forward method, overrides the `__call__` special method.
...
- **config** ([GlmImageVQVAEConfig](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageVQVAEConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **config** ([GlmImageModel](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageModel)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **images_per_sample** (`torch.LongTensor` of shape `(batch_size,)`, *optional*) --
  Number of images (including target grids) for each sample in the batch.`GlmImageModelOutputWithPast` or `tuple(torch.FloatTensor)`A `GlmImageModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.
The [GlmImageModel](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GlmImageConfig](/docs/transformers/v5.14.0/en/model_doc/glm_image#transformers.GlmImageConfig)) and inputs.
