...
[XCLIPProcessor](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPProcessor) offers all the functionalities of `image_processor_class` and `tokenizer_class`. See the
...
- **config** ([XCLIPConfig](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPConfig)) --
...
- **interpolate_pos_encoding** (`bool`, *optional*, defaults to `False`) --
  Whether to interpolate the pre-trained position encodings.`XCLIPOutput` or `tuple(torch.FloatTensor)`A `XCLIPOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XCLIPConfig](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPConfig)) and inputs.
The [XCLIPModel](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPModel) forward method, overrides the `__call__` special method.
...
- **logits_per_text** (`torch.FloatTensor` of shape `(text_batch_size, video_batch_size)`) -- The scaled dot product scores between `text_embeds` and `video_embeds`. This represents the text-video
  similarity scores.
- **text_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The text embeddings obtained by applying the projection layer to the pooled output of [XCLIPTextModel](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPTextModel).
- **text_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [XCLIPTextModel](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPTextModel).
- **vision_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [XCLIPVisionModel](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPVisionModel).
...
- **video_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The video embeddings obtained by applying the projection layer to the pooled output of
  [XCLIPVisionModel](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPVisionModel).
...
- **config** ([XCLIPTextConfig](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPTextConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XCLIPConfig](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPConfig)) and inputs.
The [XCLIPTextModel](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPTextModel) forward method, overrides the `__call__` special method.
...
- **config** ([XCLIPVisionConfig](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPVisionConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([XCLIPConfig](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPConfig)) and inputs.
The [XCLIPVisionModel](/docs/transformers/v5.14.0/en/model_doc/xclip#transformers.XCLIPVisionModel) forward method, overrides the `__call__` special method.
