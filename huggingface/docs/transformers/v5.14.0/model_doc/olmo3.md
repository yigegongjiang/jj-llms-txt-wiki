...
- Load specific intermediate checkpoints by adding the `revision` parameter to [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained).
...
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `50279`) --
...
- **config** ([Olmo3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/olmo3#transformers.Olmo3ForCausalLM)) --
...
elements depending on the configuration ([Olmo3Config](/docs/transformers/v5.14.0/en/model_doc/olmo3#transformers.Olmo3Config)) and inputs.
The [Olmo3ForCausalLM](/docs/transformers/v5.14.0/en/model_doc/olmo3#transformers.Olmo3ForCausalLM) forward method, overrides the `__call__` special method.
...
- **config** ([Olmo3Config](/docs/transformers/v5.14.0/en/model_doc/olmo3#transformers.Olmo3Config)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Olmo3Config](/docs/transformers/v5.14.0/en/model_doc/olmo3#transformers.Olmo3Config)) and inputs.
The [Olmo3Model](/docs/transformers/v5.14.0/en/model_doc/olmo3#transformers.Olmo3Model) forward method, overrides the `__call__` special method.
