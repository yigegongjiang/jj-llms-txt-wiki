...
- **config** ([Qwen3MoeConfig](/docs/transformers/v5.14.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeConfig)) --
...
elements depending on the configuration ([Qwen3MoeConfig](/docs/transformers/v5.14.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeConfig)) and inputs.
The [Qwen3MoeModel](/docs/transformers/v5.14.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeModel) forward method, overrides the `__call__` special method.
...
- **config** ([Qwen3MoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Qwen3MoeConfig](/docs/transformers/v5.14.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeConfig)) and inputs.
The [Qwen3MoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeForCausalLM) forward method, overrides the `__call__` special method.
