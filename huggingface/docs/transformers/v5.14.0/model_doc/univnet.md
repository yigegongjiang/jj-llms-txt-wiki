...
- **model_in_channels** (`int`, *optional*, defaults to 64) --
  ...
  `noise_sequence.shape[1]` and the value used in the [UnivNetFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor) class.
...
- **num_mel_bins** (`int`, *optional*, defaults to 100) --
  ...
  used in the [UnivNetFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor) class.
...
- **padding_value** (`float`, *optional*, defaults to 0.0) --
  ...
  [UnivNetFeatureExtractor.__call__()](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor.__call__). Should correspond to audio silence. The `pad_end` argument to
...
- **hop_length** (`int`, *optional*, defaults to 256) --
  ...
  that this is different from other audio feature extractors such as [SpeechT5FeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/speecht5#transformers.SpeechT5FeatureExtractor) which take
...
- **win_length** (`int`, *optional*, defaults to 1024) --
  ...
  extractors such as [SpeechT5FeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/speecht5#transformers.SpeechT5FeatureExtractor) which take the `win_length` in ms.
...
- **mel_floor** (`float`, *optional*, defaults to 1e-09) --
  Minimum value of mel frequency banks. Note that the way [UnivNetFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor) uses `mel_floor` is
  different than in [transformers.audio_utils.spectrogram()](/docs/transformers/v5.14.0/en/internal/audio_utils#transformers.audio_utils.spectrogram).
...
- **normalize_max** (`float`, *optional*, defaults to 2.3143386840820312) --
  ...
  Tacotron 2 implementation.
- **model_in_channels** (`int`, *optional*, defaults to 64) --
  The number of input channels to the [UnivNetModel](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetModel) model. This should match
...
- **return_attention_mask** (`bool`, *optional*, defaults to `True`) --
  Whether or not [__call__()](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor.__call__) should return `attention_mask`.
...
- **return_noise** (`bool`, *optional*, defaults to `True`) --
  Whether to generate and return a noise waveform for use in [UnivNetModel.forward()](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetModel.forward).
...
- **config** ([UnivNetConfig](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetConfig)) --
...
- **input_features** (`torch.FloatTensor` of shape `(batch_size, sequence_length, feature_dim)`) --
  The tensors corresponding to the input audio features. Audio features can be obtained using
  [UnivNetFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor). See [UnivNetFeatureExtractor.__call__()](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor.__call__) for details (`processor_class` uses
  [UnivNetFeatureExtractor](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor) for processing audios).
...
- **generator** (`torch.Generator`, *optional*) --
  ...
  deterministic.
  return_dict:
  Whether to return a [ModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput) subclass instead of a plain tuple.
- **return_dict** (`bool`, *optional*) --
  Whether or not to return a [ModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput) instead of a plain tuple.`UnivNetModelOutput` or `tuple(torch.FloatTensor)`A `UnivNetModelOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([UnivNetConfig](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetConfig)) and inputs.
The [UnivNetModel](/docs/transformers/v5.14.0/en/model_doc/univnet#transformers.UnivNetModel) forward method, overrides the `__call__` special method.
