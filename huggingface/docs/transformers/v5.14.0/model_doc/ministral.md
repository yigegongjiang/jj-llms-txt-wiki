...
- **config** ([MinistralConfig](/docs/transformers/v5.14.0/en/model_doc/ministral#transformers.MinistralConfig)) --
...
elements depending on the configuration ([MinistralConfig](/docs/transformers/v5.14.0/en/model_doc/ministral#transformers.MinistralConfig)) and inputs.
The [MinistralModel](/docs/transformers/v5.14.0/en/model_doc/ministral#transformers.MinistralModel) forward method, overrides the `__call__` special method.
...
- **config** ([MinistralForCausalLM](/docs/transformers/v5.14.0/en/model_doc/ministral#transformers.MinistralForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MinistralConfig](/docs/transformers/v5.14.0/en/model_doc/ministral#transformers.MinistralConfig)) and inputs.
The [MinistralForCausalLM](/docs/transformers/v5.14.0/en/model_doc/ministral#transformers.MinistralForCausalLM) forward method, overrides the `__call__` special method.
