...
- **config** ([DiffLlamaConfig](/docs/transformers/v5.14.0/en/model_doc/diffllama#transformers.DiffLlamaConfig)) --
...
elements depending on the configuration ([DiffLlamaConfig](/docs/transformers/v5.14.0/en/model_doc/diffllama#transformers.DiffLlamaConfig)) and inputs.
The [DiffLlamaModel](/docs/transformers/v5.14.0/en/model_doc/diffllama#transformers.DiffLlamaModel) forward method, overrides the `__call__` special method.
...
- **config** ([DiffLlamaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/diffllama#transformers.DiffLlamaForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DiffLlamaConfig](/docs/transformers/v5.14.0/en/model_doc/diffllama#transformers.DiffLlamaConfig)) and inputs.
The [DiffLlamaForCausalLM](/docs/transformers/v5.14.0/en/model_doc/diffllama#transformers.DiffLlamaForCausalLM) forward method, overrides the `__call__` special method.
