...
- The Funnel Transformer checkpoints are all available with a full version and a base version. The first ones should be
  used for [FunnelModel](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelModel), [FunnelForPreTraining](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForPreTraining),
  [FunnelForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForMaskedLM), [FunnelForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForTokenClassification) and
  [FunnelForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForQuestionAnswering). The second ones should be used for
  [FunnelBaseModel](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelBaseModel), [FunnelForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForSequenceClassification) and
  [FunnelForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForMultipleChoice).
...
'"}, {"name": "sep_token", "val": ": str = ''"}, {"name": "pad_token", "val": ": str = ''"}, {"name": "cls_token", "val": ": str = ''"}, {"name": "mask_token", "val": ": str = ''"}, {"name": "bos_token", "val": ": str = ''"}, {"name": "eos_token", "val": ": str = ''"}, {"name": "clean_text", "val": ": bool = True"}, {"name": "tokenize_chinese_chars", "val": ": bool = True"}, {"name": "strip_accents", "val": ": bool | None = None"}, {"name": "wordpieces_prefix", "val": ": str = '##'"}, {"name": "**kwargs", "val": ""}]}>
- **vocab_file** (`str`) --
...
Output type of [FunnelForPreTraining](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForPreTraining).

## FunnelBaseModel[[transformers.FunnelBaseModel]]

- **config** ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) --
...
elements depending on the configuration ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) and inputs.
The [FunnelBaseModel](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelBaseModel) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) and inputs.
The [FunnelModel](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelModel) forward method, overrides the `__call__` special method.
...
- **output_hidden_states** (`bool`, *optional*) --
  ...
  more detail.
- **return_dict** (`bool`, *optional*) --
  Whether or not to return a [ModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput) instead of a plain tuple.[FunnelForPreTrainingOutput](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.models.funnel.modeling_funnel.FunnelForPreTrainingOutput) or `tuple(torch.FloatTensor)`A [FunnelForPreTrainingOutput](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.models.funnel.modeling_funnel.FunnelForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) and inputs.
The [FunnelForPreTraining](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForPreTraining) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) and inputs.
The [FunnelForMaskedLM](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForMaskedLM) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) and inputs.
The [FunnelForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForSequenceClassification) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) and inputs.
The [FunnelForMultipleChoice](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForMultipleChoice) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) and inputs.
The [FunnelForTokenClassification](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForTokenClassification) forward method, overrides the `__call__` special method.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([FunnelConfig](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelConfig)) and inputs.
The [FunnelForQuestionAnswering](/docs/transformers/v5.14.0/en/model_doc/funnel#transformers.FunnelForQuestionAnswering) forward method, overrides the `__call__` special method.
