...
- **eos_token_id** (`Union[int, list[int]]`, *optional*, defaults to `53`) --
...
- **config** ([ExaoneMoeConfig](/docs/transformers/v5.14.0/en/model_doc/exaone_moe#transformers.ExaoneMoeConfig)) --
...
- **config** ([ExaoneMoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/exaone_moe#transformers.ExaoneMoeForCausalLM)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
elements depending on the configuration ([ExaoneMoeConfig](/docs/transformers/v5.14.0/en/model_doc/exaone_moe#transformers.ExaoneMoeConfig)) and inputs.
The [ExaoneMoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/exaone_moe#transformers.ExaoneMoeForCausalLM) forward method, overrides the `__call__` special method.
