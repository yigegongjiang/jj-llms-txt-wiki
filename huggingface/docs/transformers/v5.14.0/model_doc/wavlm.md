...
- WavLM is a speech model that accepts a float array corresponding to the raw waveform of the speech signal. Please use
  [Wav2Vec2Processor](/docs/transformers/v5.14.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor) for the feature extraction.
...
- **final_dropout** (`float`, *optional*, defaults to 0.1) --
  The dropout probability for the final projection layer of [WavLMForCTC](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForCTC).
...
- **ctc_zero_infinity** (`bool`, *optional*, defaults to `False`) --
  ...
  of [WavLMForCTC](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForCTC).
- **use_weighted_layer_sum** (`bool`, *optional*, defaults to `False`) --
  Whether to use a weighted average of layer outputs with learned weights. Only relevant when using an
  instance of [WavLMForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForSequenceClassification).
...
- **config** ([WavLMConfig](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMConfig)) --
...
elements depending on the configuration ([WavLMConfig](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMConfig)) and inputs.
The [WavLMModel](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMModel) forward method, overrides the `__call__` special method.
...
- **config** ([WavLMForCTC](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForCTC)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
- **target_lang** (`str`, *optional*) --
  Language id of adapter weights. Adapter weights are stored in the format adapter..safetensors or
  adapter..bin. Only relevant when using an instance of [WavLMForCTC](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForCTC) with adapters. Uses 'eng' by
  default.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([WavLMConfig](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMConfig)) and inputs.
The [WavLMForCTC](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForCTC) forward method, overrides the `__call__` special method.
...
- **config** ([WavLMForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForSequenceClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([WavLMConfig](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMConfig)) and inputs.
The [WavLMForSequenceClassification](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([WavLMForAudioFrameClassification](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForAudioFrameClassification)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([WavLMConfig](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMConfig)) and inputs.
The [WavLMForAudioFrameClassification](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForAudioFrameClassification) forward method, overrides the `__call__` special method.
...
- **config** ([WavLMForXVector](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForXVector)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([WavLMConfig](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMConfig)) and inputs.
The [WavLMForXVector](/docs/transformers/v5.14.0/en/model_doc/wavlm#transformers.WavLMForXVector) forward method, overrides the `__call__` special method.
