...
- **config** ([GraniteMoeConfig](/docs/transformers/v5.14.0/en/model_doc/granitemoe#transformers.GraniteMoeConfig)) --
...
elements depending on the configuration ([GraniteMoeConfig](/docs/transformers/v5.14.0/en/model_doc/granitemoe#transformers.GraniteMoeConfig)) and inputs.
The [GraniteMoeModel](/docs/transformers/v5.14.0/en/model_doc/granitemoe#transformers.GraniteMoeModel) forward method, overrides the `__call__` special method.
...
The [GraniteMoeForCausalLM](/docs/transformers/v5.14.0/en/model_doc/granitemoe#transformers.GraniteMoeForCausalLM) forward method, overrides the `__call__` special method.
