...
- **image_size** (`Union[int, list[int]]`, *optional*) --
...
[Sam2Processor](/docs/transformers/v5.14.0/en/model_doc/sam2#transformers.Sam2Processor) offers all the functionalities of [Sam2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/sam2#transformers.Sam2ImageProcessor). See the
[~Sam2ImageProcessor](/docs/transformers/v5.14.0/en/model_doc/sam2#transformers.Sam2ImageProcessor) for more information.
...
- **config** ([Sam2VisionConfig](/docs/transformers/v5.14.0/en/model_doc/sam2#transformers.Sam2VisionConfig)) --
...
- **config** ([Sam2Config](/docs/transformers/v5.14.0/en/model_doc/sam2#transformers.Sam2Config)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
- **target_embedding** (`torch.FloatTensor`, *optional*) --
  ...
  the model is used for personalization as introduced in [PerSAM](https://huggingface.co/papers/2305.03048).`Sam2ImageSegmentationOutput` or `tuple(torch.FloatTensor)`A `Sam2ImageSegmentationOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Sam2Config](/docs/transformers/v5.14.0/en/model_doc/sam2#transformers.Sam2Config)) and inputs.
The [Sam2Model](/docs/transformers/v5.14.0/en/model_doc/sam2#transformers.Sam2Model) forward method, overrides the `__call__` special method.
...
- **pixel_values** (`torch.FloatTensor`) --
  Input pixel values of shape `(batch_size, num_channels, height, width)`.`Sam2VisionEncoderOutput` or `tuple(torch.FloatTensor)`A `Sam2VisionEncoderOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Sam2Config](/docs/transformers/v5.14.0/en/model_doc/sam2#transformers.Sam2Config)) and inputs.
