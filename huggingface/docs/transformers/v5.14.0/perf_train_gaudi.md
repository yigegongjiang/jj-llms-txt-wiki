...
[TrainingArguments](/docs/transformers/v5.14.0/en/main_classes/trainer#transformers.TrainingArguments), [Trainer](/docs/transformers/v5.14.0/en/main_classes/trainer#transformers.Trainer), and [Pipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.Pipeline) detect Intel Gaudi devices and set the backend to `hpu` automatically.
...
Gaudi supports [torch.compile](). [TrainingArguments](/docs/transformers/v5.14.0/en/main_classes/trainer#transformers.TrainingArguments) automatically sets `torch_compile_backend` to `"hpu_backend"` when HPU is detected.
