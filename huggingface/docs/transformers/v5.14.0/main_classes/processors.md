...
- **audio_replacements** (*list[str]*, *optional*, defaults to *[]*) --
  ...
  *self._process_audio*.*tuple[list[str], list[dict[str, Any]]]*A tuple of:
...
- **input_ids** (*list[list[int]]*) --
  ...
  uniformly-shaped array.*list[list[int]]*A list of the same structure as `input_ids`, where each
...
- **padding** (`bool`, `str` or [PaddingStrategy](/docs/transformers/v5.14.0/en/internal/file_utils#transformers.utils.PaddingStrategy), *optional*) --
...
- **load_audio_backend** (`str`, *optional*) --
  Backend used by `load_audio()` to decode/resample audio referenced by URL/path
...
[DataProcessor](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.DataProcessor). The processor returns a list of
[InputExample](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.InputExample). These
[InputExample](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.InputExample) can be converted to
[InputFeatures](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.InputFeatures) in order to be fed to the model.

Base class for data converters for sequence classification data sets.

Gets a collection of [InputExample](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.InputExample) for the dev set.
...
Gets a collection of [InputExample](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.InputExample) for the test set.

Gets a collection of [InputExample](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.InputExample) for the train set.
...
[InputExample](/docs/transformers/v5.14.0/en/main_classes/processors#transformers.InputExample).
...
- **output_mode** -- String indicating the output mode. Either `regression` or `classification`Will return a list of task-specific `InputFeatures` which can be fed to the model.
...
- **evaluate** -- Boolean specifying if in evaluation mode or in training modeList of SquadExample
...
- **tokenizer** -- an instance of a child of [PreTrainedTokenizer](/docs/transformers/v5.14.0/en/main_classes/tokenizer#transformers.PythonBackend)
...
- **threads** -- multiple processing threads.list of `SquadFeatures`
