...
All models have outputs that are instances of subclasses of [ModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput). Those are
...
The `outputs` object is a [SequenceClassifierOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput), as we can see in the
...
You can't unpack a `ModelOutput` directly. Use the [to_tuple()](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput.to_tuple) method to convert it to a tuple
before.
...
Output type of [Wav2Vec2ForXVector](/docs/transformers/v5.14.0/en/model_doc/wav2vec2#transformers.Wav2Vec2ForXVector).
