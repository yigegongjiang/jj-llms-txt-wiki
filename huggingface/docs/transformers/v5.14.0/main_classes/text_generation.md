...
- PyTorch [generate()](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationMixin.generate) is implemented in [GenerationMixin](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationMixin).

You can parameterize the generate method with a [GenerationConfig](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig) class instance. Please refer to this class for the complete list of generation parameters, which control the behavior of the generation method.
...
- **bad_words_ids** (`list[list[int]]`, *optional*) --
  ...
  [NoBadWordsLogitsProcessor](/docs/transformers/v5.14.0/en/internal/generation_utils#transformers.NoBadWordsLogitsProcessor) for further documentation and examples.
...
- **sequence_bias** (`dict[tuple[int], float]`, *optional*)) --
  ...
  [SequenceBiasLogitsProcessor](/docs/transformers/v5.14.0/en/internal/generation_utils#transformers.SequenceBiasLogitsProcessor) for further documentation and examples.
- **token_healing** (`bool`) --
...
- **watermarking_config** (`BaseWatermarkingConfig` or `dict`, *optional*) --
  ...
  tokens. See the docs of [SynthIDTextWatermarkingConfig](/docs/transformers/v5.14.0/en/internal/generation_utils#transformers.SynthIDTextWatermarkingConfig) and [WatermarkingConfig](/docs/transformers/v5.14.0/en/internal/generation_utils#transformers.WatermarkingConfig) for more
...
- **return_dict_in_generate** (`bool`) --
  Whether or not to return a [ModelOutput](/docs/transformers/v5.14.0/en/main_classes/output#transformers.utils.ModelOutput), as opposed to returning exclusively the generated
...
- **kwargs** (`dict[str, Any]`, *optional*) --
  ...
  by the `return_unused_kwargs` keyword parameter.[GenerationConfig](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig)The configuration object instantiated from this pretrained model.

Instantiate a [GenerationConfig](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig) from a generation configuration file.
...
- **model_config** (`PreTrainedConfig | dict`) --
  The model config that will be used to instantiate the generation config.[GenerationConfig](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig)The configuration object instantiated from those parameters.

Instantiates a [GenerationConfig](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig) from a [PreTrainedConfig](/docs/transformers/v5.14.0/en/main_classes/configuration#transformers.PreTrainedConfig). This function is useful to convert legacy
[PreTrainedConfig](/docs/transformers/v5.14.0/en/main_classes/configuration#transformers.PreTrainedConfig) objects, which may contain generation parameters, into a stand-alone [GenerationConfig](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig).
...
[from_pretrained()](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig.from_pretrained) class method.
...
- **kwargs** (`dict[str, Any]`) --
  Dictionary of attributes to tentatively update this class.`dict[str, Any]`Dictionary containing all the key-value pairs that were not used to update the instance.
...
Validates the values of the attributes of the [GenerationConfig](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig) instance. Raises exceptions in the presence
...
- **assistant_model** (`PreTrainedModel`, *optional*) --
  ...
  assisted generation.`GenerationMode`The generation mode triggered by the instance.

Returns the generation mode triggered by the [GenerationConfig](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationConfig) instance.
...
The class exposes [generate()](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationMixin.generate), which can be used for:
- *greedy decoding* if `num_beams=1` and `do_sample=False`
- *multinomial sampling* if `num_beams=1` and `do_sample=True`
- *beam-search decoding* if `num_beams>1` and `do_sample=False`
- *beam-search multinomial sampling* if `num_beams>1` and `do_sample=True`
...
- **normalize_logits** (`bool`, *optional*, defaults to `False`) --
  Whether to normalize the logits (which, for legacy reasons, may be unnormalized).`torch.Tensor`A `torch.Tensor` of shape `(batch_size*num_return_sequences, sequence_length)` containing
...
- **workload_hints** -- Optional WorkloadHints to help the continuous batching manager make better decisions for
  default values`ContinuousBatchingManager`The manager instance to add requests and retrieve results.
