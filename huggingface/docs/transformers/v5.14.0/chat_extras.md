...
When a model supports tool-use, pass functions to the `tools` argument of [apply_chat_template()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.apply_chat_template).
...
Next, pass `messages` and a list of tools to [apply_chat_template()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.apply_chat_template). Tokenize the chat and generate a response.
...
[parse_response()](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.parse_response) to extract the tool call. For other models, you'll need to manually translate the output
