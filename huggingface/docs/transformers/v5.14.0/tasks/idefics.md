...
The IDEFICS processor wraps a [LlamaTokenizer](/docs/transformers/v5.14.0/en/model_doc/llama#transformers.LlamaTokenizer) and IDEFICS image processor into a single processor to take care of
