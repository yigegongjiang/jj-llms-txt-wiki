...
When you use Transformers' [Cache](/docs/transformers/v5.14.0/en/internal/generation_utils#transformers.Cache) class, the self-attention module performs several critical steps to integrate past and present information.
...
The example below demonstrates how to create a generation loop with [DynamicCache](/docs/transformers/v5.14.0/en/internal/generation_utils#transformers.DynamicCache). As discussed, the attention mask is a concatenation of past and current token values.
