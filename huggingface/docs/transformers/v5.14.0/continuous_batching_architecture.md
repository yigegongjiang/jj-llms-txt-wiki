...
Set the scheduler in [ContinuousBatchingConfig](/docs/transformers/v5.14.0/en/main_classes/continuous_batching#transformers.ContinuousBatchingConfig).
...
You can pin the values explicitly in [ContinuousBatchingConfig](/docs/transformers/v5.14.0/en/main_classes/continuous_batching#transformers.ContinuousBatchingConfig).
