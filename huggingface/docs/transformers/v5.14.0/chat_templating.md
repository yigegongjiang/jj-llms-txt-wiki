...
The [chat basics](./conversations) guide covers how to store chat histories and generate text from chat models using [TextGenerationPipeline](/docs/transformers/v5.14.0/en/main_classes/pipelines#transformers.TextGenerationPipeline).
...
Pass the tokenized chat to [generate()](/docs/transformers/v5.14.0/en/main_classes/text_generation#transformers.GenerationMixin.generate) to generate a response.
...
You may have noticed the [add_generation_prompt](/docs/transformers/v5.14.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.apply_chat_template.add_generation_prompt) argument in the above examples.
