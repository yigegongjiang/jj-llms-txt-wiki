...
```python
diffusers.KDPM2DiscreteScheduler(num_train_timesteps: int = 1000, beta_start: float = 0.00085, beta_end: float = 0.012, beta_schedule: str = 'linear', trained_betas: numpy.ndarray | list[float] | None = None, use_karras_sigmas: bool = False, use_exponential_sigmas: bool = False, use_beta_sigmas: bool = False, prediction_type: str = 'epsilon', timestep_spacing: str = 'linspace', steps_offset: int = 0)
```

[Source](https://github.com/huggingface/diffusers/blob/v0.40.0/src/diffusers/schedulers/scheduling_k_dpm_2_discrete.py#L103)
...
#### add_noise[[diffusers.KDPM2DiscreteScheduler.add_noise]]

```python
add_noise(original_samples: Tensor, noise: Tensor, timesteps: Tensor)
```

[Source](https://github.com/huggingface/diffusers/blob/v0.40.0/src/diffusers/schedulers/scheduling_k_dpm_2_discrete.py#L666)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.40.0/src/diffusers/schedulers/scheduling_k_dpm_2_discrete.py#L365)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.40.0/src/diffusers/schedulers/scheduling_k_dpm_2_discrete.py#L236)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.40.0/src/diffusers/schedulers/scheduling_k_dpm_2_discrete.py#L226)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.40.0/src/diffusers/schedulers/scheduling_k_dpm_2_discrete.py#L266)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.40.0/src/diffusers/schedulers/scheduling_k_dpm_2_discrete.py#L570)
...
return_dict (`bool`, defaults to `True`) : Whether or not to return a `KDPM2DiscreteSchedulerOutput` or tuple.

**Returns:**

`KDPM2DiscreteSchedulerOutput` or `tuple[torch.Tensor,
torch.Tensor]`:
