...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_k_dpm_2_ancestral_discrete.py#L104)
...
add_noisediffusers.KDPM2AncestralDiscreteScheduler.add_noisehttps://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_k_dpm_2_ancestral_discrete.py#L669[{"name": "original_samples", "val": ": Tensor"}, {"name": "noise", "val": ": Tensor"}, {"name": "timesteps", "val": ": Tensor"}]- **original_samples** (`torch.Tensor`) --
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_k_dpm_2_ancestral_discrete.py#L515)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_k_dpm_2_ancestral_discrete.py#L222)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_k_dpm_2_ancestral_discrete.py#L212)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_k_dpm_2_ancestral_discrete.py#L252)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_k_dpm_2_ancestral_discrete.py#L561)
...
return_dict (`bool`) : Whether or not to return a `KDPM2AncestralDiscreteSchedulerOutput` or tuple.

**Returns:**

``KDPM2AncestralDiscreteSchedulerOutput` or `tuple``
