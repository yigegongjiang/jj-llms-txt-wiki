...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_sde_ve.py#L45)
...
scale_model_inputdiffusers.ScoreSdeVeScheduler.scale_model_inputhttps://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_sde_ve.py#L88[{"name": "sample", "val": ": Tensor"}, {"name": "timestep", "val": ": int = None"}]- **sample** (`torch.Tensor`) --
  The input sample.
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_sde_ve.py#L122)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_sde_ve.py#L105)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_sde_ve.py#L225)
...
return_dict (`bool`, *optional*, defaults to `True`) : Whether or not to return a [SdeVeOutput](/docs/diffusers/v0.39.0/en/api/schedulers/score_sde_ve#diffusers.schedulers.scheduling_sde_ve.SdeVeOutput) or `tuple`.

**Returns:**

`[SdeVeOutput](/docs/diffusers/v0.39.0/en/api/schedulers/score_sde_ve#diffusers.schedulers.scheduling_sde_ve.SdeVeOutput) or `tuple``

If return_dict is `True`, [SdeVeOutput](/docs/diffusers/v0.39.0/en/api/schedulers/score_sde_ve#diffusers.schedulers.scheduling_sde_ve.SdeVeOutput) is returned, otherwise a tuple
is returned where the first element is the sample tensor.
#### step_pred[[diffusers.ScoreSdeVeScheduler.step_pred]]

[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_sde_ve.py#L157)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_sde_ve.py#L29)
