...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_dpmsolver_sde.py#L195)
...
add_noisediffusers.DPMSolverSDEScheduler.add_noisehttps://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_dpmsolver_sde.py#L776[{"name": "original_samples", "val": ": Tensor"}, {"name": "noise", "val": ": Tensor"}, {"name": "timesteps", "val": ": Tensor"}]- **original_samples** (`torch.Tensor`) --
...
#### index_for_timestep[[diffusers.DPMSolverSDEScheduler.index_for_timestep]]

[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_dpmsolver_sde.py#L304)
...
#### scale_model_input[[diffusers.DPMSolverSDEScheduler.scale_model_input]]

[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_dpmsolver_sde.py#L383)
...
#### set_begin_index[[diffusers.DPMSolverSDEScheduler.set_begin_index]]

[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_dpmsolver_sde.py#L373)
...
#### set_timesteps[[diffusers.DPMSolverSDEScheduler.set_timesteps]]

[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_dpmsolver_sde.py#L410)
...
num_train_timesteps (`int`, *optional*) : The number of train timesteps. If `None`, uses `self.config.num_train_timesteps`.
#### step[[diffusers.DPMSolverSDEScheduler.step]]

[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/schedulers/scheduling_dpmsolver_sde.py#L655)
...
If return_dict is `True`, `DPMSolverSDESchedulerOutput` is
