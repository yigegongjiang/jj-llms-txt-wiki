...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/llada2/pipeline_llada2.py#L59)
...
- **return_dict** (`bool`, *optional*, defaults to `True`) --
  Whether to return a [LLaDA2PipelineOutput](/docs/diffusers/v0.39.0/en/api/pipelines/llada2#diffusers.LLaDA2PipelineOutput) instead of a tuple.
...
- **callback_on_step_end_tensor_inputs** (`List[str]`, *optional*) --
  ...
  `editing_transfer_index`, `sampled_tokens`, `sampled_probs`, `active_block`.0[LLaDA2PipelineOutput](/docs/diffusers/v0.39.0/en/api/pipelines/llada2#diffusers.LLaDA2PipelineOutput) or `tuple`If `return_dict` is `True`, [LLaDA2PipelineOutput](/docs/diffusers/v0.39.0/en/api/pipelines/llada2#diffusers.LLaDA2PipelineOutput) is returned,
...
return_dict (`bool`, *optional*, defaults to `True`) : Whether to return a [LLaDA2PipelineOutput](/docs/diffusers/v0.39.0/en/api/pipelines/llada2#diffusers.LLaDA2PipelineOutput) instead of a tuple.
...
`[LLaDA2PipelineOutput](/docs/diffusers/v0.39.0/en/api/pipelines/llada2#diffusers.LLaDA2PipelineOutput) or `tuple``

If `return_dict` is `True`, [LLaDA2PipelineOutput](/docs/diffusers/v0.39.0/en/api/pipelines/llada2#diffusers.LLaDA2PipelineOutput) is returned,
otherwise a `tuple` is returned where the first element is the generated token IDs (`torch.LongTensor`)
and the second element is the decoded texts (`list[str]`), or `None` when `output_type` is `"seq"`.
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/llada2/pipeline_llada2.py#L54)
