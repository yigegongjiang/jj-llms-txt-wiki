...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L363)

[AutoPipelineForText2Image](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForText2Image) is a generic pipeline class that instantiates a text-to-image pipeline class. The
specific underlying pipeline class is automatically selected from either the
[from_pretrained()](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForText2Image.from_pretrained) or [from_pipe()](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForText2Image.from_pipe) methods.
...
from_pretraineddiffusers.AutoPipelineForText2Image.from_pretrainedhttps://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L388[{"name": "pretrained_model_or_path", "val": ""}, {"name": "**kwargs", "val": ""}]- **pretrained_model_or_path** (`str` or `os.PathLike`, *optional*) --
  Can be either:
  ...
  - A path to a *directory* (for example `./my_pipeline_directory/`) containing pipeline weights
    saved using
  [save_pretrained()](/docs/diffusers/v0.39.0/en/api/pipelines/overview#diffusers.DiffusionPipeline.save_pretrained).
...
If a `controlnet` argument is passed, it will instantiate a [StableDiffusionControlNetPipeline](/docs/diffusers/v0.39.0/en/api/pipelines/controlnet#diffusers.StableDiffusionControlNetPipeline) object.
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L536)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L653)

[AutoPipelineForImage2Image](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForImage2Image) is a generic pipeline class that instantiates an image-to-image pipeline class. The
specific underlying pipeline class is automatically selected from either the
[from_pretrained()](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForImage2Image.from_pretrained) or [from_pipe()](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForImage2Image.from_pipe) methods.
...
from_pretraineddiffusers.AutoPipelineForImage2Image.from_pretrainedhttps://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L678[{"name": "pretrained_model_or_path", "val": ""}, {"name": "**kwargs", "val": ""}]- **pretrained_model_or_path** (`str` or `os.PathLike`, *optional*) --
  Can be either:
...
If a `controlnet` argument is passed, it will instantiate a [StableDiffusionControlNetImg2ImgPipeline](/docs/diffusers/v0.39.0/en/api/pipelines/controlnet#diffusers.StableDiffusionControlNetImg2ImgPipeline)
object.
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L837)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L959)

[AutoPipelineForInpainting](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForInpainting) is a generic pipeline class that instantiates an inpainting pipeline class. The
specific underlying pipeline class is automatically selected from either the
[from_pretrained()](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForInpainting.from_pretrained) or [from_pipe()](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForInpainting.from_pipe) methods.
...
from_pretraineddiffusers.AutoPipelineForInpainting.from_pretrainedhttps://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L984[{"name": "pretrained_model_or_path", "val": ""}, {"name": "**kwargs", "val": ""}]- **pretrained_model_or_path** (`str` or `os.PathLike`, *optional*) --
  Can be either:
...
If a `controlnet` argument is passed, it will instantiate a [StableDiffusionControlNetInpaintPipeline](/docs/diffusers/v0.39.0/en/api/pipelines/controlnet#diffusers.StableDiffusionControlNetInpaintPipeline)
object.
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L1140)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L1259)

[AutoPipelineForText2Audio](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForText2Audio) is a generic pipeline class that instantiates a text-to-audio pipeline class. The
specific underlying pipeline class is automatically selected from either the
[from_pretrained()](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForText2Audio.from_pretrained) or [from_pipe()](/docs/diffusers/v0.39.0/en/api/pipelines/auto_pipeline#diffusers.AutoPipelineForText2Audio.from_pipe) methods.
...
from_pretraineddiffusers.AutoPipelineForText2Audio.from_pretrainedhttps://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L1284[{"name": "pretrained_model_or_path", "val": ""}, {"name": "**kwargs", "val": ""}]- **pretrained_model_or_path** (`str` or `os.PathLike`, *optional*) --
  Can be either:
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/pipelines/auto_pipeline.py#L1420)
