...
The `VideoProcessor` provides a unified API for video pipelines to prepare inputs for VAE encoding and post-processing outputs once they're decoded. The class inherits [VaeImageProcessor](/docs/diffusers/v0.39.0/en/api/image_processor#diffusers.VaeImageProcessor) so it includes transformations such as resizing, normalization, and conversion between PIL Image, PyTorch, and NumPy arrays.
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/video_processor.py#L28)
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/video_processor.py#L93)
