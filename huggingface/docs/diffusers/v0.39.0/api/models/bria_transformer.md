...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/models/transformers/transformer_bria.py#L504)
...
The [BriaTransformer2DModel](/docs/diffusers/v0.39.0/en/api/models/bria_transformer#diffusers.BriaTransformer2DModel) forward method.
