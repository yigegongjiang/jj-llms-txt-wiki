...
[AutoModel](/docs/diffusers/v0.39.0/en/api/models/auto_model#diffusers.AutoModel) automatically retrieves the correct model class from the checkpoint `config.json` file.

## AutoModel[[diffusers.AutoModel]]

#### diffusers.AutoModel[[diffusers.AutoModel]]

[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/models/auto_model.py#L27)

from_pretraineddiffusers.AutoModel.from_pretrainedhttps://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/models/auto_model.py#L155[{"name": "pretrained_model_or_path", "val": ": str | os.PathLike | None = None"}, {"name": "**kwargs", "val": ""}]- **pretrained_model_name_or_path** (`str` or `os.PathLike`, *optional*) --
  Can be either:
...
[Source](https://github.com/huggingface/diffusers/blob/v0.39.0/src/diffusers/models/auto_model.py#L38)
