...
After xFormers is installed, you can use it with [set_attention_backend()](/docs/diffusers/v0.39.0/en/api/models/overview#diffusers.ModelMixin.set_attention_backend) as shown in the [Attention backends](./attention_backends) guide.
