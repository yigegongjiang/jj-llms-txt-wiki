...
"}, {"name": "init_weights", "val": ": Optional[Union[bool, Literal['gaussian', 'kaiming_uniform', 'xavier_uniform']]] = 'xavier_uniform'"}]}>
- **block_size** (`int`) --
...
- **adapter_name** (`str`) -- The name of the adapter, defaults to `"default"`.`torch.nn.Module`The C3A model.
