...
"}, {"name": "init_weights", "val": ": bool = False"}]}>
- **n_frequency** (`int`) --
...
- **low_cpu_mem_usage** (`bool`, `optional`, defaults to `False`) --
  Create empty adapter weights on meta device. Useful to speed up the loading process.`torch.nn.Module`The FourierFT model.
