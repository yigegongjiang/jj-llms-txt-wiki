...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/run.py#L43)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/run.py#L1588)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/run.py#L1501)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L241)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L687)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L783)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L707)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L721)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L758)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L853)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L1105)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/deploy.py#L1075)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/deploy.py#L1230)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L899)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/imports.py#L9)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/imports.py#L163)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/__init__.py#L954)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L114)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L316)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L296)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L346)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L497)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L762)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L580)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L625)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/artifact.py#L286)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/registry.py#L51)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/registry.py#L145)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/registry.py#L163)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/registry.py#L113)
...
The [Collection](/docs/trackio/v0.37.0/en/api#trackio.Collection).
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/registry.py#L172)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/registry.py#L20)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/media/image.py#L13)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/media/video.py#L17)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/media/video.py#L93)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/media/audio.py#L19)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/media/audio.py#L90)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/media/object3d.py#L207)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/media/html.py#L17)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/table.py#L9)
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/table.py#L124)
...
#### trackio.Trace[[trackio.Trace]]

```python
trackio.Trace(messages: list[dict[str, Any]], metadata: dict | None = None, spans: list[dict[str, Any]] | None = None)
```

[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/trace.py#L8)

**Parameters:**

messages (`list[dict[str, Any]]`) : OpenAI-style messages, e.g. `{"role": "user", "content": "..."}`. Assistant messages may include `tool_calls`, and tool results may include `tool_call_id`; when no `spans` are provided, the dashboard pairs those into tool operations.

metadata (`dict`, *optional*) : Trace-level metadata, e.g. `session_id` or `environment`. The keys `status`, `duration_ms`, `latency_ms`, and `cost_usd` are used by the dashboard as trace-level fallbacks when spans do not supply them.

spans (`list[dict[str, Any]]`, *optional*) : Execution spans describing what produced the response. Each span is a dictionary keyed by `id`, `name`, and `kind` (`"span"`, `"generation"`, or `"tool"`), plus optional `parent_id`, `start_time`, `end_time`, `duration_ms`, `status`, `error`, `input`, `output`, `model`, `usage`, `cost_usd`, and `metadata`.
...
[Source](https://github.com/gradio-app/trackio/blob/v0.37.0/trackio/histogram.py#L6)
