...
To start tracking an experiment with Trackio, you first need to initialize a project with the [init()](/docs/trackio/v0.35.0/en/api#trackio.init) function:
...
Once your run is initialized, you can start logging data using the [log()](/docs/trackio/v0.35.0/en/api#trackio.log) function:
...
Each call to [log()](/docs/trackio/v0.35.0/en/api#trackio.log) automatically increments the step counter.
...
You can log tabular data using the [Table](/docs/trackio/v0.35.0/en/api#trackio.Table) class. This is useful for tracking results like predictions, or any structured data. Tables can include image columns using the [Image](/docs/trackio/v0.35.0/en/api#trackio.TrackioImage) class.
...
You can log images using the [Image](/docs/trackio/v0.35.0/en/api#trackio.TrackioImage) class.
...
You can log videos using the [Video](/docs/trackio/v0.35.0/en/api#trackio.TrackioVideo) class.
...
You can log audio using the [Audio](/docs/trackio/v0.35.0/en/api#trackio.TrackioAudio) class.
...
You can log HTML using the [Html](/docs/trackio/v0.35.0/en/api#trackio.TrackioHtml) class.
...
You can also log system metrics manually at specific times using [log_gpu()](/docs/trackio/v0.35.0/en/api#trackio.log_gpu):
...
When your run is complete, finalize it with [finish()](/docs/trackio/v0.35.0/en/api#trackio.finish).
...
interruption), call [init()](/docs/trackio/v0.35.0/en/api#trackio.init) again with the same project and run name, and set
`resume="must"`:
...
You can also track configuration parameters for your runs. This is useful for keeping track of hyperparameters or other settings used in your experiments. You can log configuration data using the `config` parameter in the [init()](/docs/trackio/v0.35.0/en/api#trackio.init) function:
