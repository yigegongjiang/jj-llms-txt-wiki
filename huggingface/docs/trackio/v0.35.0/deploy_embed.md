...
When calling [init()](/docs/trackio/v0.35.0/en/api#trackio.init), by default the service will run locally and store project data on the local machine.

But if you pass a `space_id` to [init()](/docs/trackio/v0.35.0/en/api#trackio.init), like:
