...
Publish an artifact version with [Run.link_artifact()](/docs/trackio/v0.36.0/en/api#trackio.Run.link_artifact):
...
You can also link from the artifact itself with [Artifact.link()](/docs/trackio/v0.36.0/en/api#trackio.Artifact.link), handy when the run isn't in scope:
...
Remove a link with [Artifact.unlink()](/docs/trackio/v0.36.0/en/api#trackio.Artifact.unlink), called on the linked artifact:
...
The [Registry](/docs/trackio/v0.36.0/en/api#trackio.Registry) handle lists collections and their linked versions. Reads return [Collection](/docs/trackio/v0.36.0/en/api#trackio.Collection) snapshots:
