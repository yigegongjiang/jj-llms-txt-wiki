...
Set the project and space ID directly in your TRL config (e.g. [SFTConfig](https://huggingface.co/docs/trl/v1.9.0/en/sft_trainer#trl.SFTConfig), [DPOConfig](https://huggingface.co/docs/trl/v1.9.0/en/dpo_trainer#trl.DPOConfig), [GRPOConfig](https://huggingface.co/docs/trl/v1.9.0/en/grpo_trainer#trl.GRPOConfig)):
