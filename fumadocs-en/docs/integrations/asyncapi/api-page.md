# Fumadocs (Framework Mode): createAsyncAPIPage()

Source: https://raw.githubusercontent.com/fuma-nama/fumadocs/refs/heads/main/apps/docs/content/docs/(framework)/integrations/asyncapi/api-page.mdx
