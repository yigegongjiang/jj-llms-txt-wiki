...
| Prop                | Type              | Description                                                                                                 |
| ------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------- |
| `defaultOpenLevel?` | `number`          | Open folders by default if their level is lower or equal to a specific level (Starting from 1) Default: `0` |
| `prefetch?`         | `union`           | Prefetch links, default behaviour depends on your React.js framework.                                       |
| `components?`       | `Partial<object>` |                                                                                                             |
| `banner?`           | `ReactNode`       |                                                                                                             |
| `footer?`           | `ReactNode`       |                                                                                                             |
| `collapsible?`      | `union`           | Support collapsing the sidebar on desktop mode Default: `true`                                              |
| `enabled?`          | `union`           |                                                                                                             |
| `component?`        | `ReactNode`       | **Deprecated.**                                                                                             |
| `tabMode?`          | `union`           | **Deprecated.**                                                                                             |
| `tabs?`             | `union`           | **Deprecated.**                                                                                             |
