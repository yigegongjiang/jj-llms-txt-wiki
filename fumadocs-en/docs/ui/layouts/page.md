...
| ------------ | ----------------------------------- | ---------------------------------------------------- |
| `container?` | `DetailedHTMLProps<object, object>` |                                                      |
| `header?`    | `ReactNode`                         | Custom content in TOC container, before the main TOC |
| `footer?`    | `ReactNode`                         | Custom content in TOC container, after the main TOC  |
| `style?`     | `union`                             |                                                      |
| `list?`      | `union`                             |                                                      |
...
| Prop     | Type     | Description                                                |
| -------- | -------- | ---------------------------------------------------------- |
| `items?` | `object` | Items including information for the next and previous page |
...
| Prop                | Type    | Description                                                              |
| ------------------- | ------- | ------------------------------------------------------------------------ |
| `includeRoot?`      | `union` | Include the root folders in the breadcrumb items array. Default: `false` |
| `includePage?`      | `union` | Include the page itself in the breadcrumb items array Default: `false`   |
| `includeSeparator?` | `union` | Count separator as an item Default: `false`                              |
