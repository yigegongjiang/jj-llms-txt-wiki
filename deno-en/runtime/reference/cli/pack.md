...
> Create an npm tarball from a Deno project for publishing to npm
...
- [Publishing modules](/runtime/packages/publishing/) — overview of where
  Deno-authored libraries can be published
