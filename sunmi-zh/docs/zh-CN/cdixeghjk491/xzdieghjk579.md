---
url: https://docs.sunmi.com/zh-CN/cdixeghjk491/xzdieghjk579
---

# 设备应用参数推送参数详情
更新时间：2026-05-28 17:44:46
# **接口说明**
> 设备应用版本参数推送任务详情
# 使用限制
...
| 名称  | 描述  |  
| --- | --- |  
| HTTP URL  | https://openapi.sunmi.com/v2/fin/params/open/device/push/detail  |  
| HTTP Method  | POST  |  
# 请求头  
| 字段名称  | 类型  | 是否必填  | 示例  | 描述  |  
| --- | --- | --- | --- | --- |  
...
```
curl --http1.1 -X POST 'https://openapi.sunmi.com/v2/fin/params/open/device/push/detail' 
