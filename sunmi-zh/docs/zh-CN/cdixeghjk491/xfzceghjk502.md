---
url: https://docs.sunmi.com/zh-CN/cdixeghjk491/xfzceghjk502
---

# T1双屏通信接口文档（仅适用于T1设备）
更新时间：2025-11-10 15:56:05
# 关键类说明
**包 sunmi.ds**   
...
<— **包 sunmi.ds.data** *_DataPacket类：封装了发送数据和发送回调，调用DSKernel类的sendData(DataPacket pack)函数时需要的参数实体类。_** _DataPacket.Builder类：DataPacket的builder类。_** Builder(DSData.DataType dataType)说明：构造函数。   
...
上一篇：T1 自定义副显程序开发（仅适用于T1设备）
下一篇：自定义客显程序开发说明（仅适用于T1设备）
