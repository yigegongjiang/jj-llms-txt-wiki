---
url: https://docs.sunmi.com/zh-CN/cdixeghjk491/xzdfeghjk535
---

# 设备应用参数删除
更新时间：2026-05-28 17:50:51
# **接口说明**
> 删除指定设备指定应用版本的参数
# 使用限制
...
| 名称  | 描述  |  
| --- | --- |  
| HTTP URL  | https://openapi.sunmi.com/v2/fin/params/open/device/delete  |  
| HTTP Method  | POST  |  
# 请求头  
| 字段名称  | 类型  | 是否必填  | 示例  | 描述  |  
| --- | --- | --- | --- | --- |  
...
```
curl --http1.1 -X POST 'https://openapi.sunmi.com/v2/fin/params/open/device/delete' 
