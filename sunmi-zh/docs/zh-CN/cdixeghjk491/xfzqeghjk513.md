---
url: https://docs.sunmi.com/zh-CN/cdixeghjk491/xfzqeghjk513
---

# 16、云打印机macOS SDK
更新时间：2025-12-19 22:52:03
本功能仅支持以下机型和版本：
...
如需升级请联系客服！
# 概述
本⽂档主要介绍如何通过商米提供的 SDK 快速使用商⽶云打印机。
# SDK DEMO 介绍
DEMO for macOS 下载
![](data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M4.5%203C4.5%201.61929%205.61929%200.5%207%200.5C8.38071%200.5%209.5%201.61929%209.5%203V12C9.5%2012.8284%208.82843%2013.5%208%2013.5C7.17157%2013.5%206.5%2012.8284%206.5%2012V5C6.5%204.72386%206.72386%204.5%207%204.5C7.27614%204.5%207.5%204.72386%207.5%205V12C7.5%2012.2761%207.72386%2012.5%208%2012.5C8.27614%2012.5%208.5%2012.2761%208.5%2012V3C8.5%202.17157%207.82843%201.5%207%201.5C6.17157%201.5%205.5%202.17157%205.5%203V12C5.5%2013.3807%206.61929%2014.5%208%2014.5C9.38071%2014.5%2010.5%2013.3807%2010.5%2012V5C10.5%204.72386%2010.7239%204.5%2011%204.5C11.2761%204.5%2011.5%204.72386%2011.5%205V12C11.5%2013.933%209.933%2015.5%208%2015.5C6.067%2015.5%204.5%2013.933%204.5%2012V3Z'%20fill='black'/%3e%3c/svg%3e) MacOSApp.zip 
## 1、DEMO 使用蓝牙连接
  1. 打开 DEMO，进入首页
...
![](https://cdn.sunmi.com/public/image/mgt-document/39e0803c6285439cb6fcba93bc3d3337.png)
  1. 点击 【Add Ble】进入蓝牙打印机搜索页面


  

![](https://cdn.sunmi.com/public/image/mgt-document/7ba2824c78ab4913989002e4b70eeffd.png)
  1. 连接指定的打印机，连接成功返回首页


  

![](https://cdn.sunmi.com/public/image/mgt-document/0eb5c576f4024ac7a32354cd922ac3c2.png)
## 2、DEMO 使用局域网连接
确保云打印机与 Mac 电脑连接在同一 Wi-Fi 下，点击【Add IP】进入云打印机搜索页面
  

![](https://cdn.sunmi.com/public/image/mgt-document/d3241d18539a476f983bb2459933066c.png)
## 3、DEMO 使用Wi-Fi 配网
点击【Wi-Fi Setting】进入wifi配置网络界面
  

![](https://cdn.sunmi.com/public/image/mgt-document/df15411215e84a21bbc123d8bd16a353.png)
# SDK 快速入门
  1. 云打印机 SDK for macos 下载


![](data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M4.5%203C4.5%201.61929%205.61929%200.5%207%200.5C8.38071%200.5%209.5%201.61929%209.5%203V12C9.5%2012.8284%208.82843%2013.5%208%2013.5C7.17157%2013.5%206.5%2012.8284%206.5%2012V5C6.5%204.72386%206.72386%204.5%207%204.5C7.27614%204.5%207.5%204.72386%207.5%205V12C7.5%2012.2761%207.72386%2012.5%208%2012.5C8.27614%2012.5%208.5%2012.2761%208.5%2012V3C8.5%202.17157%207.82843%201.5%207%201.5C6.17157%201.5%205.5%202.17157%205.5%203V12C5.5%2013.3807%206.61929%2014.5%208%2014.5C9.38071%2014.5%2010.5%2013.3807%2010.5%2012V5C10.5%204.72386%2010.7239%204.5%2011%204.5C11.2761%204.5%2011.5%204.72386%2011.5%205V12C11.5%2013.933%209.933%2015.5%208%2015.5C6.067%2015.5%204.5%2013.933%204.5%2012V3Z'%20fill='black'/%3e%3c/svg%3e) SunmiPrinterMacOS.framework.zip 
  1. 目前 SDK 只支持手动集成
  2. 将 SunmiPrinterMacOS 导入到 Xcode 工程目录下
  3. 在需要使用 API 的类中添加 `#import <SunmiPrinterMacOS/SunmiPrinterMacOS.h` 头文件
  4. 使用蓝牙打印机，需要在 info.plist 中添加两个蓝牙权限
...
# SDK 说明
  1. 此 SDK 需要在 macOS 10.13及以上上使用；
  2. SDK 包含搜索蓝牙打印机、连接，局域网打印机搜索、连接，Wi-Fi 配网模块模块以及提供了方便开发者调用打印机的指令的接口方法；
  3. 为了便于开发者使用，提供了 demo 用于开发者调试；
  4. 开发环境 macos（10.13及以上）、Xcode。
...
| - (**void**)searchCloudPrinter;  | 搜索蓝牙打印机  |  
| - (**void**)stopSearch;  | 停止蓝牙搜索  |  
| - (**void**)connectPeripheral:(CBPeripheral * **_Nonnull**)peripheral;  | 建立蓝牙打印机设备的连接  |  
| - (**void**)disConnectPeripheral;  | 主动断开和蓝牙打印机设备的连接  |  
...
> receivedDeviceDataBlock数据回调的说明 1. taskNumber：打印机最近一个打印任务的编号，发送获取打印机最近一个打印任务的编号时返回编号，否则为nil 2. deviceSN：打印机sn，发送获取打印机SN指令会返回打印机sn编号，否则为 nil 3. printerStatus：打印机状态，发送获取打印机状态会返回打印机状态枚举值，否则返回 -1  
| 打印机状态枚举值  | 类型  | 说明  |  
| --- | --- | --- |  
| SMPrinterStatus_Printing  | NSInteger  | 1  |  
| SMPrinterStatus_NoPaper  | NSInteger  | 2  |  
| SMPrinterStatus_RollIsExhausted  | NSInteger  | 3  |  
| SMPrinterStatus_PaperJam  | NSInteger  | 4  |  
| SMPrinterStatus_NoPaperPickup  | NSInteger  | 5  |  
| SMPrinterStatus_CoverOpened  | NSInteger  | 6  |  
| SMPrinterStatus_HeadOverheating  | NSInteger  | 7  |  
| SMPrinterStatus_MotorOverheating  | NSInteger  | 8  |  
## 协议列表  
| 方法  | 说明  |  
| --- | --- |  
| - (**void**)discoveredDevice:(SunmiBlePrinterModel * **_Nonnull**)device;  | 当搜索到设备时，会执行代理方法，可以在此协议方法中获取扫描到的设备，会执行多次，直到搜索结束  |  
| - (**void**)didFinishedSearching;  | 停止搜索之后，执行代理方法，在此代理方法中做其他逻辑处理  |  
...
| deviceMode  | NSString  | 设备mode  |  
| deviceSN  | NSString  | 设备的 SN 号  |  
...
| 方法  | 说明  |  
| --- | --- |  
| - (void)startSearchPrinterWithIp:(NSString *)searchPrinter;  | 搜索 IP 打印机设备, 指定ip 搜索，不传默认搜索所有  |  
| - (void)connectSocketWithIP:(NSString *)ip completeBlock:(IPConnectDeviceBlock)completeBlock;  | 传入设备的 IP 地址，尝试连接设备，并返回回调结果  |  
| - (**void**)deviceDisConnectWithBlock:(**void**(^)(NSError *error))block;  | 设备连接断开了并返回错误信息  |  
| - (**BOOL**)isConnectedIPService;  | 当前 IP 地址打印机是否连接  |  
| - (**void**)disConnectIPService;  | 主动断开和 IP 地址打印机的连接  |  
| - (**void**)controlDevicePrintingData:(NSData *)ipData;  | 向设备发送打印数据  |  
| - (**void**)sendSuccess:(sendIPDeviceDataSuccessBlock)block;  | 发送数据成功的回调  |  
| - (**void**)sendFail:(sendIPDeviceDataFailBlock)block;  | 发送数据失败的回调  |  
| - (**void**)receivedDeviceData:(receivedIPDeviceDataBlock)block;  | 接收数据的回调  |  
...
| 方法  | 说明  |  
| --- | --- |  
| - (**void**)discoverIPPrinter:(SunmiIpPrinterModel *)printerModel;  | 当搜索到设备时，会执行代理方法，可以在此协议方法中获取扫描到的设备，会执行多次，直到搜索结束  |  
...
| **参数名**  | **类型**  | **说明**  |  
| --- | --- | --- |  
| deviceSN  | NSString  | 通过设备的 SN，让设备进入自动配网模式  |  
# Wi-Fi 配网模块
Wifi 配网时，需要长按配网键进入配网模式，否则设置无法成功。
## 开始扫描
  * **扫描设备**
...
| **实例方法**  | **说明**  |  
| --- | --- |  
| - (void)searchCloudPrinter;  | 扫描蓝牙打印机设备  |  
当扫描到设备时，会执行协议方法：  
| **协议方法**  | **说明**  |  
| --- | --- |  
...
| **实例方法**  | **说明**  |  
| --- | --- |  
| - (void)stopSearch;  | 停止扫描蓝牙打印机设备  |  
停止扫描之后，会执行协议方法：  
| **协议方法**  | **说明**  |  
| --- | --- |  
| - (void)didFinishedSearching;  | 停止扫描之后，可以在此协议方法中做其他逻辑处理  |  
## 连接打印机设备
  * **连接设备**
...
| **实例方法**  | **说明**  |  
| --- | --- |  
| - (**void**)startPrinterWifi:(NSString * **_Nullable**)deviceSN;  | 通过SN，自动进入配网模式。自动和手动进入配网同时存在，两种模式选择一种即可  |  
| **参数名**  | **类型**  | **说明**  |  
| --- | --- | --- |  
| deviceSN  | NSString  | 打印机的 SN 编号  |  
发送指令后，进入配网模式成功会执行以下协议方法：  
| 协议方法  | 说明  |  
| --- | --- |  
| - (**void**)didEnterNetworkMode;  | 已经进入配网模式，在这里进行下一步处理  |  
## 获取打印机搜索到的WIFI列表
  * **获取Wi-Fi列表**
...
| **实例方法**  | **说明**  |  
| --- | --- |  
| - (void)searchPrinterWifiList;  | 向蓝牙打印机发送获取Wi-Fi列表的指令  |  
接收到Wi-Fi信息后，会执行协议方法：  
| **协议方法**  | **说明**  |  
| --- | --- |  
...
| **协议方法**  | **说明**  |  
| --- | --- |  
| - (void)didReceivedWifiListCompleted;  | Wi-Fi网络信息接收完毕，会执行此协议方法  |  
如果接收Wi-Fi信息失败，会执行协议方法：  
| **协议方法**  | **说明**  |  
| --- | --- |  
| - (void)didFailedToReceiveWifiInformation;  | 接收失败，在此协议方法内可做其他的自定义处理  |  
...
| **实例方法**  | **说明**  |  
| --- | --- |  
| - (void)setPrinterWifi:(NSString *_Nonnull)ssid password:(NSString * _Nullable)password;  | 发送Wi-Fi的网络的ssid和password给蓝牙打印机，为蓝牙打印机配置网络  |  
等待配网结果，会执行协议方法：  
| **协议方法**  | **说明**  |  
| --- | --- |  
| - (void)willStartConfigPrinterWifi;  | 可配置网络的命令已经发给蓝牙打印机，以在此协议方法内加入超时机制  |  
蓝牙打印机配网成功，会执行协议方法：  
| **协议方法**  | **说明**  |  
| --- | --- |  
| - (void)configPrinterWifiSuccessed;  | 配网成功，可以在此协议方法内做后续操作  |  
配网成功，向蓝牙打印机发送通知  
| **实例方法**  | **说明**  |  
| --- | --- |  
...
| **协议方法**  | **说明**  |  
| --- | --- |  
| - (void)configPrinterWifiFailed;  | 配网失败，可以在此协议方法内做后续其他操作  |  
  * **删除网络配置**

  
| **实例方法**  | **说明**  |  
| --- | --- |  
| - (void)deletePrinterWifiSetting;  | 向蓝牙打印机发送删除 wifi 配置的指令  |  
## 退出配网模式  
| **实例方法**  | **说明**  |  
| --- | --- |  
| - (void)exitPrinterWifiSetting;  | 向蓝牙打印机发送退出配网模式的指令  |  
上一篇：15、云打印机Android SDK
下一篇：17、云打印机macOS驱动
