---
url: https://docs.sunmi.com/zh-CN/cdixeghjk491/xfxxeghjk491
---

# Flutter 指令集打印接口
更新时间：2025-09-24 18:36:55
### **1.功能介绍**
...
```
Uint8List esc = Uint8List.fromList([0x1B, 0x61, 0x01]);
commandApi?.sendEscCommand(esc);
```
...
```
Uint8List tspl = Uint8List.fromList(utf8.encode("SIZE 100 100"));
commandApi?.sendTsplCommand(tspl);
```

上一篇：Flutter 打印标签小票接口
下一篇：Flutter 打印机查询接口
