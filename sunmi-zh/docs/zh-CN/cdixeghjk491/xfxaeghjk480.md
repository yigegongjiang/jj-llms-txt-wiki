---
url: https://docs.sunmi.com/zh-CN/cdixeghjk491/xfxaeghjk480
---

# Flutter 打印标签小票接口
更新时间：2025-09-24 18:36:19
### **1.功能介绍**
...
```
PrinterSdk.instance.startSettings(SettingItem.TYPE);
```
...
| setAlign  | 设置文本内容相对起始坐标的位置  | 见[Align](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih22y3oq38sffcf)  | Align.DEFAUL  |  
...
| setAlign  | 设置条码相对起始坐标位置  | 见[Align](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih22y3oq38sffcf)  | Align.DEFAUL  |  
...
| setWidth  |  设置图形的宽度  形状为线段时无效    
形状为圆形时表示圆形直径  | 单位像素  | 50  |  
| setHeight  |  设置图形的高度  形状为线段时无效    
形状为圆形时无效  | 单位像素  | 50  |  
...
| 枚举内容  | 说明  | 参考浮动值  |  
| --- | --- | --- |  
| BINARIZATION  | 二值化算法  |  二值化算法通过调整浮动值将转换不同彩色值为黑色  可根据图片颜色信息选择一般浮动值200  |  
