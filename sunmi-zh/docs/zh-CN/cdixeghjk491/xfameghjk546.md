---
url: https://docs.sunmi.com/zh-CN/cdixeghjk491/xfameghjk546
---

# Flutter 打印热敏小票接口
更新时间：2025-09-24 18:32:50
### **1.功能介绍**
...
| setWidth  |  设置行内可打印区域宽度    
 |  可设置最大范围为纸张宽度减去左边距  当可设置范围超出时仅设置最大值  | 打印机纸张宽度  |  
| setHeight  | 设置每行高度  |  行高范围在0~255像素  当行高小于打印内容时以行内最大高度内容为准  | 默认行高0像素  |  
| setAlign  | 设置之后每行的对齐方式  | 见[Align](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih22y3oq38sffcf)  | 左对齐  |  
| setRenderColor  | 设置颜色  | 见[RenderColor](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih2fw2ie016qzc)  | 默认黑色  |  
...
设置自定义字体需要指定字体的名称，且字体需位于调用app的assets目录中供打印服务使用外接非商米打印机字由打印机提供无法设置自定义字体
由于文本内容大小和位置均可以自由控制，所以**setPosY、setWidth、setHeight、setAlign** 在行打印文本时不可用
###### **示例**
bash c cpp csharp css go java javascript json kotlin less makefile markdown objectivec php plaintext python rust scss shell sql swift typescript xml yaml

```
lineApi?.addText("test1", printer.TextStyle.getStyle());
lineApi?.addText("test2", printer.TextStyle.getStyle());
lineApi?.printText("test3", printer.TextStyle.getStyle());
```
...
###### List<int>**colsWidthArr 说明**
每一列占一行的比例大小，如 [1, 1] 时将按1：1平分每列打印区域
###### List<TextStyle>**styles 说明**
每列打印内容的样式设置
...
| setReadable  | 设置HRI位置  | [见HumanReadable](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih27u77ibfe40ok)  | 不展示  |  
| setSymbology  | 设置条码类型  | 见[Symbology](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih29oz8470qrr28)  | code128  |  
| setAlign  | 设置条码行内对齐方式  | 见[Align](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih22y3oq38sffcf)  | 居左  |  
| setWidth  | 生成条码指定缩放宽度  | 当设置缩放宽度后将强制改变码内容大小  | 不缩放  |  
| setHeight  | 生成条码指定缩放高度  | 当设置缩放高度后将强制改变码内容大小  | 不缩放  |  
setWidth()和setHeight()自定义条码大小需要打印服务**6.0.0**以上版本支持（打印服务版本可通过设备中硬件管家查看）
...
| setErrorLevel  | 设置二维码纠错等级  | 见[ErrorLevel](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih2b0sgp0v2rvnyg)  | ErrorLevel.L  |  
| setAlign  | 设置二维码行内对齐方式  | 见[Align](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih22y3oq38sffcf)  | 居左  |  
...
| 可用方法  | 方法说明  | 参数说明  | 默认值  |  
| --- | --- | --- | --- |  
| setAlgorithm  | 设置图片转换方式  | 见[ImageAlgorithm](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih2d5h6g1mm62nj)  | ImageAlgorithm.BINARIZATION  |  
| setValue  | 设置额外参数  | 根据图片转换算法可能需要设置相应的参数  | [见ImageAlgorithm](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih2d5h6g1mm62nj)  |  
| setAlign  | 设置图片行内对齐方式  | 见[Align](https://alidocs.dingtalk.com/i/nodes/Gl6Pm2Db8D3xlw5aUnwMZe4rJxLq0Ee4?utm_scene=team_space&iframeQuery=anchorId%3Duu_mel8ih22y3oq38sffcf)  | 居左  |  
