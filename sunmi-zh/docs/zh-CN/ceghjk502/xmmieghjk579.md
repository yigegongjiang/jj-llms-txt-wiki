---
url: https://docs.sunmi.com/zh-CN/ceghjk502/xmmieghjk579
---

# V3H
更新时间：2026-05-22 12:11:06
## **1、V3H产品介绍**  
...
| V3H |  
| --- |  
|  **认证型号** T5F1A  |  **处理器** 高通八核处理器，最高 2.4GHz  |  **操作系统** 商米 OS (Based on Android 13 64bit)  |  **内存** 4GB+64GB  |  **显示屏** 6.75"HD+，720 * 1600，IPS  |  
 |  
|  **触摸屏** 电容多点式触摸  |  **打印机** 高速58热敏打印,最高打印速度80mm/s， 支持50mm直径打印卷纸 支持热敏小票 支持标签打印  |  **按键** 电源键， 音量键， 扫码键*2(可选）  |  **SIM卡槽** 1*Nano SIM card  |  **PSAM卡槽** 2*PSAM  |  
 |  
|  **eSIM** 支持  |  **SD卡槽** Micro SD card  |  **接口** USB接口，Type-C 支持 OTG  |  **网络** 4G/3G/2G  |  **Wi-Fi** 2.4GHz/5GHz,Support IEEE 802.11 a/b/g/n/ac  |  
 |  
|  **蓝牙** 支持2.1/3.0/4.2/4.0, BLE  |  **GPS** GPS/Glonass/Beidou/Galileo   
 |  **摄像头** 后摄：5MP自动对焦+闪光灯，支持1D/2D 条码识别(8M可选配) 前摄：2MP FF(可选)  |  **扫码头** 选配激光扫码头  |  **NFC** 选配  |  
 |  
|  **指纹** 选配  |  **音频** 扬声器 95dB 无麦克风  |  **电池** 可拆卸电池锂电池 7.7V 3100mAh  |  **Pogo Pin** 6 Pin 扩展 USB接口  |  **电源适配器** 输入：AC 100-240V 输出：5V/2A  |  
 |  
|  **尺寸** 238 _81.8_ 16.8mm  |  **重量** 419克(带电池)  |  **工作环境** 工作温度：-10°C-50°C 存储温度：-20°C-60°C  |  **配件(可选)** 扩展底座 硅胶保护套 屏幕保护膜 挂绳 手带  |   
 |  
 |  
