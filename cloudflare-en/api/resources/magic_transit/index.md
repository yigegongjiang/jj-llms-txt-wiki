...
- `result: object { interconnects }`
  ...
  - `interconnects: optional array of object { id, automatic_return_routing, bgp, 12 more }`
...
- `result: object { modified, modified_interconnects }`
  ...
  - `modified_interconnects: optional array of object { id, automatic_return_routing, bgp, 12 more }`
...
- `result: array of object { submitted_at, reboot, restart, 2 more }`
...
### Interrupt List Response

- `InterruptListResponse object { submitted_at, reboot, restart, 2 more }`
...
### Interrupt Create Response

- `InterruptCreateResponse object { submitted_at, reboot, restart, 2 more }`
