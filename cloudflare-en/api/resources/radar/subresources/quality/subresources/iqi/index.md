...
- `interpolation: optional boolean`
...
```http
curl https://api.cloudflare.com/client/v4/radar/quality/iqi/timeseries_groups \
    -H "Authorization: Bearer $CLOUDFLARE_API_TOKEN"
```
...
### IQI Timeseries Groups Response
