...
- `origin: array of "AMAZON" or "GOOGLE" or "MICROSOFT" or "ORACLE"`
...
```http
curl https://api.cloudflare.com/client/v4/radar/origins/timeseries \
    -H "Authorization: Bearer $CLOUDFLARE_API_TOKEN"
```
