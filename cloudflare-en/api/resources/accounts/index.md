...
```http
curl https://api.cloudflare.com/client/v4/$ACCOUNTS_OR_ZONES/$ACCOUNT_OR_ZONE_ID/subscriptions \
...
- `result: array of object { id, account, action, 4 more }`
...
### Audit Product Categories Response
