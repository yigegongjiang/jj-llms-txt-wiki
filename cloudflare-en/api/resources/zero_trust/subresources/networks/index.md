...
- `subnet_types: optional "cloudflare_source" or "initial_resolved_ip" or "warp"`
...
- `result: object { id, capacity, comment, 6 more }`
...
Returns the account's default Initial Resolved IP Subnet for the given address family.
...
Updates the CIDR for the account's default Initial Resolved IP Subnet of the given address
