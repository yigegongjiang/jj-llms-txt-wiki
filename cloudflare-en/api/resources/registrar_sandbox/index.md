...
### Registrar Sandbox Search Response
...
### Registrar Sandbox Check Response
...
- `result: object { completed, created_at, links, 4 more }`
...
- `result: array of object { auto_renew, created_at, domain_name, 4 more }`
...
- `result: object { auto_renew, created_at, domain_name, 4 more }`
...
```http
curl https://api.cloudflare.com/client/v4/accounts/$ACCOUNT_ID/registrar-sandbox/registrations/$DOMAIN_NAME \
    -H "Authorization: Bearer $CLOUDFLARE_API_TOKEN"
```
...
### Registration Status Get Response
...
```http
curl https://api.cloudflare.com/client/v4/accounts/$ACCOUNT_ID/registrar-sandbox/registrations/$DOMAIN_NAME/update-status \
    -H "Authorization: Bearer $CLOUDFLARE_API_TOKEN"
```
