...
- `result: array of Project`
  ...
  - `canonical_deployment: Deployment`
    ...
    - `skip_reason: optional "commit_message" or "preview_deployments_disabled" or "production_deployments_disabled" or 3 more`
...
- `Deployment object { id, aliases, build_config, 15 more }`
