...
- `result: array of object { id, cert_id, hostname, 4 more }`
...
- `result: object { id, cert_id, hostname, 4 more }`
...
- `DomainListResponse object { id, cert_id, hostname, 4 more }`
...
- `DomainGetResponse object { id, cert_id, hostname, 4 more }`
...
- `DomainUpdateResponse object { id, cert_id, hostname, 4 more }`
