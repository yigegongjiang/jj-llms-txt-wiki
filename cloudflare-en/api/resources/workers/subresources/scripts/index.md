...
- `result: array of object { id, cache_options, compatibility_date, 21 more }`
...
- `result: object { resources, id, exports_reconciliation, 3 more }`
...
- `result: object { annotations, bindings, cache_options, 12 more }`
