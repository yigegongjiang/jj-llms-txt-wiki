...
- `result: array of LoadBalancer`
  ...
  - `pool_sets: optional array of object { disabled, fixed_response, match, 2 more }`
    ...
    - `overrides: optional object { fallback_pool, pool_default_weight, pool_weights, 2 more }`
      ...
      - `pool_default_weight: optional number`
  ...
  - `rules: optional array of Rules`
    ...
    - `overrides: optional object { adaptive_routing, country_pools, default_pools, 13 more }`
...
## Create account or zone Load Balancer
...
## Update account or zone Load Balancer
...
## Patch account or zone Load Balancer
...
## Delete account or zone Load Balancer
...
- `LoadBalancer object { id, adaptive_routing, country_pools, 21 more }`
...
- `Pool object { id, check_regions, created_on, 17 more }`
