...
- `result: optional array of object { id, ca, certificates, 7 more }`
...
- `result: optional object { id, ca, certificates, 7 more }`
...
### MTLS Certificate List Response

- `MTLSCertificateListResponse object { id, ca, certificates, 7 more }`
...
### MTLS Certificate Get Response

- `MTLSCertificateGetResponse object { id, ca, certificates, 7 more }`
...
### MTLS Certificate Delete Response

- `MTLSCertificateDeleteResponse object { id, ca, certificates, 7 more }`
