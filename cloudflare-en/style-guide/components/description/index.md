...
Last updated Jun 18, 2026|Copy as Markdown|[View as Markdown](https://developers.cloudflare.com/style-guide/components/description/index.md)|[Agent setup](https://developers.cloudflare.com/agent-setup/)

The `Description` component is used `103` times on `103` pages.
