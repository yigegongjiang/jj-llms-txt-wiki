...
Last updated Jul 22, 2026|Copy as Markdown|[View as Markdown](https://developers.cloudflare.com/style-guide/frontmatter/custom-properties/index.md)|[Agent setup](https://developers.cloudflare.com/agent-setup/)
...
The `description` field is a Nimbus built-in, not a custom property, but it is required for all pages with a `pcx_content_type`. For writing guidance, refer to [Writing a description](https://developers.cloudflare.com/style-guide/frontmatter/#writing-a-description).
...
```json
{"@context":"https://schema.org","@type":"TechArticle","@id":"https://developers.cloudflare.com/style-guide/frontmatter/custom-properties/#page","headline":"Custom properties · Cloudflare Style Guide","description":"Configure custom frontmatter properties.","url":"https://developers.cloudflare.com/style-guide/frontmatter/custom-properties/","inLanguage":"en","image":"https://developers.cloudflare.com/og-docs.png","dateModified":"2026-07-22","publisher":{"@type":"Organization","name":"Cloudflare","url":"https://www.cloudflare.com/"},"isPartOf":{"@type":"WebSite","@id":"https://developers.cloudflare.com/#website","name":"Cloudflare Docs","url":"https://developers.cloudflare.com/"}}
```
