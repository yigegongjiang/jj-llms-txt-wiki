---
description: Follow writing best practices for Cloudflare docs.
...
Last updated Apr 24, 2026|Copy as Markdown|[View as Markdown](https://developers.cloudflare.com/style-guide/documentation-content-strategy/writing-guidelines/index.md)|[Agent setup](https://developers.cloudflare.com/agent-setup/)
...
Every page with a `pcx_content_type` must include a `description` in its frontmatter. The description populates the `<meta name="description">` tag, which search engines and AI systems use to decide whether to surface or cite a page.
...
For detailed guidance and examples, refer to [Writing a description](https://developers.cloudflare.com/style-guide/frontmatter/#writing-a-description).
...
```json
{"@context":"https://schema.org","@type":"TechArticle","@id":"https://developers.cloudflare.com/style-guide/documentation-content-strategy/writing-guidelines/#page","headline":"Writing guidelines · Cloudflare Style Guide","description":"Follow writing best practices for Cloudflare docs.","url":"https://developers.cloudflare.com/style-guide/documentation-content-strategy/writing-guidelines/","inLanguage":"en","image":"https://developers.cloudflare.com/og-docs.png","dateModified":"2026-04-24","publisher":{"@type":"Organization","name":"Cloudflare","url":"https://www.cloudflare.com/"},"isPartOf":{"@type":"WebSite","@id":"https://developers.cloudflare.com/#website","name":"Cloudflare Docs","url":"https://developers.cloudflare.com/"}}
```
