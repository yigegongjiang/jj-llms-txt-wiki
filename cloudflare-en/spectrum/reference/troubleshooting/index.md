...
Common use case: Citrix Gateway / VDI
...
For more details on this limitation, refer to [Spectrum Limitations](https://developers.cloudflare.com/spectrum/reference/limitations/).
...
Refer to [Edge TLS Termination](https://developers.cloudflare.com/spectrum/reference/configuration-options/#edge-tls-termination) for more details.
...
2. If using **Full (Strict)**, ensure the origin certificate is issued by a publicly trusted CA or a [Cloudflare Origin CA certificate](https://developers.cloudflare.com/ssl/origin-configuration/origin-ca/).
...
For the full status code table, refer to [Event logs](https://developers.cloudflare.com/spectrum/reference/logs/).
