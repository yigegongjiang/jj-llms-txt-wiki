...
Last updated Jun 25, 2026|Copy as Markdown|[View as Markdown](https://developers.cloudflare.com/d1/tutorials/using-read-replication-for-e-com/index.md)|[Agent setup](https://developers.cloudflare.com/agent-setup/)
...
To test it locally, you can set `"remote" : true` in the D1 binding configuration. Refer to the [remote bindings documentation](https://developers.cloudflare.com/workers/local-development/#remote-bindings) for more information.
