...
Some rules belong to the [read-only category](https://developers.cloudflare.com/ddos-protection/managed-rulesets/http/rule-categories/) and cannot have their sensitivity level or action adjusted via override. If you are unable to modify the rule causing the false positive, [contact Cloudflare Support](https://developers.cloudflare.com/support/contacting-cloudflare-support/) for assistance.
