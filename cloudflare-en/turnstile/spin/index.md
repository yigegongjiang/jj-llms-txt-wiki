...
For Cloudflare Pages projects, the agent wires siteverify inside a Pages Function, or recommends the [Pages Plugin for Turnstile](https://developers.cloudflare.com/pages/functions/plugins/turnstile/) when you'd rather use a built-in plugin than write the call yourself.
