...
Refer to the [Troubleshooting Domain control validation (DCV)](https://developers.cloudflare.com/ssl/edge-certificates/changing-dcv-method/troubleshooting/) article for more details.
