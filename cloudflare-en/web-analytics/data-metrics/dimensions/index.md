...
| Soft Navigation         | N/A        | The visitor clicked a link or submitted a form but JavaScript intercepted the navigation and made a client-side update instead. Measured via [the native Soft Navigation API ↗](https://developer.chrome.com/docs/web-platform/soft-navigations).                                                                                                                            |
| Routing APIs            | N/A        | The visitor clicked a link or submitted a form but JavaScript intercepted the navigation and made a client-side update instead. Measured via [the Navigation API ↗](https://developer.mozilla.org/en-US/docs/Web/API/Navigation%5FAPI) or [the History API ↗](https://developer.mozilla.org/en-US/docs/Web/API/History%5FAPI) when the Soft Navigation API is not supported. |
