...
Last updated May 7, 2026|Copy as Markdown|[View as Markdown](https://developers.cloudflare.com/magic-transit/analytics/query-tunnel-health/index.md)|[Agent setup](https://developers.cloudflare.com/agent-setup/)
