...
Use `this.ctx.container.exec()` to start another process inside a running Container. Refer to [Execute commands](https://developers.cloudflare.com/containers/execute-commands/) for startup, streaming, output, and process-control examples.
