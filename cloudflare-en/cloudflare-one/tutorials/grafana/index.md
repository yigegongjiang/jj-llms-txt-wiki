...
Last updated Apr 17, 2026|Copy as Markdown|[View as Markdown](https://developers.cloudflare.com/cloudflare-one/tutorials/grafana/index.md)|[Agent setup](https://developers.cloudflare.com/agent-setup/)
...
![Grafana dashboard showing a tunnel metrics graph](https://developers.cloudflare.com/cdn-cgi/image/onerror=redirect,width=2268,height=1872,format=webp/_astro/Grafana-dashboard.Bz0eyO9h.png) 
