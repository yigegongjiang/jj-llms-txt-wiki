...
![Finding the Build Command and publish Directory fields](https://developers.cloudflare.com/cdn-cgi/image/onerror=redirect,width=1454,height=1044,format=webp/_astro/netlify-build-command.DH5kCyI8.png) 
